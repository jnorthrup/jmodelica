...
class Test_Compile_Load:
    ...
    def test_load_FMU_VS2017(self):
        ...
        try:
            ...
            name = compile_fmu("Modelica.Mechanics.Rotational.Examples.CoupledClutches", compile_to="CC.fmu", compiler_options={"c_compiler":"gcc", "target_platforms":"win64"})
...
#        cl = Test_Compiler_functions.cpath_mc 
#        path = Test_Compiler_functions.fpath_mc
#        pym.compile_fmu(cl, path, compiler_options={"target_platforms":"win64"})
#
#    @testattr(windows_base = True)
...
#        cl = Test_Compiler_functions.cpath_mc 
#        path = Test_Compiler_functions.fpath_mc
#        pym.compile_fmu(cl, path, version='2.0', compiler_options={"target_platforms":"win64"})
#
#    @testattr(windows_base = True)
...
#        cl = Test_Compiler_functions.cpath_mc 
#        path = Test_Compiler_functions.fpath_mc
#        pym.compile_fmu(cl, path, target='cs', compiler_options={"target_platforms":"win64"})
#
#    @testattr(windows_base = True)
...
#        cl = Test_Compiler_functions.cpath_mc 
#        path = Test_Compiler_functions.fpath_mc
#        pym.compile_fmu(cl, path, target='cs', version='2.0', compiler_options={"target_platforms":"win64"})
