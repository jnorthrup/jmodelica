 ...
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\ast\\FlatModelica.ast:801
 * @astdecl FSubExp : FDotSubExp;
 * @production FSubExp : {@link FDotSubExp};

 */
public class FSubExp extends FDotSubExp implements Cloneable {
    /**
     * @aspect InheritedFactoryMethods
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:917
     */
    public FSubExp createEmptyNode()       { return new FSubExp();       }
    /**
    ...
    public FSubExp(FExp p0, FExp p1) {
        setChild(p0, 0);
        setChild(p1, 1);
    }
    /** @apilevel low-level 
     ...
     */
    public FSubExp clone() throws CloneNotSupportedException {
        FSubExp node = (FSubExp) super.clone();
        return node;
    }
    /** @apilevel internal 
     ...
     */
    public FSubExp treeCopyNoTransform() {
        FSubExp tree = (FSubExp) copy();
        if (children != null) {
    ...
    public FType type() {
        ...
        type_value = getLeft().type().numericPromotion(getRight().type(), false, operatorName());
    ...
    public FExp convertToAddition() {
        FExp convertToAddition_value = new FAddExp(getLeft(), getRight().makeNegated());
