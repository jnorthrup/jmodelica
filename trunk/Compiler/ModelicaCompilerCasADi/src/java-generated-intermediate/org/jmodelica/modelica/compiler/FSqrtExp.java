 ...
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\ast\\FlatModelica.ast:1370
 * @astdecl FSqrtExp : FMathematicalFunctionCall;
 * @production FSqrtExp : {@link FMathematicalFunctionCall};

 */
public class FSqrtExp extends FMathematicalFunctionCall implements Cloneable {
    /**
     * @aspect InheritedFactoryMethods
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:1027
     */
    public FSqrtExp createEmptyNode()         { return new FSqrtExp();         }
    /**
     * @aspect InheritedFactoryMethods
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:1387
     */
    public FSqrtExp(FExp a1)                    { this(emptyArgs(), a1); }
    /**
     * @aspect Derivatives
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaMiddleEnd\\src\\jastadd\\structural\\Differentiation.jrag:381
     */
    @Override
    ...
    public FSqrtExp(List<InstFunctionArgument> p0, FExp p1) {
        setChild(p0, 0);
        setChild(p1, 1);
    }
    /** @apilevel low-level 
     ...
     */
    public FSqrtExp clone() throws CloneNotSupportedException {
        FSqrtExp node = (FSqrtExp) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:47
     */
    public FSqrtExp copy() {
        try {
            FSqrtExp node = (FSqrtExp) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    public FSqrtExp treeCopyNoTransform() {
        FSqrtExp tree = (FSqrtExp) copy();
        if (children != null) {
    ...
    public CValue cevalCalc(VariableEvaluator evaluator) {
        CValue cevalCalc_VariableEvaluator_value = new CValueReal(StrictMath.sqrt(getFExp().ceval(evaluator).realValue()));
    ...
    public MX toMX() {
        MX toMX_value = getFExp().toMX().sqrt();
        return toMX_value;
    }
    /** @apilevel internal */
