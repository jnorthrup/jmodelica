...
/**
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\ast\\Modelica.ast:264
 * @astdecl SrcIfClause : SrcIfWhenClause;
 * @production SrcIfClause : {@link SrcIfWhenClause};

 */
public class SrcIfClause extends SrcIfWhenClause implements Cloneable {
    /**
     * @aspect InstantiatedExpressions
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\flattening\\Flattening.jrag:3084
     */
    protected FIfClause instantiateIfWhenClause(FExp t, List l) {
    ...
    public SrcIfClause(SrcExp p0, List<SrcStatement> p1) {
        setChild(p0, 0);
        setChild(p1, 1);
    }
    /** @apilevel low-level 
     ...
     */
    public SrcIfClause clone() throws CloneNotSupportedException {
        SrcIfClause node = (SrcIfClause) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:47
     */
    public SrcIfClause copy() {
        try {
            SrcIfClause node = (SrcIfClause) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    public SrcIfClause treeCopyNoTransform() {
        SrcIfClause tree = (SrcIfClause) copy();
        if (children != null) {
