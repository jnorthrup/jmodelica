...
/**
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\ast\\Modelica.ast:287
 * @astdecl SrcRealLitExp : SrcExp ::= <UNSIGNED_NUMBER:String>;
 * @production SrcRealLitExp : {@link SrcExp} ::= <span class="component">&lt;UNSIGNED_NUMBER:String&gt;</span>;

 */
public class SrcRealLitExp extends SrcExp implements Cloneable {
    /**
     * Constructs a real literal expression from a double.
     * @aspect Constructors
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:48
     */
    public SrcRealLitExp(double val) {
		this(String.valueOf(val));
	}
    /**
     * @aspect PrettyPrint
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\PrettyPrint.jrag:820
     */
     ...
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\flattening\\Flattening.jrag:3267
     */
    ...
    public SrcRealLitExp(String p0) {
        setUNSIGNED_NUMBER(p0);
    }
    /**
     * @declaredat ASTNode:20
     */
    public SrcRealLitExp(beaver.Symbol p0) {
        setUNSIGNED_NUMBER(p0);
    }
    /** @apilevel low-level 
     ...
     */
    public SrcRealLitExp clone() throws CloneNotSupportedException {
        SrcRealLitExp node = (SrcRealLitExp) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:47
     */
    public SrcRealLitExp copy() {
        try {
            SrcRealLitExp node = (SrcRealLitExp) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    public SrcRealLitExp treeCopyNoTransform() {
        SrcRealLitExp tree = (SrcRealLitExp) copy();
        if (children != null) {
    ...
    protected boolean is$Equal(ASTNode node) {
        return super.is$Equal(node) && (tokenString_UNSIGNED_NUMBER == ((SrcRealLitExp) node).tokenString_UNSIGNED_NUMBER);    
    }
    /**
     ...
     * @apilevel internal
     */
    public void setUNSIGNED_NUMBER(beaver.Symbol symbol) {
