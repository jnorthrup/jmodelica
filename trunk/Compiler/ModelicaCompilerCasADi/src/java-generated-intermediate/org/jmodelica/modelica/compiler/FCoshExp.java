 ...
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\ast\\FlatModelica.ast:1465
 * @astdecl FCoshExp : FMathematicalFunctionCall;
 * @production FCoshExp : {@link FMathematicalFunctionCall};

 */
public class FCoshExp extends FMathematicalFunctionCall implements Cloneable {
    /**
     * @aspect InheritedFactoryMethods
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:1016
     */
    public FCoshExp createEmptyNode()  { return new FCoshExp();  }
    /**
     * @aspect InheritedFactoryMethods
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:1396
     */
    public FCoshExp(FExp a1)                    { this(emptyArgs(), a1); }
    /**
     * @aspect Derivatives
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaMiddleEnd\\src\\jastadd\\structural\\Differentiation.jrag:357
     */
    @Override
     ...
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaCBackEnd\\src\\jastadd\\CCodeGen\\CCodeGenExpressions.jrag:549
     */
    @Override
    ...
    public FCoshExp(List<InstFunctionArgument> p0, FExp p1) {
        setChild(p0, 0);
        setChild(p1, 1);
    }
    /** @apilevel low-level 
     ...
     */
    public FCoshExp clone() throws CloneNotSupportedException {
        FCoshExp node = (FCoshExp) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:47
     */
    public FCoshExp copy() {
        try {
            FCoshExp node = (FCoshExp) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    public FCoshExp treeCopyNoTransform() {
        FCoshExp tree = (FCoshExp) copy();
        if (children != null) {
    ...
    public CValue cevalCalc(VariableEvaluator evaluator) {
        CValue cevalCalc_VariableEvaluator_value = new CValueReal(StrictMath.cosh(getFExp().ceval(evaluator).realValue()));
    ...
    public MX toMX() {
        MX toMX_value = getFExp().toMX().cosh();
        return toMX_value;
    }
    /** @apilevel internal */
