...
/**
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\ast\\InstanceTree.ast:88
 * @astdecl InstImport : BaseNode ::= PackageName:InstAccess <SrcImportClause:SrcImportClause>;
 * @production InstImport : {@link BaseNode} ::= <span class="component">PackageName:{@link InstAccess}</span> <span class="component">&lt;SrcImportClause:SrcImportClause&gt;</span>;

 */
public abstract class InstImport extends BaseNode implements Cloneable {
    /**
     * @aspect InstanceErrorCheck
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\errorcheck\\ErrorCheck.jrag:833
     */
    ...
    public InstImport(InstAccess p0, SrcImportClause p1) {
        setChild(p0, 0);
    ...
    /** @apilevel internal 
     */
    protected SrcImportClause tokenSrcImportClause_SrcImportClause;
    /**
     ...
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\instance\\InstLookupClasses.jrag:614
     */
    @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
    @ASTNodeAnnotation.Source(aspect="InstLookupImport", declaredAt="C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\instance\\InstLookupClasses.jrag:614")
    ...
    public Kind Define_kind(ASTNode _callerNode, ASTNode _childNode) {
        if (_callerNode == getPackageNameNoTransform()) {
            // @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\instance\\InstNameClassification.jrag:107
