...
/**
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\ast\\Modelica.ast:187
 * @astdecl SrcEnumComponentClause : SrcComponentClause;
 * @production SrcEnumComponentClause : {@link SrcComponentClause};

 */
public class SrcEnumComponentClause extends SrcComponentClause implements Cloneable {
    /**
     * @declaredat ASTNode:1
     */
    public SrcEnumComponentClause() {
        super();
    }
    /**
    ...
    public SrcEnumComponentClause(boolean p0, boolean p1, boolean p2, boolean p3, boolean p4, Opt<SrcTypePrefixFlow> p5, Opt<SrcTypePrefixVariability> p6, Opt<SrcTypePrefixInputOutput> p7, SrcAccess p8, Opt<SrcArraySubscripts> p9, List<SrcComponentDecl> p10, Opt<SrcConstrainingClause> p11, SrcComment p12) {
        setRedeclare(p0);
        setFinal(p1);
        setInner(p2);
        setOuter(p3);
     ...
     */
    public SrcEnumComponentClause clone() throws CloneNotSupportedException {
        SrcEnumComponentClause node = (SrcEnumComponentClause) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:63
     */
    public SrcEnumComponentClause copy() {
        try {
            SrcEnumComponentClause node = (SrcEnumComponentClause) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    @Deprecated
    public SrcEnumComponentClause fullCopy() {
     ...
     */
    public SrcEnumComponentClause treeCopyNoTransform() {
        SrcEnumComponentClause tree = (SrcEnumComponentClause) copy();
        if (children != null) {
     ...
     */
    public SrcEnumComponentClause treeCopy() {
        doFullTraversal();
        return treeCopyNoTransform();
    }
    /** @apilevel internal 
    ...
    protected boolean is$Equal(ASTNode node) {
        return super.is$Equal(node) && (tokenboolean_Redeclare == ((SrcEnumComponentClause) node).tokenboolean_Redeclare) && (tokenboolean_Final == ((SrcEnumComponentClause) node).tokenboolean_Final) && (tokenboolean_Inner == ((SrcEnumComponentClause) node).tokenboolean_Inner) && (tokenboolean_Outer == ((SrcEnumComponentClause) node).tokenboolean_Outer) && (tokenboolean_Replaceable == ((SrcEnumComponentClause) node).tokenboolean_Replaceable);    
    }
    /**
