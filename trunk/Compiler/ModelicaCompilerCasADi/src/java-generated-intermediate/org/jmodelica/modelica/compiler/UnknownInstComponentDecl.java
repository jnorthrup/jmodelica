...
/**
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\ast\\InstanceTree.ast:118
 * @astdecl UnknownInstComponentDecl : InstComponentDecl;
 * @production UnknownInstComponentDecl : {@link InstComponentDecl};

 */
public class UnknownInstComponentDecl extends InstComponentDecl implements Cloneable {
    /**
     * @declaredat ASTNode:1
     */
    public UnknownInstComponentDecl() {
        super();
    }
    /**
    ...
    public UnknownInstComponentDecl(String p0, InstAccess p1, Opt<FArraySubscripts> p2, SrcComponentDecl p3, Opt<InstModification> p4, Opt<InstConstrainingComponent> p5, Opt<FExp> p6) {
        setName(p0);
        setChild(p1, 0);
        setChild(p2, 1);
     ...
     */
    public UnknownInstComponentDecl(beaver.Symbol p0, InstAccess p1, Opt<FArraySubscripts> p2, SrcComponentDecl p3, Opt<InstModification> p4, Opt<InstConstrainingComponent> p5, Opt<FExp> p6) {
        setName(p0);
        setChild(p1, 0);
        setChild(p2, 1);
        setSrcComponentDecl(p3);
     ...
     */
    public UnknownInstComponentDecl clone() throws CloneNotSupportedException {
        UnknownInstComponentDecl node = (UnknownInstComponentDecl) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:74
     */
    public UnknownInstComponentDecl copy() {
        try {
            UnknownInstComponentDecl node = (UnknownInstComponentDecl) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    @Deprecated
    public UnknownInstComponentDecl fullCopy() {
     ...
     */
    public UnknownInstComponentDecl treeCopyNoTransform() {
        UnknownInstComponentDecl tree = (UnknownInstComponentDecl) copy();
        if (children != null) {
     ...
     */
    public UnknownInstComponentDecl treeCopy() {
        doFullTraversal();
        return treeCopyNoTransform();
    }
    /** @apilevel internal 
    ...
    protected boolean is$Equal(ASTNode node) {
        return super.is$Equal(node) && (tokenString_Name == ((UnknownInstComponentDecl) node).tokenString_Name) && (tokenSrcComponentDecl_SrcComponentDecl == ((UnknownInstComponentDecl) node).tokenSrcComponentDecl_SrcComponentDecl);    
    }
    /**
