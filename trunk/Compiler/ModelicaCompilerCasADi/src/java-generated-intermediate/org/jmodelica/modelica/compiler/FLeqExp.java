 ...
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\ast\\FlatModelica.ast:856
 * @astdecl FLeqExp : FRelExp;
 * @production FLeqExp : {@link FRelExp};

 */
public class FLeqExp extends FRelExp implements Cloneable {
    /**
     * @aspect InheritedFactoryMethods
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:931
     */
    public FLeqExp createEmptyNode() { return new FLeqExp(); }
    /**
     * @aspect InheritedFactoryMethods
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:1425
     */
    public FLeqExp(FExp e1, FExp e2) { this(e1, e2, new Opt<FExp>(), (String) null); }
    /**
    ...
    public FLeqExp(FExp p0, FExp p1, Opt<FExp> p2, String p3) {
        setChild(p0, 0);
        setChild(p1, 1);
        setChild(p2, 2);
     ...
     */
    public FLeqExp(FExp p0, FExp p1, Opt<FExp> p2, beaver.Symbol p3) {
        setChild(p0, 0);
        setChild(p1, 1);
        setChild(p2, 2);
        setIndicatorVarName(p3);
     ...
     */
    public FLeqExp clone() throws CloneNotSupportedException {
        FLeqExp node = (FLeqExp) super.clone();
        return node;
    }
    /** @apilevel internal 
     ...
     */
    public FLeqExp treeCopyNoTransform() {
        FLeqExp tree = (FLeqExp) copy();
        if (children != null) {
    ...
    protected boolean is$Equal(ASTNode node) {
        return super.is$Equal(node) && (tokenString_IndicatorVarName == ((FLeqExp) node).tokenString_IndicatorVarName);    
    }
    /**
    ...
    public CValue cevalEval(CValue left, CValue right) {
        CValue cevalEval_CValue_CValue_value = cevalType().leq(left, right);
    ...
    public String operatorName() {
        String operatorName_value = OP_LEQ;
    ...
    public String kindString() {
        String kindString_value = FRelExp.LEQ_C;
    ...
    public String kindStringPhased() {
        String kindStringPhased_value = FRelExp.LT_C;
    ...
    public String macro_C() {
        String macro_C_value = "COND_EXP_LE";
    ...
    public boolean isPhased_sub() {
        boolean isPhased_sub_value = getLeft() instanceof FTimeExp;
    ...
    public MX toMX() {
        MX toMX_value = getLeft().toMX().__le__(getRight().toMX());
        return toMX_value;
    }
    /** @apilevel internal */
