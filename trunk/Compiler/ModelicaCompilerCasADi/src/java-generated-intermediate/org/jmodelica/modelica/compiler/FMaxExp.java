 ...
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\ast\\FlatModelica.ast:1605
 * @astdecl FMaxExp : FMinMaxExp;
...
public class FMaxExp extends FMinMaxExp implements Cloneable {
     ...
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:1050
     */
    public FMaxExp createEmptyNode()          { return new FMaxExp();          }
    /**
     * @aspect InheritedFactoryMethods
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:1409
     */
    public FMaxExp(FExp a1,   Opt<FExp> a2)      { this(emptyArgs(), a1, a2); }
    /**
    ...
    public FMaxExp(List<InstFunctionArgument> p0, FExp p1, Opt<FExp> p2) {
        setChild(p0, 0);
        setChild(p1, 1);
        setChild(p2, 2);
    }
    ...
    public FExp scalarReduceExp(FExp reducer, FExp scalar) {
        FExp scalarReduceExp_FExp_FExp_value = new FIfExp(new FGtExp(reducer, scalar.treeCopy()), reducer.treeCopy(), scalar.treeCopy());
    ...
    public MX toMX() {
        MX toMX_value = getX().toMX().fmax(getY().toMX());
        return toMX_value;
    }
    /** @apilevel internal */
