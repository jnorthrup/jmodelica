 ...
 * And expression.
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\ast\\FlatModelica.ast:901
 * @astdecl FAndExp : FLogBinExp;
 * @production FAndExp : {@link FLogBinExp};

 */
public class FAndExp extends FLogBinExp implements Cloneable {
    /**
     * @aspect InheritedFactoryMethods
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:938
     */
    public FAndExp createEmptyNode() { return new FAndExp(); }
    /**
     * @aspect CCodeGenExpressions
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaCBackEnd\\src\\jastadd\\CCodeGen\\CCodeGenExpressions.jrag:1197
     */
    public static String macro_C = "LOG_EXP_AND";
    /**
    ...
    public FAndExp(FExp p0, FExp p1) {
        setChild(p0, 0);
        setChild(p1, 1);
    }
    /** @apilevel low-level 
     ...
     */
    public FAndExp clone() throws CloneNotSupportedException {
        FAndExp node = (FAndExp) super.clone();
        return node;
    }
    /** @apilevel internal 
     ...
     */
    public FAndExp treeCopyNoTransform() {
        FAndExp tree = (FAndExp) copy();
        if (children != null) {
    ...
    public CValue cevalEval(CValue left, CValue right) {
        CValue cevalEval_CValue_CValue_value = type().and(left, right);
    ...
    public Precedence precedence() {
        Precedence precedence_value = Precedence.LOGICAL_AND;
    ...
    public String operatorName() {
        String operatorName_value = OP_AND;
    ...
    public String macro_C() {
        String macro_C_value = FAndExp.macro_C;
    ...
    public MX toMX() {
        MX toMX_value = getLeft().toMX().logic_and(getRight().toMX());
        return toMX_value;
    }
    /**
    ...
    public boolean Define_hasBrancher(ASTNode _callerNode, ASTNode _childNode) {
        if (_callerNode == getRightNoTransform()) {
            // @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaCBackEnd\\src\\jastadd\\CCodeGen\\CCodeGen.jrag:588
            return true;
        }
        else if (_callerNode == getLeftNoTransform()) {
            // @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaCBackEnd\\src\\jastadd\\CCodeGen\\CCodeGen.jrag:587
            return isIndicatorGuard(getLeft()) || hasBrancher();
        }
        else {
