 ...
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\ast\\FlatModelica.ast:1410
 * @astdecl FCeilFuncExp : FEventGenExp;
 * @production FCeilFuncExp : {@link FEventGenExp};

 */
public class FCeilFuncExp extends FEventGenExp implements Cloneable {
    /**
     * @aspect InheritedFactoryMethods
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:1033
     */
    public FCeilFuncExp createEmptyNode()     { return new FCeilFuncExp();     }
    /**
     * @aspect Derivatives
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaMiddleEnd\\src\\jastadd\\structural\\Differentiation.jrag:667
     */
    @Override
     ...
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaCBackEnd\\src\\jastadd\\CCodeGen\\CCodeGenExpressions.jrag:91
     */
    @Override
    ...
    public FCeilFuncExp(List<InstFunctionArgument> p0, FExp p1) {
        setChild(p0, 0);
        setChild(p1, 1);
    }
    /** @apilevel low-level 
     ...
     */
    public FCeilFuncExp clone() throws CloneNotSupportedException {
        FCeilFuncExp node = (FCeilFuncExp) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:47
     */
    public FCeilFuncExp copy() {
        try {
            FCeilFuncExp node = (FCeilFuncExp) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    public FCeilFuncExp treeCopyNoTransform() {
        FCeilFuncExp tree = (FCeilFuncExp) copy();
        if (children != null) {
    ...
    public CValue cevalCalc(VariableEvaluator evaluator) {
        CValue cevalCalc_VariableEvaluator_value = type().ceil(getX().ceval(evaluator));
