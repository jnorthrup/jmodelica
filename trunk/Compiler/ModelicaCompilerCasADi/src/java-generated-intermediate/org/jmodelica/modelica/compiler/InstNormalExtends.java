...
/**
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\ast\\InstanceTree.ast:147
 * @astdecl InstNormalExtends : InstExtends ::= [InstClassModification];
 * @production InstNormalExtends : {@link InstExtends} ::= <span class="component">[{@link InstClassModification}]</span>;

 */
public class InstNormalExtends extends InstExtends implements Cloneable {
    /**
     * @declaredat ASTNode:1
     */
    public InstNormalExtends() {
        super();
    }
    /**
    ...
    @ASTNodeAnnotation.Constructor(
        name = {"ClassName", "SrcExtendsClause", "InstClassModification"},
        type = {"InstAccess", "SrcExtendsClause", "Opt<InstClassModification>"},
        kind = {"Child", "Token", "Opt"}
    )
    public InstNormalExtends(InstAccess p0, SrcExtendsClause p1, Opt<InstClassModification> p2) {
        setChild(p0, 0);
     ...
     */
    public InstNormalExtends clone() throws CloneNotSupportedException {
        InstNormalExtends node = (InstNormalExtends) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:58
     */
    public InstNormalExtends copy() {
        try {
            InstNormalExtends node = (InstNormalExtends) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    @Deprecated
    public InstNormalExtends fullCopy() {
     ...
     */
    public InstNormalExtends treeCopyNoTransform() {
        InstNormalExtends tree = (InstNormalExtends) copy();
        if (children != null) {
     ...
     */
    public InstNormalExtends treeCopy() {
        doFullTraversal();
        return treeCopyNoTransform();
    }
    /** @apilevel internal 
    ...
    protected boolean is$Equal(ASTNode node) {
        return super.is$Equal(node) && (tokenSrcExtendsClause_SrcExtendsClause == ((InstNormalExtends) node).tokenSrcExtendsClause_SrcExtendsClause);    
    }
    /**
    ...
    public boolean Define_inFunction(ASTNode _callerNode, ASTNode _childNode) {
        if (_callerNode == getInstClassModificationOptNoTransform()) {
            ...
            return extendsInFunction();
        }
        else {
            return getParent().Define_inFunction(this, _callerNode);
        }
    }
    /**
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\FlatUtil.jrag:1409
    ...
    public InstLookupResult<InstClassDecl> Define_lookupInstClass(ASTNode _callerNode, ASTNode _childNode, String name) {
        if (_callerNode == getInstClassModificationOptNoTransform()) {
            // @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\instance\\InstLookupClasses.jrag:66
            return lookupInstClassFromMod(name);
        }
        else {
    ...
    public InstLookupResult<InstClassDecl> Define_lookupInstClassInInstElement(ASTNode _callerNode, ASTNode _childNode, String name) {
        if (_callerNode == getInstClassModificationOptNoTransform()) {
            // @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\instance\\InstLookupClasses.jrag:651
    ...
    public InstLookupResult<InstComponentDecl> Define_lookupInstComponent(ASTNode _callerNode, ASTNode _childNode, String name) {
        if (_callerNode == getInstClassModificationOptNoTransform()) {
            // @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\instance\\InstLookupComponents.jrag:341
    ...
    public InstLookupResult<InstComponentDecl> Define_lookupInstComponentInInstElement(ASTNode _callerNode, ASTNode _childNode, String name) {
        if (_callerNode == getInstClassModificationOptNoTransform()) {
            // @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\instance\\InstLookupComponents.jrag:758
