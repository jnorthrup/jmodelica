...
/**
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\ast\\Modelica.ast:95
 * @astdecl SrcUnknownClassDecl : SrcFullClassDecl;
 * @production SrcUnknownClassDecl : {@link SrcFullClassDecl};

 */
public class SrcUnknownClassDecl extends SrcFullClassDecl implements Cloneable {
    /**
     * @declaredat ASTNode:1
     */
    public SrcUnknownClassDecl() {
        super();
    }
    /**
    ...
    public SrcUnknownClassDecl(SrcIdDecl p0, boolean p1, boolean p2, SrcRestriction p3, boolean p4, boolean p5, boolean p6, boolean p7, boolean p8, Opt<SrcConstrainingClause> p9, Opt<SrcComment> p10, Opt<SrcStringComment> p11, List<SrcClause> p12, Opt<SrcExternalClause> p13, Opt<SrcAnnotation> p14, SrcEndDecl p15) {
        setChild(p0, 0);
        setEncapsulated(p1);
        setPartial(p2);
        setChild(p3, 1);
     ...
     */
    public SrcUnknownClassDecl clone() throws CloneNotSupportedException {
        SrcUnknownClassDecl node = (SrcUnknownClassDecl) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:67
     */
    public SrcUnknownClassDecl copy() {
        try {
            SrcUnknownClassDecl node = (SrcUnknownClassDecl) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    @Deprecated
    public SrcUnknownClassDecl fullCopy() {
     ...
     */
    public SrcUnknownClassDecl treeCopyNoTransform() {
        SrcUnknownClassDecl tree = (SrcUnknownClassDecl) copy();
        if (children != null) {
     ...
     */
    public SrcUnknownClassDecl treeCopy() {
        doFullTraversal();
        return treeCopyNoTransform();
    }
    /** @apilevel internal 
    ...
    protected boolean is$Equal(ASTNode node) {
        return super.is$Equal(node) && (tokenboolean_Encapsulated == ((SrcUnknownClassDecl) node).tokenboolean_Encapsulated) && (tokenboolean_Partial == ((SrcUnknownClassDecl) node).tokenboolean_Partial) && (tokenboolean_Redeclare == ((SrcUnknownClassDecl) node).tokenboolean_Redeclare) && (tokenboolean_Final == ((SrcUnknownClassDecl) node).tokenboolean_Final) && (tokenboolean_Inner == ((SrcUnknownClassDecl) node).tokenboolean_Inner) && (tokenboolean_Outer == ((SrcUnknownClassDecl) node).tokenboolean_Outer) && (tokenboolean_Replaceable == ((SrcUnknownClassDecl) node).tokenboolean_Replaceable);    
    }
    /**
    ...
    public SrcUnknownClassDecl unknownClassDecl() {
        SrcUnknownClassDecl unknownClassDecl_value = this;
    ...
    public ResolvedAccess simpleLookupMemberScope(String name) {
        ...
        ResolvedAccess simpleLookupMemberScope_String_value = unknownAccess();
