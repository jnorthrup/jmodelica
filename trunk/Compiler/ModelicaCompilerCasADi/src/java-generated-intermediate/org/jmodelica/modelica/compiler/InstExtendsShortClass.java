...
/**
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\ast\\InstanceTree.ast:148
 * @astdecl InstExtendsShortClass : InstNormalExtends ::= <LookupNode:InstNode>;
 * @production InstExtendsShortClass : {@link InstNormalExtends} ::= <span class="component">&lt;LookupNode:InstNode&gt;</span>;

 */
public class InstExtendsShortClass extends InstNormalExtends implements Cloneable {
    /**
     * @aspect ContentCheck
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\errorcheck\\ContentsCheck.jadd:165
     */
     ...
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\instance\\InstanceTree.jrag:1159
     */
    ...
    /**
     * @aspect InstanceTreeConstruction
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\instance\\InstanceTree.jrag:1205
     */
    ...
    @ASTNodeAnnotation.Constructor(
        name = {"ClassName", "SrcExtendsClause", "InstClassModification", "LookupNode"},
        type = {"InstAccess", "SrcExtendsClause", "Opt<InstClassModification>", "InstNode"},
        kind = {"Child", "Token", "Opt", "Token"}
    )
    public InstExtendsShortClass(InstAccess p0, SrcExtendsClause p1, Opt<InstClassModification> p2, InstNode p3) {
        setChild(p0, 0);
     ...
     */
    public InstExtendsShortClass clone() throws CloneNotSupportedException {
        InstExtendsShortClass node = (InstExtendsShortClass) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:60
     */
    public InstExtendsShortClass copy() {
        try {
            InstExtendsShortClass node = (InstExtendsShortClass) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    @Deprecated
    public InstExtendsShortClass fullCopy() {
     ...
     */
    public InstExtendsShortClass treeCopyNoTransform() {
        InstExtendsShortClass tree = (InstExtendsShortClass) copy();
        if (children != null) {
     ...
     */
    public InstExtendsShortClass treeCopy() {
        doFullTraversal();
        return treeCopyNoTransform();
    }
    /** @apilevel internal 
    ...
    protected boolean is$Equal(ASTNode node) {
        return super.is$Equal(node) && (tokenSrcExtendsClause_SrcExtendsClause == ((InstExtendsShortClass) node).tokenSrcExtendsClause_SrcExtendsClause) && (tokenInstNode_LookupNode == ((InstExtendsShortClass) node).tokenInstNode_LookupNode);    
    }
    /**
     ...
     * @apilevel high-level
     */
    public void setLookupNode(InstNode value) {
        tokenInstNode_LookupNode = value;
    }
    /** @apilevel internal 
     */
    protected InstNode tokenInstNode_LookupNode;
    /**
    ...
    public InstNode getLookupNode() {
        return tokenInstNode_LookupNode;
    }
    /**
     ...
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\instance\\InstLookupClasses.jrag:127
     */
    @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.INH)
    @ASTNodeAnnotation.Source(aspect="InstLookupClasses", declaredAt="C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\instance\\InstLookupClasses.jrag:127")
    ...
    public InstLookupResult<InstClassDecl> Define_lookupInstClass(ASTNode _callerNode, ASTNode _childNode, String name) {
        if (_callerNode == getClassNameNoTransform()) {
            // @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\instance\\InstLookupClasses.jrag:82
            return lookupInstClassInChain(name);
        }
        else if (_callerNode == getInstClassModificationOptNoTransform()) {
            // @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\instance\\InstLookupClasses.jrag:81
            return getLookupNode().lookupInstClass(name);
        }
        else {
    ...
    public InstLookupResult<InstClassDecl> Define_lookupInstClassInChain(ASTNode _callerNode, ASTNode _childNode, String name) {
        if (_callerNode == getInstExtendsListNoTransform()) {
            // @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\instance\\InstLookupClasses.jrag:143
            int childIndex = _callerNode.getIndexOfChild(_childNode);
            return myInstClass().superLookupInstClassFromChain(name);
        }
        else {
            return super.Define_lookupInstClassInChain(_callerNode, _childNode, name);
        }
    }
    /**
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\instance\\InstLookupClasses.jrag:128
    ...
    public InstLookupResult<InstClassDecl> Define_lookupRedeclareExtendsInstClass(ASTNode _callerNode, ASTNode _childNode, String name) {
        if (_callerNode == getInstExtendsListNoTransform()) {
            // @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\instance\\InstLookupClasses.jrag:174
            int childIndex = _callerNode.getIndexOfChild(_childNode);
    ...
    public InstLookupResult<InstComponentDecl> Define_lookupInstComponent(ASTNode _callerNode, ASTNode _childNode, String name) {
        if (_callerNode == getInstClassModificationOptNoTransform()) {
            // @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\instance\\InstLookupComponents.jrag:342
            return getLookupNode().lookupInstComponent(name);
        }
        else {
