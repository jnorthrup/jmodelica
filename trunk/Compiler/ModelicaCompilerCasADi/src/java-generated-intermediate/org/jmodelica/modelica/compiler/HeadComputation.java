 ...
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaCBackEnd\\src\\jastadd\\CCodeGen\\CCodeGenFunction.jrag:41
 */
public class HeadComputation extends java.lang.Object implements IOComputation {
    ...
    public void prettyPrintHead(FFunctionDecl fd, CodePrinter p, CodeStream str, String indent, 
            String suffix, boolean returnArgs) {
        prettyPrintHead(fd, fd, p, str, indent, suffix, returnArgs);
    }

    public void prettyPrintHead(FFunctionDecl caller, FFunctionDecl called, CodePrinter p, 
