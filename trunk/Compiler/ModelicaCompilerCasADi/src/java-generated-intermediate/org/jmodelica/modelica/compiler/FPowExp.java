 ...
 * Power expression.
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\ast\\FlatModelica.ast:831
 * @astdecl FPowExp : FDotPowExp;
...
public class FPowExp extends FDotPowExp implements Cloneable {
     ...
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:920
     */
    public FPowExp createEmptyNode()       { return new FPowExp();       }
    /**
     * @aspect ComplianceCheck
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\errorcheck\\ComplianceCheck.jadd:255
     */
    ...
    public boolean canBuildArrayFromChild() {
        boolean canBuildArrayFromChild_value = isArray() && getRight().ceval().intValue() == 1;
    ...
    public FExp childToBuildArray() {
        FExp childToBuildArray_value = getLeft();
    ...
    private ArrayExp getArrayExp_compute() {
            ...
            if (e < 1) {
                return new FIdentity(new FIntegerLitExp(size().get(0))).getArrayExp();
            }
            if (e == 1) {
                /* Handled in getArray() */
            ...
            FType type = type();
            for (; e > 1; e--) {
                ArrayExp cur = new ArrayExp(indices());
                for (Index i : cur.indices()) {
                    Iterator<FExp> left = (res == null ? base : res).leftMulIterator(i);
