...
/**
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\ast\\Modelica.ast:223
 * @astdecl SrcArgument : SrcModification ::= <Each:boolean> <Final:boolean>;
 * @production SrcArgument : {@link SrcModification} ::= <span class="component">&lt;Each:boolean&gt;</span> <span class="component">&lt;Final:boolean&gt;</span>;

 */
public abstract class SrcArgument extends SrcModification implements Cloneable {
    /**
    ...
    public SrcArgument(boolean p0, boolean p1) {
        setEach(p0);
        setFinal(p1);
    }
    /** @apilevel low-level 
     ...
     */
    public SrcArgument clone() throws CloneNotSupportedException {
        SrcArgument node = (SrcArgument) super.clone();
        return node;
    }
    /**
     ...
     */
    @Deprecated
    public abstract SrcArgument fullCopy();
    /**
     * Create a deep copy of the AST subtree at this node.
     * The copy is dangling, i.e. has no parent.
     * @return dangling copy of the subtree at this node
     ...
     */
    public abstract SrcArgument treeCopyNoTransform();
    /**
     * Create a deep copy of the AST subtree at this node.
     ...
     */
    public abstract SrcArgument treeCopy();
    /**
    ...
    public boolean isFinal() {
        boolean isFinal_value = getFinal();
