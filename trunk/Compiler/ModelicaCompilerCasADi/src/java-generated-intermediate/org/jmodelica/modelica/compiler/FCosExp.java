 ...
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\ast\\FlatModelica.ast:1430
 * @astdecl FCosExp : FMathematicalFunctionCall;
 * @production FCosExp : {@link FMathematicalFunctionCall};

 */
public class FCosExp extends FMathematicalFunctionCall implements Cloneable {
    /**
     * @aspect InheritedFactoryMethods
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:1009
     */
    public FCosExp createEmptyNode()   { return new FCosExp();   }
    /**
     * @aspect InheritedFactoryMethods
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:1395
     */
    public FCosExp(FExp a1)                      { this(emptyArgs(), a1); }
    /**
     * @aspect Derivatives
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaMiddleEnd\\src\\jastadd\\structural\\Differentiation.jrag:281
     */
    @Override
    ...
    public FCosExp(List<InstFunctionArgument> p0, FExp p1) {
        setChild(p0, 0);
        setChild(p1, 1);
    }
    /** @apilevel low-level 
     ...
     */
    public FCosExp clone() throws CloneNotSupportedException {
        FCosExp node = (FCosExp) super.clone();
        return node;
    }
    /** @apilevel internal 
     ...
     */
    public FCosExp treeCopyNoTransform() {
        FCosExp tree = (FCosExp) copy();
        if (children != null) {
    ...
    public CValue cevalCalc(VariableEvaluator evaluator) {
        CValue cevalCalc_VariableEvaluator_value = new CValueReal(StrictMath.cos(getFExp().ceval(evaluator).realValue()));
    ...
    public MX toMX() {
        MX toMX_value = getFExp().toMX().cos();
        return toMX_value;
    }
    /** @apilevel internal */
