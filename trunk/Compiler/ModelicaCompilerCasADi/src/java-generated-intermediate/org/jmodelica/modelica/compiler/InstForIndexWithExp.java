...
/**
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\ast\\InstanceTree.ast:169
 * @astdecl InstForIndexWithExp : InstForIndex ::= FExp;
 * @production InstForIndexWithExp : {@link InstForIndex} ::= <span class="component">{@link FExp}</span>;

 */
public class InstForIndexWithExp extends InstForIndex implements Cloneable {
    /**
     * @aspect ConstantEvaluation
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\ConstantEvaluation\\ConstantEvaluation.jrag:2245
     */
    @Override
     ...
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\errorcheck\\ComplianceCheck.jadd:245
     */
     ...
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\errorcheck\\TypeCheck.jrag:928
     */
    ...
    @ASTNodeAnnotation.Constructor(
        name = {"InstPrimitive", "FExp"},
        type = {"InstForIndexPrimitive", "FExp"},
        kind = {"Child", "Child"}
    )
    public InstForIndexWithExp(InstForIndexPrimitive p0, FExp p1) {
        setChild(p0, 0);
        setChild(p1, 1);
    }
    /** @apilevel low-level 
     ...
     */
    public InstForIndexWithExp clone() throws CloneNotSupportedException {
        InstForIndexWithExp node = (InstForIndexWithExp) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:46
     */
    public InstForIndexWithExp copy() {
        try {
            InstForIndexWithExp node = (InstForIndexWithExp) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    @Deprecated
    public InstForIndexWithExp fullCopy() {
     ...
     */
    public InstForIndexWithExp treeCopyNoTransform() {
        InstForIndexWithExp tree = (InstForIndexWithExp) copy();
        if (children != null) {
     ...
     */
    public InstForIndexWithExp treeCopy() {
        doFullTraversal();
        return treeCopyNoTransform();
    }
    /** @apilevel internal 
    ...
    public FType Define_myInstForIndexType(ASTNode _callerNode, ASTNode _childNode) {
        if (_callerNode == getInstPrimitiveNoTransform()) {
            // @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\instance\\InstTypeAnalysis.jrag:68
