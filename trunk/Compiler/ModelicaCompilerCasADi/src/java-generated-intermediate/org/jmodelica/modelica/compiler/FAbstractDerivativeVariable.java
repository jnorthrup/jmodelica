 ...
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\ast\\FlatModelica.ast:206
 * @astdecl FAbstractDerivativeVariable : FRealVariable ::= <Order:int>;
 * @production FAbstractDerivativeVariable : {@link FRealVariable} ::= <span class="component">&lt;Order:int&gt;</span>;

 */
public abstract class FAbstractDerivativeVariable extends FRealVariable implements Cloneable {
    /**
     * @declaredat ASTNode:1
     */
    public FAbstractDerivativeVariable() {
        super();
    }
    /**
    ...
    public FAbstractDerivativeVariable(VisibilityType p0, TypePrefixVariability p1, TypePrefixInputOutput p2, List<FAttribute> p3, String p4, Opt<FExp> p5, Opt<FStringComment> p6, FAccess p7, int p8) {
     ...
     */
    public FAbstractDerivativeVariable(VisibilityType p0, TypePrefixVariability p1, TypePrefixInputOutput p2, List<FAttribute> p3, beaver.Symbol p4, Opt<FExp> p5, Opt<FStringComment> p6, FAccess p7, int p8) {
        setVisibilityType(p0);
        setTypePrefixVariability(p1);
        setTypePrefixInputOutput(p2);
        setChild(p3, 0);
     ...
     */
    public FAbstractDerivativeVariable clone() throws CloneNotSupportedException {
        FAbstractDerivativeVariable node = (FAbstractDerivativeVariable) super.clone();
        return node;
    }
    /**
     ...
     */
    @Deprecated
    public abstract FAbstractDerivativeVariable fullCopy();
    /**
     * Create a deep copy of the AST subtree at this node.
     * The copy is dangling, i.e. has no parent.
     * @return dangling copy of the subtree at this node
     ...
     */
    public abstract FAbstractDerivativeVariable treeCopyNoTransform();
    /**
     * Create a deep copy of the AST subtree at this node.
     ...
     */
    public abstract FAbstractDerivativeVariable treeCopy();
    /**
    ...
    public boolean isAbstractDerivativeVariable() {
        boolean isAbstractDerivativeVariable_value = true;
    ...
    public boolean isNonDummyDerivativeVariable() {
        boolean isNonDummyDerivativeVariable_value = true;
    ...
    public String name() {
        String name_value = getFAccessNoTransform().derName(order());
        return name_value;
    }
    /**
     * @attribute syn
