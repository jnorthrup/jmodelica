 ...
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\ast\\FlatModelica.ast:1390
 * @astdecl FDivFuncExp : FBinEventGenExp;
 * @production FDivFuncExp : {@link FBinEventGenExp};

 */
public class FDivFuncExp extends FBinEventGenExp implements Cloneable {
    /**
     * @aspect InheritedFactoryMethods
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:1030
     */
    public FDivFuncExp createEmptyNode()      { return new FDivFuncExp();      }
    /**
     * @aspect InheritedFactoryMethods
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:1404
     */
    public FDivFuncExp(FExp a1, FExp a2)     { this(emptyArgs(), a1, a2); }
    /**
     * @aspect Derivatives
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaMiddleEnd\\src\\jastadd\\structural\\Differentiation.jrag:468
     */
    @Override
     ...
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaCBackEnd\\src\\jastadd\\CCodeGen\\CCodeGenExpressions.jrag:98
     */
    @Override
    ...
    public FDivFuncExp(List<InstFunctionArgument> p0, FExp p1, FExp p2) {
        setChild(p0, 0);
        setChild(p1, 1);
        setChild(p2, 2);
    }
     ...
     */
    public FDivFuncExp clone() throws CloneNotSupportedException {
        FDivFuncExp node = (FDivFuncExp) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:48
     */
    public FDivFuncExp copy() {
        try {
            FDivFuncExp node = (FDivFuncExp) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    public FDivFuncExp treeCopyNoTransform() {
        FDivFuncExp tree = (FDivFuncExp) copy();
        if (children != null) {
    ...
    public CValue cevalCalc(VariableEvaluator evaluator) {
        CValue cevalCalc_VariableEvaluator_value = type().truncToZero(type().div(getX().ceval(evaluator), getY().ceval(evaluator)));
    ...
    public TypePrefixVariability expVariability() {
        TypePrefixVariability expVariability_value = getX().variability().combine(getY().variability()).combineDown(Variability.DISCRETE);
     ...
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaMiddleEnd\\src\\jastadd\\transformations\\ExtractEventGeneratingExpressions.jrag:249
     */
    @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
    @ASTNodeAnnotation.Source(aspect="ExtractEventGeneratingExpressions", declaredAt="C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaMiddleEnd\\src\\jastadd\\transformations\\ExtractEventGeneratingExpressions.jrag:249")
    public FExp createGuardExp(FExp preExp) {
        {
