...
/**
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\ast\\Modelica.ast:159
 * @astdecl SrcDefaultElementList : SrcPublicElementList;
 * @production SrcDefaultElementList : {@link SrcPublicElementList};

 */
public class SrcDefaultElementList extends SrcPublicElementList implements Cloneable {
    /**
     * @declaredat ASTNode:1
     */
    public SrcDefaultElementList() {
        super();
    }
    /**
    ...
    public SrcDefaultElementList(List<SrcElement> p0) {
        setChild(p0, 0);
    }
    /** @apilevel low-level 
     ...
     */
    public SrcDefaultElementList clone() throws CloneNotSupportedException {
        SrcDefaultElementList node = (SrcDefaultElementList) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:46
     */
    public SrcDefaultElementList copy() {
        try {
            SrcDefaultElementList node = (SrcDefaultElementList) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    @Deprecated
    public SrcDefaultElementList fullCopy() {
     ...
     */
    public SrcDefaultElementList treeCopyNoTransform() {
        SrcDefaultElementList tree = (SrcDefaultElementList) copy();
        if (children != null) {
     ...
     */
    public SrcDefaultElementList treeCopy() {
        doFullTraversal();
        return treeCopyNoTransform();
    }
    /** @apilevel internal 
    ...
    public String clauseHeader(String separator) {
        String clauseHeader_String_value = null;
    ...
    public boolean isDefaultElementList() {
        boolean isDefaultElementList_value = true;
