 ...
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\ast\\FlatModelica.ast:515
 * @astdecl FConnBranch : FConnectionsOp ::= B:FExp;
 * @production FConnBranch : {@link FConnectionsOp} ::= <span class="component">B:{@link FExp}</span>;

 */
public class FConnBranch extends FConnectionsOp implements Cloneable, ConnectionEdge {
    /**
     * @aspect InheritedFactoryMethods
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:1062
     */
    public FConnBranch createEmptyNode()        { return new FConnBranch();        }
    /**
     * @aspect OverconstrainedConnections
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\flattening\\Connections.jrag:1394
     */
    ...
    @ASTNodeAnnotation.Constructor(
        name = {"OriginalArg", "A", "B"},
        type = {"List<InstFunctionArgument>", "FExp", "FExp"},
        kind = {"List", "Child", "Child"}
    )
    public FConnBranch(List<InstFunctionArgument> p0, FExp p1, FExp p2) {
        setChild(p0, 0);
        setChild(p1, 1);
        setChild(p2, 2);
    }
     ...
     */
    public FConnBranch clone() throws CloneNotSupportedException {
        FConnBranch node = (FConnBranch) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:48
     */
    public FConnBranch copy() {
        try {
            FConnBranch node = (FConnBranch) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    public FConnBranch treeCopyNoTransform() {
        FConnBranch tree = (FConnBranch) copy();
        if (children != null) {
    ...
    public String builtInName() {
        String builtInName_value = "Connections.branch";
        return builtInName_value;
    }
    /**
     * @attribute syn
     * @aspect OverconstrainedConnections
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\flattening\\Connections.jrag:1533
     */
    @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
    @ASTNodeAnnotation.Source(aspect="OverconstrainedConnections", declaredAt="C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\flattening\\Connections.jrag:1533")
    public boolean isBreakable() {
        boolean isBreakable_value = false;
