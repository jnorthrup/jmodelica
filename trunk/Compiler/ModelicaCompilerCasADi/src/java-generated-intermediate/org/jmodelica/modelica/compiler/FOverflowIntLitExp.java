 ...
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\ast\\FlatModelica.ast:926
 * @astdecl FOverflowIntLitExp : FRealLitExp ::= <String:String>;
 * @production FOverflowIntLitExp : {@link FRealLitExp} ::= <span class="component">&lt;String:String&gt;</span>;

 */
public class FOverflowIntLitExp extends FRealLitExp implements Cloneable {
    /**
     * @aspect ContentCheck
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\errorcheck\\ContentsCheck.jadd:389
     */
    ...
    /**
     * @aspect DebugHelpers
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\util\\Util.jrag:1189
     */
    public String toString()  { return getString(); }
    /**
     * @declaredat ASTNode:1
     */
    public FOverflowIntLitExp() {
        super();
    }
    /**
    ...
    public FOverflowIntLitExp(double p0, String p1) {
        setValue(p0);
        setString(p1);
    }
    /**
     ...
     */
    public FOverflowIntLitExp(double p0, beaver.Symbol p1) {
        setValue(p0);
        setString(p1);
    }
    /** @apilevel low-level 
     ...
     */
    public FOverflowIntLitExp clone() throws CloneNotSupportedException {
        FOverflowIntLitExp node = (FOverflowIntLitExp) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:49
     */
    public FOverflowIntLitExp copy() {
        try {
            FOverflowIntLitExp node = (FOverflowIntLitExp) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    @Deprecated
    public FOverflowIntLitExp fullCopy() {
     ...
     */
    public FOverflowIntLitExp treeCopyNoTransform() {
        FOverflowIntLitExp tree = (FOverflowIntLitExp) copy();
        if (children != null) {
     ...
     */
    public FOverflowIntLitExp treeCopy() {
        doFullTraversal();
        return treeCopyNoTransform();
    }
    /** @apilevel internal 
    ...
    protected boolean is$Equal(ASTNode node) {
        return super.is$Equal(node) && (tokendouble_Value == ((FOverflowIntLitExp) node).tokendouble_Value) && (tokenString_String == ((FOverflowIntLitExp) node).tokenString_String);    
    }
    /**
