...
/**
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\ast\\Modelica.ast:326
 * @astdecl SrcArrayConstructor : SrcExp ::= SrcFunctionArguments;
 * @production SrcArrayConstructor : {@link SrcExp} ::= <span class="component">{@link SrcFunctionArguments}</span>;

 */
public class SrcArrayConstructor extends SrcExp implements Cloneable {
    /**
     * @aspect PrettyPrint
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\PrettyPrint.jrag:889
     */
     ...
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\flattening\\Flattening.jrag:3144
     */
    ...
    /**
     * @aspect NodeMethods
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\util\\Util.jrag:479
     */
    ...
    @ASTNodeAnnotation.Constructor(
        name = {"SrcFunctionArguments"},
        type = {"SrcFunctionArguments"},
        kind = {"Child"}
    )
    public SrcArrayConstructor(SrcFunctionArguments p0) {
        setChild(p0, 0);
    }
    /** @apilevel low-level 
     ...
     */
    public SrcArrayConstructor clone() throws CloneNotSupportedException {
        SrcArrayConstructor node = (SrcArrayConstructor) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:45
     */
    public SrcArrayConstructor copy() {
        try {
            SrcArrayConstructor node = (SrcArrayConstructor) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    @Deprecated
    public SrcArrayConstructor fullCopy() {
     ...
     */
    public SrcArrayConstructor treeCopyNoTransform() {
        SrcArrayConstructor tree = (SrcArrayConstructor) copy();
        if (children != null) {
     ...
     */
    public SrcArrayConstructor treeCopy() {
        doFullTraversal();
        return treeCopyNoTransform();
    }
    /** @apilevel internal 
    ...
    /**
     * Replaces the SrcFunctionArguments child.
     * @param node The new node to replace the SrcFunctionArguments child.
     * @apilevel high-level
     */
    ...
    /**
     * Retrieves the SrcFunctionArguments child.
     * @return The current node used as the SrcFunctionArguments child.
     * @apilevel high-level
     */
    @ASTNodeAnnotation.Child(name="SrcFunctionArguments")
    public SrcFunctionArguments getSrcFunctionArguments() {
        return (SrcFunctionArguments) getChild(0);
    }
    /**
     * Retrieves the SrcFunctionArguments child.
     ...
     * @apilevel low-level
     */
    public SrcFunctionArguments getSrcFunctionArgumentsNoTransform() {
        return (SrcFunctionArguments) getChildNoTransform(0);
    }
    /** 
    ...
    public List<? extends SrcExp> arrayChildrenForCeval() {
        List<? extends SrcExp> arrayChildrenForCeval_value = getSrcFunctionArguments().getSrcExps();
    ...
    public boolean isAnnotationExp() {
        boolean isAnnotationExp_value = getSrcFunctionArguments().getNumSrcExp() > 0;
    ...
    public Iterable<? extends ASTNode> annotationList() {
        Iterable<? extends ASTNode> annotationList_value = getSrcFunctionArguments().getSrcExps();
    ...
    public SrcAnnotationProvider asAnnotationProvider() {
        SrcAnnotationProvider asAnnotationProvider_value = getSrcFunctionArguments();
