...
/**
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\ast\\Modelica.ast:301
 * @astdecl SrcRangeExp : SrcExp ::= SrcExp*;
 * @production SrcRangeExp : {@link SrcExp} ::= <span class="component">{@link SrcExp}*</span>;

 */
public class SrcRangeExp extends SrcExp implements Cloneable {
    /**
     * @aspect PrettyPrint
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\PrettyPrint.jrag:617
     */
     ...
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\flattening\\Flattening.jrag:3159
     */
    ...
    public SrcRangeExp(List<SrcExp> p0) {
        setChild(p0, 0);
    }
    /** @apilevel low-level 
     ...
     */
    public SrcRangeExp clone() throws CloneNotSupportedException {
        SrcRangeExp node = (SrcRangeExp) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:46
     */
    public SrcRangeExp copy() {
        try {
            SrcRangeExp node = (SrcRangeExp) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    public SrcRangeExp treeCopyNoTransform() {
        SrcRangeExp tree = (SrcRangeExp) copy();
        if (children != null) {
