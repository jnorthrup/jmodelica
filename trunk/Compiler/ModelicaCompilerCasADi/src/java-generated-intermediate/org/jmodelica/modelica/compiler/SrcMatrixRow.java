...
/**
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\ast\\Modelica.ast:328
 * @astdecl SrcMatrixRow : SrcExp ::= SrcExp*;
 * @production SrcMatrixRow : {@link SrcExp} ::= <span class="component">{@link SrcExp}*</span>;

 */
public class SrcMatrixRow extends SrcExp implements Cloneable {
    /**
     * @aspect PrettyPrint
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\PrettyPrint.jrag:901
     */
     ...
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\flattening\\Flattening.jrag:3180
     */
    public FMatrixRow instantiate() {
    ...
    public SrcMatrixRow(List<SrcExp> p0) {
        setChild(p0, 0);
    }
    /** @apilevel low-level 
     ...
     */
    public SrcMatrixRow clone() throws CloneNotSupportedException {
        SrcMatrixRow node = (SrcMatrixRow) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:46
     */
    public SrcMatrixRow copy() {
        try {
            SrcMatrixRow node = (SrcMatrixRow) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    public SrcMatrixRow treeCopyNoTransform() {
        SrcMatrixRow tree = (SrcMatrixRow) copy();
        if (children != null) {
    ...
    public List<? extends SrcExp> arrayChildrenForCeval() {
        List<? extends SrcExp> arrayChildrenForCeval_value = getSrcExps();
