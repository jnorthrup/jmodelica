 ...
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\ast\\FlatModelica.ast:520
 * @astdecl FConnRoot : FConnectionsOp;
 * @production FConnRoot : {@link FConnectionsOp};

 */
public class FConnRoot extends FConnectionsOp implements Cloneable {
    /**
     * @aspect InheritedFactoryMethods
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:1063
     */
    public FConnRoot createEmptyNode()          { return new FConnRoot();          }
    /**
     * @aspect OverconstrainedConnections
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\flattening\\Connections.jrag:1402
     */
    ...
    public FConnRoot(List<InstFunctionArgument> p0, FExp p1) {
        setChild(p0, 0);
        setChild(p1, 1);
    }
    /** @apilevel low-level 
     ...
     */
    public FConnRoot clone() throws CloneNotSupportedException {
        FConnRoot node = (FConnRoot) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:47
     */
    public FConnRoot copy() {
        try {
            FConnRoot node = (FConnRoot) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    public FConnRoot treeCopyNoTransform() {
        FConnRoot tree = (FConnRoot) copy();
        if (children != null) {
    ...
    public String builtInName() {
        String builtInName_value = "Connections.root";
