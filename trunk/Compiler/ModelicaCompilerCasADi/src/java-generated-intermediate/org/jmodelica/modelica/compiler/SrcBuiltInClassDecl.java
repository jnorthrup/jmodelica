...
/**
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\ast\\Modelica.ast:129
 * @astdecl SrcBuiltInClassDecl : SrcClassDecl;
 * @production SrcBuiltInClassDecl : {@link SrcClassDecl};

 */
public class SrcBuiltInClassDecl extends SrcClassDecl implements Cloneable {
    /**
     * @aspect InstanceTreeConstruction
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\instance\\InstanceTree.jrag:1423
     */
    public InstBuiltInClassDecl newInstClassDecl() {
        return new InstBuiltInClassDecl(this);
    }
    /**
     * @aspect PredefinedTypes
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\source\\PredefinedTypes.jrag:741
     */
    ...
    public SrcBuiltInClassDecl(SrcIdDecl p0) {
        setChild(p0, 0);
    }
    /** @apilevel low-level 
     ...
     */
    public SrcBuiltInClassDecl clone() throws CloneNotSupportedException {
        SrcBuiltInClassDecl node = (SrcBuiltInClassDecl) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:45
     */
    public SrcBuiltInClassDecl copy() {
        try {
            SrcBuiltInClassDecl node = (SrcBuiltInClassDecl) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    @Deprecated
    public SrcBuiltInClassDecl fullCopy() {
     ...
     */
    public SrcBuiltInClassDecl treeCopyNoTransform() {
        SrcBuiltInClassDecl tree = (SrcBuiltInClassDecl) copy();
        if (children != null) {
     ...
     */
    public SrcBuiltInClassDecl treeCopy() {
        doFullTraversal();
        return treeCopyNoTransform();
    }
    /** @apilevel internal 
    ...
    public String qualifiedName() {
        String qualifiedName_value = getName().getID();
