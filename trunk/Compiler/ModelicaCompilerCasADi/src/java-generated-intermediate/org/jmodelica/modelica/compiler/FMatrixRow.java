 ...
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\ast\\FlatModelica.ast:1131
 * @astdecl FMatrixRow : FAbstractCat;
 * @production FMatrixRow : {@link FAbstractCat};

 */
public class FMatrixRow extends FAbstractCat implements Cloneable {
    /**
     * @aspect InheritedFactoryMethods
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:992
     */
    public FMatrixRow createEmptyNode()      { return new FMatrixRow();      }
    /**
     * @aspect FlatPrettyPrint
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\PrettyPrint.jrag:1577
     */
    ...
    public FMatrixRow(List<InstFunctionArgument> p0, List<FExp> p1) {
        setChild(p0, 0);
        setChild(p1, 1);
    }
    /** @apilevel low-level 
     ...
     */
    public FMatrixRow clone() throws CloneNotSupportedException {
        FMatrixRow node = (FMatrixRow) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:48
     */
    public FMatrixRow copy() {
        try {
            FMatrixRow node = (FMatrixRow) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    public FMatrixRow treeCopyNoTransform() {
        FMatrixRow tree = (FMatrixRow) copy();
        if (children != null) {
    ...
    public boolean dimensionIsOk() {
        boolean dimensionIsOk_value = true;
        return dimensionIsOk_value;
    }
    /** @apilevel internal */
