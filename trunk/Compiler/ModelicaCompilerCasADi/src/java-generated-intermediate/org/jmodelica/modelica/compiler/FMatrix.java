 ...
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\ast\\FlatModelica.ast:1126
 * @astdecl FMatrix : FAbstractCat;
 * @production FMatrix : {@link FAbstractCat};

 */
public class FMatrix extends FAbstractCat implements Cloneable {
    /**
     * @aspect InheritedFactoryMethods
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:991
     */
    public FMatrix createEmptyNode()         { return new FMatrix();         }
    /**
     * @aspect FlatPrettyPrint
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\PrettyPrint.jrag:1571
     */
    ...
    public FMatrix(List<InstFunctionArgument> p0, List<FExp> p1) {
        setChild(p0, 0);
        setChild(p1, 1);
    }
    /** @apilevel low-level 
     ...
     */
    public FMatrix clone() throws CloneNotSupportedException {
        FMatrix node = (FMatrix) super.clone();
        return node;
    }
    /** @apilevel internal 
     ...
     */
    public FMatrix treeCopyNoTransform() {
        FMatrix tree = (FMatrix) copy();
        if (children != null) {
