 ...
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\ast\\FlatModelica.ast:1570
 * @astdecl FArrayDimAsArgsExp : FInfArgsFunctionCall;
...
public abstract class FArrayDimAsArgsExp extends FInfArgsFunctionCall implements Cloneable {
    /**
     * @aspect Arrays
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Arrays.jrag:1055
     */
    ...
    public FArrayDimAsArgsExp(List<InstFunctionArgument> p0, List<FExp> p1) {
        setChild(p0, 0);
        setChild(p1, 1);
    }
    /** @apilevel low-level 
    ...
    public ArrayExp getArrayExp() {
        ...
        boolean isFinal = this.is$Final();
        state().enterLazyAttribute();
        getArrayExp_value = new ArrayExp(indices()).fill(fillExp());
