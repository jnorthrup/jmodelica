 ...
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\ast\\FlatModelica.ast:1527
 * @astdecl FSymmetric : FUnaryBuiltIn;
 * @production FSymmetric : {@link FUnaryBuiltIn};

 */
public class FSymmetric extends FUnaryBuiltIn implements Cloneable {
    /**
     * @aspect InheritedFactoryMethods
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:1040
     */
    public FSymmetric createEmptyNode()       { return new FSymmetric();       }
    /**
     * @aspect FunctionScalarization
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaMiddleEnd\\src\\jastadd\\scalarization\\ScalarizeFunctions.jrag:765
     */
    ...
    /**
     * @aspect Derivatives
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaMiddleEnd\\src\\jastadd\\structural\\Differentiation.jrag:792
     */
    @Override
    ...
    public FSymmetric(List<InstFunctionArgument> p0, FExp p1) {
        setChild(p0, 0);
        setChild(p1, 1);
    }
    /** @apilevel low-level 
     ...
     */
    public FSymmetric clone() throws CloneNotSupportedException {
        FSymmetric node = (FSymmetric) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:50
     */
    public FSymmetric copy() {
        try {
            FSymmetric node = (FSymmetric) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    public FSymmetric treeCopyNoTransform() {
        FSymmetric tree = (FSymmetric) copy();
        if (children != null) {
    ...
    public String builtInName() {
        String builtInName_value = "symmetric";
    ...
    public FType type() {
        ...
        boolean isFinal = this.is$Final();
        state().enterLazyAttribute();
        type_value = getFExp().ndims() == 2 && getFExp().size().get(0) == getFExp().size().get(1) ?
                getFExp().type() : 
                fUnknownType();
        if (isFinal && _boundaries == state().boundariesCrossed) {
        type_computed = true;
    ...
    public boolean unknownSizeSupported() {
        boolean unknownSizeSupported_value = false;
    ...
    public boolean Define_argumentDefinedTypeValid(ASTNode _callerNode, ASTNode _childNode) {
        if (_callerNode == getOriginalArgListNoTransform()) {
            // @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\errorcheck\\TypeCheck.jrag:1679
    ...
    public boolean Define_argumentTypeValid(ASTNode _callerNode, ASTNode _childNode, FType type) {
        ...
        return type.ndims() == 2 && type.size().get(0) == type.size().get(1);
    }
    /**
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\errorcheck\\TypeCheck.jrag:1708
     * @apilevel internal
