...
/**
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\ast\\InstanceTree.ast:149
 * @astdecl InstInlineExtends : InstNormalExtends;
 * @production InstInlineExtends : {@link InstNormalExtends};

 */
public class InstInlineExtends extends InstNormalExtends implements Cloneable {
    /**
     * @declaredat ASTNode:1
     */
    public InstInlineExtends() {
        super();
    }
    /**
    ...
    public InstInlineExtends(InstAccess p0, SrcExtendsClause p1, Opt<InstClassModification> p2) {
        setChild(p0, 0);
     ...
     */
    public InstInlineExtends clone() throws CloneNotSupportedException {
        InstInlineExtends node = (InstInlineExtends) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:58
     */
    public InstInlineExtends copy() {
        try {
            InstInlineExtends node = (InstInlineExtends) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    @Deprecated
    public InstInlineExtends fullCopy() {
     ...
     */
    public InstInlineExtends treeCopyNoTransform() {
        InstInlineExtends tree = (InstInlineExtends) copy();
        if (children != null) {
     ...
     */
    public InstInlineExtends treeCopy() {
        doFullTraversal();
        return treeCopyNoTransform();
    }
    /** @apilevel internal 
    ...
    protected boolean is$Equal(ASTNode node) {
        return super.is$Equal(node) && (tokenSrcExtendsClause_SrcExtendsClause == ((InstInlineExtends) node).tokenSrcExtendsClause_SrcExtendsClause);    
    }
    /**
    ...
    public String qualifiedName() {
        String qualifiedName_value = surroundingInstClass().myInheritedOrigin().qualifiedName();
    ...
    public InstLookupResult<InstClassDecl> Define_lookupInstClass(ASTNode _callerNode, ASTNode _childNode, String name) {
        if (_callerNode == getClassNameNoTransform()) {
            // @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\instance\\InstLookupClasses.jrag:76
            return getClassName().name().equals(name) ? lookupRedeclareExtendsInstClass(name) : lookupInstClass(name);
        }
        else {
    ...
    public InstLookupResult<InstClassDecl> Define_lookupRedeclareExtendsInstClass(ASTNode _callerNode, ASTNode _childNode, String name) {
        if (_callerNode == getInstExtendsListNoTransform()) {
            // @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\instance\\InstLookupClasses.jrag:172
