...
/**
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\ast\\Modelica.ast:160
 * @astdecl SrcProtectedElementList : SrcElementList;
 * @production SrcProtectedElementList : {@link SrcElementList};

 */
public class SrcProtectedElementList extends SrcElementList implements Cloneable {
    /**
     * @declaredat ASTNode:1
     */
    public SrcProtectedElementList() {
        super();
    }
    /**
    ...
    public SrcProtectedElementList(List<SrcElement> p0) {
        setChild(p0, 0);
    }
    /** @apilevel low-level 
     ...
     */
    public SrcProtectedElementList clone() throws CloneNotSupportedException {
        SrcProtectedElementList node = (SrcProtectedElementList) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:46
     */
    public SrcProtectedElementList copy() {
        try {
            SrcProtectedElementList node = (SrcProtectedElementList) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    @Deprecated
    public SrcProtectedElementList fullCopy() {
     ...
     */
    public SrcProtectedElementList treeCopyNoTransform() {
        SrcProtectedElementList tree = (SrcProtectedElementList) copy();
        if (children != null) {
     ...
     */
    public SrcProtectedElementList treeCopy() {
        doFullTraversal();
        return treeCopyNoTransform();
    }
    /** @apilevel internal 
    ...
    public String clauseHeader(String separator) {
        String clauseHeader_String_value = "protected";
    ...
    public boolean isProtectedElementList() {
        boolean isProtectedElementList_value = true;
