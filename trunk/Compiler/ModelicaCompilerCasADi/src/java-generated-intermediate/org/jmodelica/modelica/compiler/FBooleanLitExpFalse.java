 ...
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\ast\\FlatModelica.ast:941
 * @astdecl FBooleanLitExpFalse : FBooleanLitExp;
 * @production FBooleanLitExpFalse : {@link FBooleanLitExp};

 */
public class FBooleanLitExpFalse extends FBooleanLitExp implements Cloneable {
    /**
     * @aspect InheritedFactoryMethods
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:944
     */
    public FBooleanLitExpFalse createEmptyNode() { return new FBooleanLitExpFalse(); }
    /**
     * @aspect DebugHelpers
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\util\\Util.jrag:1191
     */
    public String toString() { return "false"; }
    /**
     * @aspect CCodeGenExpressions
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaCBackEnd\\src\\jastadd\\CCodeGen\\CCodeGenExpressions.jrag:81
     */
    @Override
     ...
     */
    public FBooleanLitExpFalse clone() throws CloneNotSupportedException {
        FBooleanLitExpFalse node = (FBooleanLitExpFalse) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:36
     */
    public FBooleanLitExpFalse copy() {
        try {
            FBooleanLitExpFalse node = (FBooleanLitExpFalse) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    @Deprecated
    public FBooleanLitExpFalse fullCopy() {
     ...
     */
    public FBooleanLitExpFalse treeCopyNoTransform() {
        FBooleanLitExpFalse tree = (FBooleanLitExpFalse) copy();
        if (children != null) {
     ...
     */
    public FBooleanLitExpFalse treeCopy() {
        doFullTraversal();
        return treeCopyNoTransform();
    }
    /** @apilevel internal 
    ...
    public CValue cevalCalc(VariableEvaluator evaluator) {
        CValue cevalCalc_VariableEvaluator_value = new CValueBoolean(false);
    ...
    public boolean equalsSymbolic(FExp other) {
        boolean equalsSymbolic_FExp_value = other instanceof FBooleanLitExpFalse;
        return equalsSymbolic_FExp_value;
    }
    /**
     * @attribute syn
    ...
    public String xmlTag() {
        String xmlTag_value = "BooleanLiteral";
        return xmlTag_value;
    }
    /**
