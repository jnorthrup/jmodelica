 ...
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\ast\\FlatModelica.ast:191
 * @astdecl FPreStringVariable : FStringVariable;
 * @production FPreStringVariable : {@link FStringVariable};

 */
public class FPreStringVariable extends FStringVariable implements Cloneable {
    /**
     * Create a pre variable for a string variable.
     * @aspect Constructors
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:587
     */
    public FPreStringVariable(FStringVariable fv) {
    ...
    public FPreStringVariable(VisibilityType p0, TypePrefixVariability p1, TypePrefixInputOutput p2, List<FAttribute> p3, String p4, Opt<FExp> p5, Opt<FStringComment> p6, FAccess p7) {
     ...
     */
    public FPreStringVariable(VisibilityType p0, TypePrefixVariability p1, TypePrefixInputOutput p2, List<FAttribute> p3, beaver.Symbol p4, Opt<FExp> p5, Opt<FStringComment> p6, FAccess p7) {
        setVisibilityType(p0);
        setTypePrefixVariability(p1);
        setTypePrefixInputOutput(p2);
        setChild(p3, 0);
     ...
     */
    public FPreStringVariable clone() throws CloneNotSupportedException {
        FPreStringVariable node = (FPreStringVariable) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:66
     */
    public FPreStringVariable copy() {
        try {
            FPreStringVariable node = (FPreStringVariable) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    @Deprecated
    public FPreStringVariable fullCopy() {
     ...
     */
    public FPreStringVariable treeCopyNoTransform() {
        FPreStringVariable tree = (FPreStringVariable) copy();
        if (children != null) {
     ...
     */
    public FPreStringVariable treeCopy() {
        doFullTraversal();
        return treeCopyNoTransform();
    }
    /** @apilevel internal 
    ...
    protected boolean is$Equal(ASTNode node) {
        return super.is$Equal(node) && (tokenVisibilityType_VisibilityType == ((FPreStringVariable) node).tokenVisibilityType_VisibilityType) && (tokenTypePrefixVariability_TypePrefixVariability == ((FPreStringVariable) node).tokenTypePrefixVariability_TypePrefixVariability) && (tokenTypePrefixInputOutput_TypePrefixInputOutput == ((FPreStringVariable) node).tokenTypePrefixInputOutput_TypePrefixInputOutput) && (tokenString_DerivedType == ((FPreStringVariable) node).tokenString_DerivedType);    
    }
    /**
