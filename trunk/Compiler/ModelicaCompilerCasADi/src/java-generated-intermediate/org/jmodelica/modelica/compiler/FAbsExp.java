 ...
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\ast\\FlatModelica.ast:1360
 * @astdecl FAbsExp : FVectUnaryBuiltIn;
 * @production FAbsExp : {@link FVectUnaryBuiltIn};

 */
public class FAbsExp extends FVectUnaryBuiltIn implements Cloneable {
    /**
     * @aspect InheritedFactoryMethods
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:1025
     */
    public FAbsExp createEmptyNode()          { return new FAbsExp();          }
    /**
     * @aspect InheritedFactoryMethods
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:1386
     */
    public FAbsExp(FExp a1)                      { this(emptyArgs(), a1); }
    /**
     * @aspect Derivatives
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaMiddleEnd\\src\\jastadd\\structural\\Differentiation.jrag:446
     */
    @Override
     ...
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaCBackEnd\\src\\jastadd\\CCodeGen\\CCodeGenExpressions.jrag:34
     */
    @Override
    ...
    public FAbsExp(List<InstFunctionArgument> p0, FExp p1) {
        setChild(p0, 0);
        setChild(p1, 1);
    }
    /** @apilevel low-level 
     ...
     */
    public FAbsExp clone() throws CloneNotSupportedException {
        FAbsExp node = (FAbsExp) super.clone();
        return node;
    }
    /** @apilevel internal 
     ...
     */
    public FAbsExp treeCopyNoTransform() {
        FAbsExp tree = (FAbsExp) copy();
        if (children != null) {
    ...
    public CValue cevalCalc(VariableEvaluator evaluator) {
        CValue cevalCalc_VariableEvaluator_value = type().abs(getFExp().ceval(evaluator));
    ...
    public MX toMX() {
        MX toMX_value = getFExp().toMX().fabs();
        return toMX_value;
    }
    /**
