...
/**
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\ast\\Modelica.ast:244
 * @astdecl SrcIfEquation : SrcIfWhenEquation;
 * @production SrcIfEquation : {@link SrcIfWhenEquation};

 */
public class SrcIfEquation extends SrcIfWhenEquation implements Cloneable {
    /**
     * @aspect InstantiatedExpressions
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\flattening\\Flattening.jrag:2952
     */
    ...
    public SrcIfEquation(SrcComment p0, List<SrcAbstractEquation> p1, SrcExp p2, Opt<SrcIfWhenElseEquation> p3) {
        setChild(p0, 0);
        setChild(p1, 1);
        setChild(p2, 2);
        setChild(p3, 3);
     ...
     */
    public SrcIfEquation clone() throws CloneNotSupportedException {
        SrcIfEquation node = (SrcIfEquation) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:50
     */
    public SrcIfEquation copy() {
        try {
            SrcIfEquation node = (SrcIfEquation) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    public SrcIfEquation treeCopyNoTransform() {
        SrcIfEquation tree = (SrcIfEquation) copy();
        if (children != null) {
