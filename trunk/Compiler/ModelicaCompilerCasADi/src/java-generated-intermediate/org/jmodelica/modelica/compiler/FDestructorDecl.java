 ...
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\ast\\FlatModelica.ast:64
 * @astdecl FDestructorDecl : FFunctionDecl;
...
public class FDestructorDecl extends FFunctionDecl implements Cloneable {
    ...
    public FDestructorDecl(FAccess p0, List<FFunctionVariable> p1, FAlgorithm p2, List<FAttribute> p3) {
        setChild(p0, 0);
        setChild(p1, 1);
        setChild(p2, 2);
        setChild(p3, 3);
