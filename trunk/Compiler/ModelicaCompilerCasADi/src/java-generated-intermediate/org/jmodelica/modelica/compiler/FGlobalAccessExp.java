 ...
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\ast\\FlatModelica.ast:1019
 * @astdecl FGlobalAccessExp : FAccessExp;
 * @production FGlobalAccessExp : {@link FAccessExp};

 */
public class FGlobalAccessExp extends FAccessExp implements Cloneable {
    /**
     * @aspect InheritedFactoryMethods
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:972
     */
    public FGlobalAccessExp createEmptyNode() { return new FGlobalAccessExp(); }
    /**
     * @aspect FlatPrettyPrint
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\PrettyPrint.jrag:1661
     */
     ...
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaMiddleEnd\\src\\jastadd\\Globals.jrag:227
     */
    @Override
     ...
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaMiddleEnd\\src\\jastadd\\optimizations\\InlineFunctions.jrag:1631
     */
    @Override
    ...
    public FGlobalAccessExp(FAccess p0, String p1) {
        setChild(p0, 0);
     ...
     */
    public FGlobalAccessExp(FAccess p0, beaver.Symbol p1) {
        setChild(p0, 0);
        setOriginalVariable(p1);
    }
    /** @apilevel low-level 
     ...
     */
    public FGlobalAccessExp clone() throws CloneNotSupportedException {
        FGlobalAccessExp node = (FGlobalAccessExp) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:50
     */
    public FGlobalAccessExp copy() {
        try {
            FGlobalAccessExp node = (FGlobalAccessExp) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    @Deprecated
    public FGlobalAccessExp fullCopy() {
     ...
     */
    public FGlobalAccessExp treeCopyNoTransform() {
        FGlobalAccessExp tree = (FGlobalAccessExp) copy();
        if (children != null) {
     ...
     */
    public FGlobalAccessExp treeCopy() {
        doFullTraversal();
        return treeCopyNoTransform();
    }
    /** @apilevel internal 
    ...
    protected boolean is$Equal(ASTNode node) {
        return super.is$Equal(node) && (tokenString_OriginalVariable == ((FGlobalAccessExp) node).tokenString_OriginalVariable);    
    }
    /**
    ...
    public FExp nominal() {
        FExp nominal_value = new FAbsExp(treeCopy());
