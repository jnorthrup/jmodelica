...
/**
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\ast\\Modelica.ast:294
 * @astdecl SrcFunctionCall : SrcExp ::= Name:SrcAccess [SrcFunctionArguments];
 * @production SrcFunctionCall : {@link SrcExp} ::= <span class="component">Name:{@link SrcAccess}</span> <span class="component">[{@link SrcFunctionArguments}]</span>;

 */
public class SrcFunctionCall extends SrcExp implements Cloneable {
    /**
     * @aspect PrettyPrint
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\PrettyPrint.jrag:836
     */
     ...
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\flattening\\Flattening.jrag:3306
     */
    ...
    /**
     * @aspect InstantiatedExpressions
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\flattening\\Flattening.jrag:3314
     */
    ...
    public SrcFunctionCall(SrcAccess p0, Opt<SrcFunctionArguments> p1) {
        setChild(p0, 0);
        setChild(p1, 1);
    }
    /** @apilevel low-level 
     ...
     */
    public SrcFunctionCall clone() throws CloneNotSupportedException {
        SrcFunctionCall node = (SrcFunctionCall) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:48
     */
    public SrcFunctionCall copy() {
        try {
            SrcFunctionCall node = (SrcFunctionCall) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    @Deprecated
    public SrcFunctionCall fullCopy() {
     ...
     */
    public SrcFunctionCall treeCopyNoTransform() {
        SrcFunctionCall tree = (SrcFunctionCall) copy();
        if (children != null) {
     ...
     */
    public SrcFunctionCall treeCopy() {
        doFullTraversal();
        return treeCopyNoTransform();
    }
    /** @apilevel internal 
    ...
    public AnnotationNode annotationNode(InstContext instContext) {
        ...
        AnnotationNode annotationNode_InstContext_value = new FCAnnotationNode          (this, instContext);
    ...
    public SrcAnnotationProvider asAnnotationProvider() {
        SrcAnnotationProvider asAnnotationProvider_value = new SrcSingeltonProvider(name(), getSrcFunctionArguments());
    ...
    public SrcAnnotationProvider asNamedAnnotationProvider() {
        SrcAnnotationProvider asNamedAnnotationProvider_value = hasSrcFunctionArguments() ? getSrcFunctionArguments() : null;
    ...
    public String namedAnnotationProviderName() {
        String namedAnnotationProviderName_value = name();
        return namedAnnotationProviderName_value;
    }
    /**
     * @attribute syn
     * @aspect Names
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\util\\Util.jrag:762
     */
    @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
    @ASTNodeAnnotation.Source(aspect="Names", declaredAt="C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\util\\Util.jrag:762")
    public String name() {
