...
/**
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\ast\\InstanceTree.ast:69
 * @astdecl InstReplacingPrimitiveClassDecl : InstReplacingFullClassDecl;
 * @production InstReplacingPrimitiveClassDecl : {@link InstReplacingFullClassDecl};

 */
public class InstReplacingPrimitiveClassDecl extends InstReplacingFullClassDecl implements Cloneable {
    /**
     * @declaredat ASTNode:1
     */
    public InstReplacingPrimitiveClassDecl() {
        super();
    }
    /**
    ...
    public InstReplacingPrimitiveClassDecl(SrcClassDecl p0, Opt<InstConstrainingClass> p1, InstRestriction p2, Opt<InstExternal> p3, SrcClassDecl p4, InstRedeclareClassNode p5) {
        setSrcClassDecl(p0);
        setChild(p1, 0);
        setChild(p2, 1);
        setChild(p3, 2);
     ...
     */
    public InstReplacingPrimitiveClassDecl clone() throws CloneNotSupportedException {
        InstReplacingPrimitiveClassDecl node = (InstReplacingPrimitiveClassDecl) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:61
     */
    public InstReplacingPrimitiveClassDecl copy() {
        try {
            InstReplacingPrimitiveClassDecl node = (InstReplacingPrimitiveClassDecl) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    @Deprecated
    public InstReplacingPrimitiveClassDecl fullCopy() {
     ...
     */
    public InstReplacingPrimitiveClassDecl treeCopyNoTransform() {
        InstReplacingPrimitiveClassDecl tree = (InstReplacingPrimitiveClassDecl) copy();
        if (children != null) {
     ...
     */
    public InstReplacingPrimitiveClassDecl treeCopy() {
        doFullTraversal();
        return treeCopyNoTransform();
    }
    /** @apilevel internal 
    ...
    protected boolean is$Equal(ASTNode node) {
        return super.is$Equal(node) && (tokenSrcClassDecl_SrcClassDecl == ((InstReplacingPrimitiveClassDecl) node).tokenSrcClassDecl_SrcClassDecl) && (tokenSrcClassDecl_OriginalClassDecl == ((InstReplacingPrimitiveClassDecl) node).tokenSrcClassDecl_OriginalClassDecl) && (tokenInstRedeclareClassNode_InstClassRedeclare == ((InstReplacingPrimitiveClassDecl) node).tokenInstRedeclareClassNode_InstClassRedeclare);    
    }
    /**
