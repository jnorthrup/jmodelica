...
/**
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\ast\\InstanceTree.ast:115
 * @astdecl InstEnumLiteral : InstBuiltIn;
 * @production InstEnumLiteral : {@link InstBuiltIn};

 */
public class InstEnumLiteral extends InstBuiltIn implements Cloneable {
    /**
     * @aspect Flattening
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\flattening\\Flattening.jrag:1489
     */
    public FEnumLiteral createFEnumLiteral() {
    ...
    public InstEnumLiteral(String p0, InstAccess p1, Opt<FArraySubscripts> p2, SrcComponentDecl p3, Opt<InstModification> p4, Opt<InstConstrainingComponent> p5, Opt<FExp> p6) {
        setName(p0);
        setChild(p1, 0);
        setChild(p2, 1);
     ...
     */
    public InstEnumLiteral(beaver.Symbol p0, InstAccess p1, Opt<FArraySubscripts> p2, SrcComponentDecl p3, Opt<InstModification> p4, Opt<InstConstrainingComponent> p5, Opt<FExp> p6) {
        setName(p0);
        setChild(p1, 0);
        setChild(p2, 1);
        setSrcComponentDecl(p3);
     ...
     */
    public InstEnumLiteral clone() throws CloneNotSupportedException {
        InstEnumLiteral node = (InstEnumLiteral) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:75
     */
    public InstEnumLiteral copy() {
        try {
            InstEnumLiteral node = (InstEnumLiteral) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    @Deprecated
    public InstEnumLiteral fullCopy() {
     ...
     */
    public InstEnumLiteral treeCopyNoTransform() {
        InstEnumLiteral tree = (InstEnumLiteral) copy();
        if (children != null) {
     ...
     */
    public InstEnumLiteral treeCopy() {
        doFullTraversal();
        return treeCopyNoTransform();
    }
    /** @apilevel internal 
    ...
    protected boolean is$Equal(ASTNode node) {
        return super.is$Equal(node) && (tokenString_Name == ((InstEnumLiteral) node).tokenString_Name) && (tokenSrcComponentDecl_SrcComponentDecl == ((InstEnumLiteral) node).tokenSrcComponentDecl_SrcComponentDecl);    
    }
    /**
    ...
    public CValue ceval(VariableEvaluator evaluator, Index i) {
        CValue ceval_VariableEvaluator_Index_value = new CValueEnum(type(), myIndex());
    ...
    public FType type() {
        ...
        type_value = myInstEnumClassDecl().enumType();
    ...
    public TypePrefixVariability calcVariability() {
        TypePrefixVariability calcVariability_value = Variability.CONSTANT;
    ...
    @ASTNodeAnnotation.Source(aspect="InstanceAST_API", declaredAt="C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\instance\\InstanceTree.jrag:2073")
    public InstEnumClassDecl myInstEnumClassDecl() {
        InstEnumClassDecl myInstEnumClassDecl_value = getParent().Define_myInstEnumClassDecl(this, null);
        return myInstEnumClassDecl_value;
    }
    /**
     * @attribute inh
     * @aspect InstanceAST_API
     ...
     */
    @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.INH)
    @ASTNodeAnnotation.Source(aspect="InstanceAST_API", declaredAt="C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\instance\\InstanceTree.jrag:2078")
    public int myIndex() {
        int myIndex_value = getParent().Define_myIndex(this, null);
