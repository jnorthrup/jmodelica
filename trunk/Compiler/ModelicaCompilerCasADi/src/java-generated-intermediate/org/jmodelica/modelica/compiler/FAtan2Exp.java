 ...
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\ast\\FlatModelica.ast:1455
 * @astdecl FAtan2Exp : FMathematicalFunctionCall ::= Y:FExp;
...
public class FAtan2Exp extends FMathematicalFunctionCall implements Cloneable {
     ...
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:1014
     */
    public FAtan2Exp createEmptyNode() { return new FAtan2Exp(); }
    /**
     * Create new node of same class as this, with the specified children.
     * @aspect InheritedFactoryMethods
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:1177
     */
     ...
     * Create new node of same class as this, with the specified children.
     * @aspect InheritedFactoryMethods
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:1184
     */
     ...
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\flattening\\Flattening.jrag:2608
     */
    public FExp flatten(Flattener f)                 { return createNode(getFExp().flatten(f), getY().flatten(f)); }
    /**
     * @aspect Scalarization
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaMiddleEnd\\src\\jastadd\\scalarization\\Scalarization.jrag:1731
     */
    public FExp scalarizeExp(Scalarizer s)     { return createNode(getFExp().scalarize(s), getY().scalarize(s)); }
    /**
     * @aspect Derivatives
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaMiddleEnd\\src\\jastadd\\structural\\Differentiation.jrag:337
     */
    @Override
     ...
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaCBackEnd\\src\\jastadd\\CCodeGen\\CCodeGenExpressions.jrag:559
     */
    @Override
    ...
    @ASTNodeAnnotation.Constructor(
        name = {"OriginalArg", "FExp", "Y"},
        type = {"List<InstFunctionArgument>", "FExp", "FExp"},
        kind = {"List", "Child", "Child"}
    )
    public FAtan2Exp(List<InstFunctionArgument> p0, FExp p1, FExp p2) {
        setChild(p0, 0);
        setChild(p1, 1);
        setChild(p2, 2);
    }
    ...
    public MX toMX() {
        MX toMX_value = getFExp().toMX().arctan2(getY().toMX());
        return toMX_value;
    }
    /** @apilevel internal */
