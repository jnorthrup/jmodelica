 ...
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\ast\\FlatModelica.ast:297
 * @astdecl FNoType : FCellType;
 * @production FNoType : {@link FCellType};

 */
public class FNoType extends FCellType implements Cloneable {
    /**
     * @aspect BuiltInFlatTypes
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\TypeAnalysis.jrag:1221
     */
    public static final FNoType SCALAR                     = new FNoType(Size.SCALAR);
    /**
     * @aspect CodeFuncCallInOutArg
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaCBackEnd\\src\\jastadd\\CCodeGen\\CCodeGenFunctionIO.jrag:458
     */
    @Override
     ...
     */
    public FNoType clone() throws CloneNotSupportedException {
        FNoType node = (FNoType) super.clone();
        return node;
    }
    /** @apilevel internal 
     ...
     */
    public FNoType treeCopyNoTransform() {
        FNoType tree = (FNoType) copy();
        if (children != null) {
    ...
    protected boolean is$Equal(ASTNode node) {
        return super.is$Equal(node) && (tokenSize_Size == ((FNoType) node).tokenSize_Size);    
    }
    /**
    ...
    public String name() {
        String name_value = "(no return value)";
        return name_value;
    }
    /**
     * @attribute syn
