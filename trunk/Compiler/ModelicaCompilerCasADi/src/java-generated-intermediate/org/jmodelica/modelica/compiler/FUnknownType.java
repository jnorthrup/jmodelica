 ...
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\ast\\FlatModelica.ast:336
 * @astdecl FUnknownType : FCellType;
 * @production FUnknownType : {@link FCellType};

 */
public class FUnknownType extends FCellType implements Cloneable {
    /**
     * @aspect BuiltInFlatTypes
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\TypeAnalysis.jrag:1220
     */
    public static final FUnknownType SCALAR                = new FUnknownType(Size.SCALAR);
    /**
     ...
     */
    public FUnknownType clone() throws CloneNotSupportedException {
        FUnknownType node = (FUnknownType) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:44
     */
    public FUnknownType copy() {
        try {
            FUnknownType node = (FUnknownType) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    public FUnknownType treeCopyNoTransform() {
        FUnknownType tree = (FUnknownType) copy();
        if (children != null) {
    ...
    protected boolean is$Equal(ASTNode node) {
        return super.is$Equal(node) && (tokenSize_Size == ((FUnknownType) node).tokenSize_Size);    
    }
    /**
    ...
    public String name() {
        String name_value = "(unknown type)";
        return name_value;
    }
    /**
     * @attribute syn
    ...
    public FType arrayType(Size size) {
        FType arrayType_Size_value = this;
        return arrayType_Size_value;
    }
    /** @apilevel internal */
