 ...
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\ast\\FlatModelica.ast:103
 * @astdecl UnknownFVariable : FAbstractVariable;
 * @production UnknownFVariable : {@link FAbstractVariable};

 */
public class UnknownFVariable extends FAbstractVariable implements Cloneable {
    /**
     * @declaredat ASTNode:1
     */
    public UnknownFVariable() {
        super();
    }
    /**
     ...
     */
    public UnknownFVariable clone() throws CloneNotSupportedException {
        UnknownFVariable node = (UnknownFVariable) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:37
     */
    public UnknownFVariable copy() {
        try {
            UnknownFVariable node = (UnknownFVariable) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    @Deprecated
    public UnknownFVariable fullCopy() {
     ...
     */
    public UnknownFVariable treeCopyNoTransform() {
        UnknownFVariable tree = (UnknownFVariable) copy();
        if (children != null) {
     ...
     */
    public UnknownFVariable treeCopy() {
        doFullTraversal();
        return treeCopyNoTransform();
    }
    /** @apilevel internal 
    ...
    public FExp nominal() {
        FExp nominal_value = variableNominal();
     ...
     * @attribute syn
     * @aspect FlatNames
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\FlatUtil.jrag:970
     */
    @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
    @ASTNodeAnnotation.Source(aspect="FlatNames", declaredAt="C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\FlatUtil.jrag:970")
    public FExp createAccessExp() {
        FExp createAccessExp_value = null;
