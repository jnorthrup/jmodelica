 ...
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\ast\\FlatModelica.ast:781
 * @astdecl FDotAddExp : FArtmBinExp;
 * @production FDotAddExp : {@link FArtmBinExp};

 */
public class FDotAddExp extends FArtmBinExp implements Cloneable {
    /**
     * @aspect InheritedFactoryMethods
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:921
     */
    public FDotAddExp createEmptyNode()    { return new FDotAddExp();    }
    /**
     * @aspect FlatExpressions
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\flattening\\Flattening.jrag:2674
     */
     ...
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaMiddleEnd\\src\\jastadd\\optimizations\\AliasElimination.jrag:151
     */
    ...
    /**
     * @aspect Derivatives
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaMiddleEnd\\src\\jastadd\\structural\\Differentiation.jrag:163
     */
    @Override
    ...
    public FDotAddExp(FExp p0, FExp p1) {
        setChild(p0, 0);
        setChild(p1, 1);
    }
    /** @apilevel low-level 
     ...
     */
    public FDotAddExp clone() throws CloneNotSupportedException {
        FDotAddExp node = (FDotAddExp) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:47
     */
    public FDotAddExp copy() {
        try {
            FDotAddExp node = (FDotAddExp) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    public FDotAddExp treeCopyNoTransform() {
        FDotAddExp tree = (FDotAddExp) copy();
        if (children != null) {
    ...
    public CValue cevalEval(CValue left, CValue right) {
        CValue cevalEval_CValue_CValue_value = type().add(left, right);
    ...
    public FExp createNegated() {
        FExp createNegated_value = new FDotSubExp(new FNegExp(getLeft().fullCopy()), getRight().fullCopy());
    ...
    public FExp makeNegated() {
        FExp makeNegated_value = new FDotSubExp(new FNegExp(getLeft()), getRight());
    ...
    public FType rawType() {
        FType rawType_value = getLeft().type().looseTypePromotion(getRight().type(), false, operatorName());
    ...
    public String operatorName() {
        String operatorName_value = OP_ADD;
    ...
    public MX toMX() {
        MX toMX_value = getLeft().toMX().__add__(getRight().toMX());
        return toMX_value;
    }
    /** @apilevel internal */
    public ASTNode rewriteTo() {
        // Declared at C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaMiddleEnd\\src\\jastadd\\structural\\Symbolic.jrag:508
        if (getLeftNoTransform().isLiteralZero()) {
            return rewriteRule0();
        }
        // Declared at C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaMiddleEnd\\src\\jastadd\\structural\\Symbolic.jrag:509
    ...
    /**
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaMiddleEnd\\src\\jastadd\\structural\\Symbolic.jrag:508
     * @apilevel internal
     */    private FExp rewriteRule0() {
        return getRight();
    }
    /**
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaMiddleEnd\\src\\jastadd\\structural\\Symbolic.jrag:509
     * @apilevel internal
