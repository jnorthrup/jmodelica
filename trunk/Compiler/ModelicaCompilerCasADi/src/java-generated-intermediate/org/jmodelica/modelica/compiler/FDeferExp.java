...
/**
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\ast\\InstanceTree.ast:179
 * @astdecl FDeferExp : FExp ::= <FExp:FExp>;
 * @production FDeferExp : {@link FExp} ::= <span class="component">&lt;FExp:FExp&gt;</span>;

 */
public class FDeferExp extends FExp implements Cloneable {
    /**
     * @aspect InheritedFactoryMethods
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:994
     */
    public FDeferExp createEmptyNode()       { return new FDeferExp();       }
    /**
     * @aspect FlatPrettyPrint
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\PrettyPrint.jrag:1950
     */
     ...
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\flattening\\Flattening.jrag:2356
     */
    @Override
     ...
     */
    public FDeferExp clone() throws CloneNotSupportedException {
        FDeferExp node = (FDeferExp) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:44
     */
    public FDeferExp copy() {
        try {
            FDeferExp node = (FDeferExp) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    public FDeferExp treeCopyNoTransform() {
        FDeferExp tree = (FDeferExp) copy();
        if (children != null) {
    ...
    protected boolean is$Equal(ASTNode node) {
        return super.is$Equal(node) && (tokenFExp_FExp == ((FDeferExp) node).tokenFExp_FExp);    
    }
    /**
     * Replaces the lexeme FExp.
     * @param value The new value for the lexeme FExp.
     * @apilevel high-level
     */
    public void setFExp(FExp value) {
        tokenFExp_FExp = value;
    }
    /** @apilevel internal 
     */
    protected FExp tokenFExp_FExp;
    /**
     * Retrieves the value for the lexeme FExp.
     * @return The value for the lexeme FExp.
     * @apilevel high-level
     */
    @ASTNodeAnnotation.Token(name="FExp")
    public FExp getFExp() {
        return tokenFExp_FExp;
    }
    /**
    ...
    public Array getArray() {
        Array getArray_value = getFExp().getArray();
    ...
    public CValue cevalArray(VariableEvaluator evaluator, Index i) {
        CValue cevalArray_VariableEvaluator_Index_value = getFExp().cevalArray(evaluator, i);
    ...
    public FExp cell(Index i) {
        FExp cell_Index_value = getFExp().cell(i);
