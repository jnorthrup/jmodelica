...
/**
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\ast\\Modelica.ast:122
 * @astdecl SrcIntegerClassDecl : SrcPrimitiveClassDecl;
 * @production SrcIntegerClassDecl : {@link SrcPrimitiveClassDecl};

 */
public class SrcIntegerClassDecl extends SrcPrimitiveClassDecl implements Cloneable {
    /**
     * Create from a SrcFullClassDecl - will destroy that node!
     * @aspect PredefinedTypes
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\source\\PredefinedTypes.jrag:308
     */
    public SrcIntegerClassDecl(SrcFullClassDecl fcd) {
        super(fcd);
    }
    /**
     * @declaredat ASTNode:1
     */
    public SrcIntegerClassDecl() {
        super();
    }
    /**
    ...
    public SrcIntegerClassDecl(SrcIdDecl p0, boolean p1, boolean p2, SrcRestriction p3, boolean p4, boolean p5, boolean p6, boolean p7, boolean p8, Opt<SrcConstrainingClause> p9, Opt<SrcComment> p10, Opt<SrcStringComment> p11, List<SrcClause> p12, Opt<SrcExternalClause> p13, Opt<SrcAnnotation> p14, SrcEndDecl p15) {
        setChild(p0, 0);
        setEncapsulated(p1);
        setPartial(p2);
        setChild(p3, 1);
     ...
     */
    public SrcIntegerClassDecl clone() throws CloneNotSupportedException {
        SrcIntegerClassDecl node = (SrcIntegerClassDecl) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:66
     */
    public SrcIntegerClassDecl copy() {
        try {
            SrcIntegerClassDecl node = (SrcIntegerClassDecl) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    @Deprecated
    public SrcIntegerClassDecl fullCopy() {
     ...
     */
    public SrcIntegerClassDecl treeCopyNoTransform() {
        SrcIntegerClassDecl tree = (SrcIntegerClassDecl) copy();
        if (children != null) {
     ...
     */
    public SrcIntegerClassDecl treeCopy() {
        doFullTraversal();
        return treeCopyNoTransform();
    }
    /** @apilevel internal 
    ...
    protected boolean is$Equal(ASTNode node) {
        return super.is$Equal(node) && (tokenboolean_Encapsulated == ((SrcIntegerClassDecl) node).tokenboolean_Encapsulated) && (tokenboolean_Partial == ((SrcIntegerClassDecl) node).tokenboolean_Partial) && (tokenboolean_Redeclare == ((SrcIntegerClassDecl) node).tokenboolean_Redeclare) && (tokenboolean_Final == ((SrcIntegerClassDecl) node).tokenboolean_Final) && (tokenboolean_Inner == ((SrcIntegerClassDecl) node).tokenboolean_Inner) && (tokenboolean_Outer == ((SrcIntegerClassDecl) node).tokenboolean_Outer) && (tokenboolean_Replaceable == ((SrcIntegerClassDecl) node).tokenboolean_Replaceable);    
    }
    /**
