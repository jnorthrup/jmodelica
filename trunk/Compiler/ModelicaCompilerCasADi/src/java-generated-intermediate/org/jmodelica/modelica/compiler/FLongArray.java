 ...
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\ast\\FlatModelica.ast:1104
 * @astdecl FLongArray : FArray;
 * @production FLongArray : {@link FArray};

 */
public class FLongArray extends FArray implements Cloneable {
    /**
     * @aspect InheritedFactoryMethods
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:988
     */
    public FLongArray createEmptyNode()      { return new FLongArray();      }
    /**
     * @aspect FlatPrettyPrint
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\PrettyPrint.jrag:1921
     */
    ...
    public FLongArray(List<FExp> p0) {
        setChild(p0, 0);
    }
    /** @apilevel low-level 
     ...
     */
    public FLongArray clone() throws CloneNotSupportedException {
        FLongArray node = (FLongArray) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:46
     */
    public FLongArray copy() {
        try {
            FLongArray node = (FLongArray) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    public FLongArray treeCopyNoTransform() {
        FLongArray tree = (FLongArray) copy();
        if (children != null) {
