 ...
 * Addition expression.
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\ast\\FlatModelica.ast:786
 * @astdecl FAddExp : FDotAddExp;
 * @production FAddExp : {@link FDotAddExp};

 */
public class FAddExp extends FDotAddExp implements Cloneable {
    /**
     * @aspect InheritedFactoryMethods
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:916
     */
    public FAddExp createEmptyNode()       { return new FAddExp();       }
    /**
    ...
    public FAddExp(FExp p0, FExp p1) {
        setChild(p0, 0);
        setChild(p1, 1);
    }
    /** @apilevel low-level 
     ...
     */
    public FAddExp clone() throws CloneNotSupportedException {
        FAddExp node = (FAddExp) super.clone();
        return node;
    }
    /** @apilevel internal 
     ...
     */
    public FAddExp treeCopyNoTransform() {
        FAddExp tree = (FAddExp) copy();
        if (children != null) {
    ...
    public FExp createNegated() {
        FExp createNegated_value = new FSubExp(new FNegExp(getLeft().fullCopy()), getRight().fullCopy());
    ...
    public FExp makeNegated() {
        FExp makeNegated_value = new FSubExp(new FNegExp(getLeft()), getRight());
     ...
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\TypeAnalysis.jrag:335
     */
    @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
    @ASTNodeAnnotation.Source(aspect="FlatTypeAnalysis", declaredAt="C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\TypeAnalysis.jrag:335")
    public FType rawType() {
        FType rawType_value = getLeft().type().typePromotion(getRight().type(), false, operatorName());
