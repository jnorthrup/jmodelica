...
/**
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\ast\\InstanceTree.ast:47
 * @astdecl InstExtendClassDecl : InstFullClassDecl;
 * @production InstExtendClassDecl : {@link InstFullClassDecl};

 */
public class InstExtendClassDecl extends InstFullClassDecl implements Cloneable {
    /**
     * @declaredat ASTNode:1
     */
    public InstExtendClassDecl() {
        super();
    }
    /**
    ...
    public InstExtendClassDecl(SrcClassDecl p0, Opt<InstConstrainingClass> p1, InstRestriction p2, Opt<InstExternal> p3) {
        setSrcClassDecl(p0);
        setChild(p1, 0);
        setChild(p2, 1);
        setChild(p3, 2);
     ...
     */
    public InstExtendClassDecl clone() throws CloneNotSupportedException {
        InstExtendClassDecl node = (InstExtendClassDecl) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:59
     */
    public InstExtendClassDecl copy() {
        try {
            InstExtendClassDecl node = (InstExtendClassDecl) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    @Deprecated
    public InstExtendClassDecl fullCopy() {
     ...
     */
    public InstExtendClassDecl treeCopyNoTransform() {
        InstExtendClassDecl tree = (InstExtendClassDecl) copy();
        if (children != null) {
     ...
     */
    public InstExtendClassDecl treeCopy() {
        doFullTraversal();
        return treeCopyNoTransform();
    }
    /** @apilevel internal 
    ...
    protected boolean is$Equal(ASTNode node) {
        return super.is$Equal(node) && (tokenSrcClassDecl_SrcClassDecl == ((InstExtendClassDecl) node).tokenSrcClassDecl_SrcClassDecl);    
    }
    /**
