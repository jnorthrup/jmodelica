 ...
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\ast\\FlatModelica.ast:1214
 * @astdecl InstGivenArgument : InstFunctionArgument ::= FExp;
 * @production InstGivenArgument : {@link InstFunctionArgument} ::= <span class="component">{@link FExp}</span>;

 */
public abstract class InstGivenArgument extends InstFunctionArgument implements Cloneable {
    /**
     * @aspect InstFunctionBinding
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\instance\\InstFunctionBinding.jrag:888
     */
     ...
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\instance\\InstanceTree.jrag:1648
     */
    public FExp getOriginalFExp()    { return getFExpNoTransform(); }
    /**
     * @declaredat ASTNode:1
     */
    public InstGivenArgument() {
        super();
    }
    /**
    ...
    public InstGivenArgument(FExp p0) {
        setChild(p0, 0);
    }
    /** @apilevel low-level 
     ...
     */
    public InstGivenArgument clone() throws CloneNotSupportedException {
        InstGivenArgument node = (InstGivenArgument) super.clone();
        return node;
    }
    /**
     ...
     */
    @Deprecated
    public abstract InstGivenArgument fullCopy();
    /**
     * Create a deep copy of the AST subtree at this node.
     * The copy is dangling, i.e. has no parent.
     * @return dangling copy of the subtree at this node
     ...
     */
    public abstract InstGivenArgument treeCopyNoTransform();
    /**
     * Create a deep copy of the AST subtree at this node.
     ...
     */
    public abstract InstGivenArgument treeCopy();
    /**
    ...
    public boolean isVectorized() {
        ...
        isVectorized_value = getFExp().ndims() > getBoundInput().ndims() && inVectorizedCall();
