...
/**
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\ast\\Modelica.ast:162
 * @astdecl SrcInitialEquationClause : SrcEquationClause;
 * @production SrcInitialEquationClause : {@link SrcEquationClause};

 */
public class SrcInitialEquationClause extends SrcEquationClause implements Cloneable {
    /**
     * @declaredat ASTNode:1
     */
    public SrcInitialEquationClause() {
        super();
    }
    /**
    ...
    public SrcInitialEquationClause(List<SrcAbstractEquation> p0) {
        setChild(p0, 0);
    }
    /** @apilevel low-level 
     ...
     */
    public SrcInitialEquationClause clone() throws CloneNotSupportedException {
        SrcInitialEquationClause node = (SrcInitialEquationClause) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:46
     */
    public SrcInitialEquationClause copy() {
        try {
            SrcInitialEquationClause node = (SrcInitialEquationClause) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    @Deprecated
    public SrcInitialEquationClause fullCopy() {
     ...
     */
    public SrcInitialEquationClause treeCopyNoTransform() {
        SrcInitialEquationClause tree = (SrcInitialEquationClause) copy();
        if (children != null) {
     ...
     */
    public SrcInitialEquationClause treeCopy() {
        doFullTraversal();
        return treeCopyNoTransform();
    }
    /** @apilevel internal 
    ...
    public String clauseHeader(String separator) {
        String clauseHeader_String_value = "initial" + separator + "equation";
    ...
    public boolean isInitialEquationClause() {
        boolean isInitialEquationClause_value = true;
    ...
    public boolean Define_isInitial(ASTNode _callerNode, ASTNode _childNode) {
        if (_callerNode == getSrcAbstractEquationListNoTransform()) {
            ...
            return super.Define_isInitial(_callerNode, _childNode);
        }
    }
    /**
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\util\\Util.jrag:1415
