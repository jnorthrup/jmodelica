...
/**
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\ast\\InstanceTree.ast:172
 * @astdecl InstForIndexPrimitive : InstPrimitive;
 * @production InstForIndexPrimitive : {@link InstPrimitive};

 */
public class InstForIndexPrimitive extends InstPrimitive implements Cloneable {
    /**
     * @declaredat ASTNode:1
     */
    public InstForIndexPrimitive() {
        super();
    }
    /**
    ...
    public InstForIndexPrimitive(String p0, InstAccess p1, Opt<FArraySubscripts> p2, SrcComponentDecl p3, Opt<InstModification> p4, Opt<InstConstrainingComponent> p5, Opt<FExp> p6) {
        setName(p0);
        setChild(p1, 0);
        setChild(p2, 1);
     ...
     */
    public InstForIndexPrimitive(beaver.Symbol p0, InstAccess p1, Opt<FArraySubscripts> p2, SrcComponentDecl p3, Opt<InstModification> p4, Opt<InstConstrainingComponent> p5, Opt<FExp> p6) {
        setName(p0);
        setChild(p1, 0);
        setChild(p2, 1);
        setSrcComponentDecl(p3);
     ...
     */
    public InstForIndexPrimitive clone() throws CloneNotSupportedException {
        InstForIndexPrimitive node = (InstForIndexPrimitive) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:75
     */
    public InstForIndexPrimitive copy() {
        try {
            InstForIndexPrimitive node = (InstForIndexPrimitive) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    @Deprecated
    public InstForIndexPrimitive fullCopy() {
     ...
     */
    public InstForIndexPrimitive treeCopyNoTransform() {
        InstForIndexPrimitive tree = (InstForIndexPrimitive) copy();
        if (children != null) {
     ...
     */
    public InstForIndexPrimitive treeCopy() {
        doFullTraversal();
        return treeCopyNoTransform();
    }
    /** @apilevel internal 
    ...
    protected boolean is$Equal(ASTNode node) {
        return super.is$Equal(node) && (tokenString_Name == ((InstForIndexPrimitive) node).tokenString_Name) && (tokenSrcComponentDecl_SrcComponentDecl == ((InstForIndexPrimitive) node).tokenSrcComponentDecl_SrcComponentDecl);    
    }
    /**
    ...
    public FType primitiveScalarType() {
        FType primitiveScalarType_value = myInstForIndexType();
    ...
    public AnnotationNode evalAnnotation() {
        AnnotationNode evalAnnotation_value = AnnotationNode.NO_ANNOTATION;
        return evalAnnotation_value;
    }
    /** @apilevel internal */
    ...
    public Environment getMergedEnvironment() {
        ...
        getMergedEnvironment_value = new Environment();
    ...
    @ASTNodeAnnotation.Source(aspect="InstTypeAnalysis", declaredAt="C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\instance\\InstTypeAnalysis.jrag:67")
    public FType myInstForIndexType() {
        FType myInstForIndexType_value = getParent().Define_myInstForIndexType(this, null);
        return myInstForIndexType_value;
    }
    /** @apilevel internal */
