 ...
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\ast\\FlatModelica.ast:811
 * @astdecl FMulExp : FDotMulExp;
...
public class FMulExp extends FDotMulExp implements Cloneable {
    /**
     * @aspect Arrays
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Arrays.jrag:1423
     */
     ...
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:918
     */
    public FMulExp createEmptyNode()       { return new FMulExp();       }
    /**
     * @aspect FlatTypeCheck
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\errorcheck\\TypeCheck.jrag:860
     */
     ...
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaMiddleEnd\\src\\jastadd\\scalarization\\Scalarization.jrag:1607
     */
     ...
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaMiddleEnd\\src\\jastadd\\scalarization\\ScalarizeFunctions.jrag:527
     */
    ...
    /**
     * @aspect FunctionScalarization
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaMiddleEnd\\src\\jastadd\\scalarization\\ScalarizeFunctions.jrag:536
     */
    public void unknownFunctionArrayTemporariesMatrix(Scalarizer s) {
        ForNames names = s.getNames();
        FAccessExp sum = new FAccessExp(calcTempVarName());
        s.addTempVar(type().scalarType(), sum.name(), true);
    ...
    /**
     * @aspect FunctionScalarization
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaMiddleEnd\\src\\jastadd\\scalarization\\ScalarizeFunctions.jrag:588
     */
    public void unknownFunctionArrayTemporariesElementWise(Scalarizer s) {
        ForNames names = s.getNames();
        FAccessExp sum = new FAccessExp(calcTempVarName());
        s.addTempVar(type().scalarType(), sum.name(), true);
    ...
    /**
     * @aspect Variability
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Variability.jrag:522
     */
    private TypePrefixVariability refined_Variability_FMulExp_expVariability()
{
     ...
     * @attribute syn
     * @aspect Arrays
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Arrays.jrag:342
     */
    @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
    @ASTNodeAnnotation.Source(aspect="Arrays", declaredAt="C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Arrays.jrag:342")
    ...
    public TypePrefixVariability expVariability() {
        TypePrefixVariability expVariability_value = taggedByVProp ? Variability.CONSTANT : refined_Variability_FMulExp_expVariability();
    ...
    public boolean extractTemp() {
        boolean extractTemp_value = (inFunction() && myFClass().noUnrollingInFunctions() || extractAsUnknown())
                    && (!isElementWise() || isArray() && isFunctionCallIO()) || isForIndexExp();
