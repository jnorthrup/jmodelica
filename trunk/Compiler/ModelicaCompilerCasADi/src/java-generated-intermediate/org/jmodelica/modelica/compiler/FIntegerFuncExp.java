 ...
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\ast\\FlatModelica.ast:1415
 * @astdecl FIntegerFuncExp : FFloorFuncExp;
 * @production FIntegerFuncExp : {@link FFloorFuncExp};

 */
public class FIntegerFuncExp extends FFloorFuncExp implements Cloneable {
    /**
     * @aspect InheritedFactoryMethods
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:1035
     */
    public FIntegerFuncExp createEmptyNode()  { return new FIntegerFuncExp();  }
    /**
     * @aspect InheritedFactoryMethods
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:1397
     */
    public FIntegerFuncExp(FExp a1)      { this(emptyArgs(), a1); }
    /**
     * @declaredat ASTNode:1
     */
    public FIntegerFuncExp() {
        super();
    }
    /**
    ...
    public FIntegerFuncExp(List<InstFunctionArgument> p0, FExp p1) {
        setChild(p0, 0);
        setChild(p1, 1);
    }
    /** @apilevel low-level 
     ...
     */
    public FIntegerFuncExp clone() throws CloneNotSupportedException {
        FIntegerFuncExp node = (FIntegerFuncExp) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:48
     */
    public FIntegerFuncExp copy() {
        try {
            FIntegerFuncExp node = (FIntegerFuncExp) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    @Deprecated
    public FIntegerFuncExp fullCopy() {
     ...
     */
    public FIntegerFuncExp treeCopyNoTransform() {
        FIntegerFuncExp tree = (FIntegerFuncExp) copy();
        if (children != null) {
     ...
     */
    public FIntegerFuncExp treeCopy() {
        doFullTraversal();
        return treeCopyNoTransform();
    }
    /** @apilevel internal 
    ...
    public CValue cevalCalc(VariableEvaluator evaluator) {
        CValue cevalCalc_VariableEvaluator_value = getX().ceval(evaluator).convertInteger();
