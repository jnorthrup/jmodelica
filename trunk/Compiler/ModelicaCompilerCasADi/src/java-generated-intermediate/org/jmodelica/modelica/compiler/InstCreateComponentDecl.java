...
/**
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\ast\\InstanceTree.ast:134
 * @astdecl InstCreateComponentDecl : InstComponentDecl ::= <LookupNode:InstLookupRedirectNode>;
 * @production InstCreateComponentDecl : {@link InstComponentDecl} ::= <span class="component">&lt;LookupNode:InstLookupRedirectNode&gt;</span>;

 */
public class InstCreateComponentDecl extends InstComponentDecl implements Cloneable {
    /**
     * Constructor with only necessary args. 
     * @aspect Constructors
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:151
     */
    public InstCreateComponentDecl(SrcComponentDecl cd, InstLookupRedirectNode ln) {
        this(cd.name(), cd.getClassName().newInstAccess(), new Opt(), cd, new Opt(), new Opt(), new Opt(), ln);
    }
    /**
     * @declaredat ASTNode:1
     */
    public InstCreateComponentDecl() {
        super();
    }
    /**
    ...
    public InstCreateComponentDecl(String p0, InstAccess p1, Opt<FArraySubscripts> p2, SrcComponentDecl p3, Opt<InstModification> p4, Opt<InstConstrainingComponent> p5, Opt<FExp> p6, InstLookupRedirectNode p7) {
        setName(p0);
        setChild(p1, 0);
        setChild(p2, 1);
     ...
     */
    public InstCreateComponentDecl(beaver.Symbol p0, InstAccess p1, Opt<FArraySubscripts> p2, SrcComponentDecl p3, Opt<InstModification> p4, Opt<InstConstrainingComponent> p5, Opt<FExp> p6, InstLookupRedirectNode p7) {
        setName(p0);
        setChild(p1, 0);
        setChild(p2, 1);
        setSrcComponentDecl(p3);
     ...
     */
    public InstCreateComponentDecl clone() throws CloneNotSupportedException {
        InstCreateComponentDecl node = (InstCreateComponentDecl) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:76
     */
    public InstCreateComponentDecl copy() {
        try {
            InstCreateComponentDecl node = (InstCreateComponentDecl) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    @Deprecated
    public InstCreateComponentDecl fullCopy() {
     ...
     */
    public InstCreateComponentDecl treeCopyNoTransform() {
        InstCreateComponentDecl tree = (InstCreateComponentDecl) copy();
        if (children != null) {
     ...
     */
    public InstCreateComponentDecl treeCopy() {
        doFullTraversal();
        return treeCopyNoTransform();
    }
    /** @apilevel internal 
    ...
    protected boolean is$Equal(ASTNode node) {
        return super.is$Equal(node) && (tokenString_Name == ((InstCreateComponentDecl) node).tokenString_Name) && (tokenSrcComponentDecl_SrcComponentDecl == ((InstCreateComponentDecl) node).tokenSrcComponentDecl_SrcComponentDecl) && (tokenInstLookupRedirectNode_LookupNode == ((InstCreateComponentDecl) node).tokenInstLookupRedirectNode_LookupNode);    
    }
    /**
    ...
    public ASTNode rewriteTo() {
        // Declared at C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\instance\\InstanceTree.jrag:1107
        return rewriteRule0();
    }
    /**
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\instance\\InstanceTree.jrag:1107
     * @apilevel internal
     */    private InstComponentDecl rewriteRule0() {
        return getClassName().myInstClassDecl().newInstComponentDecl(getSrcComponentDecl());
    }
}
