 ...
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\ast\\FlatModelica.ast:1480
 * @astdecl FLogExp : FMathematicalFunctionCall;
 * @production FLogExp : {@link FMathematicalFunctionCall};

 */
public class FLogExp extends FMathematicalFunctionCall implements Cloneable {
    /**
     * @aspect InheritedFactoryMethods
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:1019
     */
    public FLogExp createEmptyNode()   { return new FLogExp();   }
    /**
     * @aspect InheritedFactoryMethods
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:1391
     */
    public FLogExp(FExp a1)                      { this(emptyArgs(), a1); }
    /**
     * @aspect Derivatives
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaMiddleEnd\\src\\jastadd\\structural\\Differentiation.jrag:369
     */
    @Override
     ...
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaCBackEnd\\src\\jastadd\\CCodeGen\\CCodeGenExpressions.jrag:534
     */
    @Override
    ...
    public FLogExp(List<InstFunctionArgument> p0, FExp p1) {
        setChild(p0, 0);
        setChild(p1, 1);
    }
    /** @apilevel low-level 
     ...
     */
    public FLogExp clone() throws CloneNotSupportedException {
        FLogExp node = (FLogExp) super.clone();
        return node;
    }
    /** @apilevel internal 
     ...
     */
    public FLogExp treeCopyNoTransform() {
        FLogExp tree = (FLogExp) copy();
        if (children != null) {
    ...
    public CValue cevalCalc(VariableEvaluator evaluator) {
        CValue cevalCalc_VariableEvaluator_value = new CValueReal(StrictMath.log(getFExp().ceval(evaluator).realValue()));
    ...
    public MX toMX() {
        MX toMX_value = getFExp().toMX().log();
        return toMX_value;
    }
    /** @apilevel internal */
