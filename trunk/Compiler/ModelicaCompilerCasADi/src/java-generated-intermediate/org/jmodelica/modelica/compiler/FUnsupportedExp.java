 ...
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\ast\\FlatModelica.ast:761
 * @astdecl FUnsupportedExp : FExp;
 * @production FUnsupportedExp : {@link FExp};

 */
public class FUnsupportedExp extends FExp implements Cloneable {
    /**
     * @aspect InheritedFactoryMethods
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:911
     */
    public FUnsupportedExp createEmptyNode()     { return new FUnsupportedExp();     }
    /**
     * @aspect FlatPrettyPrint
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\PrettyPrint.jrag:1612
     */
    protected void prettyPrintExp(Printer p, CodeStream str, String indent) {
	}
    /**
     * @aspect ComplianceCheck
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\errorcheck\\ComplianceCheck.jadd:132
     */
     ...
     */
    public FUnsupportedExp clone() throws CloneNotSupportedException {
        FUnsupportedExp node = (FUnsupportedExp) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:36
     */
    public FUnsupportedExp copy() {
        try {
            FUnsupportedExp node = (FUnsupportedExp) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    @Deprecated
    public FUnsupportedExp fullCopy() {
     ...
     */
    public FUnsupportedExp treeCopyNoTransform() {
        FUnsupportedExp tree = (FUnsupportedExp) copy();
        if (children != null) {
     ...
     */
    public FUnsupportedExp treeCopy() {
        doFullTraversal();
        return treeCopyNoTransform();
    }
    /** @apilevel internal 
