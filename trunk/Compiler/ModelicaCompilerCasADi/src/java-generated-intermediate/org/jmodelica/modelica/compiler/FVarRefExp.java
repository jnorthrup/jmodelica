 ...
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\ast\\FlatModelica.ast:997
 * @astdecl FVarRefExp : FAbstractArrayExp;
 * @production FVarRefExp : {@link FAbstractArrayExp};

 */
public abstract class FVarRefExp extends FAbstractArrayExp implements Cloneable {
    /**
     ...
     */
    public FVarRefExp clone() throws CloneNotSupportedException {
        FVarRefExp node = (FVarRefExp) super.clone();
        return node;
    }
    /**
     ...
     */
    @Deprecated
    public abstract FVarRefExp fullCopy();
    /**
     * Create a deep copy of the AST subtree at this node.
     * The copy is dangling, i.e. has no parent.
     * @return dangling copy of the subtree at this node
     ...
     */
    public abstract FVarRefExp treeCopyNoTransform();
    /**
     * Create a deep copy of the AST subtree at this node.
     ...
     */
    public abstract FVarRefExp treeCopy();
    /**
    ...
    public boolean isDynamicState() {
        boolean isDynamicState_value = false;
