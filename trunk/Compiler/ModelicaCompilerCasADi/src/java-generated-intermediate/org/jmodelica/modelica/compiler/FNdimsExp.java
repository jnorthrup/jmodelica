 ...
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\ast\\FlatModelica.ast:1490
 * @astdecl FNdimsExp : FUnaryBuiltIn;
 * @production FNdimsExp : {@link FUnaryBuiltIn};

 */
public class FNdimsExp extends FUnaryBuiltIn implements Cloneable {
    /**
     * @aspect InheritedFactoryMethods
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:1023
     */
    public FNdimsExp createEmptyNode()        { return new FNdimsExp();        }
    /**
     * @aspect ForceVariability
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\errorcheck\\ContentsCheck.jadd:936
     */
    public void forceUsesVariability(ErrorCheckType checkType, TypePrefixVariability v) {}
    /**
     * @aspect Scalarization
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaMiddleEnd\\src\\jastadd\\scalarization\\Scalarization.jrag:1639
     */
    ...
    public FNdimsExp(List<InstFunctionArgument> p0, FExp p1) {
        setChild(p0, 0);
        setChild(p1, 1);
    }
    /** @apilevel low-level 
     ...
     */
    public FNdimsExp clone() throws CloneNotSupportedException {
        FNdimsExp node = (FNdimsExp) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:50
     */
    public FNdimsExp copy() {
        try {
            FNdimsExp node = (FNdimsExp) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    public FNdimsExp treeCopyNoTransform() {
        FNdimsExp tree = (FNdimsExp) copy();
        if (children != null) {
    ...
    public CValue cevalCalc(VariableEvaluator evaluator) {
        CValue cevalCalc_VariableEvaluator_value = new CValueInteger(getFExp().ndims());
    ...
    public String builtInName() {
        String builtInName_value = "ndims";
    ...
    public boolean Define_argumentDefinedTypeValid(ASTNode _callerNode, ASTNode _childNode) {
        if (_callerNode == getOriginalArgListNoTransform()) {
            // @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\errorcheck\\TypeCheck.jrag:1684
