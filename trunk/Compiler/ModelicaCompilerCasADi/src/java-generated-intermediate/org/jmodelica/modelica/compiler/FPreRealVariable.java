 ...
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\ast\\FlatModelica.ast:176
 * @astdecl FPreRealVariable : FRealVariable;
 * @production FPreRealVariable : {@link FRealVariable};

 */
public class FPreRealVariable extends FRealVariable implements Cloneable {
    /**
     * Create a pre variable for a discrete real variable.
     * @aspect Constructors
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:519
     */
    public FPreRealVariable(FRealVariable fv) {
    ...
    public FPreRealVariable(VisibilityType p0, TypePrefixVariability p1, TypePrefixInputOutput p2, List<FAttribute> p3, String p4, Opt<FExp> p5, Opt<FStringComment> p6, FAccess p7) {
     ...
     */
    public FPreRealVariable(VisibilityType p0, TypePrefixVariability p1, TypePrefixInputOutput p2, List<FAttribute> p3, beaver.Symbol p4, Opt<FExp> p5, Opt<FStringComment> p6, FAccess p7) {
        setVisibilityType(p0);
        setTypePrefixVariability(p1);
        setTypePrefixInputOutput(p2);
        setChild(p3, 0);
     ...
     */
    public FPreRealVariable clone() throws CloneNotSupportedException {
        FPreRealVariable node = (FPreRealVariable) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:66
     */
    public FPreRealVariable copy() {
        try {
            FPreRealVariable node = (FPreRealVariable) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    @Deprecated
    public FPreRealVariable fullCopy() {
     ...
     */
    public FPreRealVariable treeCopyNoTransform() {
        FPreRealVariable tree = (FPreRealVariable) copy();
        if (children != null) {
     ...
     */
    public FPreRealVariable treeCopy() {
        doFullTraversal();
        return treeCopyNoTransform();
    }
    /** @apilevel internal 
    ...
    protected boolean is$Equal(ASTNode node) {
        return super.is$Equal(node) && (tokenVisibilityType_VisibilityType == ((FPreRealVariable) node).tokenVisibilityType_VisibilityType) && (tokenTypePrefixVariability_TypePrefixVariability == ((FPreRealVariable) node).tokenTypePrefixVariability_TypePrefixVariability) && (tokenTypePrefixInputOutput_TypePrefixInputOutput == ((FPreRealVariable) node).tokenTypePrefixInputOutput_TypePrefixInputOutput) && (tokenString_DerivedType == ((FPreRealVariable) node).tokenString_DerivedType);    
    }
    /**
