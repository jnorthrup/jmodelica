...
/**
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\ast\\Modelica.ast:120
 * @astdecl SrcPrimitiveClassDecl : SrcFullClassDecl;
 * @production SrcPrimitiveClassDecl : {@link SrcFullClassDecl};

 */
public class SrcPrimitiveClassDecl extends SrcFullClassDecl implements Cloneable {
    /**
     * @aspect InstanceTreeConstruction
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\instance\\InstanceTree.jrag:1419
     */
    public InstPrimitiveClassDecl newInstClassDecl() {
    	return new InstPrimitiveClassDecl(this, new Opt(), newInstRestriction(), newInstExternalOpt());
    }
    /**
     * @aspect InstanceTreeConstruction
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\instance\\InstanceTree.jrag:1446
     */
     ...
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\source\\PredefinedTypes.jrag:294
     */
    public SrcPrimitiveClassDecl(SrcFullClassDecl fcd) {
        super(fcd);
    }
    /**
     ...
     * @aspect PredefinedTypes
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\source\\PredefinedTypes.jrag:330
     */
    static public SrcPrimitiveClassDecl create(SrcFullClassDecl fcd) {
    ...
    public SrcPrimitiveClassDecl(SrcIdDecl p0, boolean p1, boolean p2, SrcRestriction p3, boolean p4, boolean p5, boolean p6, boolean p7, boolean p8, Opt<SrcConstrainingClause> p9, Opt<SrcComment> p10, Opt<SrcStringComment> p11, List<SrcClause> p12, Opt<SrcExternalClause> p13, Opt<SrcAnnotation> p14, SrcEndDecl p15) {
        setChild(p0, 0);
        setEncapsulated(p1);
        setPartial(p2);
        setChild(p3, 1);
     ...
     */
    public SrcPrimitiveClassDecl clone() throws CloneNotSupportedException {
        SrcPrimitiveClassDecl node = (SrcPrimitiveClassDecl) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:66
     */
    public SrcPrimitiveClassDecl copy() {
        try {
            SrcPrimitiveClassDecl node = (SrcPrimitiveClassDecl) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    @Deprecated
    public SrcPrimitiveClassDecl fullCopy() {
     ...
     */
    public SrcPrimitiveClassDecl treeCopyNoTransform() {
        SrcPrimitiveClassDecl tree = (SrcPrimitiveClassDecl) copy();
        if (children != null) {
     ...
     */
    public SrcPrimitiveClassDecl treeCopy() {
        doFullTraversal();
        return treeCopyNoTransform();
    }
    /** @apilevel internal 
    ...
    protected boolean is$Equal(ASTNode node) {
        return super.is$Equal(node) && (tokenboolean_Encapsulated == ((SrcPrimitiveClassDecl) node).tokenboolean_Encapsulated) && (tokenboolean_Partial == ((SrcPrimitiveClassDecl) node).tokenboolean_Partial) && (tokenboolean_Redeclare == ((SrcPrimitiveClassDecl) node).tokenboolean_Redeclare) && (tokenboolean_Final == ((SrcPrimitiveClassDecl) node).tokenboolean_Final) && (tokenboolean_Inner == ((SrcPrimitiveClassDecl) node).tokenboolean_Inner) && (tokenboolean_Outer == ((SrcPrimitiveClassDecl) node).tokenboolean_Outer) && (tokenboolean_Replaceable == ((SrcPrimitiveClassDecl) node).tokenboolean_Replaceable);    
    }
    /**
