 ...
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\ast\\FlatModelica.ast:1405
 * @astdecl FFloorFuncExp : FEventGenExp;
 * @production FFloorFuncExp : {@link FEventGenExp};

 */
public class FFloorFuncExp extends FEventGenExp implements Cloneable {
    /**
     * @aspect InheritedFactoryMethods
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:1034
     */
    public FFloorFuncExp createEmptyNode()    { return new FFloorFuncExp();    }
    /**
     * @aspect InheritedFactoryMethods
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:1398
     */
    public FFloorFuncExp(FExp a1)          { this(emptyArgs(), a1); }
    /**
     * @aspect Derivatives
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaMiddleEnd\\src\\jastadd\\structural\\Differentiation.jrag:672
     */
    @Override
     ...
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaCBackEnd\\src\\jastadd\\CCodeGen\\CCodeGenExpressions.jrag:134
     */
    @Override
    ...
    public FFloorFuncExp(List<InstFunctionArgument> p0, FExp p1) {
        setChild(p0, 0);
        setChild(p1, 1);
    }
    /** @apilevel low-level 
     ...
     */
    public FFloorFuncExp clone() throws CloneNotSupportedException {
        FFloorFuncExp node = (FFloorFuncExp) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:47
     */
    public FFloorFuncExp copy() {
        try {
            FFloorFuncExp node = (FFloorFuncExp) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    public FFloorFuncExp treeCopyNoTransform() {
        FFloorFuncExp tree = (FFloorFuncExp) copy();
        if (children != null) {
    ...
    public CValue cevalCalc(VariableEvaluator evaluator) {
        CValue cevalCalc_VariableEvaluator_value = getX().ceval(evaluator).convertInteger().convertReal();
    ...
    public String builtInName() {
        String builtInName_value = "floor";
