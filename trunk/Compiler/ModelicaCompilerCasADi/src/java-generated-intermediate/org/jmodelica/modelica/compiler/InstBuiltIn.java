...
/**
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\ast\\InstanceTree.ast:114
 * @astdecl InstBuiltIn : InstPrimitive;
 * @production InstBuiltIn : {@link InstPrimitive};

 */
public class InstBuiltIn extends InstPrimitive implements Cloneable {
    /**
     * @aspect InstanceErrorCheck
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\errorcheck\\ErrorCheck.jrag:1081
     */
    ...
    public InstBuiltIn(String p0, InstAccess p1, Opt<FArraySubscripts> p2, SrcComponentDecl p3, Opt<InstModification> p4, Opt<InstConstrainingComponent> p5, Opt<FExp> p6) {
        setName(p0);
        setChild(p1, 0);
        setChild(p2, 1);
     ...
     */
    public InstBuiltIn(beaver.Symbol p0, InstAccess p1, Opt<FArraySubscripts> p2, SrcComponentDecl p3, Opt<InstModification> p4, Opt<InstConstrainingComponent> p5, Opt<FExp> p6) {
        setName(p0);
        setChild(p1, 0);
        setChild(p2, 1);
        setSrcComponentDecl(p3);
     ...
     */
    public InstBuiltIn clone() throws CloneNotSupportedException {
        InstBuiltIn node = (InstBuiltIn) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:74
     */
    public InstBuiltIn copy() {
        try {
            InstBuiltIn node = (InstBuiltIn) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    public InstBuiltIn treeCopyNoTransform() {
        InstBuiltIn tree = (InstBuiltIn) copy();
        if (children != null) {
    ...
    protected boolean is$Equal(ASTNode node) {
        return super.is$Equal(node) && (tokenString_Name == ((InstBuiltIn) node).tokenString_Name) && (tokenSrcComponentDecl_SrcComponentDecl == ((InstBuiltIn) node).tokenSrcComponentDecl_SrcComponentDecl);    
    }
    /**
    ...
    public boolean isAttribute() {
        boolean isAttribute_value = true;
    ...
    public boolean isReal() {
        boolean isReal_value = myInstClass().finalClass().primitiveName().equals("RealType");
        return isReal_value;
    }
    /**
     * @attribute syn
    ...
    public boolean isInteger() {
        boolean isInteger_value = myInstClass().finalClass().primitiveName().equals("IntegerType");
    ...
    public boolean isBoolean() {
        boolean isBoolean_value = myInstClass().finalClass().primitiveName().equals("BooleanType");
    ...
    public boolean isString() {
        boolean isString_value = myInstClass().finalClass().primitiveName().equals("StringType");
