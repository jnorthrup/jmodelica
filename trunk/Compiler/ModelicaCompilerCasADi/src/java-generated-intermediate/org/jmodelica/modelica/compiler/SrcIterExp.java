...
/**
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\ast\\Modelica.ast:300
 * @astdecl SrcIterExp : SrcExp ::= SrcExp SrcForIndex*;
 * @production SrcIterExp : {@link SrcExp} ::= <span class="component">{@link SrcExp}</span> <span class="component">{@link SrcForIndex}*</span>;

 */
public class SrcIterExp extends SrcExp implements Cloneable {
    /**
     * @aspect InstantiatedExpressions
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\flattening\\Flattening.jrag:3151
     */
    ...
    @ASTNodeAnnotation.Constructor(
        name = {"SrcExp", "SrcForIndex"},
        type = {"SrcExp", "List<SrcForIndex>"},
        kind = {"Child", "List"}
    )
    public SrcIterExp(SrcExp p0, List<SrcForIndex> p1) {
        setChild(p0, 0);
        setChild(p1, 1);
    }
    /** @apilevel low-level 
     ...
     */
    public SrcIterExp clone() throws CloneNotSupportedException {
        SrcIterExp node = (SrcIterExp) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:47
     */
    public SrcIterExp copy() {
        try {
            SrcIterExp node = (SrcIterExp) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    public SrcIterExp treeCopyNoTransform() {
        SrcIterExp tree = (SrcIterExp) copy();
        if (children != null) {
