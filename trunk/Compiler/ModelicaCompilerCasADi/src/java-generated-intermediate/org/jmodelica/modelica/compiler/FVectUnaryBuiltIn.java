 ...
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\ast\\FlatModelica.ast:1278
 * @astdecl FVectUnaryBuiltIn : FUnaryBuiltIn;
 * @production FVectUnaryBuiltIn : {@link FUnaryBuiltIn};

 */
public abstract class FVectUnaryBuiltIn extends FUnaryBuiltIn implements Cloneable {
    /**
     * @declaredat ASTNode:1
     */
    public FVectUnaryBuiltIn() {
        super();
    }
    /**
    ...
    public FVectUnaryBuiltIn(List<InstFunctionArgument> p0, FExp p1) {
        setChild(p0, 0);
        setChild(p1, 1);
    }
    /** @apilevel low-level 
     ...
     */
    public FVectUnaryBuiltIn clone() throws CloneNotSupportedException {
        FVectUnaryBuiltIn node = (FVectUnaryBuiltIn) super.clone();
        return node;
    }
    /**
     ...
     */
    @Deprecated
    public abstract FVectUnaryBuiltIn fullCopy();
    /**
     * Create a deep copy of the AST subtree at this node.
     * The copy is dangling, i.e. has no parent.
     * @return dangling copy of the subtree at this node
     ...
     */
    public abstract FVectUnaryBuiltIn treeCopyNoTransform();
    /**
     * Create a deep copy of the AST subtree at this node.
     ...
     */
    public abstract FVectUnaryBuiltIn treeCopy();
    /**
    ...
    public Size size() {
        ...
        boolean isFinal = this.is$Final();
        state().enterLazyAttribute();
        size_value = getFExp().size().contractRight(ndims());
        if (isFinal && _boundaries == state().boundariesCrossed) {
        size_computed = true;
    ...
    public FType type() {
        ...
        boolean isFinal = this.is$Final();
        state().enterLazyAttribute();
        type_value = scalarType().sizedType(size());
        if (isFinal && _boundaries == state().boundariesCrossed) {
        type_computed = true;
    ...
    public FType scalarType() {
        FType scalarType_value = getFExp().type().scalarType();
    ...
    public boolean Define_argumentDefinedTypeValid(ASTNode _callerNode, ASTNode _childNode) {
        if (_callerNode == getOriginalArgListNoTransform()) {
            // @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\errorcheck\\TypeCheck.jrag:1687
