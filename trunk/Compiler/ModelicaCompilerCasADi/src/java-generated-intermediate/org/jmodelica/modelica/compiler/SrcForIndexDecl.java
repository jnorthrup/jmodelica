...
/**
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\ast\\Modelica.ast:252
 * @astdecl SrcForIndexDecl : SrcComponentDecl;
 * @production SrcForIndexDecl : {@link SrcComponentDecl};

 */
public class SrcForIndexDecl extends SrcComponentDecl implements Cloneable {
    /**
     * @declaredat ASTNode:1
     */
    public SrcForIndexDecl() {
        super();
    }
    /**
    ...
    public SrcForIndexDecl(SrcIdDecl p0, Opt<SrcArraySubscripts> p1, Opt<SrcModification> p2, Opt<SrcConditionalAttribute> p3, SrcComment p4) {
        setChild(p0, 0);
        setChild(p1, 1);
        setChild(p2, 2);
        setChild(p3, 3);
     ...
     */
    public SrcForIndexDecl clone() throws CloneNotSupportedException {
        SrcForIndexDecl node = (SrcForIndexDecl) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:52
     */
    public SrcForIndexDecl copy() {
        try {
            SrcForIndexDecl node = (SrcForIndexDecl) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    @Deprecated
    public SrcForIndexDecl fullCopy() {
     ...
     */
    public SrcForIndexDecl treeCopyNoTransform() {
        SrcForIndexDecl tree = (SrcForIndexDecl) copy();
        if (children != null) {
     ...
     */
    public SrcForIndexDecl treeCopy() {
        doFullTraversal();
        return treeCopyNoTransform();
    }
    /** @apilevel internal 
