 ...
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\ast\\FlatModelica.ast:1651
 * @astdecl FActualStream : FStreamBuiltIn;
 * @production FActualStream : {@link FStreamBuiltIn};

 */
public class FActualStream extends FStreamBuiltIn implements Cloneable {
    /**
     * @aspect InheritedFactoryMethods
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:1057
     */
    public FActualStream createEmptyNode()    { return new FActualStream();    }
    /**
     * @declaredat ASTNode:1
     */
    public FActualStream() {
        super();
    }
    /**
    ...
    public FActualStream(List<InstFunctionArgument> p0, FExp p1) {
        setChild(p0, 0);
        setChild(p1, 1);
    }
    /** @apilevel low-level 
     ...
     */
    public FActualStream clone() throws CloneNotSupportedException {
        FActualStream node = (FActualStream) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:47
     */
    public FActualStream copy() {
        try {
            FActualStream node = (FActualStream) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    public FActualStream treeCopyNoTransform() {
        FActualStream tree = (FActualStream) copy();
        if (children != null) {
    ...
    public String builtInName() {
        String builtInName_value = "actualStream";
        return builtInName_value;
    }
    /** @apilevel internal */
    public ASTNode rewriteTo() {
        // Declared at C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\flattening\\Connections.jrag:351
        if (rewriteStreams) {
            return rewriteRule0();
        }
    ...
    /**
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\flattening\\Connections.jrag:351
     * @apilevel internal
     */
