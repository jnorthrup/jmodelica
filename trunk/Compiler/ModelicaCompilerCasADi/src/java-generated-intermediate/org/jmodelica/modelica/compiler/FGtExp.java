 ...
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\ast\\FlatModelica.ast:861
 * @astdecl FGtExp : FRelExp;
 * @production FGtExp : {@link FRelExp};

 */
public class FGtExp extends FRelExp implements Cloneable {
    /**
     * @aspect InheritedFactoryMethods
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:932
     */
    public FGtExp createEmptyNode()  { return new FGtExp();  }
    /**
     * @aspect InheritedFactoryMethods
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:1426
     */
    public FGtExp(FExp e1, FExp e2)   { this(e1, e2, new Opt<FExp>(), (String) null); }
    /**
    ...
    public FGtExp(FExp p0, FExp p1, Opt<FExp> p2, String p3) {
        setChild(p0, 0);
        setChild(p1, 1);
        setChild(p2, 2);
     ...
     */
    public FGtExp(FExp p0, FExp p1, Opt<FExp> p2, beaver.Symbol p3) {
        setChild(p0, 0);
        setChild(p1, 1);
        setChild(p2, 2);
        setIndicatorVarName(p3);
     ...
     */
    public FGtExp clone() throws CloneNotSupportedException {
        FGtExp node = (FGtExp) super.clone();
        return node;
    }
    /** @apilevel internal 
     ...
     */
    public FGtExp treeCopyNoTransform() {
        FGtExp tree = (FGtExp) copy();
        if (children != null) {
    ...
    protected boolean is$Equal(ASTNode node) {
        return super.is$Equal(node) && (tokenString_IndicatorVarName == ((FGtExp) node).tokenString_IndicatorVarName);    
    }
    /**
    ...
    public CValue cevalEval(CValue left, CValue right) {
        CValue cevalEval_CValue_CValue_value = cevalType().gt(left, right);
    ...
    public String operatorName() {
        String operatorName_value = OP_GT;
    ...
    public String kindString() {
        String kindString_value = FRelExp.GT_C;
    ...
    public String kindStringPhased() {
        String kindStringPhased_value = FRelExp.GEQ_C;
    ...
    public String macro_C() {
        String macro_C_value = "COND_EXP_GT";
    ...
    public MX toMX() {
        MX toMX_value = getRight().toMX().__lt__(getLeft().toMX());
        return toMX_value;
    }
    /** @apilevel internal */
