...
/**
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\ast\\Modelica.ast:168
 * @astdecl SrcInlineExtendsClause : SrcExtendsClause;
 * @production SrcInlineExtendsClause : {@link SrcExtendsClause};

 */
public class SrcInlineExtendsClause extends SrcExtendsClause implements Cloneable {
    /**
     * @aspect InstanceTreeConstruction
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\instance\\InstanceTree.jrag:1564
     */
    ...
    public SrcInlineExtendsClause(SrcAccess p0, Opt<SrcClassModification> p1, Opt<SrcAnnotation> p2) {
        setChild(p0, 0);
        setChild(p1, 1);
        setChild(p2, 2);
    }
     ...
     */
    public SrcInlineExtendsClause clone() throws CloneNotSupportedException {
        SrcInlineExtendsClause node = (SrcInlineExtendsClause) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:49
     */
    public SrcInlineExtendsClause copy() {
        try {
            SrcInlineExtendsClause node = (SrcInlineExtendsClause) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    @Deprecated
    public SrcInlineExtendsClause fullCopy() {
     ...
     */
    public SrcInlineExtendsClause treeCopyNoTransform() {
        SrcInlineExtendsClause tree = (SrcInlineExtendsClause) copy();
        if (children != null) {
     ...
     */
    public SrcInlineExtendsClause treeCopy() {
        doFullTraversal();
        return treeCopyNoTransform();
    }
    /** @apilevel internal 
