...
/**
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\ast\\Modelica.ast:243
 * @astdecl SrcIfWhenEquation : SrcIfWhenElseEquation ::= Test:SrcExp [Else:SrcIfWhenElseEquation];
 * @production SrcIfWhenEquation : {@link SrcIfWhenElseEquation} ::= <span class="component">Test:{@link SrcExp}</span> <span class="component">[Else:{@link SrcIfWhenElseEquation}]</span>;

 */
public abstract class SrcIfWhenEquation extends SrcIfWhenElseEquation implements Cloneable {
    /**
     * @aspect InstantiatedExpressions
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\flattening\\Flattening.jrag:2942
     */
    protected FIfWhenEquation instantiate(FIfWhenEquation res) {
    ...
    public SrcIfWhenEquation(SrcComment p0, List<SrcAbstractEquation> p1, SrcExp p2, Opt<SrcIfWhenElseEquation> p3) {
        setChild(p0, 0);
        setChild(p1, 1);
        setChild(p2, 2);
        setChild(p3, 3);
     ...
     */
    public SrcIfWhenEquation clone() throws CloneNotSupportedException {
        SrcIfWhenEquation node = (SrcIfWhenEquation) super.clone();
        return node;
    }
    /**
     ...
     */
    @Deprecated
    public abstract SrcIfWhenEquation fullCopy();
    /**
     * Create a deep copy of the AST subtree at this node.
     * The copy is dangling, i.e. has no parent.
     * @return dangling copy of the subtree at this node
     ...
     */
    public abstract SrcIfWhenEquation treeCopyNoTransform();
    /**
     * Create a deep copy of the AST subtree at this node.
     ...
     */
    public abstract SrcIfWhenEquation treeCopy();
    /**
