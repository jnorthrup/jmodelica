 ...
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\ast\\FlatModelica.ast:851
 * @astdecl FLtExp : FRelExp;
 * @production FLtExp : {@link FRelExp};

 */
public class FLtExp extends FRelExp implements Cloneable {
    /**
     * @aspect InheritedFactoryMethods
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:930
     */
    public FLtExp createEmptyNode()  { return new FLtExp();  }
    /**
     * @aspect InheritedFactoryMethods
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:1424
     */
    public FLtExp(FExp e1, FExp e2)   { this(e1, e2, new Opt<FExp>(), (String) null); }
    /**
    ...
    public FLtExp(FExp p0, FExp p1, Opt<FExp> p2, String p3) {
        setChild(p0, 0);
        setChild(p1, 1);
        setChild(p2, 2);
     ...
     */
    public FLtExp(FExp p0, FExp p1, Opt<FExp> p2, beaver.Symbol p3) {
        setChild(p0, 0);
        setChild(p1, 1);
        setChild(p2, 2);
        setIndicatorVarName(p3);
     ...
     */
    public FLtExp clone() throws CloneNotSupportedException {
        FLtExp node = (FLtExp) super.clone();
        return node;
    }
    /** @apilevel internal 
     ...
     */
    public FLtExp treeCopyNoTransform() {
        FLtExp tree = (FLtExp) copy();
        if (children != null) {
    ...
    protected boolean is$Equal(ASTNode node) {
        return super.is$Equal(node) && (tokenString_IndicatorVarName == ((FLtExp) node).tokenString_IndicatorVarName);    
    }
    /**
    ...
    public CValue cevalEval(CValue left, CValue right) {
        CValue cevalEval_CValue_CValue_value = cevalType().lt(left, right);
    ...
    public String operatorName() {
        String operatorName_value = OP_LT;
    ...
    public String kindString() {
        String kindString_value = FRelExp.LT_C;
    ...
    public String kindStringPhased() {
        String kindStringPhased_value = FRelExp.LEQ_C;
    ...
    public String macro_C() {
        String macro_C_value = "COND_EXP_LT";
    ...
    public MX toMX() {
        MX toMX_value = getLeft().toMX().__lt__(getRight().toMX());
        return toMX_value;
    }
    /** @apilevel internal */
