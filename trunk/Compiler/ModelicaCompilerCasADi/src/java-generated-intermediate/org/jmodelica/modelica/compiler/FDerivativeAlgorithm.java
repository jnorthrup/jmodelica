 ...
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\ast\\FlatModelica.ast:598
 * @astdecl FDerivativeAlgorithm : FAlgorithm ::= <Order:int>;
...
public class FDerivativeAlgorithm extends FAlgorithm implements Cloneable {
     ...
     * @aspect Constructors
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:192
     */
    ...
    @ASTNodeAnnotation.Constructor(
        name = {"Type", "FAttribute", "FStringComment", "FStatement", "Order"},
        type = {"EquationType", "List<FAttribute>", "Opt<FStringComment>", "List<FStatement>", "int"},
        kind = {"Token", "List", "Opt", "List", "Token"}
    )
    public FDerivativeAlgorithm(EquationType p0, List<FAttribute> p1, Opt<FStringComment> p2, List<FStatement> p3, int p4) {
        setType(p0);
        setChild(p1, 0);
        setChild(p2, 1);
        setChild(p3, 2);
    ...
    protected boolean is$Equal(ASTNode node) {
        return super.is$Equal(node) && (tokenEquationType_Type == ((FDerivativeAlgorithm) node).tokenEquationType_Type) && (tokenint_Order == ((FDerivativeAlgorithm) node).tokenint_Order);    
    }
    /**
