...
/**
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\ast\\Modelica.ast:228
 * @astdecl SrcElementRedeclare : SrcNamedModification;
 * @production SrcElementRedeclare : {@link SrcNamedModification};

 */
public abstract class SrcElementRedeclare extends SrcNamedModification implements Cloneable {
    /**
     * @declaredat ASTNode:1
     */
    public SrcElementRedeclare() {
        super();
    }
    /**
    ...
    public SrcElementRedeclare(boolean p0, boolean p1, SrcAccess p2) {
        setEach(p0);
        setFinal(p1);
        setChild(p2, 0);
    }
     ...
     */
    public SrcElementRedeclare clone() throws CloneNotSupportedException {
        SrcElementRedeclare node = (SrcElementRedeclare) super.clone();
        return node;
    }
    /**
     ...
     */
    @Deprecated
    public abstract SrcElementRedeclare fullCopy();
    /**
     * Create a deep copy of the AST subtree at this node.
     * The copy is dangling, i.e. has no parent.
     * @return dangling copy of the subtree at this node
     ...
     */
    public abstract SrcElementRedeclare treeCopyNoTransform();
    /**
     * Create a deep copy of the AST subtree at this node.
     ...
     */
    public abstract SrcElementRedeclare treeCopy();
    /**
