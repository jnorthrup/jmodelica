...
/**
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\ast\\InstanceTree.ast:136
 * @astdecl InstCreateReplacingComponentDecl : InstCreateComponentDecl ::= <OriginalDecl:SrcComponentDecl> <InstComponentRedeclare:InstComponentRedeclare> <InstConstrainingRedeclare:InstComponentRedeclare>;
 * @production InstCreateReplacingComponentDecl : {@link InstCreateComponentDecl} ::= <span class="component">&lt;OriginalDecl:SrcComponentDecl&gt;</span> <span class="component">&lt;InstComponentRedeclare:InstComponentRedeclare&gt;</span> <span class="component">&lt;InstConstrainingRedeclare:InstComponentRedeclare&gt;</span>;

 */
public class InstCreateReplacingComponentDecl extends InstCreateComponentDecl implements Cloneable {
    /**
     * Constructor with only necessary args. 
     * @aspect Constructors
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:168
     */
    public InstCreateReplacingComponentDecl(
    ...
    @ASTNodeAnnotation.Constructor(
        name = {"Name", "ClassName", "LocalFArraySubscripts", "SrcComponentDecl", "InstModification", "InstConstrainingComponent", "ConditionalAttribute", "LookupNode", "OriginalDecl", "InstComponentRedeclare", "InstConstrainingRedeclare"},
        type = {"String", "InstAccess", "Opt<FArraySubscripts>", "SrcComponentDecl", "Opt<InstModification>", "Opt<InstConstrainingComponent>", "Opt<FExp>", "InstLookupRedirectNode", "SrcComponentDecl", "InstComponentRedeclare", "InstComponentRedeclare"},
        kind = {"Token", "Child", "Opt", "Token", "Opt", "Opt", "Opt", "Token", "Token", "Token", "Token"}
    )
    public InstCreateReplacingComponentDecl(String p0, InstAccess p1, Opt<FArraySubscripts> p2, SrcComponentDecl p3, Opt<InstModification> p4, Opt<InstConstrainingComponent> p5, Opt<FExp> p6, InstLookupRedirectNode p7, SrcComponentDecl p8, InstComponentRedeclare p9, InstComponentRedeclare p10) {
        setName(p0);
        setChild(p1, 0);
        setChild(p2, 1);
        ...
        setLookupNode(p7);
        setOriginalDecl(p8);
        setInstComponentRedeclare(p9);
        setInstConstrainingRedeclare(p10);
    }
    /**
     * @declaredat ASTNode:45
     */
    public InstCreateReplacingComponentDecl(beaver.Symbol p0, InstAccess p1, Opt<FArraySubscripts> p2, SrcComponentDecl p3, Opt<InstModification> p4, Opt<InstConstrainingComponent> p5, Opt<FExp> p6, InstLookupRedirectNode p7, SrcComponentDecl p8, InstComponentRedeclare p9, InstComponentRedeclare p10) {
        setName(p0);
        setChild(p1, 0);
        setChild(p2, 1);
        setSrcComponentDecl(p3);
     ...
     */
    public InstCreateReplacingComponentDecl clone() throws CloneNotSupportedException {
        InstCreateReplacingComponentDecl node = (InstCreateReplacingComponentDecl) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:82
     */
    public InstCreateReplacingComponentDecl copy() {
        try {
            InstCreateReplacingComponentDecl node = (InstCreateReplacingComponentDecl) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    @Deprecated
    public InstCreateReplacingComponentDecl fullCopy() {
     ...
     */
    public InstCreateReplacingComponentDecl treeCopyNoTransform() {
        InstCreateReplacingComponentDecl tree = (InstCreateReplacingComponentDecl) copy();
        if (children != null) {
     ...
     */
    public InstCreateReplacingComponentDecl treeCopy() {
        doFullTraversal();
        return treeCopyNoTransform();
    }
    /** @apilevel internal 
    ...
    protected boolean is$Equal(ASTNode node) {
        return super.is$Equal(node) && (tokenString_Name == ((InstCreateReplacingComponentDecl) node).tokenString_Name) && (tokenSrcComponentDecl_SrcComponentDecl == ((InstCreateReplacingComponentDecl) node).tokenSrcComponentDecl_SrcComponentDecl) && (tokenInstLookupRedirectNode_LookupNode == ((InstCreateReplacingComponentDecl) node).tokenInstLookupRedirectNode_LookupNode) && (tokenSrcComponentDecl_OriginalDecl == ((InstCreateReplacingComponentDecl) node).tokenSrcComponentDecl_OriginalDecl) && (tokenInstComponentRedeclare_InstComponentRedeclare == ((InstCreateReplacingComponentDecl) node).tokenInstComponentRedeclare_InstComponentRedeclare) && (tokenInstComponentRedeclare_InstConstrainingRedeclare == ((InstCreateReplacingComponentDecl) node).tokenInstComponentRedeclare_InstConstrainingRedeclare);    
    }
    /**
    ...
    /**
     * Replaces the lexeme LookupNode.
     * @param value The new value for the lexeme LookupNode.
     * @apilevel high-level
     */
    public void setLookupNode(InstLookupRedirectNode value) {
        tokenInstLookupRedirectNode_LookupNode = value;
    }
    /**
     * Retrieves the value for the lexeme LookupNode.
     * @return The value for the lexeme LookupNode.
     * @apilevel high-level
     */
    @ASTNodeAnnotation.Token(name="LookupNode")
    public InstLookupRedirectNode getLookupNode() {
        return tokenInstLookupRedirectNode_LookupNode;
    }
    /**
    ...
    /**
     * Replaces the lexeme InstConstrainingRedeclare.
     * @param value The new value for the lexeme InstConstrainingRedeclare.
     * @apilevel high-level
     */
    public void setInstConstrainingRedeclare(InstComponentRedeclare value) {
        tokenInstComponentRedeclare_InstConstrainingRedeclare = value;
    }
    /** @apilevel internal 
     */
    protected InstComponentRedeclare tokenInstComponentRedeclare_InstConstrainingRedeclare;
    /**
     * Retrieves the value for the lexeme InstConstrainingRedeclare.
     * @return The value for the lexeme InstConstrainingRedeclare.
     * @apilevel high-level
     */
    @ASTNodeAnnotation.Token(name="InstConstrainingRedeclare")
    public InstComponentRedeclare getInstConstrainingRedeclare() {
        return tokenInstComponentRedeclare_InstConstrainingRedeclare;
    }
    /**
    ...
    public ASTNode rewriteTo() {
        // Declared at C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\instance\\InstanceTree.jrag:1101
        return rewriteRule0();
    }
    /**
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\instance\\InstanceTree.jrag:1101
     * @apilevel internal
     */    private InstComponentDecl rewriteRule0() {
        return getClassName().myInstClassDecl().newInstReplacingComponent(
