 ...
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\ast\\FlatModelica.ast:181
 * @astdecl FPreIntegerVariable : FIntegerVariable;
 * @production FPreIntegerVariable : {@link FIntegerVariable};

 */
public class FPreIntegerVariable extends FIntegerVariable implements Cloneable {
    /**
     * Create a pre variable for an integer variable.
     * @aspect Constructors
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:536
     */
    public FPreIntegerVariable(FIntegerVariable fv) {
    ...
    public FPreIntegerVariable(VisibilityType p0, TypePrefixVariability p1, TypePrefixInputOutput p2, List<FAttribute> p3, String p4, Opt<FExp> p5, Opt<FStringComment> p6, FAccess p7) {
     ...
     */
    public FPreIntegerVariable(VisibilityType p0, TypePrefixVariability p1, TypePrefixInputOutput p2, List<FAttribute> p3, beaver.Symbol p4, Opt<FExp> p5, Opt<FStringComment> p6, FAccess p7) {
        setVisibilityType(p0);
        setTypePrefixVariability(p1);
        setTypePrefixInputOutput(p2);
        setChild(p3, 0);
     ...
     */
    public FPreIntegerVariable clone() throws CloneNotSupportedException {
        FPreIntegerVariable node = (FPreIntegerVariable) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:66
     */
    public FPreIntegerVariable copy() {
        try {
            FPreIntegerVariable node = (FPreIntegerVariable) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    @Deprecated
    public FPreIntegerVariable fullCopy() {
     ...
     */
    public FPreIntegerVariable treeCopyNoTransform() {
        FPreIntegerVariable tree = (FPreIntegerVariable) copy();
        if (children != null) {
     ...
     */
    public FPreIntegerVariable treeCopy() {
        doFullTraversal();
        return treeCopyNoTransform();
    }
    /** @apilevel internal 
    ...
    protected boolean is$Equal(ASTNode node) {
        return super.is$Equal(node) && (tokenVisibilityType_VisibilityType == ((FPreIntegerVariable) node).tokenVisibilityType_VisibilityType) && (tokenTypePrefixVariability_TypePrefixVariability == ((FPreIntegerVariable) node).tokenTypePrefixVariability_TypePrefixVariability) && (tokenTypePrefixInputOutput_TypePrefixInputOutput == ((FPreIntegerVariable) node).tokenTypePrefixInputOutput_TypePrefixInputOutput) && (tokenString_DerivedType == ((FPreIntegerVariable) node).tokenString_DerivedType);    
    }
    /**
