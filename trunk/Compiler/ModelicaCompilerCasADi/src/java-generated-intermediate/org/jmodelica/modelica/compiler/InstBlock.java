...
/**
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\ast\\InstanceTree.ast:73
 * @astdecl InstBlock : InstRestriction;
 * @production InstBlock : {@link InstRestriction};

 */
public class InstBlock extends InstRestriction implements Cloneable {
    /**
     ...
     */
    public InstBlock clone() throws CloneNotSupportedException {
        InstBlock node = (InstBlock) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:36
     */
    public InstBlock copy() {
        try {
            InstBlock node = (InstBlock) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    public InstBlock treeCopyNoTransform() {
        InstBlock tree = (InstBlock) copy();
        if (children != null) {
