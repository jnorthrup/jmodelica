...
/**
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\ast\\InstanceTree.ast:80
 * @astdecl InstMRecord : InstRestriction;
 * @production InstMRecord : {@link InstRestriction};

 */
public class InstMRecord extends InstRestriction implements Cloneable {
    /**
     * @aspect Flattening
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\flattening\\Flattening.jrag:727
     */
     ...
     */
    public InstMRecord clone() throws CloneNotSupportedException {
        InstMRecord node = (InstMRecord) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:36
     */
    public InstMRecord copy() {
        try {
            InstMRecord node = (InstMRecord) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    public InstMRecord treeCopyNoTransform() {
        InstMRecord tree = (InstMRecord) copy();
        if (children != null) {
    ...
    public FRecordType createEmptyFRecordType(Size s) {
        FRecordType createEmptyFRecordType_Size_value = new FRecordType(s, myInstClassDecl().qualifiedName(), new List(), null);
