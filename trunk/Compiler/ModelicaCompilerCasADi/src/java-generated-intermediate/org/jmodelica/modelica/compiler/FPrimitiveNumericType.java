 ...
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\ast\\FlatModelica.ast:302
 * @astdecl FPrimitiveNumericType : FPrimitiveType;
 * @production FPrimitiveNumericType : {@link FPrimitiveType};

 */
public abstract class FPrimitiveNumericType extends FPrimitiveType implements Cloneable {
    /**
     * @aspect BuiltInFlatTypes
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\TypeAnalysis.jrag:1446
     */
    ...
    /**
     * @aspect BuiltInFlatTypes
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\TypeAnalysis.jrag:1479
     */
    ...
    public FPrimitiveNumericType(Size p0) {
        setSize(p0);
    }
    /** @apilevel low-level 
     ...
     */
    public FPrimitiveNumericType clone() throws CloneNotSupportedException {
        FPrimitiveNumericType node = (FPrimitiveNumericType) super.clone();
        return node;
    }
    /**
     ...
     */
    @Deprecated
    public abstract FPrimitiveNumericType fullCopy();
    /**
     * Create a deep copy of the AST subtree at this node.
     * The copy is dangling, i.e. has no parent.
     * @return dangling copy of the subtree at this node
     ...
     */
    public abstract FPrimitiveNumericType treeCopyNoTransform();
    /**
     * Create a deep copy of the AST subtree at this node.
     ...
     */
    public abstract FPrimitiveNumericType treeCopy();
    /**
    ...
    public boolean equivalentTo(CommonType type, boolean allowUnknown) {
        boolean equivalentTo_CommonType_boolean_value = type.isNumeric() && dimensionCompatible(type, allowUnknown);
