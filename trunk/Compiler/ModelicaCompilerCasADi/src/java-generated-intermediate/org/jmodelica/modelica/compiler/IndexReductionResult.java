 ...
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaMiddleEnd\\src\\jastadd\\structural\\IndexReduction.jrag:1478
 */
public class IndexReductionResult extends java.lang.Object {
    private Collection<IndexReductionBiPGraph.DSSet> dsSets = new ArrayList<IndexReductionBiPGraph.DSSet>();

    public void addDSSet(IndexReductionBiPGraph.DSSet set) {
        dsSets.add(set);
    }

    public Collection<IndexReductionBiPGraph.DSSet> getDSSets() {
        return dsSets;
    }

    public void markDSAsFailed() {
        dsSets = null;
    }

    public boolean hasDSFailed() {
        return dsSets == null;
    }
