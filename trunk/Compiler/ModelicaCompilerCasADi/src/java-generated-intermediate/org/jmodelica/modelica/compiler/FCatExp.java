 ...
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\ast\\FlatModelica.ast:1121
 * @astdecl FCatExp : FAbstractCat ::= Dim:FExp;
 * @production FCatExp : {@link FAbstractCat} ::= <span class="component">Dim:{@link FExp}</span>;

 */
public class FCatExp extends FAbstractCat implements Cloneable {
    /**
     * @aspect Components
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Components.jrag:120
     */
     ...
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:990
     */
    public FCatExp createEmptyNode()         { return new FCatExp();         }
    /**
     * @aspect FlatPrettyPrint
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\PrettyPrint.jrag:1803
     */
     ...
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\errorcheck\\TypeCheck.jrag:1204
     */
     ...
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\flattening\\Flattening.jrag:2714
     */
    public FCatExp flatten(Flattener f) {
    ...
    /**
     * @aspect Derivatives
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaMiddleEnd\\src\\jastadd\\structural\\Differentiation.jrag:686
     */
    @Override
    ...
    public FCatExp(List<InstFunctionArgument> p0, List<FExp> p1, FExp p2) {
        setChild(p0, 0);
        setChild(p1, 1);
        setChild(p2, 2);
    }
     ...
     */
    public FCatExp clone() throws CloneNotSupportedException {
        FCatExp node = (FCatExp) super.clone();
        return node;
    }
    /** @apilevel internal 
     ...
     */
    public FCatExp treeCopyNoTransform() {
        FCatExp tree = (FCatExp) copy();
        if (children != null) {
    ...
    /**
     * Replaces the Dim child.
     * @param node The new node to replace the Dim child.
     * @apilevel high-level
     */
    ...
    /**
     * Retrieves the Dim child.
     * @return The current node used as the Dim child.
     * @apilevel high-level
     */
    @ASTNodeAnnotation.Child(name="Dim")
    public FExp getDim() {
    ...
    public int ndimsForArg(int i) {
        int ndimsForArg_int_value = getFExp(i).ndims();
    ...
    public boolean dimensionIsOk() {
        boolean dimensionIsOk_value = getDim().isConstantExp() && 
