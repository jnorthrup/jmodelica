...
/**
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\ast\\InstanceTree.ast:54
 * @astdecl UnknownInstClassDecl : InstFullClassDecl;
 * @production UnknownInstClassDecl : {@link InstFullClassDecl};

 */
public class UnknownInstClassDecl extends InstFullClassDecl implements Cloneable {
    /**
     * @aspect InstanceErrorCheck
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\errorcheck\\ErrorCheck.jrag:620
     */
    ...
    public UnknownInstClassDecl(SrcClassDecl p0, Opt<InstConstrainingClass> p1, InstRestriction p2, Opt<InstExternal> p3) {
        setSrcClassDecl(p0);
        setChild(p1, 0);
        setChild(p2, 1);
        setChild(p3, 2);
     ...
     */
    public UnknownInstClassDecl clone() throws CloneNotSupportedException {
        UnknownInstClassDecl node = (UnknownInstClassDecl) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:59
     */
    public UnknownInstClassDecl copy() {
        try {
            UnknownInstClassDecl node = (UnknownInstClassDecl) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    @Deprecated
    public UnknownInstClassDecl fullCopy() {
     ...
     */
    public UnknownInstClassDecl treeCopyNoTransform() {
        UnknownInstClassDecl tree = (UnknownInstClassDecl) copy();
        if (children != null) {
     ...
     */
    public UnknownInstClassDecl treeCopy() {
        doFullTraversal();
        return treeCopyNoTransform();
    }
    /** @apilevel internal 
    ...
    protected boolean is$Equal(ASTNode node) {
        return super.is$Equal(node) && (tokenSrcClassDecl_SrcClassDecl == ((UnknownInstClassDecl) node).tokenSrcClassDecl_SrcClassDecl);    
    }
    /**
