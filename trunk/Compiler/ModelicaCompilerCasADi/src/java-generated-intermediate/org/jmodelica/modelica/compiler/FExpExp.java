 ...
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\ast\\FlatModelica.ast:1475
 * @astdecl FExpExp : FMathematicalFunctionCall;
 * @production FExpExp : {@link FMathematicalFunctionCall};

 */
public class FExpExp extends FMathematicalFunctionCall implements Cloneable {
    /**
     * @aspect InheritedFactoryMethods
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:1018
     */
    public FExpExp createEmptyNode()   { return new FExpExp();   }
    /**
     * @aspect Derivatives
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaMiddleEnd\\src\\jastadd\\structural\\Differentiation.jrag:307
     */
    @Override
     ...
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaCBackEnd\\src\\jastadd\\CCodeGen\\CCodeGenExpressions.jrag:529
     */
    @Override
    ...
    public FExpExp(List<InstFunctionArgument> p0, FExp p1) {
        setChild(p0, 0);
        setChild(p1, 1);
    }
    /** @apilevel low-level 
     ...
     */
    public FExpExp clone() throws CloneNotSupportedException {
        FExpExp node = (FExpExp) super.clone();
        return node;
    }
    /** @apilevel internal 
     ...
     */
    public FExpExp treeCopyNoTransform() {
        FExpExp tree = (FExpExp) copy();
        if (children != null) {
    ...
    public CValue cevalCalc(VariableEvaluator evaluator) {
        CValue cevalCalc_VariableEvaluator_value = new CValueReal(StrictMath.exp(getFExp().ceval(evaluator).realValue()));
    ...
    public MX toMX() {
        MX toMX_value = getFExp().toMX().exp();
        return toMX_value;
    }
    /** @apilevel internal */
