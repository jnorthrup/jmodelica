 ...
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\ast\\FlatModelica.ast:535
 * @astdecl FConnIsRoot : FConnBoolOp;
 * @production FConnIsRoot : {@link FConnBoolOp};

 */
public class FConnIsRoot extends FConnBoolOp implements Cloneable {
    /**
     * @aspect InheritedFactoryMethods
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:1065
     */
    public FConnIsRoot createEmptyNode()        { return new FConnIsRoot();        }
    /**
    ...
    public FConnIsRoot(List<InstFunctionArgument> p0, FExp p1) {
        setChild(p0, 0);
        setChild(p1, 1);
    }
    /** @apilevel low-level 
     ...
     */
    public FConnIsRoot clone() throws CloneNotSupportedException {
        FConnIsRoot node = (FConnIsRoot) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:47
     */
    public FConnIsRoot copy() {
        try {
            FConnIsRoot node = (FConnIsRoot) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    public FConnIsRoot treeCopyNoTransform() {
        FConnIsRoot tree = (FConnIsRoot) copy();
        if (children != null) {
    ...
    public boolean cevalFromGraph() {
        boolean cevalFromGraph_value = connectionGraph.ops(getA()).isRoot;
        return cevalFromGraph_value;
    }
    /**
     * @attribute syn
    ...
    public String builtInName() {
        String builtInName_value = "Connections.isRoot";
