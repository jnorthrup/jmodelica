 ...
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\ast\\FlatModelica.ast:1271
 * @astdecl FUnaryBuiltIn : FBuiltInFunctionCall ::= FExp;
 * @production FUnaryBuiltIn : {@link FBuiltInFunctionCall} ::= <span class="component">{@link FExp}</span>;

 */
public abstract class FUnaryBuiltIn extends FBuiltInFunctionCall implements Cloneable {
    /**
     * @aspect InheritedFactoryMethods
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:899
     */
    public abstract FUnaryBuiltIn createEmptyNode();
    /**
     * Create new node of same class as this, with the specified children.
     * @aspect InheritedFactoryMethods
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:1132
     */
    public FUnaryBuiltIn createNode(FExp exp) {
     ...
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\errorcheck\\ComplianceCheck.jadd:232
     */
     ...
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\flattening\\Flattening.jrag:2555
     */
    public FExp flatten(Flattener f)   { return createNode(getFExp().flatten(f)); }
    /**
     * @aspect Scalarization
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaMiddleEnd\\src\\jastadd\\scalarization\\Scalarization.jrag:1732
     */
    public FExp scalarizeExp(Scalarizer s) { return createNode(getFExp().scalarize(s)); }
    /**
     * @declaredat ASTNode:1
     */
    public FUnaryBuiltIn() {
        super();
    }
    /**
    ...
    public FUnaryBuiltIn(List<InstFunctionArgument> p0, FExp p1) {
        setChild(p0, 0);
        setChild(p1, 1);
    }
    /** @apilevel low-level 
     ...
     */
    public FUnaryBuiltIn clone() throws CloneNotSupportedException {
        FUnaryBuiltIn node = (FUnaryBuiltIn) super.clone();
        return node;
    }
    /**
     ...
     */
    @Deprecated
    public abstract FUnaryBuiltIn fullCopy();
    /**
     * Create a deep copy of the AST subtree at this node.
     * The copy is dangling, i.e. has no parent.
     * @return dangling copy of the subtree at this node
     ...
     */
    public abstract FUnaryBuiltIn treeCopyNoTransform();
    /**
     * Create a deep copy of the AST subtree at this node.
     ...
     */
    public abstract FUnaryBuiltIn treeCopy();
    /**
     ...
     * @attribute syn
     * @aspect ComplianceCheck
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\errorcheck\\ComplianceCheck.jadd:239
     */
    @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
    @ASTNodeAnnotation.Source(aspect="ComplianceCheck", declaredAt="C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\errorcheck\\ComplianceCheck.jadd:239")
    public boolean unknownSizeSupported() {
        boolean unknownSizeSupported_value = true;
        return unknownSizeSupported_value;
    }
    /** @apilevel internal */
