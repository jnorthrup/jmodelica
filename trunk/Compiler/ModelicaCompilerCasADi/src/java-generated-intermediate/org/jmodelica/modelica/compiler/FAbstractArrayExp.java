 ...
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\ast\\FlatModelica.ast:754
 * @astdecl FAbstractArrayExp : FAbstractExp ::= ArrayExp;
 * @production FAbstractArrayExp : {@link FAbstractExp} ::= <span class="component">{@link ArrayExp}</span>;

 */
public abstract class FAbstractArrayExp extends FAbstractExp implements Cloneable {
    /**
     * @declaredat ASTNode:1
     */
    public FAbstractArrayExp() {
        super();
    }
    /**
     ...
     */
    public FAbstractArrayExp clone() throws CloneNotSupportedException {
        FAbstractArrayExp node = (FAbstractArrayExp) super.clone();
        return node;
    }
    /**
     ...
     */
    @Deprecated
    public abstract FAbstractArrayExp fullCopy();
    /**
     * Create a deep copy of the AST subtree at this node.
     * The copy is dangling, i.e. has no parent.
     * @return dangling copy of the subtree at this node
     ...
     */
    public abstract FAbstractArrayExp treeCopyNoTransform();
    /**
     * Create a deep copy of the AST subtree at this node.
     ...
     */
    public abstract FAbstractArrayExp treeCopy();
    /**
    ...
    public Array getArray() {
        {
                if (isArray()) {
                    if (canBuildArrayFromChild()) {
                        return childToBuildArray().getArray();
                    } else {
                        return getArrayExp();
                    }
                } else {
    ...
    public boolean canBuildArrayFromChild() {
        boolean canBuildArrayFromChild_value = false;
    ...
    public CValue cevalCalc(VariableEvaluator evaluator) {
        { throw new ConstantEvaluationException(null, "Can not evaluate scalar array expression ");}
    }
    /** @apilevel internal */
