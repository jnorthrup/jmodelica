...
/**
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\ast\\InstanceTree.ast:135
 * @astdecl InstCreateForIndexPrimitive : InstPrimitive ::= <LookupNode:InstLookupRedirectNode>;
 * @production InstCreateForIndexPrimitive : {@link InstPrimitive} ::= <span class="component">&lt;LookupNode:InstLookupRedirectNode&gt;</span>;

 */
public class InstCreateForIndexPrimitive extends InstPrimitive implements Cloneable {
    /**
     * Constructor with only necessary args. 
     * @aspect Constructors
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:158
     */
    public InstCreateForIndexPrimitive(SrcComponentDecl cd) {
     ...
     */
    public InstCreateForIndexPrimitive() {
        super();
    }
    /**
    ...
    @ASTNodeAnnotation.Constructor(
        name = {"Name", "ClassName", "LocalFArraySubscripts", "SrcComponentDecl", "InstModification", "InstConstrainingComponent", "ConditionalAttribute", "LookupNode"},
        type = {"String", "InstAccess", "Opt<FArraySubscripts>", "SrcComponentDecl", "Opt<InstModification>", "Opt<InstConstrainingComponent>", "Opt<FExp>", "InstLookupRedirectNode"},
        kind = {"Token", "Child", "Opt", "Token", "Opt", "Opt", "Opt", "Token"}
    )
    public InstCreateForIndexPrimitive(String p0, InstAccess p1, Opt<FArraySubscripts> p2, SrcComponentDecl p3, Opt<InstModification> p4, Opt<InstConstrainingComponent> p5, Opt<FExp> p6, InstLookupRedirectNode p7) {
        setName(p0);
        setChild(p1, 0);
        setChild(p2, 1);
     ...
     */
    public InstCreateForIndexPrimitive(beaver.Symbol p0, InstAccess p1, Opt<FArraySubscripts> p2, SrcComponentDecl p3, Opt<InstModification> p4, Opt<InstConstrainingComponent> p5, Opt<FExp> p6, InstLookupRedirectNode p7) {
        setName(p0);
        setChild(p1, 0);
        setChild(p2, 1);
        setSrcComponentDecl(p3);
     ...
     */
    public InstCreateForIndexPrimitive clone() throws CloneNotSupportedException {
        InstCreateForIndexPrimitive node = (InstCreateForIndexPrimitive) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:76
     */
    public InstCreateForIndexPrimitive copy() {
        try {
            InstCreateForIndexPrimitive node = (InstCreateForIndexPrimitive) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    @Deprecated
    public InstCreateForIndexPrimitive fullCopy() {
     ...
     */
    public InstCreateForIndexPrimitive treeCopyNoTransform() {
        InstCreateForIndexPrimitive tree = (InstCreateForIndexPrimitive) copy();
        if (children != null) {
     ...
     */
    public InstCreateForIndexPrimitive treeCopy() {
        doFullTraversal();
        return treeCopyNoTransform();
    }
    /** @apilevel internal 
    ...
    protected boolean is$Equal(ASTNode node) {
        return super.is$Equal(node) && (tokenString_Name == ((InstCreateForIndexPrimitive) node).tokenString_Name) && (tokenSrcComponentDecl_SrcComponentDecl == ((InstCreateForIndexPrimitive) node).tokenSrcComponentDecl_SrcComponentDecl) && (tokenInstLookupRedirectNode_LookupNode == ((InstCreateForIndexPrimitive) node).tokenInstLookupRedirectNode_LookupNode);    
    }
    /**
    ...
    /** @apilevel internal 
     */
    protected InstLookupRedirectNode tokenInstLookupRedirectNode_LookupNode;
    /**
    ...
    public InstLookupResult<InstClassDecl> Define_lookupInstClass(ASTNode _callerNode, ASTNode _childNode, String name) {
        ...
        return (getLookupNode() == null) ? lookupInstClass(name) : getLookupNode().lookupInstClassRedirect(name);
    }
    /**
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\instance\\InstLookupClasses.jrag:29
     * @apilevel internal
    ...
    public ASTNode rewriteTo() {
        // Declared at C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\instance\\InstanceTree.jrag:1111
        return rewriteRule0();
    }
    /**
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\instance\\InstanceTree.jrag:1111
     * @apilevel internal
     */    private InstPrimitive rewriteRule0() {
        return (InstPrimitive) getClassName().myInstClassDecl().newInstComponentDecl(getSrcComponentDecl());
    }
}
