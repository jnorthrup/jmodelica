 ...
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaMiddleEnd\\src\\jastadd\\structural\\BLT.jrag:2751
 */
public class SCCBlock<E extends AbstractEq<E, V>, V extends AbstractVar<E, V>> extends TarjanComponent<E> {
    public BlockDependency computeBlockDependency() {
        return computeBlockDependency(this);
    }

    public static <E extends AbstractEq<E, V>, V extends AbstractVar<E, V>>
    BlockDependency computeBlockDependency(TarjanComponent<E> block) {
    ...
    public boolean containsDynamicStates() {
        for (E eqn : this)
    ...
    public AbstractEquationBlock createEquationBlock(EquationBlockFactory.BlockProducer producer, StepUtil stepUtil, boolean isInitial) {
        return EquationBlockFactory.createEquationBlock(this, producer, stepUtil, isInitial);
    }
