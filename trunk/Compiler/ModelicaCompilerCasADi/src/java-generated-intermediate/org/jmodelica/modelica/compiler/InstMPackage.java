...
/**
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\ast\\InstanceTree.ast:78
 * @astdecl InstMPackage : InstRestriction;
 * @production InstMPackage : {@link InstRestriction};

 */
public class InstMPackage extends InstRestriction implements Cloneable {
    /**
     * @aspect ContentCheck
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\errorcheck\\ContentsCheck.jadd:617
     */
    ...
    /**
     * @aspect ContentCheck
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\errorcheck\\ContentsCheck.jadd:636
     */
     ...
     */
    public InstMPackage clone() throws CloneNotSupportedException {
        InstMPackage node = (InstMPackage) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:36
     */
    public InstMPackage copy() {
        try {
            InstMPackage node = (InstMPackage) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    public InstMPackage treeCopyNoTransform() {
        InstMPackage tree = (InstMPackage) copy();
        if (children != null) {
