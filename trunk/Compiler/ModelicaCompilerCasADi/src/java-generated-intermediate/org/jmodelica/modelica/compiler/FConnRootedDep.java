 ...
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\ast\\FlatModelica.ast:547
 * @astdecl FConnRootedDep : FConnRooted;
 * @production FConnRootedDep : {@link FConnRooted};

 */
public class FConnRootedDep extends FConnRooted implements Cloneable {
    /**
     * @aspect InheritedFactoryMethods
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:1067
     */
    public FConnRootedDep createEmptyNode()     { return new FConnRootedDep();     }
    /**
     * @aspect ContentCheck
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\errorcheck\\ContentsCheck.jadd:252
     */
    ...
    public FConnRootedDep(List<InstFunctionArgument> p0, FExp p1) {
        setChild(p0, 0);
        setChild(p1, 1);
    }
    /** @apilevel low-level 
     ...
     */
    public FConnRootedDep clone() throws CloneNotSupportedException {
        FConnRootedDep node = (FConnRootedDep) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:47
     */
    public FConnRootedDep copy() {
        try {
            FConnRootedDep node = (FConnRootedDep) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    @Deprecated
    public FConnRootedDep fullCopy() {
     ...
     */
    public FConnRootedDep treeCopyNoTransform() {
        FConnRootedDep tree = (FConnRootedDep) copy();
        if (children != null) {
     ...
     */
    public FConnRootedDep treeCopy() {
        doFullTraversal();
        return treeCopyNoTransform();
    }
    /** @apilevel internal 
    ...
    public String builtInName() {
        String builtInName_value = "rooted";
