 ...
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\ast\\FlatModelica.ast:1545
 * @astdecl FIdentity : FAbstractDiagonal;
 * @production FIdentity : {@link FAbstractDiagonal};

 */
public class FIdentity extends FAbstractDiagonal implements Cloneable {
    /**
     * @aspect InheritedFactoryMethods
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:1044
     */
    public FIdentity createEmptyNode()        { return new FIdentity();        }
    /**
     * @aspect InheritedFactoryMethods
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:1399
     */
    public FIdentity(FExp a1)                  { this(emptyArgs(), a1); }
    /**
     * @aspect FlatTypeCheck
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\errorcheck\\TypeCheck.jrag:707
     */
    ...
    /**
     * @aspect FlatTypeCheck
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\errorcheck\\TypeCheck.jrag:712
     */
    ...
    /**
     * @aspect Derivatives
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaMiddleEnd\\src\\jastadd\\structural\\Differentiation.jrag:756
     */
    @Override
    ...
    public FIdentity(List<InstFunctionArgument> p0, FExp p1) {
        setChild(p0, 0);
        setChild(p1, 1);
    }
    /** @apilevel low-level 
     ...
     */
    public FIdentity clone() throws CloneNotSupportedException {
        FIdentity node = (FIdentity) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:50
     */
    public FIdentity copy() {
        try {
            FIdentity node = (FIdentity) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    public FIdentity treeCopyNoTransform() {
        FIdentity tree = (FIdentity) copy();
        if (children != null) {
    ...
    public String builtInName() {
        String builtInName_value = "identity";
     ...
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaMiddleEnd\\src\\jastadd\\scalarization\\ScalarizeFunctions.jrag:660
     */
    @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
    @ASTNodeAnnotation.Source(aspect="FunctionScalarization", declaredAt="C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaMiddleEnd\\src\\jastadd\\scalarization\\ScalarizeFunctions.jrag:660")
    public FExp scalarizeDiagonalElement(Scalarizer s) {
        FExp scalarizeDiagonalElement_Scalarizer_value = new FIntegerLitExp(1);
        return scalarizeDiagonalElement_Scalarizer_value;
    }
    /** @apilevel internal */
