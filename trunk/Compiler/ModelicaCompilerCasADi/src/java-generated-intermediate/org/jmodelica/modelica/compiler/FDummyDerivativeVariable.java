 ...
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\ast\\FlatModelica.ast:219
 * @astdecl FDummyDerivativeVariable : FAbstractDerivativeVariable;
 * @production FDummyDerivativeVariable : {@link FAbstractDerivativeVariable};

 */
public class FDummyDerivativeVariable extends FAbstractDerivativeVariable implements Cloneable {
    /**
     * Create a derivative variable with only the required children.
     * @aspect Constructors
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:511
     */
    public FDummyDerivativeVariable(VisibilityType vt, 
     ...
     */
    public FDummyDerivativeVariable() {
        super();
    }
    /**
    ...
    public FDummyDerivativeVariable(VisibilityType p0, TypePrefixVariability p1, TypePrefixInputOutput p2, List<FAttribute> p3, String p4, Opt<FExp> p5, Opt<FStringComment> p6, FAccess p7, int p8) {
     ...
     */
    public FDummyDerivativeVariable(VisibilityType p0, TypePrefixVariability p1, TypePrefixInputOutput p2, List<FAttribute> p3, beaver.Symbol p4, Opt<FExp> p5, Opt<FStringComment> p6, FAccess p7, int p8) {
        setVisibilityType(p0);
        setTypePrefixVariability(p1);
        setTypePrefixInputOutput(p2);
        setChild(p3, 0);
     ...
     */
    public FDummyDerivativeVariable clone() throws CloneNotSupportedException {
        FDummyDerivativeVariable node = (FDummyDerivativeVariable) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:67
     */
    public FDummyDerivativeVariable copy() {
        try {
            FDummyDerivativeVariable node = (FDummyDerivativeVariable) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    @Deprecated
    public FDummyDerivativeVariable fullCopy() {
     ...
     */
    public FDummyDerivativeVariable treeCopyNoTransform() {
        FDummyDerivativeVariable tree = (FDummyDerivativeVariable) copy();
        if (children != null) {
     ...
     */
    public FDummyDerivativeVariable treeCopy() {
        doFullTraversal();
        return treeCopyNoTransform();
    }
    /** @apilevel internal 
    ...
    protected boolean is$Equal(ASTNode node) {
        return super.is$Equal(node) && (tokenVisibilityType_VisibilityType == ((FDummyDerivativeVariable) node).tokenVisibilityType_VisibilityType) && (tokenTypePrefixVariability_TypePrefixVariability == ((FDummyDerivativeVariable) node).tokenTypePrefixVariability_TypePrefixVariability) && (tokenTypePrefixInputOutput_TypePrefixInputOutput == ((FDummyDerivativeVariable) node).tokenTypePrefixInputOutput_TypePrefixInputOutput) && (tokenString_DerivedType == ((FDummyDerivativeVariable) node).tokenString_DerivedType) && (tokenint_Order == ((FDummyDerivativeVariable) node).tokenint_Order);    
    }
    /**
    ...
    public boolean isDummyDerivativeVariable() {
        boolean isDummyDerivativeVariable_value = true;
     ...
     * @attribute syn
     * @aspect FlatNames
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\FlatUtil.jrag:314
     */
    @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
    @ASTNodeAnnotation.Source(aspect="FlatNames", declaredAt="C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\FlatUtil.jrag:314")
    public String derPrefixName() {
        String derPrefixName_value = getFAccess().derPrefixName(order());
        return derPrefixName_value;
    }
    /**
    ...
    public FAccessExp createAccessExp() {
        FAccessExp createAccessExp_value = new FDummyDerExp(createFAccess(), (String)null, order());
    ...
    public String displayName() {
        String displayName_value = derPrefixName();
