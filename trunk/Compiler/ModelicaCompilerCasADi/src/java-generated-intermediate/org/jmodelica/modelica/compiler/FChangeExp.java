 ...
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\ast\\FlatModelica.ast:1305
 * @astdecl FChangeExp : FUnaryBuiltIn;
 * @production FChangeExp : {@link FUnaryBuiltIn};

 */
public class FChangeExp extends FUnaryBuiltIn implements Cloneable {
    /**
     * @aspect InheritedFactoryMethods
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:955
     */
    public FChangeExp createEmptyNode()      { return new FChangeExp();      }
    /**
     * @aspect ComplianceCheck
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\errorcheck\\ComplianceCheck.jadd:155
     */
    ...
    /**
     * @aspect ContentCheck
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\errorcheck\\ContentsCheck.jadd:145
     */
     ...
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\errorcheck\\TypeCheck.jrag:1311
     */
     ...
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\errorcheck\\TypeCheck.jrag:1893
     */
     ...
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\flattening\\Flattening.jrag:2578
     */
    public FExp flatten(Flattener f)      { return new FNeqExp(getFExp().flatten(f), FPreExp.create(getFExp().flatten(f), this)); }
    /**
    ...
    public FChangeExp(List<InstFunctionArgument> p0, FExp p1) {
        setChild(p0, 0);
        setChild(p1, 1);
    }
    /** @apilevel low-level 
     ...
     */
    public FChangeExp clone() throws CloneNotSupportedException {
        FChangeExp node = (FChangeExp) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:48
     */
    public FChangeExp copy() {
        try {
            FChangeExp node = (FChangeExp) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    public FChangeExp treeCopyNoTransform() {
        FChangeExp tree = (FChangeExp) copy();
        if (children != null) {
    ...
    public CValue cevalCalc(VariableEvaluator evaluator) {
        CValue cevalCalc_VariableEvaluator_value = variability().constantVariability() ? CValueBoolean.FALSE : CValue.UNKNOWN;
    ...
    public String builtInName() {
        String builtInName_value = "change";
    ...
    public TypePrefixVariability expVariability() {
        TypePrefixVariability expVariability_value = getFExp().variability().combineDown(Variability.DISCRETE);
    ...
    public boolean Define_argumentDefinedTypeValid(ASTNode _callerNode, ASTNode _childNode) {
        if (_callerNode == getOriginalArgListNoTransform()) {
            // @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\errorcheck\\TypeCheck.jrag:1700
