 ...
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\ast\\FlatModelica.ast:400
 * @astdecl FInternalAttribute : FAttribute;
 * @production FInternalAttribute : {@link FAttribute};

 */
public class FInternalAttribute extends FAttribute implements Cloneable {
    /**
     * Create an FInternalAttribute with only the children that are 
     * valid for them.
     * @aspect Constructors
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:627
     */
    public FInternalAttribute(String name) {
     ...
     * valid for them.
     * @aspect Constructors
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:636
     */
    public FInternalAttribute(String name, int level) {
        this(new FAccessEmpty(), new FIdDecl(new FAccessString(name)), new Opt<FExp>(), 
     ...
     * valid for them.
     * @aspect Constructors
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:645
     */
    public FInternalAttribute(String name, FExp value) {
     ...
     * valid for them.
     * @aspect Constructors
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:654
     */
    public FInternalAttribute(String name, FExp exp, boolean eachKey) {
     ...
     * valid for them.
     * @aspect Constructors
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:663
     */
    public FInternalAttribute(String name, FExp exp, int level, boolean eachKey) {
	    this(new FAccessEmpty(), new FIdDecl(new FAccessString(name)), new Opt<FExp>(exp), 
     ...
     * valid for them.
     * @aspect Constructors
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:672
     */
    public FInternalAttribute(String name, int level, boolean eachKey) {
        this(new FAccessEmpty(), new FIdDecl(new FAccessString(name)), new Opt<FExp>(), 
                true, level, eachKey ? new Opt<FEach>(new FEach()) : new Opt<FEach>(), new Opt<FFinal>(), new List<FAttribute>());
    }
    /**
     ...
     * valid for them.
     * @aspect Constructors
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:681
     */
    public FInternalAttribute(String type, String name, FExp exp, int level) {
        this(new FAccessString(type), new FIdDecl(new FAccessString(name)), new Opt<FExp>(exp), 
                true, level, new Opt<FEach>(), new Opt<FFinal>(), new List<FAttribute>());
    }
    /**
     * @aspect InheritedFactoryMethods
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:1321
     */
    public FInternalAttribute createEmptyNode() { return new FInternalAttribute(); }
    /**
     * @aspect AliasElimination
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaMiddleEnd\\src\\jastadd\\optimizations\\AliasElimination.jrag:344
     */
    ...
    public FInternalAttribute(CommonAccess p0, FIdDecl p1, Opt<FExp> p2, boolean p3, int p4, Opt<FEach> p5, Opt<FFinal> p6, List<FAttribute> p7) {
        setChild(p0, 0);
        setChild(p1, 1);
        setChild(p2, 2);
        setAttributeSet(p3);
     ...
     */
    public FInternalAttribute clone() throws CloneNotSupportedException {
        FInternalAttribute node = (FInternalAttribute) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:56
     */
    public FInternalAttribute copy() {
        try {
            FInternalAttribute node = (FInternalAttribute) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    @Deprecated
    public FInternalAttribute fullCopy() {
     ...
     */
    public FInternalAttribute treeCopyNoTransform() {
        FInternalAttribute tree = (FInternalAttribute) copy();
        if (children != null) {
     ...
     */
    public FInternalAttribute treeCopy() {
        doFullTraversal();
        return treeCopyNoTransform();
    }
    /** @apilevel internal 
    ...
    protected boolean is$Equal(ASTNode node) {
        return super.is$Equal(node) && (tokenboolean_AttributeSet == ((FInternalAttribute) node).tokenboolean_AttributeSet) && (tokenint_Level == ((FInternalAttribute) node).tokenint_Level);    
    }
    /**
