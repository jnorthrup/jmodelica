 ...
 * Or expression.
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\ast\\FlatModelica.ast:896
 * @astdecl FOrExp : FLogBinExp;
 * @production FOrExp : {@link FLogBinExp};

 */
public class FOrExp extends FLogBinExp implements Cloneable {
    /**
     * @aspect InheritedFactoryMethods
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:937
     */
    public FOrExp createEmptyNode()  { return new FOrExp();  }
    /**
     ...
     */
    public FOrExp clone() throws CloneNotSupportedException {
        FOrExp node = (FOrExp) super.clone();
        return node;
    }
    /** @apilevel internal 
     ...
     */
    public FOrExp treeCopyNoTransform() {
        FOrExp tree = (FOrExp) copy();
        if (children != null) {
    ...
    public CValue cevalEval(CValue left, CValue right) {
        CValue cevalEval_CValue_CValue_value = type().or(left, right);
    ...
    public Precedence precedence() {
        Precedence precedence_value = Precedence.LOGICAL_OR;
    ...
    public boolean isInitialGuard() {
        boolean isInitialGuard_value = getLeft().isInitialGuard() || getRight().isInitialGuard();
    ...
    public String operatorName() {
        String operatorName_value = OP_OR;
    ...
    public boolean negateIndicatorGuard(FExp e) {
        boolean negateIndicatorGuard_FExp_value = true;
    ...
    public String macro_C() {
        String macro_C_value = "LOG_EXP_OR";
    ...
    public MX toMX() {
        MX toMX_value = getLeft().toMX().logic_or(getRight().toMX());
        return toMX_value;
    }
    /**
    ...
    public boolean Define_hasBrancher(ASTNode _callerNode, ASTNode _childNode) {
        if (_callerNode == getRightNoTransform()) {
            // @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaCBackEnd\\src\\jastadd\\CCodeGen\\CCodeGen.jrag:590
            return true;
        }
        else if (_callerNode == getLeftNoTransform()) {
            // @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaCBackEnd\\src\\jastadd\\CCodeGen\\CCodeGen.jrag:589
