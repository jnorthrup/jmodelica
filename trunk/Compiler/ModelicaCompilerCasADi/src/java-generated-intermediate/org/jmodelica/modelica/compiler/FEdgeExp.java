 ...
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\ast\\FlatModelica.ast:1300
 * @astdecl FEdgeExp : FUnaryBuiltIn;
 * @production FEdgeExp : {@link FUnaryBuiltIn};

 */
public class FEdgeExp extends FUnaryBuiltIn implements Cloneable {
    /**
     * @aspect InheritedFactoryMethods
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:954
     */
    public FEdgeExp createEmptyNode()        { return new FEdgeExp();        }
    /**
     * @aspect ComplianceCheck
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\errorcheck\\ComplianceCheck.jadd:151
     */
    ...
    /**
     * @aspect ContentCheck
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\errorcheck\\ContentsCheck.jadd:139
     */
     ...
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\errorcheck\\TypeCheck.jrag:1306
     */
     ...
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\flattening\\Flattening.jrag:2556
     */
    public FExp flatten(Flattener f)        { return new FAndExp(getFExp().flatten(f), new FNotExp(getFExp().flatten(f).createFPreExp())); }
    /**
    ...
    public FEdgeExp(List<InstFunctionArgument> p0, FExp p1) {
        setChild(p0, 0);
        setChild(p1, 1);
    }
    /** @apilevel low-level 
     ...
     */
    public FEdgeExp clone() throws CloneNotSupportedException {
        FEdgeExp node = (FEdgeExp) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:48
     */
    public FEdgeExp copy() {
        try {
            FEdgeExp node = (FEdgeExp) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    public FEdgeExp treeCopyNoTransform() {
        FEdgeExp tree = (FEdgeExp) copy();
        if (children != null) {
    ...
    public boolean Define_argumentDefinedTypeValid(ASTNode _callerNode, ASTNode _childNode) {
        if (_callerNode == getOriginalArgListNoTransform()) {
            // @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\errorcheck\\TypeCheck.jrag:1699
