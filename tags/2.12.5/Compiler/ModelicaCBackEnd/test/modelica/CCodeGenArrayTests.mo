...
void func_CCodeGenArrayTests_RecordArray10_g_def0(jmi_real_t x_v, jmi_string_t s_v, jmi_real_t* y_o) {
    ...
    JMI_ARRAY_INIT_1(HEAP, jmi_real_t, jmi_array_t, jmi_array_rec_1(temp_1_a, 1)->x, 2, 1, 2)
    i1_0in = 0;
    i1_0ie = floor((2) - (1));
    for (i1_0i = 1; i1_0in <= i1_0ie; i1_0i = 1 + (++i1_0in)) {
        jmi_array_ref_1(jmi_array_rec_1(temp_1_a, 1)->x, i1_0i) = jmi_array_val_1(temp_2_a, i1_0i);
    }
    JMI_ARRAY_INIT_1(HEAP, jmi_string_t, jmi_string_array_t, jmi_array_rec_1(temp_1_a, 1)->s, 1, 1, 1)
    i1_1in = 0;
    i1_1ie = floor((1) - (1));
    ...
    JMI_ARRAY_INIT_1(HEAP, jmi_real_t, jmi_array_t, jmi_array_rec_1(temp_1_a, 2)->x, 1, 1, 1)
    i1_2in = 0;
    i1_2ie = floor((1) - (1));
    ...
    JMI_ARRAY_INIT_1(HEAP, jmi_string_t, jmi_string_array_t, jmi_array_rec_1(temp_1_a, 2)->s, 2, 1, 2)
    i1_3in = 0;
    i1_3ie = floor((2) - (1));
