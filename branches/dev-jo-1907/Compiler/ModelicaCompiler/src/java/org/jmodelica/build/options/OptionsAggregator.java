...
public class OptionsAggregator {
    ...
    public static final String HEADER = "package %s;%n"
            ...
            + " */%n"
            + "public class CompileOptions extends OptionRegistry {%n";
    ...
    public static final String FOOTER = "%n"
            ...
            + "    }%n"
            + "%n"
            + "    public static CompileOptions buildOptions() {%n"
            + "        return new CompileOptions(false);%n"
            + "    }%n"
            + "%n"
            + "    public static CompileOptions buildTestOptions() {%n"
            + "        return new CompileOptions(true);%n"
            + "    }%n"
            + "%n"
            + "    public CompileOptions copy() {%n"
            + "        CompileOptions options = new CompileOptions(isTest);%n"
    ...
    public static void main(String[] args) throws IOException, OptionsAggregationException {
        ...
        File outFile = new File(outDir, "CompileOptions.java");
