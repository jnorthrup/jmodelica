...
public class OptionsAggregator {
    ...
    public static final String HEADER = "package %s;%n"
            ...
            + "%n"
            + "import org.jmodelica.common.options.Option;%n"
            + "import org.jmodelica.common.options.OptionRegistry;%n"
            + "import org.jmodelica.common.options.OptionRegistry.DefaultValue;%n"
            + "import org.jmodelica.common.options.OptionRegistry.Category;%n"
            + "import org.jmodelica.common.options.OptionRegistry.OptionType;%n"
            + "import org.jmodelica.common.options.OptionRegistry.IntegerOption;%n"
            ...
            + " */%n"
            + "public class OptionsAggregated extends OptionRegistry {%n";
    ...
    public static final String FOOTER = "%n"
            ...
            + "        return new OptionsAggregated(false);%n"
            + "    }%n"
            + "%n"
            + "    public static OptionsAggregated buildTestOptions() {%n"
            + "        return new OptionsAggregated(true);%n"
            + "    }%n"
            + "%n"
            + "    public OptionsAggregated copy() {%n"
            + "        OptionsAggregated options = new OptionsAggregated(isTest);%n"
    ...
    public static class OptionDeclaration extends Option {
        ...
        public void printDeclaration(PrintStream out) {
            out.format("public %sOption %s;", kind, name);
        }

        public void printInitialization(PrintStream out, String indent) {
            ...
            if (inverted.isEmpty()) {
                if (defaultValue.equals(testDefaultValue)) {
                    ...
                    defaultValueInit = String.format("new DefaultValue<>(isTest ? %s : %s)",
    ...
    public void generateCalls(PrintStream out, String indent) {
        for (OptionDeclaration opt : getOptions()) {
            if (!opt.removed) {
                opt.printInitialization(out, indent);
                out.println();
            }
        }
    }
