...
/**
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\ast\\Modelica.ast:322
 * @astdecl SrcGlobalAccess : SrcAccess ::= SrcAccess;
 * @production SrcGlobalAccess : {@link SrcAccess} ::= <span class="component">{@link SrcAccess}</span>;

 */
public class SrcGlobalAccess extends SrcAccess implements Cloneable {
    /**
     * @aspect PrettyPrint
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\PrettyPrint.jrag:872
     */
     ...
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\instance\\InstanceTree.jrag:1595
     */
    ...
    /**
     * @aspect Names
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\util\\Util.jrag:1013
     */
    ...
    public SrcGlobalAccess(SrcAccess p0) {
        setChild(p0, 0);
    }
    /** @apilevel low-level 
     ...
     */
    public SrcGlobalAccess clone() throws CloneNotSupportedException {
        SrcGlobalAccess node = (SrcGlobalAccess) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:46
     */
    public SrcGlobalAccess copy() {
        try {
            SrcGlobalAccess node = (SrcGlobalAccess) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    @Deprecated
    public SrcGlobalAccess fullCopy() {
     ...
     */
    public SrcGlobalAccess treeCopyNoTransform() {
        SrcGlobalAccess tree = (SrcGlobalAccess) copy();
        if (children != null) {
     ...
     */
    public SrcGlobalAccess treeCopy() {
        doFullTraversal();
        return treeCopyNoTransform();
    }
    /** @apilevel internal 
    ...
    /**
     * Replaces the SrcAccess child.
     * @param node The new node to replace the SrcAccess child.
     * @apilevel high-level
     */
    ...
    /**
     * Retrieves the SrcAccess child.
     * @return The current node used as the SrcAccess child.
     * @apilevel high-level
     */
    @ASTNodeAnnotation.Child(name="SrcAccess")
     ...
     * @apilevel low-level
     */
    public SrcAccess getSrcAccessNoTransform() {
    ...
    public ResolvedAccess resolveAccess() {
        ResolvedAccess resolveAccess_value = getSrcAccess().resolveAccess();
    ...
    public Iterable<SrcAccess> nameParts() {
        Iterable<SrcAccess> nameParts_value = getSrcAccess().nameParts();
     ...
     * @attribute syn
     * @aspect Names
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\util\\Util.jrag:706
     */
    @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
    @ASTNodeAnnotation.Source(aspect="Names", declaredAt="C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\util\\Util.jrag:706")
    public String name() {
        ...
        name_value = "." + getSrcAccessNoTransform().name();
    ...
    public String qualifiedName() {
        String qualifiedName_value = "." + getSrcAccess().qualifiedName();
    ...
    public String lastName() {
        String lastName_value = getSrcAccessNoTransform().lastName();
    ...
    public SrcAccess getLastAccess() {
        SrcAccess getLastAccess_value = getSrcAccess().getLastAccess();
    ...
    public SrcAccess getFirstAccess() {
        SrcAccess getFirstAccess_value = getSrcAccess().getFirstAccess();
    ...
    public boolean isQualified() {
        boolean isQualified_value = getSrcAccess().isQualified();
    ...
    public ResolvedAccess Define_simpleLookupHelper(ASTNode _callerNode, ASTNode _childNode, String name) {
        if (_callerNode == getSrcAccessNoTransform()) {
            // @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\source\\SimpleLookup.jrag:280
