...
/**
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\ast\\InstanceTree.ast:48
 * @astdecl InstAbstractShortClassDecl : InstBaseClassDecl;
 * @production InstAbstractShortClassDecl : {@link InstBaseClassDecl};

 */
public abstract class InstAbstractShortClassDecl extends InstBaseClassDecl implements Cloneable {
    /**
     * @aspect AnnotationAPI
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\util\\Annotations.jrag:2145
     */
     ...
     * Enviroment. 
     * @aspect AnnotationAPI
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\util\\Annotations.jrag:2169
     */
     ...
     */
    public InstAbstractShortClassDecl() {
        super();
    }
    /**
    ...
    public InstAbstractShortClassDecl(SrcClassDecl p0, Opt<InstConstrainingClass> p1, InstRestriction p2) {
        setSrcClassDecl(p0);
        setChild(p1, 0);
        setChild(p2, 1);
    }
     ...
     */
    public InstAbstractShortClassDecl clone() throws CloneNotSupportedException {
        InstAbstractShortClassDecl node = (InstAbstractShortClassDecl) super.clone();
        return node;
    }
    /**
     ...
     */
    @Deprecated
    public abstract InstAbstractShortClassDecl fullCopy();
    /**
     * Create a deep copy of the AST subtree at this node.
     * The copy is dangling, i.e. has no parent.
     * @return dangling copy of the subtree at this node
     ...
     */
    public abstract InstAbstractShortClassDecl treeCopyNoTransform();
    /**
     * Create a deep copy of the AST subtree at this node.
     ...
     */
    public abstract InstAbstractShortClassDecl treeCopy();
    /**
    ...
    public String printClassAnnotations(String prefix) {
        String printClassAnnotations_String_value = getSrcShortClassDecl().srcAnnotation().toString();
        return printClassAnnotations_String_value;
    }
    /**
     * @attribute syn
     * @aspect InstanceAST_API
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\instance\\InstanceTree.jrag:1960
     */
    @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
    @ASTNodeAnnotation.Source(aspect="InstanceAST_API", declaredAt="C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\instance\\InstanceTree.jrag:1960")
    public SrcShortClassDecl getSrcShortClassDecl() {
        SrcShortClassDecl getSrcShortClassDecl_value = (SrcShortClassDecl)getSrcClassDecl();
        return getSrcShortClassDecl_value;
    }
    /**
    ...
    public AnnotationNode annotation(InstContext instContext) {
        AnnotationNode annotation_InstContext_value = !isFunction() ? mySrcAnnotatable().annotation(instContext) : getSrcClassDecl().annotation(instContext);
    ...
    /** @apilevel internal */
    private void isAbsoluteValue_reset() {
        isAbsoluteValue_computed = false;
    }
    /** @apilevel internal */
    protected boolean isAbsoluteValue_computed = false;

    /** @apilevel internal */
    protected boolean isAbsoluteValue_value;

    /**
     * @attribute syn
     * @aspect AbsoluteValue
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\FmiXMLCodeGen\\src\\jastadd\\AbsoluteValue.jrag:28
     */
    @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
    @ASTNodeAnnotation.Source(aspect="AbsoluteValue", declaredAt="C:\\stuff\\workspace\\JModelica\\Compiler\\FmiXMLCodeGen\\src\\jastadd\\AbsoluteValue.jrag:28")
    public boolean isAbsoluteValue() {
        ASTState state = state();
        if (isAbsoluteValue_computed) {
            return isAbsoluteValue_value;
        }
        int _boundaries = state.boundariesCrossed;
        boolean isFinal = this.is$Final();
        state().enterLazyAttribute();
        isAbsoluteValue_value = isAbsoluteValue(myTargetInstClassDecl());
        if (isFinal && _boundaries == state().boundariesCrossed) {
        isAbsoluteValue_computed = true;
