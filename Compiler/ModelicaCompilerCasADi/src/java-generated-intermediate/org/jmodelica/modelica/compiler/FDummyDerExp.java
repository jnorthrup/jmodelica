 ...
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\ast\\FlatModelica.ast:1056
 * @astdecl FDummyDerExp : FAbstractDerExp;
 * @production FDummyDerExp : {@link FAbstractDerExp};

 */
public class FDummyDerExp extends FAbstractDerExp implements Cloneable {
    /**
     * @aspect InheritedFactoryMethods
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:976
     */
    public FDummyDerExp createEmptyNode()   { return new FDummyDerExp();   }
    /**
     * @aspect FlatPrettyPrint
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\PrettyPrint.jrag:1686
     */
    ...
    public FDummyDerExp(FAccess p0, String p1, int p2) {
        setChild(p0, 0);
     ...
     */
    public FDummyDerExp(FAccess p0, beaver.Symbol p1, int p2) {
        setChild(p0, 0);
        setOriginalVariable(p1);
        setOrder(p2);
    }
     ...
     */
    public FDummyDerExp clone() throws CloneNotSupportedException {
        FDummyDerExp node = (FDummyDerExp) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:52
     */
    public FDummyDerExp copy() {
        try {
            FDummyDerExp node = (FDummyDerExp) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    public FDummyDerExp treeCopyNoTransform() {
        FDummyDerExp tree = (FDummyDerExp) copy();
        if (children != null) {
    ...
    protected boolean is$Equal(ASTNode node) {
        return super.is$Equal(node) && (tokenString_OriginalVariable == ((FDummyDerExp) node).tokenString_OriginalVariable) && (tokenint_Order == ((FDummyDerExp) node).tokenint_Order);    
    }
    /**
     ...
     * @attribute syn
     * @aspect FlatNames
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\FlatUtil.jrag:315
     */
    @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
    @ASTNodeAnnotation.Source(aspect="FlatNames", declaredAt="C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\FlatUtil.jrag:315")
