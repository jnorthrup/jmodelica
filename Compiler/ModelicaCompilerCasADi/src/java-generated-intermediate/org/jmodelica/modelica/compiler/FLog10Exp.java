 ...
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\ast\\FlatModelica.ast:1485
 * @astdecl FLog10Exp : FMathematicalFunctionCall;
 * @production FLog10Exp : {@link FMathematicalFunctionCall};

 */
public class FLog10Exp extends FMathematicalFunctionCall implements Cloneable {
    /**
     * @aspect InheritedFactoryMethods
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:1020
     */
    public FLog10Exp createEmptyNode() { return new FLog10Exp(); }
    /**
     * @aspect Derivatives
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaMiddleEnd\\src\\jastadd\\structural\\Differentiation.jrag:375
     */
    @Override
     ...
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaCBackEnd\\src\\jastadd\\CCodeGen\\CCodeGenExpressions.jrag:539
     */
    @Override
    ...
    public FLog10Exp(List<InstFunctionArgument> p0, FExp p1) {
        setChild(p0, 0);
        setChild(p1, 1);
    }
    /** @apilevel low-level 
     ...
     */
    public FLog10Exp clone() throws CloneNotSupportedException {
        FLog10Exp node = (FLog10Exp) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:47
     */
    public FLog10Exp copy() {
        try {
            FLog10Exp node = (FLog10Exp) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    public FLog10Exp treeCopyNoTransform() {
        FLog10Exp tree = (FLog10Exp) copy();
        if (children != null) {
    ...
    public CValue cevalCalc(VariableEvaluator evaluator) {
        CValue cevalCalc_VariableEvaluator_value = new CValueReal(StrictMath.log10(getFExp().ceval(evaluator).realValue()));
    ...
    public String builtInName() {
        String builtInName_value = "log10";
    ...
    public MX toMX() {
        MX toMX_value = getFExp().toMX().log10();
        return toMX_value;
    }
    /** @apilevel internal */
