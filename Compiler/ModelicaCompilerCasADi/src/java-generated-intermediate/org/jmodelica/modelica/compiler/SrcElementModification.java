...
/**
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\ast\\Modelica.ast:226
 * @astdecl SrcElementModification : SrcNamedModification ::= [SrcModification] SrcComment;
 * @production SrcElementModification : {@link SrcNamedModification} ::= <span class="component">[{@link SrcModification}]</span> <span class="component">{@link SrcComment}</span>;

 */
public abstract class SrcElementModification extends SrcNamedModification implements Cloneable {
    /**
     * @aspect PrettyPrint
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\PrettyPrint.jrag:679
     */
    ...
    public SrcElementModification(boolean p0, boolean p1, SrcAccess p2, Opt<SrcModification> p3, SrcComment p4) {
        setEach(p0);
        setFinal(p1);
        setChild(p2, 0);
        setChild(p3, 1);
     ...
     */
    public SrcElementModification clone() throws CloneNotSupportedException {
        SrcElementModification node = (SrcElementModification) super.clone();
        return node;
    }
    /**
     ...
     */
    @Deprecated
    public abstract SrcElementModification fullCopy();
    /**
     * Create a deep copy of the AST subtree at this node.
     * The copy is dangling, i.e. has no parent.
     * @return dangling copy of the subtree at this node
     ...
     */
    public abstract SrcElementModification treeCopyNoTransform();
    /**
     * Create a deep copy of the AST subtree at this node.
     ...
     */
    public abstract SrcElementModification treeCopy();
    /**
     ...
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\source\\SourceTraversal.jrag:235
     */
    @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
    @ASTNodeAnnotation.Source(aspect="SourceTraversal", declaredAt="C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\source\\SourceTraversal.jrag:235")
