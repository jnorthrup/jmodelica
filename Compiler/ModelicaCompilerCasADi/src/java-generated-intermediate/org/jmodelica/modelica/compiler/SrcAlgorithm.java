...
/**
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\ast\\Modelica.ast:163
 * @astdecl SrcAlgorithm : SrcClause ::= SrcStatement*;
 * @production SrcAlgorithm : {@link SrcClause} ::= <span class="component">{@link SrcStatement}*</span>;

 */
public class SrcAlgorithm extends SrcClause implements Cloneable {
    /**
     * @aspect PrettyPrint
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\PrettyPrint.jrag:421
     */
     ...
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\flattening\\Flattening.jrag:2905
     */
    ...
    /**
     * @aspect InstantiatedExpressions
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\flattening\\Flattening.jrag:2979
     */
    ...
    public SrcAlgorithm(List<SrcStatement> p0) {
        setChild(p0, 0);
    }
    /** @apilevel low-level 
     ...
     */
    public SrcAlgorithm clone() throws CloneNotSupportedException {
        SrcAlgorithm node = (SrcAlgorithm) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:46
     */
    public SrcAlgorithm copy() {
        try {
            SrcAlgorithm node = (SrcAlgorithm) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    public SrcAlgorithm treeCopyNoTransform() {
        SrcAlgorithm tree = (SrcAlgorithm) copy();
        if (children != null) {
    ...
    public String clauseHeader(String separator) {
        String clauseHeader_String_value = "algorithm";
    ...
    public Iterator<SrcAlgorithm> algorithmIterator() {
        Iterator<SrcAlgorithm> algorithmIterator_value = new SingleIterator(this);
    ...
    public boolean isAlgorithm() {
        boolean isAlgorithm_value = true;
