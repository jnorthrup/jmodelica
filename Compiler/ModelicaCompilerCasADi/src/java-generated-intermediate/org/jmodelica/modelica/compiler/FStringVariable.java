 ...
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\ast\\FlatModelica.ast:161
 * @astdecl FStringVariable : FVariable;
 * @production FStringVariable : {@link FVariable};

 */
public class FStringVariable extends FVariable implements Cloneable {
    /**
     * Create a string variable with only the required children.
     * @aspect Constructors
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:579
     */
    public FStringVariable(VisibilityType vt, 
     ...
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:1315
     */
    public FStringVariable createEmptyNode()  					{ return new FStringVariable(); }
    /**
     * @aspect TransformCanonical
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaMiddleEnd\\src\\jastadd\\TransformCanonical.jrag:1148
     */
    ...
    /**
     * @aspect XMLCodeGen
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFMUXBackEnd\\src\\jastadd\\XMLCodeGen.jrag:614
     */
    @Override
    ...
    public FStringVariable(VisibilityType p0, TypePrefixVariability p1, TypePrefixInputOutput p2, List<FAttribute> p3, String p4, Opt<FExp> p5, Opt<FStringComment> p6, FAccess p7) {
     ...
     */
    public FStringVariable(VisibilityType p0, TypePrefixVariability p1, TypePrefixInputOutput p2, List<FAttribute> p3, beaver.Symbol p4, Opt<FExp> p5, Opt<FStringComment> p6, FAccess p7) {
        setVisibilityType(p0);
        setTypePrefixVariability(p1);
        setTypePrefixInputOutput(p2);
        setChild(p3, 0);
     ...
     */
    public FStringVariable clone() throws CloneNotSupportedException {
        FStringVariable node = (FStringVariable) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:67
     */
    public FStringVariable copy() {
        try {
            FStringVariable node = (FStringVariable) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    @Deprecated
    public FStringVariable fullCopy() {
     ...
     */
    public FStringVariable treeCopyNoTransform() {
        FStringVariable tree = (FStringVariable) copy();
        if (children != null) {
     ...
     */
    public FStringVariable treeCopy() {
        doFullTraversal();
        return treeCopyNoTransform();
    }
    /** @apilevel internal 
    ...
    protected boolean is$Equal(ASTNode node) {
        return super.is$Equal(node) && (tokenVisibilityType_VisibilityType == ((FStringVariable) node).tokenVisibilityType_VisibilityType) && (tokenTypePrefixVariability_TypePrefixVariability == ((FStringVariable) node).tokenTypePrefixVariability_TypePrefixVariability) && (tokenTypePrefixInputOutput_TypePrefixInputOutput == ((FStringVariable) node).tokenTypePrefixInputOutput_TypePrefixInputOutput) && (tokenString_DerivedType == ((FStringVariable) node).tokenString_DerivedType);    
    }
    /**
    ...
    public CValue startAttributeCValue() {
        CValue startAttributeCValue_value = attributeCValueString(FAttribute.START);
        return startAttributeCValue_value;
    }
    /**
     * @attribute syn
     * @aspect FlatAPIAttributes
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\FlatAPI\\FlatAPIAttributes.jrag:211
     */
    @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
    @ASTNodeAnnotation.Source(aspect="FlatAPIAttributes", declaredAt="C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\FlatAPI\\FlatAPIAttributes.jrag:211")
    public String startAttribute() {
        String startAttribute_value = startAttributeCValue().stringValue();
    ...
    public String name_C() {
        ...
        boolean isFinal = this.is$Final();
        state().enterLazyAttribute();
        name_C_value = name_C("_s_" + variabilityCausality_C());
        if (isFinal && _boundaries == state().boundariesCrossed) {
