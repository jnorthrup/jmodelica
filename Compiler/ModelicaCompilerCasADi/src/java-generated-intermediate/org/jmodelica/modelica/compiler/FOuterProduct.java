 ...
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\ast\\FlatModelica.ast:1555
 * @astdecl FOuterProduct : FBuiltInFunctionCall ::= X:FExp Y:FExp;
 * @production FOuterProduct : {@link FBuiltInFunctionCall} ::= <span class="component">X:{@link FExp}</span> <span class="component">Y:{@link FExp}</span>;

 */
public class FOuterProduct extends FBuiltInFunctionCall implements Cloneable {
    /**
     * @aspect InheritedFactoryMethods
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:1043
     */
    public FOuterProduct createEmptyNode()    { return new FOuterProduct();    }
    /**
     * @aspect InheritedFactoryMethods
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:1405
     */
    public FOuterProduct(FExp a1, FExp a2) { this(emptyArgs(), a1, a2); }
    /**
     * @aspect FlatExpressions
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\flattening\\Flattening.jrag:2632
     */
    public FOuterProduct flatten(Flattener f) { return new FOuterProduct(getX().flatten(f), getY().flatten(f)); }
    /**
     * @aspect FunctionScalarization
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaMiddleEnd\\src\\jastadd\\scalarization\\ScalarizeFunctions.jrag:789
     */
    ...
    /**
     * @aspect Derivatives
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaMiddleEnd\\src\\jastadd\\structural\\Differentiation.jrag:721
     */
    @Override
    ...
    public FOuterProduct(List<InstFunctionArgument> p0, FExp p1, FExp p2) {
        setChild(p0, 0);
        setChild(p1, 1);
        setChild(p2, 2);
    }
     ...
     */
    public FOuterProduct clone() throws CloneNotSupportedException {
        FOuterProduct node = (FOuterProduct) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:52
     */
    public FOuterProduct copy() {
        try {
            FOuterProduct node = (FOuterProduct) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    public FOuterProduct treeCopyNoTransform() {
        FOuterProduct tree = (FOuterProduct) copy();
        if (children != null) {
    ...
    public String builtInName() {
        String builtInName_value = "outerProduct";
