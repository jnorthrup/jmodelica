...
/**
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\ast\\InstanceTree.ast:55
 * @astdecl BadInstClassDecl : InstClassDecl;
 * @production BadInstClassDecl : {@link InstClassDecl};

 */
public class BadInstClassDecl extends InstClassDecl implements Cloneable {
    /**
     * @aspect InstanceTreeConstruction
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\instance\\InstanceTree.jrag:1263
     */
    ...
    /**
     * @aspect InstanceTreeConstruction
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\instance\\InstanceTree.jrag:1378
     */
    ...
    public BadInstClassDecl(SrcClassDecl p0) {
        setSrcClassDecl(p0);
    }
    /** @apilevel low-level 
     ...
     */
    public BadInstClassDecl clone() throws CloneNotSupportedException {
        BadInstClassDecl node = (BadInstClassDecl) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:55
     */
    public BadInstClassDecl copy() {
        try {
            BadInstClassDecl node = (BadInstClassDecl) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    @Deprecated
    public BadInstClassDecl fullCopy() {
     ...
     */
    public BadInstClassDecl treeCopyNoTransform() {
        BadInstClassDecl tree = (BadInstClassDecl) copy();
        if (children != null) {
     ...
     */
    public BadInstClassDecl treeCopy() {
        doFullTraversal();
        return treeCopyNoTransform();
    }
    /** @apilevel internal 
    ...
    protected boolean is$Equal(ASTNode node) {
        return super.is$Equal(node) && (tokenSrcClassDecl_SrcClassDecl == ((BadInstClassDecl) node).tokenSrcClassDecl_SrcClassDecl);    
    }
    /**
    ...
    public String qualifiedName() {
        ...
        qualifiedName_value = buildQualifiedName();
