 ...
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaCBackEnd\\src\\jastadd\\CCodeGen\\CCodeGenFunctionPartial.jrag:177
 */
public class TempNameStructComputation extends StructComputation {
    
        int i;

     // iteration index of tempNames.length
        String[] tempNames;
    ...
    public TempNameStructComputation print(ArrayList<FFunctionVariable> variables, String[] tempNames, CodePrinter p, CodeStream str,
            String indent) {
