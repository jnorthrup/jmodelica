 ...
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\ast\\FlatModelica.ast:1575
 * @astdecl FOnes : FArrayDimAsArgsExp;
 * @production FOnes : {@link FArrayDimAsArgsExp};

 */
public class FOnes extends FArrayDimAsArgsExp implements Cloneable {
    /**
     * @aspect InheritedFactoryMethods
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:1046
     */
    public FOnes createEmptyNode()            { return new FOnes();            }
    /**
     * @aspect Scalarization
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaMiddleEnd\\src\\jastadd\\scalarization\\Scalarization.jrag:1778
     */
    ...
    /**
     * @aspect Derivatives
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaMiddleEnd\\src\\jastadd\\structural\\Differentiation.jrag:708
     */
    @Override
    ...
    public FOnes(List<InstFunctionArgument> p0, List<FExp> p1) {
        setChild(p0, 0);
        setChild(p1, 1);
    }
    /** @apilevel low-level 
     ...
     */
    public FOnes clone() throws CloneNotSupportedException {
        FOnes node = (FOnes) super.clone();
        return node;
    }
    /** @apilevel internal 
     ...
     */
    public FOnes treeCopyNoTransform() {
        FOnes tree = (FOnes) copy();
        if (children != null) {
    ...
    public FExp fillExp() {
        FExp fillExp_value = new FIntegerLitExp(1);
