 ...
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\ast\\FlatModelica.ast:921
 * @astdecl FIntegerLitExp : FNumericLitExp ::= <Value:int>;
 * @production FIntegerLitExp : {@link FNumericLitExp} ::= <span class="component">&lt;Value:int&gt;</span>;

 */
public class FIntegerLitExp extends FNumericLitExp implements Cloneable {
    /**
     * @aspect Constructors
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:870
     */
    public FIntegerSubscript createFSubscript() {
        return new FIntegerSubscript(getValue());
    }
    /**
     * @aspect InheritedFactoryMethods
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:942
     */
    public FIntegerLitExp createEmptyNode()      { return new FIntegerLitExp();      }
    /**
     * @aspect DebugHelpers
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\util\\Util.jrag:1188
     */
    public String toString()      { return Integer.toString(getValue()); }
    /**
     * @declaredat ASTNode:1
     */
    public FIntegerLitExp() {
        super();
    }
    /**
     ...
     */
    public FIntegerLitExp clone() throws CloneNotSupportedException {
        FIntegerLitExp node = (FIntegerLitExp) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:44
     */
    public FIntegerLitExp copy() {
        try {
            FIntegerLitExp node = (FIntegerLitExp) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    @Deprecated
    public FIntegerLitExp fullCopy() {
     ...
     */
    public FIntegerLitExp treeCopyNoTransform() {
        FIntegerLitExp tree = (FIntegerLitExp) copy();
        if (children != null) {
     ...
     */
    public FIntegerLitExp treeCopy() {
        doFullTraversal();
        return treeCopyNoTransform();
    }
    /** @apilevel internal 
    ...
    protected boolean is$Equal(ASTNode node) {
        return super.is$Equal(node) && (tokenint_Value == ((FIntegerLitExp) node).tokenint_Value);    
    }
    /**
    ...
    public boolean isIntegerLiteral() {
        boolean isIntegerLiteral_value = true;
    ...
    public boolean isIntegerLiteral(int v) {
        boolean isIntegerLiteral_int_value = getValue() == v;
    ...
    public CValue cevalCalc(VariableEvaluator evaluator) {
        CValue cevalCalc_VariableEvaluator_value = new CValueInteger(getValue());
    ...
    public FExp createNegated() {
        FExp createNegated_value = new FIntegerLitExp(- getValue());
    ...
    public boolean isLiteral(int i) {
        boolean isLiteral_int_value = getValue() == i;
    ...
    public String xmlTag() {
        String xmlTag_value = "IntegerLiteral";
        return xmlTag_value;
    }
    /**
     * @attribute syn
     * @aspect CCodeGenExpressions
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaCBackEnd\\src\\jastadd\\CCodeGen\\CCodeGenExpressions.jrag:389
     */
    @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
    @ASTNodeAnnotation.Source(aspect="CCodeGenExpressions", declaredAt="C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaCBackEnd\\src\\jastadd\\CCodeGen\\CCodeGenExpressions.jrag:389")
    public boolean shouldWrap() {
        boolean shouldWrap_value = inIfCondition() || inFunctionArg();
    ...
    public MX toMX() {
        MX toMX_value = new MX((double)getValue());
        return toMX_value;
    }
    /**
    ...
    @ASTNodeAnnotation.Source(aspect="CCodeGenExpressions", declaredAt="C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaCBackEnd\\src\\jastadd\\CCodeGen\\CCodeGenExpressions.jrag:405")
    public boolean inFunctionArg() {
        boolean inFunctionArg_value = getParent().Define_inFunctionArg(this, null);
        return inFunctionArg_value;
    }
    /** @apilevel internal */
