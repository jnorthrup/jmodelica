...
/**
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\ast\\Modelica.ast:118
 * @astdecl SrcExtendClassDecl : SrcFullClassDecl ::= SrcInlineExtendsClause;
 * @production SrcExtendClassDecl : {@link SrcFullClassDecl} ::= <span class="component">{@link SrcInlineExtendsClause}</span>;

 */
public class SrcExtendClassDecl extends SrcFullClassDecl implements Cloneable {
    /**
     * @aspect InstanceTreeConstruction
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\instance\\InstanceTree.jrag:1399
     */
    ...
    @ASTNodeAnnotation.Constructor(
        name = {"Name", "Encapsulated", "Partial", "SrcRestriction", "Redeclare", "Final", "Inner", "Outer", "Replaceable", "SrcConstrainingClause", "ConstrainingClauseComment", "SrcStringComment", "SrcClause", "SrcExternalClause", "SrcAnnotation", "SrcEndDecl", "SrcInlineExtendsClause"},
        type = {"SrcIdDecl", "boolean", "boolean", "SrcRestriction", "boolean", "boolean", "boolean", "boolean", "boolean", "Opt<SrcConstrainingClause>", "Opt<SrcComment>", "Opt<SrcStringComment>", "List<SrcClause>", "Opt<SrcExternalClause>", "Opt<SrcAnnotation>", "SrcEndDecl", "SrcInlineExtendsClause"},
        kind = {"Child", "Token", "Token", "Child", "Token", "Token", "Token", "Token", "Token", "Opt", "Opt", "Opt", "List", "Opt", "Opt", "Child", "Child"}
    )
    public SrcExtendClassDecl(SrcIdDecl p0, boolean p1, boolean p2, SrcRestriction p3, boolean p4, boolean p5, boolean p6, boolean p7, boolean p8, Opt<SrcConstrainingClause> p9, Opt<SrcComment> p10, Opt<SrcStringComment> p11, List<SrcClause> p12, Opt<SrcExternalClause> p13, Opt<SrcAnnotation> p14, SrcEndDecl p15, SrcInlineExtendsClause p16) {
        setChild(p0, 0);
        setEncapsulated(p1);
        setPartial(p2);
        setChild(p3, 1);
     ...
     */
    public SrcExtendClassDecl clone() throws CloneNotSupportedException {
        SrcExtendClassDecl node = (SrcExtendClassDecl) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:67
     */
    public SrcExtendClassDecl copy() {
        try {
            SrcExtendClassDecl node = (SrcExtendClassDecl) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    @Deprecated
    public SrcExtendClassDecl fullCopy() {
     ...
     */
    public SrcExtendClassDecl treeCopyNoTransform() {
        SrcExtendClassDecl tree = (SrcExtendClassDecl) copy();
        if (children != null) {
     ...
     */
    public SrcExtendClassDecl treeCopy() {
        doFullTraversal();
        return treeCopyNoTransform();
    }
    /** @apilevel internal 
    ...
    protected boolean is$Equal(ASTNode node) {
        return super.is$Equal(node) && (tokenboolean_Encapsulated == ((SrcExtendClassDecl) node).tokenboolean_Encapsulated) && (tokenboolean_Partial == ((SrcExtendClassDecl) node).tokenboolean_Partial) && (tokenboolean_Redeclare == ((SrcExtendClassDecl) node).tokenboolean_Redeclare) && (tokenboolean_Final == ((SrcExtendClassDecl) node).tokenboolean_Final) && (tokenboolean_Inner == ((SrcExtendClassDecl) node).tokenboolean_Inner) && (tokenboolean_Outer == ((SrcExtendClassDecl) node).tokenboolean_Outer) && (tokenboolean_Replaceable == ((SrcExtendClassDecl) node).tokenboolean_Replaceable);    
    }
    /**
    ...
    /**
     * Replaces the SrcInlineExtendsClause child.
     * @param node The new node to replace the SrcInlineExtendsClause child.
     * @apilevel high-level
     */
    public void setSrcInlineExtendsClause(SrcInlineExtendsClause node) {
        setChild(node, 9);
    }
    /**
     * Retrieves the SrcInlineExtendsClause child.
     * @return The current node used as the SrcInlineExtendsClause child.
     * @apilevel high-level
     */
    @ASTNodeAnnotation.Child(name="SrcInlineExtendsClause")
    public SrcInlineExtendsClause getSrcInlineExtendsClause() {
        return (SrcInlineExtendsClause) getChild(9);
    }
    /**
     * Retrieves the SrcInlineExtendsClause child.
     * <p><em>This method does not invoke AST transformations.</em></p>
     ...
     * @apilevel low-level
     */
    public SrcInlineExtendsClause getSrcInlineExtendsClauseNoTransform() {
        return (SrcInlineExtendsClause) getChildNoTransform(9);
    }
    /**
     * @attribute syn
     * @aspect InstanceTreeConstruction
    ...
    public boolean hasRedeclare() {
        boolean hasRedeclare_value = true;
    ...
    public Iterable<SrcExtendsClause> superClasses() {
        Iterable<SrcExtendsClause> superClasses_value = new ChainedIterable(
    ...
    public boolean isClassExtends() {
        boolean isClassExtends_value = true;
