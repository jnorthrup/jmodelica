 ...
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\ast\\FlatModelica.ast:911
 * @astdecl FNumericLitExp : FLitExp;
 * @production FNumericLitExp : {@link FLitExp};

 */
public abstract class FNumericLitExp extends FLitExp implements Cloneable {
    /**
     * @aspect CCodeGenExpressions
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaCBackEnd\\src\\jastadd\\CCodeGen\\CCodeGenExpressions.jrag:372
     */
    @Override
    ...
    /**
     * @aspect CCodeGenExpressions
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaCBackEnd\\src\\jastadd\\CCodeGen\\CCodeGenExpressions.jrag:388
     */
    public abstract boolean shouldWrap();
    /**
     * @declaredat ASTNode:1
     */
    public FNumericLitExp() {
        super();
    }
    /**
     ...
     */
    public FNumericLitExp clone() throws CloneNotSupportedException {
        FNumericLitExp node = (FNumericLitExp) super.clone();
        return node;
    }
    /**
     ...
     */
    @Deprecated
    public abstract FNumericLitExp fullCopy();
    /**
     * Create a deep copy of the AST subtree at this node.
     * The copy is dangling, i.e. has no parent.
     * @return dangling copy of the subtree at this node
     ...
     */
    public abstract FNumericLitExp treeCopyNoTransform();
    /**
     * Create a deep copy of the AST subtree at this node.
     ...
     */
    public abstract FNumericLitExp treeCopy();
    /**
    ...
    public boolean isLiteralZero() {
        boolean isLiteralZero_value = type().isScalar() && ceval().realValue() == 0.0;
    ...
    public boolean isLiteralOne() {
        boolean isLiteralOne_value = type().isScalar() && ceval().realValue() == 1.0;
    ...
    public boolean isLiteralMinusOne() {
        boolean isLiteralMinusOne_value = type().isScalar() && ceval().realValue() == -1.0;
     ...
     * @attribute syn
     * @aspect CCodeGenExpressions
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaCBackEnd\\src\\jastadd\\CCodeGen\\CCodeGenExpressions.jrag:392
     */
    @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
    @ASTNodeAnnotation.Source(aspect="CCodeGenExpressions", declaredAt="C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaCBackEnd\\src\\jastadd\\CCodeGen\\CCodeGenExpressions.jrag:392")
    public boolean shouldAppendZeroFractionalPart(CodePrinter p, String value) {
        boolean shouldAppendZeroFractionalPart_CodePrinter_String_value = p.inGeneratedFunctionCall(this) && !value.contains(".");
        return shouldAppendZeroFractionalPart_CodePrinter_String_value;
    }
    /** @apilevel internal */
