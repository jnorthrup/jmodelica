...
/**
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\ast\\Modelica.ast:285
 * @astdecl SrcNegExp : SrcExp ::= SrcExp;
 * @production SrcNegExp : {@link SrcExp} ::= <span class="component">{@link SrcExp}</span>;

 */
public class SrcNegExp extends SrcExp implements Cloneable {
    /**
     * @aspect PrettyPrint
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\PrettyPrint.jrag:792
     */
     ...
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\flattening\\Flattening.jrag:3227
     */
     ...
     */
    public SrcNegExp clone() throws CloneNotSupportedException {
        SrcNegExp node = (SrcNegExp) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:45
     */
    public SrcNegExp copy() {
        try {
            SrcNegExp node = (SrcNegExp) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    public SrcNegExp treeCopyNoTransform() {
        SrcNegExp tree = (SrcNegExp) copy();
        if (children != null) {
