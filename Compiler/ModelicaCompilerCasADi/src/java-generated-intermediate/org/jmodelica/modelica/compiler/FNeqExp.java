 ...
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\ast\\FlatModelica.ast:881
 * @astdecl FNeqExp : FEqRelExp;
 * @production FNeqExp : {@link FEqRelExp};

 */
public class FNeqExp extends FEqRelExp implements Cloneable {
    /**
     * @aspect InheritedFactoryMethods
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:935
     */
    public FNeqExp createEmptyNode() { return new FNeqExp(); }
    /**
     * @aspect InheritedFactoryMethods
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:1429
     */
    public FNeqExp(FExp e1, FExp e2) { this(e1, e2, new Opt<FExp>(), (String) null); }
    /**
    ...
    public FNeqExp(FExp p0, FExp p1, Opt<FExp> p2, String p3) {
        setChild(p0, 0);
        setChild(p1, 1);
        setChild(p2, 2);
     ...
     */
    public FNeqExp(FExp p0, FExp p1, Opt<FExp> p2, beaver.Symbol p3) {
        setChild(p0, 0);
        setChild(p1, 1);
        setChild(p2, 2);
        setIndicatorVarName(p3);
     ...
     */
    public FNeqExp clone() throws CloneNotSupportedException {
        FNeqExp node = (FNeqExp) super.clone();
        return node;
    }
    /** @apilevel internal 
     ...
     */
    public FNeqExp treeCopyNoTransform() {
        FNeqExp tree = (FNeqExp) copy();
        if (children != null) {
    ...
    protected boolean is$Equal(ASTNode node) {
        return super.is$Equal(node) && (tokenString_IndicatorVarName == ((FNeqExp) node).tokenString_IndicatorVarName);    
    }
    /**
    ...
    public CValue cevalEval(CValue left, CValue right) {
        CValue cevalEval_CValue_CValue_value = cevalType().neq(left, right);
    ...
    public String operatorName() {
        String operatorName_value = OP_NEQ;
    ...
    public boolean relIsInverted_C() {
        boolean relIsInverted_C_value = true;
    ...
    public MX toMX() {
        MX toMX_value = getLeft().toMX().__ne__(getRight().toMX());
        return toMX_value;
    }
    /** @apilevel internal */
