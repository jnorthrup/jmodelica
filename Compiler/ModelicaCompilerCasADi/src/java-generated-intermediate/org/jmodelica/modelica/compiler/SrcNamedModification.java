...
/**
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\ast\\Modelica.ast:225
 * @astdecl SrcNamedModification : SrcArgument ::= Name:SrcAccess;
 * @production SrcNamedModification : {@link SrcArgument} ::= <span class="component">Name:{@link SrcAccess}</span>;

 */
public abstract class SrcNamedModification extends SrcArgument implements Cloneable {
    /**
     * @declaredat ASTNode:1
     */
    public SrcNamedModification() {
        super();
    }
    /**
    ...
    @ASTNodeAnnotation.Constructor(
        name = {"Each", "Final", "Name"},
        type = {"boolean", "boolean", "SrcAccess"},
        kind = {"Token", "Token", "Child"}
    )
    public SrcNamedModification(boolean p0, boolean p1, SrcAccess p2) {
        setEach(p0);
        setFinal(p1);
        setChild(p2, 0);
    }
     ...
     */
    public SrcNamedModification clone() throws CloneNotSupportedException {
        SrcNamedModification node = (SrcNamedModification) super.clone();
        return node;
    }
    /**
     ...
     */
    @Deprecated
    public abstract SrcNamedModification fullCopy();
    /**
     * Create a deep copy of the AST subtree at this node.
     * The copy is dangling, i.e. has no parent.
     * @return dangling copy of the subtree at this node
     ...
     */
    public abstract SrcNamedModification treeCopyNoTransform();
    /**
     * Create a deep copy of the AST subtree at this node.
     ...
     */
    public abstract SrcNamedModification treeCopy();
    /**
     ...
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\util\\Annotations.jrag:1956
     */
    @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
    @ASTNodeAnnotation.Source(aspect="AnnotationAPI", declaredAt="C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\util\\Annotations.jrag:1956")
    ...
    public String annotationName() {
        String annotationName_value = getName().name();
