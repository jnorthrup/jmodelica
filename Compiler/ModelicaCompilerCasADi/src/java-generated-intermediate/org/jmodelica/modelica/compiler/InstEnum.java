...
/**
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\ast\\InstanceTree.ast:112
 * @astdecl InstEnum : InstPrimitive;
 * @production InstEnum : {@link InstPrimitive};

 */
public class InstEnum extends InstPrimitive implements Cloneable {
    /**
     * @aspect ComplianceCheck
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\errorcheck\\ComplianceCheck.jadd:325
     */
    ...
    /**
     * @aspect Flattening
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\flattening\\Flattening.jrag:1330
     */
    ...
    /**
     * @aspect Flattening
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\flattening\\Flattening.jrag:1543
     */
    public FEnumVariable createEmptyFVariable() {
    ...
    public InstEnum(String p0, InstAccess p1, Opt<FArraySubscripts> p2, SrcComponentDecl p3, Opt<InstModification> p4, Opt<InstConstrainingComponent> p5, Opt<FExp> p6) {
        setName(p0);
        setChild(p1, 0);
        setChild(p2, 1);
     ...
     */
    public InstEnum(beaver.Symbol p0, InstAccess p1, Opt<FArraySubscripts> p2, SrcComponentDecl p3, Opt<InstModification> p4, Opt<InstConstrainingComponent> p5, Opt<FExp> p6) {
        setName(p0);
        setChild(p1, 0);
        setChild(p2, 1);
        setSrcComponentDecl(p3);
     ...
     */
    public InstEnum clone() throws CloneNotSupportedException {
        InstEnum node = (InstEnum) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:75
     */
    public InstEnum copy() {
        try {
            InstEnum node = (InstEnum) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    public InstEnum treeCopyNoTransform() {
        InstEnum tree = (InstEnum) copy();
        if (children != null) {
    ...
    protected boolean is$Equal(ASTNode node) {
        return super.is$Equal(node) && (tokenString_Name == ((InstEnum) node).tokenString_Name) && (tokenSrcComponentDecl_SrcComponentDecl == ((InstEnum) node).tokenSrcComponentDecl_SrcComponentDecl);    
    }
    /**
    ...
    public FType type() {
        ...
        type_value = myInstClass().enumType().sizedType(size());
