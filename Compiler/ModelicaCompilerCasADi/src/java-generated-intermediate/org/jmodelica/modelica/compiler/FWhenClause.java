 ...
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\ast\\FlatModelica.ast:686
 * @astdecl FWhenClause : FIfWhenClause;
 * @production FWhenClause : {@link FIfWhenClause};

 */
public class FWhenClause extends FIfWhenClause implements Cloneable {
    /**
     * @aspect InheritedFactoryMethods
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:1299
     */
    public FWhenClause createEmptyNode() { return new FWhenClause(); }
    /**
     * @aspect FlatTypeCheck
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\errorcheck\\TypeCheck.jrag:1164
     */
     ...
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\flattening\\FlatteningStatements.jrag:166
     */
    ...
    public FWhenClause(FExp p0, List<FStatement> p1) {
        setChild(p0, 0);
        setChild(p1, 1);
    }
    /** @apilevel low-level 
     ...
     */
    public FWhenClause clone() throws CloneNotSupportedException {
        FWhenClause node = (FWhenClause) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:47
     */
    public FWhenClause copy() {
        try {
            FWhenClause node = (FWhenClause) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    public FWhenClause treeCopyNoTransform() {
        FWhenClause tree = (FWhenClause) copy();
        if (children != null) {
    ...
    public boolean Define_inWhen(ASTNode _callerNode, ASTNode _childNode) {
        if (_callerNode == getFStatementListNoTransform()) {
            // @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\FlatUtil.jrag:1822
