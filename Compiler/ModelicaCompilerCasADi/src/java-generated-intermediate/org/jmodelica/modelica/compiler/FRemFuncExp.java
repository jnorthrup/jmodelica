 ...
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\ast\\FlatModelica.ast:1400
 * @astdecl FRemFuncExp : FBinEventGenExp;
 * @production FRemFuncExp : {@link FBinEventGenExp};

 */
public class FRemFuncExp extends FBinEventGenExp implements Cloneable {
    /**
     * @aspect InheritedFactoryMethods
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:1032
     */
    public FRemFuncExp createEmptyNode()      { return new FRemFuncExp();      }
    /**
     * @aspect FlatExpressions
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\flattening\\Flattening.jrag:2554
     */
    public FExp flatten(Flattener f)     { return new FSubExp(getX().flatten(f), new FMulExp(new FDivFuncExp(getX().flatten(f), getY().flatten(f)), getY().flatten(f)));}
    /**
     * @aspect Derivatives
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaMiddleEnd\\src\\jastadd\\structural\\Differentiation.jrag:485
     */
    @Override
    ...
    public FRemFuncExp(List<InstFunctionArgument> p0, FExp p1, FExp p2) {
        setChild(p0, 0);
        setChild(p1, 1);
        setChild(p2, 2);
    }
     ...
     */
    public FRemFuncExp clone() throws CloneNotSupportedException {
        FRemFuncExp node = (FRemFuncExp) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:48
     */
    public FRemFuncExp copy() {
        try {
            FRemFuncExp node = (FRemFuncExp) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    public FRemFuncExp treeCopyNoTransform() {
        FRemFuncExp tree = (FRemFuncExp) copy();
        if (children != null) {
    ...
    public CValue cevalCalc(VariableEvaluator evaluator) {
        CValue cevalCalc_VariableEvaluator_value = type().sub(getX().ceval(evaluator), type().mul(type().truncToZero(type().div(getX().ceval(evaluator), getY().ceval(evaluator))), getY().ceval(evaluator)));
