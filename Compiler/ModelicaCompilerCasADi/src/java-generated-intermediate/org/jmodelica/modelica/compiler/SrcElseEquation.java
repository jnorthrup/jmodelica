...
/**
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\ast\\Modelica.ast:246
 * @astdecl SrcElseEquation : SrcIfWhenElseEquation;
 * @production SrcElseEquation : {@link SrcIfWhenElseEquation};

 */
public class SrcElseEquation extends SrcIfWhenElseEquation implements Cloneable {
    /**
     * @aspect InstantiatedExpressions
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\flattening\\Flattening.jrag:2960
     */
    ...
    public SrcElseEquation(SrcComment p0, List<SrcAbstractEquation> p1) {
        setChild(p0, 0);
        setChild(p1, 1);
    }
    /** @apilevel low-level 
     ...
     */
    public SrcElseEquation clone() throws CloneNotSupportedException {
        SrcElseEquation node = (SrcElseEquation) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:47
     */
    public SrcElseEquation copy() {
        try {
            SrcElseEquation node = (SrcElseEquation) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    @Deprecated
    public SrcElseEquation fullCopy() {
     ...
     */
    public SrcElseEquation treeCopyNoTransform() {
        SrcElseEquation tree = (SrcElseEquation) copy();
        if (children != null) {
     ...
     */
    public SrcElseEquation treeCopy() {
        doFullTraversal();
        return treeCopyNoTransform();
    }
    /** @apilevel internal 
