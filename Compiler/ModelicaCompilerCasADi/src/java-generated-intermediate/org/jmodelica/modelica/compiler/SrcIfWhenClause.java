...
/**
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\ast\\Modelica.ast:263
 * @astdecl SrcIfWhenClause : SrcBaseNode ::= Test:SrcExp SrcStatement*;
 * @production SrcIfWhenClause : {@link SrcBaseNode} ::= <span class="component">Test:{@link SrcExp}</span> <span class="component">{@link SrcStatement}*</span>;

 */
public abstract class SrcIfWhenClause extends SrcBaseNode implements Cloneable {
    /**
     * @aspect PrettyPrint
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\PrettyPrint.jrag:496
     */
     ...
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\flattening\\Flattening.jrag:3074
     */
    ...
    /**
     * @aspect InstantiatedExpressions
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\flattening\\Flattening.jrag:3082
     */
    protected abstract FIfWhenClause instantiateIfWhenClause(FExp t, List l);
    /**
     * @declaredat ASTNode:1
     */
    public SrcIfWhenClause() {
        super();
    }
    /**
    ...
    @ASTNodeAnnotation.Constructor(
        name = {"Test", "SrcStatement"},
        type = {"SrcExp", "List<SrcStatement>"},
        kind = {"Child", "List"}
    )
    public SrcIfWhenClause(SrcExp p0, List<SrcStatement> p1) {
        setChild(p0, 0);
        setChild(p1, 1);
    }
    /** @apilevel low-level 
     ...
     */
    public SrcIfWhenClause clone() throws CloneNotSupportedException {
        SrcIfWhenClause node = (SrcIfWhenClause) super.clone();
        return node;
    }
    /**
     ...
     */
    @Deprecated
    public abstract SrcIfWhenClause fullCopy();
    /**
     * Create a deep copy of the AST subtree at this node.
     * The copy is dangling, i.e. has no parent.
     * @return dangling copy of the subtree at this node
     ...
     */
    public abstract SrcIfWhenClause treeCopyNoTransform();
    /**
     * Create a deep copy of the AST subtree at this node.
     ...
     */
    public abstract SrcIfWhenClause treeCopy();
    /**
    ...
    public List<SrcStatement> getSrcStatementList() {
        List<SrcStatement> list = (List<SrcStatement>) getChild(1);
        return list;
    }
    /**
     * Retrieves the SrcStatement list.
    ...
    public List<SrcStatement> getSrcStatementListNoTransform() {
        return (List<SrcStatement>) getChildNoTransform(1);
    }
    /**
