 ...
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\ast\\FlatModelica.ast:557
 * @astdecl FDecouple : FUnaryBuiltIn;
 * @production FDecouple : {@link FUnaryBuiltIn};

 */
public class FDecouple extends FUnaryBuiltIn implements Cloneable {
    /**
     * @aspect InheritedFactoryMethods
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:1069
     */
    public FDecouple createEmptyNode()          { return new FDecouple();          }
    /**
     * @aspect ComplianceCheck
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\errorcheck\\ComplianceCheck.jadd:174
     */
     ...
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\flattening\\Flattening.jrag:2650
     */
    ...
    public FDecouple(List<InstFunctionArgument> p0, FExp p1) {
        setChild(p0, 0);
        setChild(p1, 1);
    }
    /** @apilevel low-level 
     ...
     */
    public FDecouple clone() throws CloneNotSupportedException {
        FDecouple node = (FDecouple) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:48
     */
    public FDecouple copy() {
        try {
            FDecouple node = (FDecouple) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    public FDecouple treeCopyNoTransform() {
        FDecouple tree = (FDecouple) copy();
        if (children != null) {
    ...
    public String builtInName() {
        String builtInName_value = "Subtask.decouple";
    ...
    public boolean Define_argumentDefinedTypeValid(ASTNode _callerNode, ASTNode _childNode) {
        if (_callerNode == getOriginalArgListNoTransform()) {
            // @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\errorcheck\\TypeCheck.jrag:1691
