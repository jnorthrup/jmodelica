...
/**
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\ast\\InstanceTree.ast:189
 * @astdecl InstClassModification : InstModification ::= InstArgument*;
...
public class InstClassModification extends InstModification implements Cloneable {
    /**
     * @aspect ContentCheck
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\errorcheck\\ContentsCheck.jadd:189
     */
     ...
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\instance\\InstanceTree.jrag:231
     */
    ...
    @ASTNodeAnnotation.Constructor(
        name = {"SrcModification", "InstArgument"},
        type = {"SrcModificationOrRedeclareElement", "List<InstArgument>"},
        kind = {"Token", "List"}
    )
    public InstClassModification(SrcModificationOrRedeclareElement p0, List<InstArgument> p1) {
    ...
    protected boolean is$Equal(ASTNode node) {
        return super.is$Equal(node) && (tokenSrcModificationOrRedeclareElement_SrcModification == ((InstClassModification) node).tokenSrcModificationOrRedeclareElement_SrcModification);    
    }
    /**
    ...
    public void addInstArgument(InstArgument node) {
        List<InstArgument> list = (parent == null) ? getInstArgumentListNoTransform() : getInstArgumentList();
        if (list == List.EMPTY) {
    ...
    /**
     * @return the element at index {@code i} in the InstArgument list without
     * triggering rewrites.
     */
    public InstArgument getInstArgumentNoTransform(int i) {
        return (InstArgument) getInstArgumentListNoTransform().getChildNoTransform(i);
    }
    /**
     * Retrieves the InstArgument list.
     * @return The node representing the InstArgument list.
     ...
     * @attribute syn
     * @aspect InstModifications
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\instance\\InstanceTree.jrag:309
     */
    @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
    @ASTNodeAnnotation.Source(aspect="InstModifications", declaredAt="C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\instance\\InstanceTree.jrag:309")
    public SrcClassModification getSrcClassModification() {
        SrcClassModification getSrcClassModification_value = (SrcClassModification)     getSrcModification();
        return getSrcClassModification_value;
    }
    /** @apilevel internal */
