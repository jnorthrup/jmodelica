...
/**
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\ast\\Modelica.ast:121
 * @astdecl SrcRealClassDecl : SrcPrimitiveClassDecl;
 * @production SrcRealClassDecl : {@link SrcPrimitiveClassDecl};

 */
public class SrcRealClassDecl extends SrcPrimitiveClassDecl implements Cloneable {
    /**
     * Create from a SrcFullClassDecl - will destroy that node!
     * @aspect PredefinedTypes
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\source\\PredefinedTypes.jrag:301
     */
    public SrcRealClassDecl(SrcFullClassDecl fcd) {
        super(fcd);
    }
    /**
     * @declaredat ASTNode:1
     */
    public SrcRealClassDecl() {
        super();
    }
    /**
    ...
    public SrcRealClassDecl(SrcIdDecl p0, boolean p1, boolean p2, SrcRestriction p3, boolean p4, boolean p5, boolean p6, boolean p7, boolean p8, Opt<SrcConstrainingClause> p9, Opt<SrcComment> p10, Opt<SrcStringComment> p11, List<SrcClause> p12, Opt<SrcExternalClause> p13, Opt<SrcAnnotation> p14, SrcEndDecl p15) {
        setChild(p0, 0);
        setEncapsulated(p1);
        setPartial(p2);
        setChild(p3, 1);
     ...
     */
    public SrcRealClassDecl clone() throws CloneNotSupportedException {
        SrcRealClassDecl node = (SrcRealClassDecl) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:66
     */
    public SrcRealClassDecl copy() {
        try {
            SrcRealClassDecl node = (SrcRealClassDecl) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    @Deprecated
    public SrcRealClassDecl fullCopy() {
     ...
     */
    public SrcRealClassDecl treeCopyNoTransform() {
        SrcRealClassDecl tree = (SrcRealClassDecl) copy();
        if (children != null) {
     ...
     */
    public SrcRealClassDecl treeCopy() {
        doFullTraversal();
        return treeCopyNoTransform();
    }
    /** @apilevel internal 
    ...
    protected boolean is$Equal(ASTNode node) {
        return super.is$Equal(node) && (tokenboolean_Encapsulated == ((SrcRealClassDecl) node).tokenboolean_Encapsulated) && (tokenboolean_Partial == ((SrcRealClassDecl) node).tokenboolean_Partial) && (tokenboolean_Redeclare == ((SrcRealClassDecl) node).tokenboolean_Redeclare) && (tokenboolean_Final == ((SrcRealClassDecl) node).tokenboolean_Final) && (tokenboolean_Inner == ((SrcRealClassDecl) node).tokenboolean_Inner) && (tokenboolean_Outer == ((SrcRealClassDecl) node).tokenboolean_Outer) && (tokenboolean_Replaceable == ((SrcRealClassDecl) node).tokenboolean_Replaceable);    
    }
    /**
