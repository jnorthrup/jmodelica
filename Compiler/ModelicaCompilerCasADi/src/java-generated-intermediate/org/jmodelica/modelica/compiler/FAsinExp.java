 ...
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\ast\\FlatModelica.ast:1440
 * @astdecl FAsinExp : FMathematicalFunctionCall;
 * @production FAsinExp : {@link FMathematicalFunctionCall};

 */
public class FAsinExp extends FMathematicalFunctionCall implements Cloneable {
    /**
     * @aspect InheritedFactoryMethods
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:1011
     */
    public FAsinExp createEmptyNode()  { return new FAsinExp();  }
    /**
     * @aspect Derivatives
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaMiddleEnd\\src\\jastadd\\structural\\Differentiation.jrag:313
     */
    @Override
    ...
    public FAsinExp(List<InstFunctionArgument> p0, FExp p1) {
        setChild(p0, 0);
        setChild(p1, 1);
    }
    /** @apilevel low-level 
     ...
     */
    public FAsinExp clone() throws CloneNotSupportedException {
        FAsinExp node = (FAsinExp) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:47
     */
    public FAsinExp copy() {
        try {
            FAsinExp node = (FAsinExp) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    public FAsinExp treeCopyNoTransform() {
        FAsinExp tree = (FAsinExp) copy();
        if (children != null) {
    ...
    public CValue cevalCalc(VariableEvaluator evaluator) {
        CValue cevalCalc_VariableEvaluator_value = new CValueReal(StrictMath.asin(getFExp().ceval(evaluator).realValue()));
    ...
    public MX toMX() {
        MX toMX_value = getFExp().toMX().arcsin();
        return toMX_value;
    }
    /** @apilevel internal */
