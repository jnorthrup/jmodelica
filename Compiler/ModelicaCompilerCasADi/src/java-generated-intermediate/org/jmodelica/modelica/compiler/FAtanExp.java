 ...
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\ast\\FlatModelica.ast:1450
 * @astdecl FAtanExp : FMathematicalFunctionCall;
 * @production FAtanExp : {@link FMathematicalFunctionCall};

 */
public class FAtanExp extends FMathematicalFunctionCall implements Cloneable {
    /**
     * @aspect InheritedFactoryMethods
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:1013
     */
    public FAtanExp createEmptyNode()  { return new FAtanExp();  }
    /**
     * @aspect Derivatives
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaMiddleEnd\\src\\jastadd\\structural\\Differentiation.jrag:329
     */
    @Override
    ...
    public FAtanExp(List<InstFunctionArgument> p0, FExp p1) {
        setChild(p0, 0);
        setChild(p1, 1);
    }
    /** @apilevel low-level 
     ...
     */
    public FAtanExp clone() throws CloneNotSupportedException {
        FAtanExp node = (FAtanExp) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:47
     */
    public FAtanExp copy() {
        try {
            FAtanExp node = (FAtanExp) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    public FAtanExp treeCopyNoTransform() {
        FAtanExp tree = (FAtanExp) copy();
        if (children != null) {
    ...
    public CValue cevalCalc(VariableEvaluator evaluator) {
        CValue cevalCalc_VariableEvaluator_value = new CValueReal(StrictMath.atan(getFExp().ceval(evaluator).realValue()));
    ...
    public MX toMX() {
        MX toMX_value = getFExp().toMX().arctan();
        return toMX_value;
    }
    /** @apilevel internal */
