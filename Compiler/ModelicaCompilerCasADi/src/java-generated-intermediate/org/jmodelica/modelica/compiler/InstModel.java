...
/**
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\ast\\InstanceTree.ast:72
 * @astdecl InstModel : InstRestriction;
 * @production InstModel : {@link InstRestriction};

 */
public class InstModel extends InstRestriction implements Cloneable {
    /**
     ...
     */
    public InstModel clone() throws CloneNotSupportedException {
        InstModel node = (InstModel) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:36
     */
    public InstModel copy() {
        try {
            InstModel node = (InstModel) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    public InstModel treeCopyNoTransform() {
        InstModel tree = (InstModel) copy();
        if (children != null) {
