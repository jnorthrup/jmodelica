...
/**
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\ast\\InstanceTree.ast:150
 * @astdecl InstReplacingExtendsShortClass : InstExtends ::= <InstExtendsShortClass:InstExtendsShortClass>;
...
public class InstReplacingExtendsShortClass extends InstExtends implements Cloneable {
    /**
     * @aspect ContentCheck
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\errorcheck\\ContentsCheck.jadd:170
     */
     ...
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\instance\\InstanceTree.jrag:1163
     */
    ...
    @ASTNodeAnnotation.Constructor(
        name = {"ClassName", "SrcExtendsClause", "InstExtendsShortClass"},
        type = {"InstAccess", "SrcExtendsClause", "InstExtendsShortClass"},
        kind = {"Child", "Token", "Token"}
    )
    public InstReplacingExtendsShortClass(InstAccess p0, SrcExtendsClause p1, InstExtendsShortClass p2) {
        setChild(p0, 0);
    ...
    protected boolean is$Equal(ASTNode node) {
        return super.is$Equal(node) && (tokenSrcExtendsClause_SrcExtendsClause == ((InstReplacingExtendsShortClass) node).tokenSrcExtendsClause_SrcExtendsClause) && (tokenInstExtendsShortClass_InstExtendsShortClass == ((InstReplacingExtendsShortClass) node).tokenInstExtendsShortClass_InstExtendsShortClass);    
    }
    /**
    ...
    @ASTNodeAnnotation.Source(aspect="InstLookupClasses", declaredAt="C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\instance\\InstLookupClasses.jrag:128")
    ...
    public InstLookupResult<InstClassDecl> Define_lookupInstClass(ASTNode _callerNode, ASTNode _childNode, String name) {
        if (_callerNode == getClassNameNoTransform()) {
            // @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\instance\\InstLookupClasses.jrag:83
