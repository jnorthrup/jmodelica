 ...
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\ast\\FlatModelica.ast:1615
 * @astdecl FSumExp : FReductionExp;
 * @production FSumExp : {@link FReductionExp};

 */
public class FSumExp extends FReductionExp implements Cloneable {
    /**
     * @aspect InheritedFactoryMethods
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:1051
     */
    public FSumExp createEmptyNode()          { return new FSumExp();          }
    /**
     * @aspect FlatPrettyPrint
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\PrettyPrint.jrag:1726
     */
    ...
    /**
     * @aspect Derivatives
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaMiddleEnd\\src\\jastadd\\structural\\Differentiation.jrag:778
     */
    @Override
    ...
    public FSumExp(List<InstFunctionArgument> p0, FExp p1) {
        setChild(p0, 0);
        setChild(p1, 1);
    }
    /** @apilevel low-level 
     ...
     */
    public FSumExp clone() throws CloneNotSupportedException {
        FSumExp node = (FSumExp) super.clone();
        return node;
    }
    /** @apilevel internal 
     ...
     */
    public FSumExp treeCopyNoTransform() {
        FSumExp tree = (FSumExp) copy();
        if (children != null) {
    ...
    public CValue reduceStartValue() {
        CValue reduceStartValue_value = type().createCValue(0);
    ...
    public CValue scalarReduceStartValue() {
        CValue scalarReduceStartValue_value = type().createCValueScalar(0);
    ...
    public CValue reduceOperation(CValue leftValue, CValue rightValue) {
        CValue reduceOperation_CValue_CValue_value = type().add(leftValue, rightValue);
    ...
    public FBinExp scalarReduceExp() {
        FBinExp scalarReduceExp_value = new FAddExp();
    ...
    public FExp scalarReduceExp(FExp reducer, FExp scalar) {
        FExp scalarReduceExp_FExp_FExp_value = new FAddExp(reducer, scalar);
