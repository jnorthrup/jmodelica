 ...
 * @ast class
 * @aspect ErrorCheck
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\errorcheck\\ErrorCheck.jrag:208
 */
public class UtilInterface extends java.lang.Object implements ProblemOptionsProvider {
    ...
    private static final ParserHandler FALLBACK_PARSER_HANDLER = new ParserHandler();
    ...
    public static UtilInterface create(ModelicaCompiler mc) {
        return create(mc, mc.getOptions(), mc.getErrorHandler(), mc.getExternalFunctionCache(), null);
    }

    public static UtilInterface create(UtilInterface other) {
    ...
    public static UtilInterface create(OptionRegistry options) {
        return create(null, options, new DefaultErrorHandler(), null, null);
    }

    public static UtilInterface create(OptionRegistry options, IErrorHandler eh) {
        return create(null, options, eh, null, null);
    }

    private static UtilInterface create(ModelicaCompiler mc, OptionRegistry options, 
            IErrorHandler eh, ExternalFunctionCache efc, File path) {
        return new UtilInterface(mc, options, eh, efc, path);
    }

    public void transferRoot(Root root) {
        clean();
