...
/**
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\ast\\Modelica.ast:230
 * @astdecl SrcComponentRedeclare : SrcElementRedeclare ::= SrcComponentClause;
 * @production SrcComponentRedeclare : {@link SrcElementRedeclare} ::= <span class="component">{@link SrcComponentClause}</span>;

 */
public class SrcComponentRedeclare extends SrcElementRedeclare implements Cloneable {
    /**
     * @aspect PrettyPrint
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\PrettyPrint.jrag:692
     */
     ...
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\instance\\InstanceTree.jrag:280
     */
     ...
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\util\\SrcAnnotations.jrag:349
     */
    @Override
    ...
    @ASTNodeAnnotation.Constructor(
        name = {"Each", "Final", "Name", "SrcComponentClause"},
        type = {"boolean", "boolean", "SrcAccess", "SrcComponentClause"},
        kind = {"Token", "Token", "Child", "Child"}
    )
    public SrcComponentRedeclare(boolean p0, boolean p1, SrcAccess p2, SrcComponentClause p3) {
        setEach(p0);
        setFinal(p1);
        setChild(p2, 0);
        setChild(p3, 1);
     ...
     */
    public SrcComponentRedeclare clone() throws CloneNotSupportedException {
        SrcComponentRedeclare node = (SrcComponentRedeclare) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:48
     */
    public SrcComponentRedeclare copy() {
        try {
            SrcComponentRedeclare node = (SrcComponentRedeclare) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    @Deprecated
    public SrcComponentRedeclare fullCopy() {
     ...
     */
    public SrcComponentRedeclare treeCopyNoTransform() {
        SrcComponentRedeclare tree = (SrcComponentRedeclare) copy();
        if (children != null) {
     ...
     */
    public SrcComponentRedeclare treeCopy() {
        doFullTraversal();
        return treeCopyNoTransform();
    }
    /** @apilevel internal 
    ...
    protected boolean is$Equal(ASTNode node) {
        return super.is$Equal(node) && (tokenboolean_Each == ((SrcComponentRedeclare) node).tokenboolean_Each) && (tokenboolean_Final == ((SrcComponentRedeclare) node).tokenboolean_Final);    
    }
    /**
    ...
    /**
     * Replaces the SrcComponentClause child.
     * @param node The new node to replace the SrcComponentClause child.
     * @apilevel high-level
     */
    public void setSrcComponentClause(SrcComponentClause node) {
        setChild(node, 1);
    }
    /**
     * Retrieves the SrcComponentClause child.
     * @return The current node used as the SrcComponentClause child.
     * @apilevel high-level
     */
    @ASTNodeAnnotation.Child(name="SrcComponentClause")
    public SrcComponentClause getSrcComponentClause() {
        return (SrcComponentClause) getChild(1);
    }
    /**
     * Retrieves the SrcComponentClause child.
     * <p><em>This method does not invoke AST transformations.</em></p>
     ...
     * @apilevel low-level
     */
    public SrcComponentClause getSrcComponentClauseNoTransform() {
        return (SrcComponentClause) getChildNoTransform(1);
    }
    /**
     * @attribute syn
     * @aspect InstModifications
    ...
    public SrcComponentDecl componentRedeclareDecl() {
        SrcComponentDecl componentRedeclareDecl_value = getSrcComponentDecl();
        return componentRedeclareDecl_value;
    }
    /**
     * @attribute syn
     * @aspect SourceTraversal
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\source\\SourceTraversal.jrag:206
     */
    @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
    @ASTNodeAnnotation.Source(aspect="SourceTraversal", declaredAt="C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\source\\SourceTraversal.jrag:206")
    public SrcComponentDecl getSrcComponentDecl() {
        SrcComponentDecl getSrcComponentDecl_value = getSrcComponentClause().getSrcComponentDecl(0);
        return getSrcComponentDecl_value;
    }
    /**
     * @attribute syn
     * @aspect Modifiers
    ...
    public boolean isComponentRedeclare() {
        boolean isComponentRedeclare_value = true;
    ...
    public SrcComponentDecl getSrcComponentRedeclare() {
        SrcComponentDecl getSrcComponentRedeclare_value = getSrcComponentDecl();
    ...
    public ResolvedAccess Define_simpleLookupHelper(ASTNode _callerNode, ASTNode _childNode, String name) {
        if (_callerNode == getSrcComponentClauseNoTransform()) {
            // @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\source\\SimpleLookup.jrag:289
