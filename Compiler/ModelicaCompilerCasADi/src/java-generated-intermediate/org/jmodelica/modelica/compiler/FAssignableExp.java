...
/**
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\ast\\FlatModelica.ast:1000
 * @astdecl FAssignableExp : FVarRefExp;
 * @production FAssignableExp : {@link FVarRefExp};

 */
public abstract class FAssignableExp extends FVarRefExp implements Cloneable {
    /**
     * @aspect ConstantEvaluationStatements
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\ConstantEvaluation\\ConstantEvaluationStatements.jrag:95
     */
    @Override
    public abstract void assignToInFuncEval(AlgorithmEvaluator evaluator, CValue right, FType rightType);
    /**
     * @declaredat ASTNode:1
     */
    public FAssignableExp() {
        super();
    }
    /**
     ...
     */
    public FAssignableExp clone() throws CloneNotSupportedException {
        FAssignableExp node = (FAssignableExp) super.clone();
        return node;
    }
    /**
     ...
     */
    @Deprecated
    public abstract FAssignableExp fullCopy();
    /**
     * Create a deep copy of the AST subtree at this node.
     * The copy is dangling, i.e. has no parent.
     * @return dangling copy of the subtree at this node
     ...
     */
    public abstract FAssignableExp treeCopyNoTransform();
    /**
     * Create a deep copy of the AST subtree at this node.
     ...
     */
    public abstract FAssignableExp treeCopy();
    /**
    ...
    public abstract boolean isOkTrivialInlineInFor();
    /**
     * @attribute syn
    ...
    public abstract Set<String> sortingAssignedNames();
    /**
    ...
    @ASTNodeAnnotation.Source(aspect="FVariableUses", declaredAt="C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\FlatAPI\\FlatAPI.jrag:3368")
     ...
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\FlatAPI\\FlatAPI.jrag:4241
     */
    @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.INH)
    @ASTNodeAnnotation.Source(aspect="FlatAlgorithmAPI", declaredAt="C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\FlatAPI\\FlatAPI.jrag:4241")
