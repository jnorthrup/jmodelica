 ...
 * by the compiler.
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\ast\\FlatModelica.ast:225
 * @astdecl FDynamicDerivativeVariable : FAbstractDerivativeVariable ::= <Set:DynamicStateSet>;
 * @production FDynamicDerivativeVariable : {@link FAbstractDerivativeVariable} ::= <span class="component">&lt;Set:DynamicStateSet&gt;</span>;

 */
public class FDynamicDerivativeVariable extends FAbstractDerivativeVariable implements Cloneable {
    /**
     * @declaredat ASTNode:1
     */
    public FDynamicDerivativeVariable() {
        super();
    }
    /**
    ...
    @ASTNodeAnnotation.Constructor(
        name = {"VisibilityType", "TypePrefixVariability", "TypePrefixInputOutput", "FAttribute", "DerivedType", "BindingExp", "FStringComment", "FAccess", "Order", "Set"},
        type = {"VisibilityType", "TypePrefixVariability", "TypePrefixInputOutput", "List<FAttribute>", "String", "Opt<FExp>", "Opt<FStringComment>", "FAccess", "int", "DynamicStateSet"},
        kind = {"Token", "Token", "Token", "List", "Token", "Opt", "Opt", "Child", "Token", "Token"}
    )
    public FDynamicDerivativeVariable(VisibilityType p0, TypePrefixVariability p1, TypePrefixInputOutput p2, List<FAttribute> p3, String p4, Opt<FExp> p5, Opt<FStringComment> p6, FAccess p7, int p8, DynamicStateSet p9) {
     ...
     */
    public FDynamicDerivativeVariable(VisibilityType p0, TypePrefixVariability p1, TypePrefixInputOutput p2, List<FAttribute> p3, beaver.Symbol p4, Opt<FExp> p5, Opt<FStringComment> p6, FAccess p7, int p8, DynamicStateSet p9) {
        setVisibilityType(p0);
        setTypePrefixVariability(p1);
        setTypePrefixInputOutput(p2);
        setChild(p3, 0);
     ...
     */
    public FDynamicDerivativeVariable clone() throws CloneNotSupportedException {
        FDynamicDerivativeVariable node = (FDynamicDerivativeVariable) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:69
     */
    public FDynamicDerivativeVariable copy() {
        try {
            FDynamicDerivativeVariable node = (FDynamicDerivativeVariable) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    @Deprecated
    public FDynamicDerivativeVariable fullCopy() {
     ...
     */
    public FDynamicDerivativeVariable treeCopyNoTransform() {
        FDynamicDerivativeVariable tree = (FDynamicDerivativeVariable) copy();
        if (children != null) {
     ...
     */
    public FDynamicDerivativeVariable treeCopy() {
        doFullTraversal();
        return treeCopyNoTransform();
    }
    /** @apilevel internal 
    ...
    protected boolean is$Equal(ASTNode node) {
        return super.is$Equal(node) && (tokenVisibilityType_VisibilityType == ((FDynamicDerivativeVariable) node).tokenVisibilityType_VisibilityType) && (tokenTypePrefixVariability_TypePrefixVariability == ((FDynamicDerivativeVariable) node).tokenTypePrefixVariability_TypePrefixVariability) && (tokenTypePrefixInputOutput_TypePrefixInputOutput == ((FDynamicDerivativeVariable) node).tokenTypePrefixInputOutput_TypePrefixInputOutput) && (tokenString_DerivedType == ((FDynamicDerivativeVariable) node).tokenString_DerivedType) && (tokenint_Order == ((FDynamicDerivativeVariable) node).tokenint_Order) && (tokenDynamicStateSet_Set == ((FDynamicDerivativeVariable) node).tokenDynamicStateSet_Set);    
    }
    /**
    ...
    public boolean isDynamicDerivativeVariable() {
        boolean isDynamicDerivativeVariable_value = true;
        return isDynamicDerivativeVariable_value;
    }
    /**
     * @attribute syn
     * @aspect FlatNames
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\FlatUtil.jrag:317
     */
    @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
    @ASTNodeAnnotation.Source(aspect="FlatNames", declaredAt="C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\FlatUtil.jrag:317")
    public String dynDerName() {
        String dynDerName_value = getFAccess().dynDerName(order());
    ...
    public FAccessExp createAccessExp() {
        FAccessExp createAccessExp_value = new FDynamicDerExp(createFAccess(), (String)null, order());
    ...
    public String displayName() {
        String displayName_value = dynDerName();
