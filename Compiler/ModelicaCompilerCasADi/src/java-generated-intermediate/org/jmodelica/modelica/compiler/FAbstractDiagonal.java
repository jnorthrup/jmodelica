...
/**
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\ast\\FlatModelica.ast:1540
 * @astdecl FAbstractDiagonal : FUnaryBuiltIn;
 * @production FAbstractDiagonal : {@link FUnaryBuiltIn};

 */
public abstract class FAbstractDiagonal extends FUnaryBuiltIn implements Cloneable {
    /**
     * @aspect FunctionScalarization
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaMiddleEnd\\src\\jastadd\\scalarization\\ScalarizeFunctions.jrag:642
     */
    ...
    public FAbstractDiagonal(List<InstFunctionArgument> p0, FExp p1) {
        setChild(p0, 0);
        setChild(p1, 1);
    }
    /** @apilevel low-level 
     ...
     */
    public FAbstractDiagonal clone() throws CloneNotSupportedException {
        FAbstractDiagonal node = (FAbstractDiagonal) super.clone();
        return node;
    }
    /**
     ...
     */
    @Deprecated
    public abstract FAbstractDiagonal fullCopy();
    /**
     * Create a deep copy of the AST subtree at this node.
     * The copy is dangling, i.e. has no parent.
     * @return dangling copy of the subtree at this node
     ...
     */
    public abstract FAbstractDiagonal treeCopyNoTransform();
    /**
     * Create a deep copy of the AST subtree at this node.
     ...
     */
    public abstract FAbstractDiagonal treeCopy();
    /**
    ...
    public abstract FExp scalarizeDiagonalElement(Scalarizer s);
    /** @apilevel internal */
