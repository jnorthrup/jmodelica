...
/**
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\ast\\InstanceTree.ast:83
 * @astdecl InstOperatorRecord : InstMRecord;
 * @production InstOperatorRecord : {@link InstMRecord};

 */
public class InstOperatorRecord extends InstMRecord implements Cloneable {
    /**
     * @aspect ContentCheck
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\errorcheck\\ContentsCheck.jadd:623
     */
     ...
     */
    public InstOperatorRecord clone() throws CloneNotSupportedException {
        InstOperatorRecord node = (InstOperatorRecord) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:37
     */
    public InstOperatorRecord copy() {
        try {
            InstOperatorRecord node = (InstOperatorRecord) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    @Deprecated
    public InstOperatorRecord fullCopy() {
     ...
     */
    public InstOperatorRecord treeCopyNoTransform() {
        InstOperatorRecord tree = (InstOperatorRecord) copy();
        if (children != null) {
     ...
     */
    public InstOperatorRecord treeCopy() {
        doFullTraversal();
        return treeCopyNoTransform();
    }
    /** @apilevel internal 
    ...
    public String toString() {
        String toString_value = "operator record";
    ...
    public FRecordType createEmptyFRecordType(Size s) {
        FRecordType createEmptyFRecordType_Size_value = new FOperatorRecordType(s, myInstClassDecl().baseClassName(), new List(), null, operatorMap());
    ...
    public InstRestriction inheritedRestriction() {
        InstRestriction inheritedRestriction_value = this;
        return inheritedRestriction_value;
    }
    /** @apilevel internal */
    private void operatorMap_reset() {
        operatorMap_computed = false;
        
        operatorMap_value = null;
    }
    /** @apilevel internal */
    protected boolean operatorMap_computed = false;

    /** @apilevel internal */
    protected Map<String,InstClassDecl> operatorMap_value;

    /**
     * @attribute syn
     * @aspect OperatorRecordTypes
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\instance\\OperatorRecords.jrag:25
     */
    @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
    @ASTNodeAnnotation.Source(aspect="OperatorRecordTypes", declaredAt="C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\instance\\OperatorRecords.jrag:25")
    public Map<String,InstClassDecl> operatorMap() {
        ASTState state = state();
        if (operatorMap_computed) {
            return operatorMap_value;
        }
        int _boundaries = state.boundariesCrossed;
        boolean isFinal = this.is$Final();
        state().enterLazyAttribute();
        operatorMap_value = operatorMap_compute();
        if (isFinal && _boundaries == state().boundariesCrossed) {
        operatorMap_computed = true;
    ...
    /** @apilevel internal */
    private Map<String,InstClassDecl> operatorMap_compute() {
