...
/**
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\ast\\InstanceTree.ast:61
 * @astdecl InstReplacingShortClassDecl : InstShortClassDecl ::= <OriginalClassDecl:SrcClassDecl> OriginalInstClass:InstClassDecl <InstClassRedeclare:InstRedeclareClassNode>;
 * @production InstReplacingShortClassDecl : {@link InstShortClassDecl} ::= <span class="component">&lt;OriginalClassDecl:SrcClassDecl&gt;</span> <span class="component">OriginalInstClass:{@link InstClassDecl}</span> <span class="component">&lt;InstClassRedeclare:InstRedeclareClassNode&gt;</span>;

 */
public class InstReplacingShortClassDecl extends InstShortClassDecl implements Cloneable {
    /**
     * @aspect InstanceErrorCheck
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\errorcheck\\ErrorCheck.jrag:1062
     */
    public void collectInstModificationErrors(ErrorCheckType checkType) { }
    /**
     * @aspect InstanceErrorCheck
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\errorcheck\\ErrorCheck.jrag:1064
     */
     ...
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\instance\\InstanceTree.jrag:1151
     */
    ...
    /**
     * @aspect InstanceTreeConstruction
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\instance\\InstanceTree.jrag:1678
     */
    public InstReplacingSimpleShortClassDecl createInstSimpleShortClassDecl() {
     ...
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\util\\Annotations.jrag:2116
     */
     ...
     */
    public InstReplacingShortClassDecl() {
        super();
    }
    /**
    ...
    @ASTNodeAnnotation.Constructor(
        name = {"SrcClassDecl", "InstConstrainingClass", "InstRestriction", "FArraySubscripts", "OriginalClassDecl", "InstClassRedeclare"},
        type = {"SrcClassDecl", "Opt<InstConstrainingClass>", "InstRestriction", "Opt<FArraySubscripts>", "SrcClassDecl", "InstRedeclareClassNode"},
        kind = {"Token", "Opt", "Child", "Opt", "Token", "Token"}
    )
    public InstReplacingShortClassDecl(SrcClassDecl p0, Opt<InstConstrainingClass> p1, InstRestriction p2, Opt<FArraySubscripts> p3, SrcClassDecl p4, InstRedeclareClassNode p5) {
        setSrcClassDecl(p0);
        setChild(p1, 0);
        setChild(p2, 1);
        setChild(p3, 2);
     ...
     */
    public InstReplacingShortClassDecl clone() throws CloneNotSupportedException {
        InstReplacingShortClassDecl node = (InstReplacingShortClassDecl) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:62
     */
    public InstReplacingShortClassDecl copy() {
        try {
            InstReplacingShortClassDecl node = (InstReplacingShortClassDecl) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    @Deprecated
    public InstReplacingShortClassDecl fullCopy() {
     ...
     */
    public InstReplacingShortClassDecl treeCopyNoTransform() {
        InstReplacingShortClassDecl tree = (InstReplacingShortClassDecl) copy();
        if (children != null) {
     ...
     */
    public InstReplacingShortClassDecl treeCopy() {
        doFullTraversal();
        return treeCopyNoTransform();
    }
    /** @apilevel internal 
    ...
    protected boolean is$Equal(ASTNode node) {
        return super.is$Equal(node) && (tokenSrcClassDecl_SrcClassDecl == ((InstReplacingShortClassDecl) node).tokenSrcClassDecl_SrcClassDecl) && (tokenSrcClassDecl_OriginalClassDecl == ((InstReplacingShortClassDecl) node).tokenSrcClassDecl_OriginalClassDecl) && (tokenInstRedeclareClassNode_InstClassRedeclare == ((InstReplacingShortClassDecl) node).tokenInstRedeclareClassNode_InstClassRedeclare);    
    }
    /**
    ...
    public InstLookupResult<InstClassDecl> superLookupInstClassFromChain(String name) {
        InstLookupResult<InstClassDecl> superLookupInstClassFromChain_String_value = getInstExtends(0).lookupInstClass(name);
    ...
    public InstNode instLookupNodeForShortClassExtends() {
        InstNode instLookupNodeForShortClassExtends_value = getInstClassRedeclare().instLookupNodeForShortClassExtends();
     ...
     * @attribute syn nta
     * @aspect InstanceTreeConstruction
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\instance\\InstanceTree.jrag:1628
     */
    @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN, isNTA=true)
    @ASTNodeAnnotation.Source(aspect="InstanceTreeConstruction", declaredAt="C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\instance\\InstanceTree.jrag:1628")
    ...
    public boolean shouldBeExpanded() {
        boolean shouldBeExpanded_value = super.shouldBeExpanded() || 
    ...
    public boolean isThisClass(InstNode node) {
        boolean isThisClass_InstNode_value = getInstClassRedeclare().isThisClass(node);
    ...
    public FAccess Define_retrieveFAccess(ASTNode _callerNode, ASTNode _childNode) {
        if (_callerNode == getOriginalInstClassNoTransform()) {
            // @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\flattening\\FlatteningAccess.jrag:204
    ...
    public InstLookupResult<InstClassDecl> Define_lookupInstClass(ASTNode _callerNode, ASTNode _childNode, String name) {
        if (_callerNode == getAnnotationExpListNoTransform()) {
            // @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\util\\Annotations.jrag:271
            int childIndex = _callerNode.getIndexOfChild(_childNode);
            return getInstClassRedeclare().lookupInstClass(name);
        }
        else if (_callerNode == getInstConstrainingClassOptNoTransform()) {
            // @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\instance\\InstLookupClasses.jrag:92
            return lookupInstClass(name);
        }
        else if (_callerNode == getOriginalInstClassNoTransform()) {
            // @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\instance\\InstLookupClasses.jrag:89
            return lookupInstClass(name);
        }
        else {
            int childIndex = this.getIndexOfChild(_callerNode);
    ...
    public Environment Define_myEnvironment(ASTNode _callerNode, ASTNode _childNode) {
        if (_callerNode == getOriginalInstClassNoTransform()) {
            // @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\instance\\InstanceTree.jrag:594
    ...
    public Environment Define_myEnvironment(ASTNode _callerNode, ASTNode _childNode, String name) {
        if (_callerNode == getOriginalInstClassNoTransform()) {
            // @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\instance\\InstanceTree.jrag:595
            return filteredEnvironment().filter(name);
        }
        else {
