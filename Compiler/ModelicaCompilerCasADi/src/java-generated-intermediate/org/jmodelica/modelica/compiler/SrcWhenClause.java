...
/**
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\ast\\Modelica.ast:265
 * @astdecl SrcWhenClause : SrcIfWhenClause;
 * @production SrcWhenClause : {@link SrcIfWhenClause};

 */
public class SrcWhenClause extends SrcIfWhenClause implements Cloneable {
    /**
     * @aspect InstantiatedExpressions
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\flattening\\Flattening.jrag:3088
     */
    protected FWhenClause instantiateIfWhenClause(FExp t, List l) {
        return new FWhenClause(t, l);
    }
    /**
     * @declaredat ASTNode:1
     */
    public SrcWhenClause() {
        super();
    }
    /**
    ...
    public SrcWhenClause(SrcExp p0, List<SrcStatement> p1) {
        setChild(p0, 0);
        setChild(p1, 1);
    }
    /** @apilevel low-level 
     ...
     */
    public SrcWhenClause clone() throws CloneNotSupportedException {
        SrcWhenClause node = (SrcWhenClause) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:47
     */
    public SrcWhenClause copy() {
        try {
            SrcWhenClause node = (SrcWhenClause) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    public SrcWhenClause treeCopyNoTransform() {
        SrcWhenClause tree = (SrcWhenClause) copy();
        if (children != null) {
