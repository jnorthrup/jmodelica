 ...
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\ast\\FlatModelica.ast:540
 * @astdecl FConnRooted : FConnBoolOp;
 * @production FConnRooted : {@link FConnBoolOp};

 */
public class FConnRooted extends FConnBoolOp implements Cloneable {
    /**
     * @aspect InheritedFactoryMethods
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:1066
     */
    public FConnRooted createEmptyNode()        { return new FConnRooted();        }
    /**
    ...
    public FConnRooted(List<InstFunctionArgument> p0, FExp p1) {
        setChild(p0, 0);
        setChild(p1, 1);
    }
    /** @apilevel low-level 
     ...
     */
    public FConnRooted clone() throws CloneNotSupportedException {
        FConnRooted node = (FConnRooted) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:47
     */
    public FConnRooted copy() {
        try {
            FConnRooted node = (FConnRooted) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    public FConnRooted treeCopyNoTransform() {
        FConnRooted tree = (FConnRooted) copy();
        if (children != null) {
    ...
    public boolean cevalFromGraph() {
        boolean cevalFromGraph_value = connectionGraph.ops(getA()).rooted;
    ...
    public String builtInName() {
        String builtInName_value = "Connections.rooted";
