...
/**
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\ast\\Modelica.ast:125
 * @astdecl SrcEnumClassDecl : SrcPrimitiveClassDecl;
 * @production SrcEnumClassDecl : {@link SrcPrimitiveClassDecl};

 */
public class SrcEnumClassDecl extends SrcPrimitiveClassDecl implements Cloneable {
    /**
     * @aspect InstanceTreeConstruction
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\instance\\InstanceTree.jrag:1431
     */
    public InstEnumClassDecl newInstClassDecl() {
     ...
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\source\\PredefinedTypes.jrag:287
     */
    public SrcEnumClassDecl(SrcFullClassDecl fcd) {
        super(fcd);
    }
    /**
     * @declaredat ASTNode:1
     */
    public SrcEnumClassDecl() {
        super();
    }
    /**
    ...
    public SrcEnumClassDecl(SrcIdDecl p0, boolean p1, boolean p2, SrcRestriction p3, boolean p4, boolean p5, boolean p6, boolean p7, boolean p8, Opt<SrcConstrainingClause> p9, Opt<SrcComment> p10, Opt<SrcStringComment> p11, List<SrcClause> p12, Opt<SrcExternalClause> p13, Opt<SrcAnnotation> p14, SrcEndDecl p15) {
        setChild(p0, 0);
        setEncapsulated(p1);
        setPartial(p2);
        setChild(p3, 1);
     ...
     */
    public SrcEnumClassDecl clone() throws CloneNotSupportedException {
        SrcEnumClassDecl node = (SrcEnumClassDecl) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:66
     */
    public SrcEnumClassDecl copy() {
        try {
            SrcEnumClassDecl node = (SrcEnumClassDecl) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    @Deprecated
    public SrcEnumClassDecl fullCopy() {
     ...
     */
    public SrcEnumClassDecl treeCopyNoTransform() {
        SrcEnumClassDecl tree = (SrcEnumClassDecl) copy();
        if (children != null) {
     ...
     */
    public SrcEnumClassDecl treeCopy() {
        doFullTraversal();
        return treeCopyNoTransform();
    }
    /** @apilevel internal 
    ...
    protected boolean is$Equal(ASTNode node) {
        return super.is$Equal(node) && (tokenboolean_Encapsulated == ((SrcEnumClassDecl) node).tokenboolean_Encapsulated) && (tokenboolean_Partial == ((SrcEnumClassDecl) node).tokenboolean_Partial) && (tokenboolean_Redeclare == ((SrcEnumClassDecl) node).tokenboolean_Redeclare) && (tokenboolean_Final == ((SrcEnumClassDecl) node).tokenboolean_Final) && (tokenboolean_Inner == ((SrcEnumClassDecl) node).tokenboolean_Inner) && (tokenboolean_Outer == ((SrcEnumClassDecl) node).tokenboolean_Outer) && (tokenboolean_Replaceable == ((SrcEnumClassDecl) node).tokenboolean_Replaceable);    
    }
    /**
    ...
    public Iterable<SrcComponentDecl> components() {
        Iterable<SrcComponentDecl> components_value = new ChainedIterable(componentsIterable(), enumBase().componentsIterable());
        return components_value;
    }
    /**
     * @attribute syn
     * @aspect SourceTraversal
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\source\\SourceTraversal.jrag:82
     */
    @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
    @ASTNodeAnnotation.Source(aspect="SourceTraversal", declaredAt="C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\source\\SourceTraversal.jrag:82")
    public Iterable<SrcComponentDecl> componentsIterable() {
        Iterable<SrcComponentDecl> componentsIterable_value = super.components();
        return componentsIterable_value;
    }
    /**
     * @attribute syn
     * @aspect SourceTraversal
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\source\\SourceTraversal.jrag:83
     */
    @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
    @ASTNodeAnnotation.Source(aspect="SourceTraversal", declaredAt="C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\source\\SourceTraversal.jrag:83")
    public SrcEnumClassDecl enumBase() {
        SrcEnumClassDecl enumBase_value = ((SourceRoot) root()).getProgram().getEnumBaseDecl();
        return enumBase_value;
    }
    /** @apilevel internal */
