 ...
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\ast\\FlatModelica.ast:1445
 * @astdecl FAcosExp : FMathematicalFunctionCall;
 * @production FAcosExp : {@link FMathematicalFunctionCall};

 */
public class FAcosExp extends FMathematicalFunctionCall implements Cloneable {
    /**
     * @aspect InheritedFactoryMethods
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:1012
     */
    public FAcosExp createEmptyNode()  { return new FAcosExp();  }
    /**
     * @aspect Derivatives
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaMiddleEnd\\src\\jastadd\\structural\\Differentiation.jrag:321
     */
    @Override
    ...
    public FAcosExp(List<InstFunctionArgument> p0, FExp p1) {
        setChild(p0, 0);
        setChild(p1, 1);
    }
    /** @apilevel low-level 
     ...
     */
    public FAcosExp clone() throws CloneNotSupportedException {
        FAcosExp node = (FAcosExp) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:47
     */
    public FAcosExp copy() {
        try {
            FAcosExp node = (FAcosExp) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    public FAcosExp treeCopyNoTransform() {
        FAcosExp tree = (FAcosExp) copy();
        if (children != null) {
    ...
    public CValue cevalCalc(VariableEvaluator evaluator) {
        CValue cevalCalc_VariableEvaluator_value = new CValueReal(StrictMath.acos(getFExp().ceval(evaluator).realValue()));
    ...
    public MX toMX() {
        MX toMX_value = getFExp().toMX().arccos();
        return toMX_value;
    }
    /** @apilevel internal */
