 ...
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\ast\\FlatModelica.ast:1345
 * @astdecl FTerminalExp : FSimulationStateBuiltIn;
 * @production FTerminalExp : {@link FSimulationStateBuiltIn};

 */
public class FTerminalExp extends FSimulationStateBuiltIn implements Cloneable {
    /**
     * @aspect InheritedFactoryMethods
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:962
     */
    public FTerminalExp createEmptyNode()    { return new FTerminalExp();    }
    /**
     * @aspect ComplianceCheck
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\errorcheck\\ComplianceCheck.jadd:272
     */
     ...
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaCBackEnd\\src\\jastadd\\CCodeGen\\CCodeGenExpressions.jrag:339
     */
    @Override
    ...
    public FTerminalExp(List<InstFunctionArgument> p0) {
        setChild(p0, 0);
    }
    /** @apilevel low-level 
     ...
     */
    public FTerminalExp clone() throws CloneNotSupportedException {
        FTerminalExp node = (FTerminalExp) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:46
     */
    public FTerminalExp copy() {
        try {
            FTerminalExp node = (FTerminalExp) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    public FTerminalExp treeCopyNoTransform() {
        FTerminalExp tree = (FTerminalExp) copy();
        if (children != null) {
    ...
    public CValue cevalCalc(VariableEvaluator evaluator) {
        CValue cevalCalc_VariableEvaluator_value = CValueBoolean.FALSE;
    ...
    public String builtInName() {
        String builtInName_value = "terminal";
