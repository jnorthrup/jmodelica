...
/**
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\ast\\FlatModelica.ast:1497
 * @astdecl FUnknownSizeExp : FSizeExp;
 * @production FUnknownSizeExp : {@link FSizeExp};

 */
public class FUnknownSizeExp extends FSizeExp implements Cloneable {
    /**
     * @aspect Constructors
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:388
     */
    public FUnknownSizeExp(FExp exp, int dim) {
        super(exp, dim);
    }
    /**
     * @aspect FunctionCallSizes
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Sizes.jrag:357
     */
     ...
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaMiddleEnd\\src\\jastadd\\scalarization\\Scalarization.jrag:1635
     */
    ...
    public FUnknownSizeExp(List<InstFunctionArgument> p0, FExp p1, Opt<FExp> p2) {
        setChild(p0, 0);
        setChild(p1, 1);
        setChild(p2, 2);
    }
     ...
     */
    public FUnknownSizeExp clone() throws CloneNotSupportedException {
        FUnknownSizeExp node = (FUnknownSizeExp) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:49
     */
    public FUnknownSizeExp copy() {
        try {
            FUnknownSizeExp node = (FUnknownSizeExp) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    @Deprecated
    public FUnknownSizeExp fullCopy() {
     ...
     */
    public FUnknownSizeExp treeCopyNoTransform() {
        FUnknownSizeExp tree = (FUnknownSizeExp) copy();
        if (children != null) {
     ...
     */
    public FUnknownSizeExp treeCopy() {
        doFullTraversal();
        return treeCopyNoTransform();
    }
    /** @apilevel internal 
    ...
    public CValue cevalCalc(VariableEvaluator evaluator) {
        CValue cevalCalc_VariableEvaluator_value = inFunction() ? getFExp().cevalCalc(evaluator).size().ceval(evaluator, dimension()) : CValue.UNKNOWN;
    ...
    public boolean isCircularCalc() {
        boolean isCircularCalc_value = getDim().isCircular() || getFExp().asCommonAccess().isCircular(dimension());
    ...
    public TypePrefixVariability expVariability() {
        TypePrefixVariability expVariability_value = Variability.FIXEDPARAMETER.combine(getDim().variability());
    ...
    public boolean Define_flattenFASContext(ASTNode _callerNode, ASTNode _childNode) {
        if (_callerNode == getFExpNoTransform()) {
            // @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\flattening\\FlatteningAccess.jrag:159
            return false;
        }
        else {
