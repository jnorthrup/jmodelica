...
/**
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\ast\\FlatModelica.ast:1007
 * @astdecl FComponentExp : FExp ::= FExp <Name:String>;
 * @production FComponentExp : {@link FExp} ::= <span class="component">{@link FExp}</span> <span class="component">&lt;Name:String&gt;</span>;

 */
public class FComponentExp extends FExp implements Cloneable {
    /**
     * @aspect InheritedFactoryMethods
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:908
     */
    public FComponentExp createEmptyNode() { return new FComponentExp(); }
    /**
     * @aspect FlatPrettyPrint
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\PrettyPrint.jrag:1944
     */
    ...
    public FComponentExp(FExp p0, String p1) {
        setChild(p0, 0);
        setName(p1);
    }
    /**
     ...
     */
    public FComponentExp(FExp p0, beaver.Symbol p1) {
        setChild(p0, 0);
        setName(p1);
    }
    /** @apilevel low-level 
     ...
     */
    public FComponentExp clone() throws CloneNotSupportedException {
        FComponentExp node = (FComponentExp) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:50
     */
    public FComponentExp copy() {
        try {
            FComponentExp node = (FComponentExp) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    public FComponentExp treeCopyNoTransform() {
        FComponentExp tree = (FComponentExp) copy();
        if (children != null) {
    ...
    protected boolean is$Equal(ASTNode node) {
        return super.is$Equal(node) && (tokenString_Name == ((FComponentExp) node).tokenString_Name);    
    }
    /**
    ...
    public CValue cevalCalc(VariableEvaluator evaluator) {
        CValue cevalCalc_VariableEvaluator_value = getFExp().ceval().component(getName());
    ...
    public FType type() {
        FType type_value = getFExp().type().componentType(getName());
        return type_value;
    }
    /**
     * @attribute syn
    ...
    public TypePrefixVariability expVariability() {
        TypePrefixVariability expVariability_value = getFExp().variability().component(getName());
