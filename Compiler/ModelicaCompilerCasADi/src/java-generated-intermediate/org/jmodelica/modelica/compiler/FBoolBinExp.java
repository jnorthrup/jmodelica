 ...
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\ast\\FlatModelica.ast:841
 * @astdecl FBoolBinExp : FBinExp;
 * @production FBoolBinExp : {@link FBinExp};

 */
public abstract class FBoolBinExp extends FBinExp implements Cloneable {
    /**
    ...
    public FBoolBinExp(FExp p0, FExp p1) {
        setChild(p0, 0);
        setChild(p1, 1);
    }
    /** @apilevel low-level 
     ...
     */
    public FBoolBinExp clone() throws CloneNotSupportedException {
        FBoolBinExp node = (FBoolBinExp) super.clone();
        return node;
    }
    /**
     ...
     */
    @Deprecated
    public abstract FBoolBinExp fullCopy();
    /**
     * Create a deep copy of the AST subtree at this node.
     * The copy is dangling, i.e. has no parent.
     * @return dangling copy of the subtree at this node
     ...
     */
    public abstract FBoolBinExp treeCopyNoTransform();
    /**
     * Create a deep copy of the AST subtree at this node.
     ...
     */
    public abstract FBoolBinExp treeCopy();
    /**
    ...
    public abstract String macro_C();
    /**
     * @attribute syn
