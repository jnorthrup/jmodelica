 ...
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\ast\\FlatModelica.ast:1425
 * @astdecl FSinExp : FMathematicalFunctionCall;
 * @production FSinExp : {@link FMathematicalFunctionCall};

 */
public class FSinExp extends FMathematicalFunctionCall implements Cloneable {
    /**
     * @aspect InheritedFactoryMethods
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:1008
     */
    public FSinExp createEmptyNode()   { return new FSinExp();   }
    /**
     * @aspect InheritedFactoryMethods
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:1393
     */
    public FSinExp(FExp a1)                      { this(emptyArgs(), a1); }
    /**
     * @aspect Derivatives
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaMiddleEnd\\src\\jastadd\\structural\\Differentiation.jrag:268
     */
    @Override
    ...
    public FSinExp(List<InstFunctionArgument> p0, FExp p1) {
        setChild(p0, 0);
        setChild(p1, 1);
    }
    /** @apilevel low-level 
     ...
     */
    public FSinExp clone() throws CloneNotSupportedException {
        FSinExp node = (FSinExp) super.clone();
        return node;
    }
    /** @apilevel internal 
     ...
     */
    public FSinExp treeCopyNoTransform() {
        FSinExp tree = (FSinExp) copy();
        if (children != null) {
    ...
    public CValue cevalCalc(VariableEvaluator evaluator) {
        CValue cevalCalc_VariableEvaluator_value = new CValueReal(StrictMath.sin(getFExp().ceval(evaluator).realValue()));
    ...
    public MX toMX() {
        MX toMX_value = getFExp().toMX().sin();
        return toMX_value;
    }
    /** @apilevel internal */
