...
/**
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\ast\\InstanceTree.ast:74
 * @astdecl InstMClass : InstRestriction;
 * @production InstMClass : {@link InstRestriction};

 */
public class InstMClass extends InstRestriction implements Cloneable {
    /**
     ...
     */
    public InstMClass clone() throws CloneNotSupportedException {
        InstMClass node = (InstMClass) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:36
     */
    public InstMClass copy() {
        try {
            InstMClass node = (InstMClass) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    public InstMClass treeCopyNoTransform() {
        InstMClass tree = (InstMClass) copy();
        if (children != null) {
