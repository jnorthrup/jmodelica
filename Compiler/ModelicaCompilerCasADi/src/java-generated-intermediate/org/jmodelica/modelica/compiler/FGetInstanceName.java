 ...
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\ast\\FlatModelica.ast:1666
 * @astdecl FGetInstanceName : FNoArgBuiltIn;
 * @production FGetInstanceName : {@link FNoArgBuiltIn};

 */
public class FGetInstanceName extends FNoArgBuiltIn implements Cloneable {
    /**
     * @aspect InheritedFactoryMethods
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:1059
     */
    public FGetInstanceName createEmptyNode() { return new FGetInstanceName(); }
    /**
     * @aspect FlatExpressions
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\flattening\\Flattening.jrag:2620
     */
    public FExp flatten(Flattener f) { return new FStringLitExp(calcInstanceName()); }
    /**
     * @declaredat ASTNode:1
     */
    public FGetInstanceName() {
        super();
    }
    /**
    ...
    @ASTNodeAnnotation.Constructor(
        name = {"OriginalArg"},
        type = {"List<InstFunctionArgument>"},
        kind = {"List"}
    )
    public FGetInstanceName(List<InstFunctionArgument> p0) {
        setChild(p0, 0);
    }
    /** @apilevel low-level 
     ...
     */
    public FGetInstanceName clone() throws CloneNotSupportedException {
        FGetInstanceName node = (FGetInstanceName) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:47
     */
    public FGetInstanceName copy() {
        try {
            FGetInstanceName node = (FGetInstanceName) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    @Deprecated
    public FGetInstanceName fullCopy() {
     ...
     */
    public FGetInstanceName treeCopyNoTransform() {
        FGetInstanceName tree = (FGetInstanceName) copy();
        if (children != null) {
     ...
     */
    public FGetInstanceName treeCopy() {
        doFullTraversal();
        return treeCopyNoTransform();
    }
    /** @apilevel internal 
    ...
    public CValue cevalCalc(VariableEvaluator evaluator) {
        CValue cevalCalc_VariableEvaluator_value = new CValueString(calcInstanceName());
    ...
    public String builtInName() {
        String builtInName_value = "getInstanceName";
    ...
    @ASTNodeAnnotation.Source(aspect="ConstantEvaluation", declaredAt="C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\ConstantEvaluation\\ConstantEvaluation.jrag:2797")
    public String calcInstanceName() {
        String calcInstanceName_value = getParent().Define_calcInstanceName(this, null);
        return calcInstanceName_value;
    }
    /**
     * @attribute inh
     * @aspect InstBindingType
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\instance\\InstTypeAnalysis.jrag:429
     */
    @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.INH)
    @ASTNodeAnnotation.Source(aspect="InstBindingType", declaredAt="C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\instance\\InstTypeAnalysis.jrag:429")
