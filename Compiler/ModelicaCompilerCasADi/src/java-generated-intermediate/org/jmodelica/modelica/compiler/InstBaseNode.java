...
/**
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\ast\\InstanceTree.ast:28
 * @astdecl InstBaseNode : InstNode;
 * @production InstBaseNode : {@link InstNode};

 */
public abstract class InstBaseNode extends InstNode implements Cloneable {
    /**
     ...
     */
    public InstBaseNode clone() throws CloneNotSupportedException {
        InstBaseNode node = (InstBaseNode) super.clone();
        return node;
    }
    /**
     ...
     */
    @Deprecated
    public abstract InstBaseNode fullCopy();
    /**
     * Create a deep copy of the AST subtree at this node.
     * The copy is dangling, i.e. has no parent.
     * @return dangling copy of the subtree at this node
     ...
     */
    public abstract InstBaseNode treeCopyNoTransform();
    /**
     * Create a deep copy of the AST subtree at this node.
     ...
     */
    public abstract InstBaseNode treeCopy();
    /**
    ...
    public InstLookupResult<InstClassDecl> Define_lookupTopRedeclareExtendsInstClass(ASTNode _callerNode, ASTNode _childNode, String name) {
        if (_callerNode == getInstExtendsListNoTransform()) {
            ...
            return lookupLastRedeclareExtendsInstClass(name);
        }
        else {
            return getParent().Define_lookupTopRedeclareExtendsInstClass(this, _callerNode, name);
        }
    }
    /**
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\instance\\InstLookupClasses.jrag:190
