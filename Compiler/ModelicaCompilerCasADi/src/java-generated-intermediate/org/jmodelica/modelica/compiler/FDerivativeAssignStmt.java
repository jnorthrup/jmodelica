 ...
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\ast\\FlatModelica.ast:614
 * @astdecl FDerivativeAssignStmt : FAssignStmt ::= <Order:int>;
 * @production FDerivativeAssignStmt : {@link FAssignStmt} ::= <span class="component">&lt;Order:int&gt;</span>;

 */
public class FDerivativeAssignStmt extends FAssignStmt implements Cloneable {
    /**
     * @declaredat ASTNode:1
     */
    public FDerivativeAssignStmt() {
        super();
    }
    /**
    ...
    @ASTNodeAnnotation.Constructor(
        name = {"Left", "Right", "Order"},
        type = {"FAssignableExp", "FExp", "int"},
        kind = {"Child", "Child", "Token"}
    )
    public FDerivativeAssignStmt(FAssignableExp p0, FExp p1, int p2) {
        setChild(p0, 0);
        setChild(p1, 1);
        setOrder(p2);
    }
     ...
     */
    public FDerivativeAssignStmt clone() throws CloneNotSupportedException {
        FDerivativeAssignStmt node = (FDerivativeAssignStmt) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:47
     */
    public FDerivativeAssignStmt copy() {
        try {
            FDerivativeAssignStmt node = (FDerivativeAssignStmt) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    @Deprecated
    public FDerivativeAssignStmt fullCopy() {
     ...
     */
    public FDerivativeAssignStmt treeCopyNoTransform() {
        FDerivativeAssignStmt tree = (FDerivativeAssignStmt) copy();
        if (children != null) {
     ...
     */
    public FDerivativeAssignStmt treeCopy() {
        doFullTraversal();
        return treeCopyNoTransform();
    }
    /** @apilevel internal 
    ...
    protected boolean is$Equal(ASTNode node) {
        return super.is$Equal(node) && (tokenint_Order == ((FDerivativeAssignStmt) node).tokenint_Order);    
    }
    /**
