 ...
 * by dynamic states.
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\ast\\FlatModelica.ast:237
 * @astdecl FDynamicAlgebraicVariable : FRealVariable ::= <Set:DynamicStateSet> <Number:int>;
 * @production FDynamicAlgebraicVariable : {@link FRealVariable} ::= <span class="component">&lt;Set:DynamicStateSet&gt;</span> <span class="component">&lt;Number:int&gt;</span>;

 */
public class FDynamicAlgebraicVariable extends FRealVariable implements Cloneable {
    /**
     * Constructs a new dynamic state variable
     * @aspect Constructors
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:619
     */
    public FDynamicAlgebraicVariable(DynamicStateSet set, int number) {
     ...
     */
    public FDynamicAlgebraicVariable() {
        super();
    }
    /**
    ...
    public FDynamicAlgebraicVariable(VisibilityType p0, TypePrefixVariability p1, TypePrefixInputOutput p2, List<FAttribute> p3, String p4, Opt<FExp> p5, Opt<FStringComment> p6, FAccess p7, DynamicStateSet p8, int p9) {
     ...
     */
    public FDynamicAlgebraicVariable(VisibilityType p0, TypePrefixVariability p1, TypePrefixInputOutput p2, List<FAttribute> p3, beaver.Symbol p4, Opt<FExp> p5, Opt<FStringComment> p6, FAccess p7, DynamicStateSet p8, int p9) {
        setVisibilityType(p0);
        setTypePrefixVariability(p1);
        setTypePrefixInputOutput(p2);
        setChild(p3, 0);
     ...
     */
    public FDynamicAlgebraicVariable clone() throws CloneNotSupportedException {
        FDynamicAlgebraicVariable node = (FDynamicAlgebraicVariable) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:69
     */
    public FDynamicAlgebraicVariable copy() {
        try {
            FDynamicAlgebraicVariable node = (FDynamicAlgebraicVariable) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    @Deprecated
    public FDynamicAlgebraicVariable fullCopy() {
     ...
     */
    public FDynamicAlgebraicVariable treeCopyNoTransform() {
        FDynamicAlgebraicVariable tree = (FDynamicAlgebraicVariable) copy();
        if (children != null) {
     ...
     */
    public FDynamicAlgebraicVariable treeCopy() {
        doFullTraversal();
        return treeCopyNoTransform();
    }
    /** @apilevel internal 
    ...
    protected boolean is$Equal(ASTNode node) {
        return super.is$Equal(node) && (tokenVisibilityType_VisibilityType == ((FDynamicAlgebraicVariable) node).tokenVisibilityType_VisibilityType) && (tokenTypePrefixVariability_TypePrefixVariability == ((FDynamicAlgebraicVariable) node).tokenTypePrefixVariability_TypePrefixVariability) && (tokenTypePrefixInputOutput_TypePrefixInputOutput == ((FDynamicAlgebraicVariable) node).tokenTypePrefixInputOutput_TypePrefixInputOutput) && (tokenString_DerivedType == ((FDynamicAlgebraicVariable) node).tokenString_DerivedType) && (tokenDynamicStateSet_Set == ((FDynamicAlgebraicVariable) node).tokenDynamicStateSet_Set) && (tokenint_Number == ((FDynamicAlgebraicVariable) node).tokenint_Number);    
    }
    /**
    ...
    public boolean isFDynamicAlgebraicVariable() {
        boolean isFDynamicAlgebraicVariable_value = true;
    ...
    public FDynamicAlgebraicVariable asFDynamicAlgebraicVariable() {
        FDynamicAlgebraicVariable asFDynamicAlgebraicVariable_value = this;
        return asFDynamicAlgebraicVariable_value;
    }
    /**
     * @attribute syn
    ...
    public Collection<FVariable> bltDependencyVars() {
        Collection<FVariable> bltDependencyVars_value = getSet().fVarsColl();
    ...
    protected void collect_contributors_FClass_dynamicAlgebraicVariables(FClass _root, java.util.Map<ASTNode, java.util.Set<ASTNode>> _map) {
        // @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\FlatAPI\\FlatAPI.jrag:1517
        {
        ...
        super.collect_contributors_FClass_dynamicAlgebraicVariables(_root, _map);
    }
    /** @apilevel internal */
    protected void contributeTo_FClass_dynamicAlgebraicVariables(LinkedHashSet<FDynamicAlgebraicVariable> collection) {
        super.contributeTo_FClass_dynamicAlgebraicVariables(collection);
        collection.add(this);
    }
}
