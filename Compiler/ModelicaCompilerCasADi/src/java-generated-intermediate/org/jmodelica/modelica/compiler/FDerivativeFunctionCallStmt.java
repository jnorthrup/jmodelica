 ...
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\ast\\FlatModelica.ast:630
 * @astdecl FDerivativeFunctionCallStmt : FFunctionCallStmt ::= <Order:int>;
 * @production FDerivativeFunctionCallStmt : {@link FFunctionCallStmt} ::= <span class="component">&lt;Order:int&gt;</span>;

 */
public class FDerivativeFunctionCallStmt extends FFunctionCallStmt implements Cloneable {
    /**
     * @declaredat ASTNode:1
     */
    public FDerivativeFunctionCallStmt() {
        super();
    }
    /**
    ...
    @ASTNodeAnnotation.Constructor(
        name = {"Left", "Call", "Order"},
        type = {"List<FFunctionCallLeft>", "FAbstractFunctionCall", "int"},
        kind = {"List", "Child", "Token"}
    )
    public FDerivativeFunctionCallStmt(List<FFunctionCallLeft> p0, FAbstractFunctionCall p1, int p2) {
        setChild(p0, 0);
        setChild(p1, 1);
        setOrder(p2);
    }
     ...
     */
    public FDerivativeFunctionCallStmt clone() throws CloneNotSupportedException {
        FDerivativeFunctionCallStmt node = (FDerivativeFunctionCallStmt) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:48
     */
    public FDerivativeFunctionCallStmt copy() {
        try {
            FDerivativeFunctionCallStmt node = (FDerivativeFunctionCallStmt) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    @Deprecated
    public FDerivativeFunctionCallStmt fullCopy() {
     ...
     */
    public FDerivativeFunctionCallStmt treeCopyNoTransform() {
        FDerivativeFunctionCallStmt tree = (FDerivativeFunctionCallStmt) copy();
        if (children != null) {
     ...
     */
    public FDerivativeFunctionCallStmt treeCopy() {
        doFullTraversal();
        return treeCopyNoTransform();
    }
    /** @apilevel internal 
    ...
    protected boolean is$Equal(ASTNode node) {
        return super.is$Equal(node) && (tokenint_Order == ((FDerivativeFunctionCallStmt) node).tokenint_Order);    
    }
    /**
