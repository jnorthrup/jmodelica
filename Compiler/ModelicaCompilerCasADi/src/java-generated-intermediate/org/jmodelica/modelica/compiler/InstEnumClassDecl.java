...
/**
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\ast\\InstanceTree.ast:52
 * @astdecl InstEnumClassDecl : InstPrimitiveClassDecl;
 * @production InstEnumClassDecl : {@link InstPrimitiveClassDecl};

 */
public class InstEnumClassDecl extends InstPrimitiveClassDecl implements Cloneable {
    /**
     * @aspect InstanceTreeConstruction
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\instance\\InstanceTree.jrag:1288
     */
    ...
    public InstEnumClassDecl(SrcClassDecl p0, Opt<InstConstrainingClass> p1, InstRestriction p2, Opt<InstExternal> p3) {
        setSrcClassDecl(p0);
        setChild(p1, 0);
        setChild(p2, 1);
        setChild(p3, 2);
     ...
     */
    public InstEnumClassDecl clone() throws CloneNotSupportedException {
        InstEnumClassDecl node = (InstEnumClassDecl) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:60
     */
    public InstEnumClassDecl copy() {
        try {
            InstEnumClassDecl node = (InstEnumClassDecl) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    @Deprecated
    public InstEnumClassDecl fullCopy() {
     ...
     */
    public InstEnumClassDecl treeCopyNoTransform() {
        InstEnumClassDecl tree = (InstEnumClassDecl) copy();
        if (children != null) {
     ...
     */
    public InstEnumClassDecl treeCopy() {
        doFullTraversal();
        return treeCopyNoTransform();
    }
    /** @apilevel internal 
    ...
    protected boolean is$Equal(ASTNode node) {
        return super.is$Equal(node) && (tokenSrcClassDecl_SrcClassDecl == ((InstEnumClassDecl) node).tokenSrcClassDecl_SrcClassDecl);    
    }
    /**
    ...
    public boolean isComponentSizeClass() {
        boolean isComponentSizeClass_value = true;
    ...
    public InstLookupResult<InstClassDecl> lookupInstClassRedirect(String name) {
        InstLookupResult<InstClassDecl> lookupInstClassRedirect_String_value = lookupInstBuiltInClass(name);
        return lookupInstClassRedirect_String_value;
    }
    /** @apilevel internal */
    private void enumLiterals_reset() {
        enumLiterals_computed = false;
        
        enumLiterals_value = null;
    }
    /** @apilevel internal */
    protected boolean enumLiterals_computed = false;

    /** @apilevel internal */
    protected ArrayList<InstEnumLiteral> enumLiterals_value;

    /**
     * @attribute syn
     * @aspect InstanceAST_API
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\instance\\InstanceTree.jrag:2088
     */
    @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
    @ASTNodeAnnotation.Source(aspect="InstanceAST_API", declaredAt="C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\instance\\InstanceTree.jrag:2088")
    public ArrayList<InstEnumLiteral> enumLiterals() {
        ASTState state = state();
        if (enumLiterals_computed) {
            return enumLiterals_value;
        }
        int _boundaries = state.boundariesCrossed;
        boolean isFinal = this.is$Final();
        state().enterLazyAttribute();
        enumLiterals_value = enumLiterals_compute();
        if (isFinal && _boundaries == state().boundariesCrossed) {
        enumLiterals_computed = true;
    ...
    /** @apilevel internal */
    private ArrayList<InstEnumLiteral> enumLiterals_compute() {
    ...
    public boolean extendsEnum() {
        boolean extendsEnum_value = true;
    ...
    @ASTNodeAnnotation.Source(aspect="EnumLookup", declaredAt="C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\instance\\InstLookupClasses.jrag:752")
    public InstLookupResult<InstClassDecl> lookupInstBuiltInClass(String name) {
        InstLookupResult<InstClassDecl> lookupInstBuiltInClass_String_value = getParent().Define_lookupInstBuiltInClass(this, null, name);
        return lookupInstBuiltInClass_String_value;
    }
    /**
    ...
    public FAccess Define_retrieveFAccess(ASTNode _callerNode, ASTNode _childNode) {
        ...
        return new FAccessString(qualifiedName());
    }
    /**
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\flattening\\FlatteningAccess.jrag:196
     * @apilevel internal
    ...
    public InstLookupResult<InstClassDecl> Define_lookupInstClass(ASTNode _callerNode, ASTNode _childNode, String name) {
        int childIndex = this.getIndexOfChild(_callerNode);
        return lookupInstBuiltInClass(name);
    }
    /**
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\instance\\InstLookupClasses.jrag:29
     * @apilevel internal
    ...
    public InstEnumClassDecl Define_myInstEnumClassDecl(ASTNode _callerNode, ASTNode _childNode) {
        if (_callerNode == getInstComponentDeclListNoTransform()) {
            ...
            return super.Define_myInstEnumClassDecl(_callerNode, _childNode);
        }
    }
    /**
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\instance\\InstanceTree.jrag:2073
    ...
    public int Define_myIndex(ASTNode _callerNode, ASTNode _childNode) {
        if (_callerNode == getInstComponentDeclListNoTransform()) {
            ...
            return enumLiterals().indexOf(getInstComponentDecl(i)) + 1;
        }
        else {
            return super.Define_myIndex(_callerNode, _childNode);
        }
    }
    /**
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\instance\\InstanceTree.jrag:2078
