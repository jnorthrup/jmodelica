...
/**
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\ast\\InstanceTree.ast:109
 * @astdecl InstComposite : InstComponentDecl;
 * @production InstComposite : {@link InstComponentDecl};

 */
public class InstComposite extends InstComponentDecl implements Cloneable {
    /**
     * @aspect FlatTypeCheck
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\errorcheck\\TypeCheck.jrag:60
     */
    ...
    public InstComposite(String p0, InstAccess p1, Opt<FArraySubscripts> p2, SrcComponentDecl p3, Opt<InstModification> p4, Opt<InstConstrainingComponent> p5, Opt<FExp> p6) {
        setName(p0);
        setChild(p1, 0);
        setChild(p2, 1);
     ...
     */
    public InstComposite(beaver.Symbol p0, InstAccess p1, Opt<FArraySubscripts> p2, SrcComponentDecl p3, Opt<InstModification> p4, Opt<InstConstrainingComponent> p5, Opt<FExp> p6) {
        setName(p0);
        setChild(p1, 0);
        setChild(p2, 1);
        setSrcComponentDecl(p3);
     ...
     */
    public InstComposite clone() throws CloneNotSupportedException {
        InstComposite node = (InstComposite) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:74
     */
    public InstComposite copy() {
        try {
            InstComposite node = (InstComposite) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    public InstComposite treeCopyNoTransform() {
        InstComposite tree = (InstComposite) copy();
        if (children != null) {
    ...
    protected boolean is$Equal(ASTNode node) {
        return super.is$Equal(node) && (tokenString_Name == ((InstComposite) node).tokenString_Name) && (tokenSrcComponentDecl_SrcComponentDecl == ((InstComposite) node).tokenSrcComponentDecl_SrcComponentDecl);    
    }
    /**
    ...
    public String subType(InstNode t, String name, boolean top) {
        String subType_InstNode_String_boolean_value = compareTypes(t, this, name, t.isCompositeType(),  false, top);
    ...
    public boolean isCompositeType() {
        boolean isCompositeType_value = true;
