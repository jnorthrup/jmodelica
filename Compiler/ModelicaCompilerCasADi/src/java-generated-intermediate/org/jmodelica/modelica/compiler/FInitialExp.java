 ...
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\ast\\FlatModelica.ast:1340
 * @astdecl FInitialExp : FSimulationStateBuiltIn;
 * @production FInitialExp : {@link FSimulationStateBuiltIn};

 */
public class FInitialExp extends FSimulationStateBuiltIn implements Cloneable {
    /** Decides what initial() is currently evaluated to. 
     * @aspect ConstantEvaluation
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\ConstantEvaluation\\ConstantEvaluation.jrag:2602
     */
    private static CValue evaluationValue = CValueBoolean.FALSE;
    /** Set the value for initial() to evaluate to. 
     * @aspect ConstantEvaluation
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\ConstantEvaluation\\ConstantEvaluation.jrag:2605
     */
    public static void setIsInitial(boolean value) {
          evaluationValue = new CValueBoolean(value);
    }
    /**
     * @aspect InheritedFactoryMethods
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:961
     */
    public FInitialExp createEmptyNode()     { return new FInitialExp();     }
    /**
     * @aspect ComplianceCheck
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\errorcheck\\ComplianceCheck.jadd:159
     */
    ...
    /**
     * @aspect WhenClauses
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaMiddleEnd\\src\\jastadd\\transformations\\WhenTransformation.jrag:162
     */
     ...
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaCBackEnd\\src\\jastadd\\CCodeGen\\CCodeGenExpressions.jrag:239
     */
    @Override
    ...
    public FInitialExp(List<InstFunctionArgument> p0) {
        setChild(p0, 0);
    }
    /** @apilevel low-level 
     ...
     */
    public FInitialExp clone() throws CloneNotSupportedException {
        FInitialExp node = (FInitialExp) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:46
     */
    public FInitialExp copy() {
        try {
            FInitialExp node = (FInitialExp) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    public FInitialExp treeCopyNoTransform() {
        FInitialExp tree = (FInitialExp) copy();
        if (children != null) {
    ...
    public CValue cevalCalc(VariableEvaluator evaluator) {
        CValue cevalCalc_VariableEvaluator_value = evaluationValue;
    ...
    public boolean isInitialGuard() {
        boolean isInitialGuard_value = true;
    ...
    public String builtInName() {
        String builtInName_value = "initial";
