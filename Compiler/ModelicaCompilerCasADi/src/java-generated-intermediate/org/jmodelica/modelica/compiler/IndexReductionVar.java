 ...
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaMiddleEnd\\src\\jastadd\\structural\\IndexReduction.jrag:512
 */
public class IndexReductionVar extends AbstractVar<IndexReductionEq, IndexReductionVar> {
    public boolean dynamicSetCandidate(IndexReductionBiPGraph.Coefficient coefficient, FVariable.StateSelect stateSelect) {
        if (coefficient == null)
            return false;
    ...
    public boolean dynamicSetCandidate(FVariable.StateSelect stateSelect) {
        return stateSelect != FVariable.StateSelect.NEVER && stateSelect != FVariable.StateSelect.ALWAYS;
    }

    

        private IndexReductionVar meDifferentiated = null;

     // A reference to this variable differentiated once
