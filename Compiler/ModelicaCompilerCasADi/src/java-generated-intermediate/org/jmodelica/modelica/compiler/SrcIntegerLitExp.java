...
/**
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\ast\\Modelica.ast:288
 * @astdecl SrcIntegerLitExp : SrcExp ::= <UNSIGNED_INTEGER:String>;
 * @production SrcIntegerLitExp : {@link SrcExp} ::= <span class="component">&lt;UNSIGNED_INTEGER:String&gt;</span>;

 */
public class SrcIntegerLitExp extends SrcExp implements Cloneable {
    /**
     * Constructs an integer literal expression from an integer.
     * @aspect Constructors
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:55
     */
    public SrcIntegerLitExp(int val) {
		this(String.valueOf(val));
	}
    /**
     * @aspect PrettyPrint
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\PrettyPrint.jrag:824
     */
     ...
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\flattening\\Flattening.jrag:3272
     */
    ...
    public SrcIntegerLitExp(String p0) {
        setUNSIGNED_INTEGER(p0);
    }
    /**
     * @declaredat ASTNode:20
     */
    public SrcIntegerLitExp(beaver.Symbol p0) {
        setUNSIGNED_INTEGER(p0);
    }
    /** @apilevel low-level 
     ...
     */
    public SrcIntegerLitExp clone() throws CloneNotSupportedException {
        SrcIntegerLitExp node = (SrcIntegerLitExp) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:47
     */
    public SrcIntegerLitExp copy() {
        try {
            SrcIntegerLitExp node = (SrcIntegerLitExp) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    @Deprecated
    public SrcIntegerLitExp fullCopy() {
     ...
     */
    public SrcIntegerLitExp treeCopyNoTransform() {
        SrcIntegerLitExp tree = (SrcIntegerLitExp) copy();
        if (children != null) {
     ...
     */
    public SrcIntegerLitExp treeCopy() {
        doFullTraversal();
        return treeCopyNoTransform();
    }
    /** @apilevel internal 
    ...
    protected boolean is$Equal(ASTNode node) {
        return super.is$Equal(node) && (tokenString_UNSIGNED_INTEGER == ((SrcIntegerLitExp) node).tokenString_UNSIGNED_INTEGER);    
    }
    /**
     ...
     * @apilevel internal
     */
    public void setUNSIGNED_INTEGER(beaver.Symbol symbol) {
