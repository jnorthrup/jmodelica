 ...
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\ast\\FlatModelica.ast:1335
 * @astdecl FSimulationStateBuiltIn : FNoArgBuiltIn;
 * @production FSimulationStateBuiltIn : {@link FNoArgBuiltIn};

 */
public abstract class FSimulationStateBuiltIn extends FNoArgBuiltIn implements Cloneable {
    /**
     * @declaredat ASTNode:1
     */
    public FSimulationStateBuiltIn() {
        super();
    }
    /**
    ...
    public FSimulationStateBuiltIn(List<InstFunctionArgument> p0) {
        setChild(p0, 0);
    }
    /** @apilevel low-level 
     ...
     */
    public FSimulationStateBuiltIn clone() throws CloneNotSupportedException {
        FSimulationStateBuiltIn node = (FSimulationStateBuiltIn) super.clone();
        return node;
    }
    /**
     ...
     */
    @Deprecated
    public abstract FSimulationStateBuiltIn fullCopy();
    /**
     * Create a deep copy of the AST subtree at this node.
     * The copy is dangling, i.e. has no parent.
     * @return dangling copy of the subtree at this node
     ...
     */
    public abstract FSimulationStateBuiltIn treeCopyNoTransform();
    /**
     * Create a deep copy of the AST subtree at this node.
     ...
     */
    public abstract FSimulationStateBuiltIn treeCopy();
    /**
