 ...
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\ast\\FlatModelica.ast:871
 * @astdecl FEqRelExp : FRelExp;
 * @production FEqRelExp : {@link FRelExp};

 */
public abstract class FEqRelExp extends FRelExp implements Cloneable {
    /**
     * @aspect FlatTypeCheck
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\errorcheck\\TypeCheck.jrag:678
     */
    @Override
    ...
    public FEqRelExp(FExp p0, FExp p1, Opt<FExp> p2, String p3) {
        setChild(p0, 0);
        setChild(p1, 1);
        setChild(p2, 2);
     ...
     */
    public FEqRelExp(FExp p0, FExp p1, Opt<FExp> p2, beaver.Symbol p3) {
        setChild(p0, 0);
        setChild(p1, 1);
        setChild(p2, 2);
        setIndicatorVarName(p3);
     ...
     */
    public FEqRelExp clone() throws CloneNotSupportedException {
        FEqRelExp node = (FEqRelExp) super.clone();
        return node;
    }
    /**
     ...
     */
    @Deprecated
    public abstract FEqRelExp fullCopy();
    /**
     * Create a deep copy of the AST subtree at this node.
     * The copy is dangling, i.e. has no parent.
     * @return dangling copy of the subtree at this node
     ...
     */
    public abstract FEqRelExp treeCopyNoTransform();
    /**
     * Create a deep copy of the AST subtree at this node.
     ...
     */
    public abstract FEqRelExp treeCopy();
    /**
    ...
    public boolean isTimeEventGenerating() {
        boolean isTimeEventGenerating_value = false;
    ...
    public boolean generateTypeError() {
        boolean generateTypeError_value = super.generateTypeError() ||
