...
/**
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\ast\\Modelica.ast:158
 * @astdecl SrcPublicElementList : SrcElementList;
 * @production SrcPublicElementList : {@link SrcElementList};

 */
public class SrcPublicElementList extends SrcElementList implements Cloneable {
    /**
     * @declaredat ASTNode:1
     */
    public SrcPublicElementList() {
        super();
    }
    /**
    ...
    public SrcPublicElementList(List<SrcElement> p0) {
        setChild(p0, 0);
    }
    /** @apilevel low-level 
     ...
     */
    public SrcPublicElementList clone() throws CloneNotSupportedException {
        SrcPublicElementList node = (SrcPublicElementList) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:46
     */
    public SrcPublicElementList copy() {
        try {
            SrcPublicElementList node = (SrcPublicElementList) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    @Deprecated
    public SrcPublicElementList fullCopy() {
     ...
     */
    public SrcPublicElementList treeCopyNoTransform() {
        SrcPublicElementList tree = (SrcPublicElementList) copy();
        if (children != null) {
     ...
     */
    public SrcPublicElementList treeCopy() {
        doFullTraversal();
        return treeCopyNoTransform();
    }
    /** @apilevel internal 
    ...
    public String clauseHeader(String separator) {
        String clauseHeader_String_value = "public";
    ...
    public boolean isPublicElementList() {
        boolean isPublicElementList_value = true;
    ...
    public boolean Define_isPublic(ASTNode _callerNode, ASTNode _childNode) {
        if (_callerNode == getSrcElementListNoTransform()) {
            // @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\util\\Util.jrag:1205
            int childIndex = _callerNode.getIndexOfChild(_childNode);
            return true;
        }
        else {
            return getParent().Define_isPublic(this, _callerNode);
        }
    }
    /**
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\util\\Util.jrag:1203
