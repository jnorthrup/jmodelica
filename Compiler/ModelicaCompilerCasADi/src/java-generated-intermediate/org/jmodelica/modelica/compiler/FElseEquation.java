 ...
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\ast\\FlatModelica.ast:587
 * @astdecl FElseEquation : FIfWhenElseEquation;
 * @production FElseEquation : {@link FIfWhenElseEquation};

 */
public class FElseEquation extends FIfWhenElseEquation implements Cloneable {
    /**
     * Construcs a else equation without any residual.
     * @aspect Constructors
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:87
     */
    public FElseEquation(EquationType type, List<FAbstractEquation> eqns) {
        this(type, new List<FAttribute>(), new Opt<FStringComment>(), eqns);
    }
    /**
     * @aspect InheritedFactoryMethods
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:1304
     */
    public FElseEquation createEmptyNode() { return new FElseEquation(); }
    /**
     ...
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaMiddleEnd\\src\\jastadd\\transformations\\IfEquationElimination.jrag:160
     */
     ...
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaMiddleEnd\\src\\jastadd\\transformations\\IfEquationRewrite.jrag:177
     */
     ...
     * @aspect IfEquationRewrite
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaMiddleEnd\\src\\jastadd\\transformations\\IfEquationRewrite.jrag:406
     */
    ...
    /**
     * @aspect CCodeGen
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaCBackEnd\\src\\jastadd\\CCodeGen\\CCodeGen.jrag:381
     */
    @Override
    ...
    public FElseEquation(EquationType p0, List<FAttribute> p1, Opt<FStringComment> p2, List<FAbstractEquation> p3) {
        setType(p0);
        setChild(p1, 0);
        setChild(p2, 1);
        setChild(p3, 2);
     ...
     */
    public FElseEquation clone() throws CloneNotSupportedException {
        FElseEquation node = (FElseEquation) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:52
     */
    public FElseEquation copy() {
        try {
            FElseEquation node = (FElseEquation) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    public FElseEquation treeCopyNoTransform() {
        FElseEquation tree = (FElseEquation) copy();
        if (children != null) {
    ...
    protected boolean is$Equal(ASTNode node) {
        return super.is$Equal(node) && (tokenEquationType_Type == ((FElseEquation) node).tokenEquationType_Type);    
    }
    /**
    ...
    public Collection<FAbstractEquation> diff(String name) {
        Collection<FAbstractEquation> diff_String_value = Arrays.asList(dynamicFAbstractEquation(
                    new FElseEquation(getType(), FAbstractEquation.diffList(name, getFAbstractEquations()))));
        return diff_String_value;
    }
    /** @apilevel internal */
