 ...
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\ast\\FlatModelica.ast:1560
 * @astdecl FLinspace : FBuiltInFunctionCall ::= StartExp:FExp StopExp:FExp N:FExp;
 * @production FLinspace : {@link FBuiltInFunctionCall} ::= <span class="component">StartExp:{@link FExp}</span> <span class="component">StopExp:{@link FExp}</span> <span class="component">N:{@link FExp}</span>;

 */
public class FLinspace extends FBuiltInFunctionCall implements Cloneable {
    /**
     * @aspect InheritedFactoryMethods
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:996
     */
    public FLinspace createEmptyNode()       { return new FLinspace();       }
    /**
     * @aspect InheritedFactoryMethods
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:1413
     */
    public FLinspace(FExp a1, FExp a2, FExp a3)           { this(emptyArgs(), a1, a2, a3); }
    /**
     * @aspect FlatTypeCheck
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\errorcheck\\TypeCheck.jrag:687
     */
    ...
    /**
     * @aspect FlatTypeCheck
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\errorcheck\\TypeCheck.jrag:692
     */
     ...
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\flattening\\Flattening.jrag:2459
     */
    public FLinspace flatten(Flattener f) {
     ...
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaMiddleEnd\\src\\jastadd\\scalarization\\Scalarization.jrag:1618
     */
     ...
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaMiddleEnd\\src\\jastadd\\scalarization\\ScalarizeFunctions.jrag:970
     */
    ...
    /**
     * @aspect Derivatives
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaMiddleEnd\\src\\jastadd\\structural\\Differentiation.jrag:713
     */
    @Override
    ...
    @ASTNodeAnnotation.Constructor(
        name = {"OriginalArg", "StartExp", "StopExp", "N"},
        type = {"List<InstFunctionArgument>", "FExp", "FExp", "FExp"},
        kind = {"List", "Child", "Child", "Child"}
    )
    public FLinspace(List<InstFunctionArgument> p0, FExp p1, FExp p2, FExp p3) {
        setChild(p0, 0);
        setChild(p1, 1);
        setChild(p2, 2);
        setChild(p3, 3);
     ...
     */
    public FLinspace clone() throws CloneNotSupportedException {
        FLinspace node = (FLinspace) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:53
     */
    public FLinspace copy() {
        try {
            FLinspace node = (FLinspace) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    public FLinspace treeCopyNoTransform() {
        FLinspace tree = (FLinspace) copy();
        if (children != null) {
    ...
    /**
     * Replaces the StartExp child.
     * @param node The new node to replace the StartExp child.
     * @apilevel high-level
     */
    public void setStartExp(FExp node) {
        setChild(node, 1);
    }
    /**
     * Retrieves the StartExp child.
     * @return The current node used as the StartExp child.
     * @apilevel high-level
     */
    @ASTNodeAnnotation.Child(name="StartExp")
    public FExp getStartExp() {
     ...
     * @apilevel low-level
     */
    public FExp getStartExpNoTransform() {
        return (FExp) getChildNoTransform(1);
    }
    /**
     * Replaces the StopExp child.
     * @param node The new node to replace the StopExp child.
     * @apilevel high-level
     */
    public void setStopExp(FExp node) {
        setChild(node, 2);
    }
    /**
     * Retrieves the StopExp child.
     * @return The current node used as the StopExp child.
     * @apilevel high-level
     */
    @ASTNodeAnnotation.Child(name="StopExp")
    public FExp getStopExp() {
     ...
     * @apilevel low-level
     */
    public FExp getStopExpNoTransform() {
        return (FExp) getChildNoTransform(2);
    }
    /**
     * Replaces the N child.
     * @param node The new node to replace the N child.
     * @apilevel high-level
     */
    public void setN(FExp node) {
        setChild(node, 3);
    }
    /**
     * Retrieves the N child.
     * @return The current node used as the N child.
     * @apilevel high-level
     */
    @ASTNodeAnnotation.Child(name="N")
    public FExp getN() {
    ...
    public String builtInName() {
        String builtInName_value = "linspace";
     ...
     * @attribute syn
     * @aspect FlatTypeAnalysis
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\TypeAnalysis.jrag:525
     */
    @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
    @ASTNodeAnnotation.Source(aspect="FlatTypeAnalysis", declaredAt="C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\TypeAnalysis.jrag:525")
    public boolean hasValidN() {
        {
    ...
    public TypePrefixVariability expVariability() {
        TypePrefixVariability expVariability_value = getStartExp().variability().combine(getStopExp().variability());
