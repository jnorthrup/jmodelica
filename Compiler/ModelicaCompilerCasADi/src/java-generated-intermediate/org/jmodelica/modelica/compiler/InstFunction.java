...
/**
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\ast\\InstanceTree.ast:79
 * @astdecl InstFunction : InstRestriction;
 * @production InstFunction : {@link InstRestriction};

 */
public class InstFunction extends InstRestriction implements Cloneable {
    /**
     * @aspect ContentCheck
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\errorcheck\\ContentsCheck.jadd:645
     */
    public void checkIfAllowedInOperator(ErrorCheckType checkType) {}
    /**
     * @aspect Flattening
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\flattening\\Flattening.jrag:479
     */
     ...
     */
    public InstFunction clone() throws CloneNotSupportedException {
        InstFunction node = (InstFunction) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:36
     */
    public InstFunction copy() {
        try {
            InstFunction node = (InstFunction) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    public InstFunction treeCopyNoTransform() {
        InstFunction tree = (InstFunction) copy();
        if (children != null) {
