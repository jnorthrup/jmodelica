 ...
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\ast\\FlatModelica.ast:1258
 * @astdecl InstMultipleBoundArgument : InstBadArgument ::= Arg:InstFunctionArgument*;
 * @production InstMultipleBoundArgument : {@link InstBadArgument} ::= <span class="component">Arg:{@link InstFunctionArgument}*</span>;

 */
public class InstMultipleBoundArgument extends InstBadArgument implements Cloneable {
    /**
     * @aspect InstFunctionBinding
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\instance\\InstFunctionBinding.jrag:36
     */
    ...
    /**
     * @aspect InstFunctionBinding
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\instance\\InstFunctionBinding.jrag:74
     */
     ...
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\util\\Annotations.jrag:368
     */
     ...
     */
    public InstMultipleBoundArgument() {
        super();
    }
    /**
    ...
    public InstMultipleBoundArgument(List<InstFunctionArgument> p0) {
        setChild(p0, 0);
    }
    /** @apilevel low-level 
     ...
     */
    public InstMultipleBoundArgument clone() throws CloneNotSupportedException {
        InstMultipleBoundArgument node = (InstMultipleBoundArgument) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:46
     */
    public InstMultipleBoundArgument copy() {
        try {
            InstMultipleBoundArgument node = (InstMultipleBoundArgument) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    @Deprecated
    public InstMultipleBoundArgument fullCopy() {
     ...
     */
    public InstMultipleBoundArgument treeCopyNoTransform() {
        InstMultipleBoundArgument tree = (InstMultipleBoundArgument) copy();
        if (children != null) {
     ...
     */
    public InstMultipleBoundArgument treeCopy() {
        doFullTraversal();
        return treeCopyNoTransform();
    }
    /** @apilevel internal 
     ...
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\errorcheck\\TypeCheck.jrag:1527
     */
    @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
    @ASTNodeAnnotation.Source(aspect="FlatTypeCheck", declaredAt="C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\errorcheck\\TypeCheck.jrag:1527")
    public String errorString() {
        String errorString_value = "multiple arguments matches input";
        return errorString_value;
    }
    /**
    ...
    public boolean Define_isInstRecordConstructorArg(ASTNode _callerNode, ASTNode _childNode) {
        if (_callerNode == getArgListNoTransform()) {
            ...
            return isInstRecordConstructorArg();
        }
        else {
