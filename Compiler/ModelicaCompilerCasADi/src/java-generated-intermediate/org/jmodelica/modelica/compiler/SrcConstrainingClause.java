...
/**
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\ast\\Modelica.ast:131
 * @astdecl SrcConstrainingClause : SrcBaseNode ::= SrcAccess [SrcClassModification];
 * @production SrcConstrainingClause : {@link SrcBaseNode} ::= <span class="component">{@link SrcAccess}</span> <span class="component">[{@link SrcClassModification}]</span>;

 */
public class SrcConstrainingClause extends SrcBaseNode implements Cloneable {
    /**
     * @aspect PrettyPrint
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\PrettyPrint.jrag:589
     */
    ...
    @ASTNodeAnnotation.Constructor(
        name = {"SrcAccess", "SrcClassModification"},
        type = {"SrcAccess", "Opt<SrcClassModification>"},
        kind = {"Child", "Opt"}
    )
    public SrcConstrainingClause(SrcAccess p0, Opt<SrcClassModification> p1) {
        setChild(p0, 0);
        setChild(p1, 1);
    }
    /** @apilevel low-level 
     ...
     */
    public SrcConstrainingClause clone() throws CloneNotSupportedException {
        SrcConstrainingClause node = (SrcConstrainingClause) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:47
     */
    public SrcConstrainingClause copy() {
        try {
            SrcConstrainingClause node = (SrcConstrainingClause) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    @Deprecated
    public SrcConstrainingClause fullCopy() {
     ...
     */
    public SrcConstrainingClause treeCopyNoTransform() {
        SrcConstrainingClause tree = (SrcConstrainingClause) copy();
        if (children != null) {
     ...
     */
    public SrcConstrainingClause treeCopy() {
        doFullTraversal();
        return treeCopyNoTransform();
    }
    /** @apilevel internal 
