 ...
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\ast\\FlatModelica.ast:866
 * @astdecl FGeqExp : FRelExp;
 * @production FGeqExp : {@link FRelExp};

 */
public class FGeqExp extends FRelExp implements Cloneable {
    /**
     * @aspect InheritedFactoryMethods
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:933
     */
    public FGeqExp createEmptyNode() { return new FGeqExp(); }
    /**
     * @aspect InheritedFactoryMethods
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:1427
     */
    public FGeqExp(FExp e1, FExp e2) { this(e1, e2, new Opt<FExp>(), (String) null); }
    /**
    ...
    public FGeqExp(FExp p0, FExp p1, Opt<FExp> p2, String p3) {
        setChild(p0, 0);
        setChild(p1, 1);
        setChild(p2, 2);
     ...
     */
    public FGeqExp(FExp p0, FExp p1, Opt<FExp> p2, beaver.Symbol p3) {
        setChild(p0, 0);
        setChild(p1, 1);
        setChild(p2, 2);
        setIndicatorVarName(p3);
     ...
     */
    public FGeqExp clone() throws CloneNotSupportedException {
        FGeqExp node = (FGeqExp) super.clone();
        return node;
    }
    /** @apilevel internal 
     ...
     */
    public FGeqExp treeCopyNoTransform() {
        FGeqExp tree = (FGeqExp) copy();
        if (children != null) {
    ...
    protected boolean is$Equal(ASTNode node) {
        return super.is$Equal(node) && (tokenString_IndicatorVarName == ((FGeqExp) node).tokenString_IndicatorVarName);    
    }
    /**
    ...
    public CValue cevalEval(CValue left, CValue right) {
        CValue cevalEval_CValue_CValue_value = cevalType().geq(left, right);
    ...
    public String operatorName() {
        String operatorName_value = OP_GEQ;
    ...
    public String kindString() {
        String kindString_value = FRelExp.GEQ_C;
    ...
    public String kindStringPhased() {
        String kindStringPhased_value = FRelExp.GT_C;
    ...
    public String macro_C() {
        String macro_C_value = "COND_EXP_GE";
    ...
    public boolean isPhased_sub() {
        boolean isPhased_sub_value = getRight() instanceof FTimeExp;
        return isPhased_sub_value;
    }
    /**
    ...
    public MX toMX() {
        MX toMX_value = getRight().toMX().__le__(getLeft().toMX());
        return toMX_value;
    }
    /** @apilevel internal */
