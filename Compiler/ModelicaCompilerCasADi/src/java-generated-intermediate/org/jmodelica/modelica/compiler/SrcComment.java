...
/**
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\ast\\Modelica.ast:211
 * @astdecl SrcComment : SrcBaseNode ::= [SrcStringComment] [SrcAnnotation];
 * @production SrcComment : {@link SrcBaseNode} ::= <span class="component">[{@link SrcStringComment}]</span> <span class="component">[{@link SrcAnnotation}]</span>;

 */
public class SrcComment extends SrcBaseNode implements Cloneable, StringCommentSource, ASTNodeWithAnnotation {
    /**
     * @aspect SrcAnnotations
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\util\\SrcAnnotations.jrag:72
     */
    ...
    /**
     * @aspect SrcAnnotations
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\util\\SrcAnnotations.jrag:93
     */
    ...
    @ASTNodeAnnotation.Constructor(
        name = {"SrcStringComment", "SrcAnnotation"},
        type = {"Opt<SrcStringComment>", "Opt<SrcAnnotation>"},
        kind = {"Opt", "Opt"}
    )
    public SrcComment(Opt<SrcStringComment> p0, Opt<SrcAnnotation> p1) {
        setChild(p0, 0);
        setChild(p1, 1);
    }
    /** @apilevel low-level 
     ...
     */
    public SrcComment clone() throws CloneNotSupportedException {
        SrcComment node = (SrcComment) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:48
     */
    public SrcComment copy() {
        try {
            SrcComment node = (SrcComment) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    public SrcComment treeCopyNoTransform() {
        SrcComment tree = (SrcComment) copy();
        if (children != null) {
    ...
    public Opt<SrcStringComment> getSrcStringCommentOpt() {
        return (Opt<SrcStringComment>) getChild(0);
    }
    /**
    ...
    public Opt<SrcStringComment> getSrcStringCommentOptNoTransform() {
        return (Opt<SrcStringComment>) getChildNoTransform(0);
    }
    /**
    ...
    public Opt<SrcAnnotation> getSrcAnnotationOpt() {
        return (Opt<SrcAnnotation>) getChild(1);
    }
    /**
    ...
    public Opt<SrcAnnotation> getSrcAnnotationOptNoTransform() {
        return (Opt<SrcAnnotation>) getChildNoTransform(1);
    }
    /**
    ...
    public AnnotationNode createNullAnnotationNode(InstContext instContext) {
        AnnotationNode createNullAnnotationNode_InstContext_value = new CommentAnnotationNode(this, instContext);
