...
/**
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\ast\\Modelica.ast:242
 * @astdecl SrcIfWhenElseEquation : SrcAbstractEquation ::= SrcAbstractEquation*;
 * @production SrcIfWhenElseEquation : {@link SrcAbstractEquation} ::= <span class="component">{@link SrcAbstractEquation}*</span>;

 */
public abstract class SrcIfWhenElseEquation extends SrcAbstractEquation implements Cloneable {
    /**
     * @aspect InstantiatedExpressions
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\flattening\\Flattening.jrag:2934
     */
    protected FIfWhenElseEquation instantiate(FIfWhenElseEquation res) {
    ...
    /**
     * @aspect InstantiatedExpressions
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\flattening\\Flattening.jrag:2950
     */
    public abstract FIfWhenElseEquation instantiate();
    /**
     * @declaredat ASTNode:1
     */
    public SrcIfWhenElseEquation() {
        super();
    }
    /**
    ...
    @ASTNodeAnnotation.Constructor(
        name = {"SrcComment", "SrcAbstractEquation"},
        type = {"SrcComment", "List<SrcAbstractEquation>"},
        kind = {"Child", "List"}
    )
    public SrcIfWhenElseEquation(SrcComment p0, List<SrcAbstractEquation> p1) {
        setChild(p0, 0);
        setChild(p1, 1);
    }
    /** @apilevel low-level 
     ...
     */
    public SrcIfWhenElseEquation clone() throws CloneNotSupportedException {
        SrcIfWhenElseEquation node = (SrcIfWhenElseEquation) super.clone();
        return node;
    }
    /**
     ...
     */
    @Deprecated
    public abstract SrcIfWhenElseEquation fullCopy();
    /**
     * Create a deep copy of the AST subtree at this node.
     * The copy is dangling, i.e. has no parent.
     * @return dangling copy of the subtree at this node
     ...
     */
    public abstract SrcIfWhenElseEquation treeCopyNoTransform();
    /**
     * Create a deep copy of the AST subtree at this node.
     ...
     */
    public abstract SrcIfWhenElseEquation treeCopy();
    /**
