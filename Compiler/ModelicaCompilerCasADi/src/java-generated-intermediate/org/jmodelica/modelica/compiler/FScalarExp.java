 ...
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\ast\\FlatModelica.ast:1507
 * @astdecl FScalarExp : FDimensionConvert;
 * @production FScalarExp : {@link FDimensionConvert};

 */
public class FScalarExp extends FDimensionConvert implements Cloneable {
    /**
     * @aspect InheritedFactoryMethods
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:1036
     */
    public FScalarExp createEmptyNode()       { return new FScalarExp();       }
    /**
     * @aspect Scalarization
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaMiddleEnd\\src\\jastadd\\scalarization\\Scalarization.jrag:1782
     */
    ...
    public FScalarExp(List<InstFunctionArgument> p0, FExp p1) {
        setChild(p0, 0);
        setChild(p1, 1);
    }
    /** @apilevel low-level 
     ...
     */
    public FScalarExp clone() throws CloneNotSupportedException {
        FScalarExp node = (FScalarExp) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:50
     */
    public FScalarExp copy() {
        try {
            FScalarExp node = (FScalarExp) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    public FScalarExp treeCopyNoTransform() {
        FScalarExp tree = (FScalarExp) copy();
        if (children != null) {
    ...
    public int[] dimensionsToKeep() {
        ...
        dimensionsToKeep_value = new int[] {};
    ...
    public Size sizeForScalarArg() {
        Size sizeForScalarArg_value = Size.SCALAR;
    ...
    public CValue cevalCalc(VariableEvaluator evaluator) {
        CValue cevalCalc_VariableEvaluator_value = getFExp().ceval(evaluator).array().getCell(0);
    ...
    public String builtInName() {
        String builtInName_value = "scalar";
    ...
    public String Define_expectedArgumentType(ASTNode _callerNode, ASTNode _childNode) {
        ...
        return "array with exactly 1 element";
    }
    /**
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\errorcheck\\TypeCheck.jrag:1744
     * @apilevel internal
