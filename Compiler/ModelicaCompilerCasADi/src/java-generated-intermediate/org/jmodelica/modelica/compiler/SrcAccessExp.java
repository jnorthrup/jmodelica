...
/**
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\ast\\Modelica.ast:318
 * @astdecl SrcAccessExp : SrcExp ::= SrcAccess;
 * @production SrcAccessExp : {@link SrcExp} ::= <span class="component">{@link SrcAccess}</span>;

 */
public class SrcAccessExp extends SrcExp implements Cloneable {
    /**
     * @aspect InstantiatedExpressions
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\flattening\\Flattening.jrag:3135
     */
    ...
    public SrcAccessExp(SrcAccess p0) {
        setChild(p0, 0);
    }
    /** @apilevel low-level 
     ...
     */
    public SrcAccessExp clone() throws CloneNotSupportedException {
        SrcAccessExp node = (SrcAccessExp) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:45
     */
    public SrcAccessExp copy() {
        try {
            SrcAccessExp node = (SrcAccessExp) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    public SrcAccessExp treeCopyNoTransform() {
        SrcAccessExp tree = (SrcAccessExp) copy();
        if (children != null) {
    ...
    public CValue ceval() {
        CValue ceval_value = new CValueUnknownAccess(getSrcAccess().name());
        return ceval_value;
    }
    /**
     * @attribute syn
    ...
    public String avalueString() {
        String avalueString_value = getSrcAccess().name();
    ...
    public SrcAccess asAccess() {
        SrcAccess asAccess_value = getSrcAccess();
        return asAccess_value;
    }
    /** @apilevel internal */
