...
/**
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\ast\\Modelica.ast:266
 * @astdecl SrcForStmt : SrcStatement ::= SrcForIndex* SrcStatement*;
 * @production SrcForStmt : {@link SrcStatement} ::= <span class="component">{@link SrcForIndex}*</span> <span class="component">{@link SrcStatement}*</span>;

 */
public class SrcForStmt extends SrcStatement implements Cloneable {
    /**
     * @aspect PrettyPrint
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\PrettyPrint.jrag:504
     */
     ...
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\flattening\\Flattening.jrag:3093
     */
    protected InstForStmt instantiateStatement() {
        List il = new List();
    ...
    @ASTNodeAnnotation.Constructor(
        name = {"SrcComment", "SrcForIndex", "SrcStatement"},
        type = {"SrcComment", "List<SrcForIndex>", "List<SrcStatement>"},
        kind = {"Child", "List", "List"}
    )
    public SrcForStmt(SrcComment p0, List<SrcForIndex> p1, List<SrcStatement> p2) {
        setChild(p0, 0);
        setChild(p1, 1);
        setChild(p2, 2);
    }
     ...
     */
    public SrcForStmt clone() throws CloneNotSupportedException {
        SrcForStmt node = (SrcForStmt) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:49
     */
    public SrcForStmt copy() {
        try {
            SrcForStmt node = (SrcForStmt) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    public SrcForStmt treeCopyNoTransform() {
        SrcForStmt tree = (SrcForStmt) copy();
        if (children != null) {
     ...
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\source\\SimpleLookup.jrag:458
     */
    @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
    @ASTNodeAnnotation.Source(aspect="SimpleClassLookup", declaredAt="C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\source\\SimpleLookup.jrag:458")
    public ResolvedAccess simpleLookupForStmt(String name) {
        {
    ...
    public ResolvedAccess Define_simpleLookupHelper(ASTNode _callerNode, ASTNode _childNode, String name) {
        ...
        return simpleLookupForStmt(name);
    }
    /**
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\source\\SimpleLookup.jrag:278
     * @apilevel internal
