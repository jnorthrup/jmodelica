 ...
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\ast\\FlatModelica.ast:1640
 * @astdecl FInStream : FStreamBuiltIn;
 * @production FInStream : {@link FStreamBuiltIn};

 */
public class FInStream extends FStreamBuiltIn implements Cloneable {
    /**
     * @aspect InheritedFactoryMethods
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:1055
     */
    public FInStream createEmptyNode()        { return new FInStream();        }
    /**
     * @aspect InheritedFactoryMethods
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:1389
     */
    public FInStream(FExp a1)                  { this(emptyArgs(), a1); }
    /**
     * @aspect Connections
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\flattening\\Connections.jrag:81
     */
    protected FExp expandInStreamExp() {
    ...
    public FInStream(List<InstFunctionArgument> p0, FExp p1) {
        setChild(p0, 0);
        setChild(p1, 1);
    }
    /** @apilevel low-level 
     ...
     */
    public FInStream clone() throws CloneNotSupportedException {
        FInStream node = (FInStream) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:47
     */
    public FInStream copy() {
        try {
            FInStream node = (FInStream) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    public FInStream treeCopyNoTransform() {
        FInStream tree = (FInStream) copy();
        if (children != null) {
    ...
    public String builtInName() {
        String builtInName_value = "inStream";
        return builtInName_value;
    }
    /** @apilevel internal */
    public ASTNode rewriteTo() {
        // Declared at C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\flattening\\Connections.jrag:78
        if (rewriteStreams) {
            return rewriteRule0();
        }
    ...
    /**
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\flattening\\Connections.jrag:78
     * @apilevel internal
