...
/**
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\ast\\InstanceTree.ast:51
 * @astdecl InstPrimitiveClassDecl : InstFullClassDecl;
 * @production InstPrimitiveClassDecl : {@link InstFullClassDecl};

 */
public class InstPrimitiveClassDecl extends InstFullClassDecl implements Cloneable {
    /**
     * @aspect InstanceTreeConstruction
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\instance\\InstanceTree.jrag:1284
     */
    ...
    public InstPrimitiveClassDecl(SrcClassDecl p0, Opt<InstConstrainingClass> p1, InstRestriction p2, Opt<InstExternal> p3) {
        setSrcClassDecl(p0);
        setChild(p1, 0);
        setChild(p2, 1);
        setChild(p3, 2);
     ...
     */
    public InstPrimitiveClassDecl clone() throws CloneNotSupportedException {
        InstPrimitiveClassDecl node = (InstPrimitiveClassDecl) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:59
     */
    public InstPrimitiveClassDecl copy() {
        try {
            InstPrimitiveClassDecl node = (InstPrimitiveClassDecl) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    @Deprecated
    public InstPrimitiveClassDecl fullCopy() {
     ...
     */
    public InstPrimitiveClassDecl treeCopyNoTransform() {
        InstPrimitiveClassDecl tree = (InstPrimitiveClassDecl) copy();
        if (children != null) {
     ...
     */
    public InstPrimitiveClassDecl treeCopy() {
        doFullTraversal();
        return treeCopyNoTransform();
    }
    /** @apilevel internal 
    ...
    protected boolean is$Equal(ASTNode node) {
        return super.is$Equal(node) && (tokenSrcClassDecl_SrcClassDecl == ((InstPrimitiveClassDecl) node).tokenSrcClassDecl_SrcClassDecl);    
    }
    /**
