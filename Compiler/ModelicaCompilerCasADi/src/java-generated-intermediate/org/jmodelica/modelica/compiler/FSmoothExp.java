 ...
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\ast\\FlatModelica.ast:1295
 * @astdecl FSmoothExp : FBuiltInFunctionCall ::= Order:FExp FExp;
 * @production FSmoothExp : {@link FBuiltInFunctionCall} ::= <span class="component">Order:{@link FExp}</span> <span class="component">{@link FExp}</span>;

 */
public class FSmoothExp extends FBuiltInFunctionCall implements Cloneable {
    /**
     * @aspect Constructors
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:412
     */
    public FSmoothExp(int order, FExp exp) {
        this(new FIntegerLitExp(order), exp);
    }
    /**
     * @aspect InheritedFactoryMethods
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:953
     */
    public FSmoothExp createEmptyNode()      { return new FSmoothExp();      }
    /**
     * @aspect InheritedFactoryMethods
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:1406
     */
    public FSmoothExp(FExp a1, FExp a2)       { this(emptyArgs(), a1, a2); }
    /**
     * @aspect FlatExpressions
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\flattening\\Flattening.jrag:2634
     */
    public FSmoothExp flatten(Flattener f)    { return new FSmoothExp(getOrder().flatten(f), getFExp().flatten(f)); }
    /**
     * @aspect Scalarization
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaMiddleEnd\\src\\jastadd\\scalarization\\Scalarization.jrag:1747
     */
    public FExp scalarizeExp(Scalarizer s)     { return new FSmoothExp(getOrder().scalarize(s), getFExp().scalarize(s)); }
    /**
     * @aspect Derivatives
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaMiddleEnd\\src\\jastadd\\structural\\Differentiation.jrag:387
     */
    @Override
     ...
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaCBackEnd\\src\\jastadd\\CCodeGen\\CCodeGenExpressions.jrag:332
     */
    @Override
    ...
    @ASTNodeAnnotation.Constructor(
        name = {"OriginalArg", "Order", "FExp"},
        type = {"List<InstFunctionArgument>", "FExp", "FExp"},
        kind = {"List", "Child", "Child"}
    )
    public FSmoothExp(List<InstFunctionArgument> p0, FExp p1, FExp p2) {
        setChild(p0, 0);
        setChild(p1, 1);
        setChild(p2, 2);
    }
     ...
     */
    public FSmoothExp clone() throws CloneNotSupportedException {
        FSmoothExp node = (FSmoothExp) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:52
     */
    public FSmoothExp copy() {
        try {
            FSmoothExp node = (FSmoothExp) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    public FSmoothExp treeCopyNoTransform() {
        FSmoothExp tree = (FSmoothExp) copy();
        if (children != null) {
    ...
    /**
     * Replaces the Order child.
     * @param node The new node to replace the Order child.
     * @apilevel high-level
     */
    public void setOrder(FExp node) {
        setChild(node, 1);
    }
    /**
     * Retrieves the Order child.
     * @return The current node used as the Order child.
     * @apilevel high-level
     */
    @ASTNodeAnnotation.Child(name="Order")
    public FExp getOrder() {
     ...
     * @apilevel low-level
     */
    public FExp getOrderNoTransform() {
     ...
     * @attribute syn
     * @aspect FlatAPI
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\FlatAPI\\FlatAPI.jrag:2077
     */
    @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
    @ASTNodeAnnotation.Source(aspect="FlatAPI", declaredAt="C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\FlatAPI\\FlatAPI.jrag:2077")
    public int order() {
        int order_value = getOrder().ceval().intValue();
        return order_value;
    }
    /**
     * @attribute syn
    ...
    public String builtInName() {
        String builtInName_value = "smooth";
    ...
    public boolean generatesEvents() {
        boolean generatesEvents_value = super.generatesEvents() && !(order() == 0 && myOptions().getBooleanOption("disable_smooth_events"));
    ...
    public boolean Define_inSmoothExp(ASTNode _callerNode, ASTNode _childNode, int order) {
        ...
        return getOrder().ceval().intValue() >= order;
    }
    /**
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\FlatUtil.jrag:1792
     * @apilevel internal
    ...
    public boolean Define_argumentDefinedTypeValid(ASTNode _callerNode, ASTNode _childNode) {
        if (_callerNode == getOriginalArgListNoTransform()) {
            // @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\errorcheck\\TypeCheck.jrag:1697
    ...
    public ASTNode rewriteTo() {
        // Declared at C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaMiddleEnd\\src\\jastadd\\structural\\Symbolic.jrag:534
        if (!getFExpNoTransform().needsSmooth()) {
            return rewriteRule0();
        }
        return super.rewriteTo();
    }
    /**
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaMiddleEnd\\src\\jastadd\\structural\\Symbolic.jrag:534
     * @apilevel internal
