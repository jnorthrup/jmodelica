 ...
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\ast\\FlatModelica.ast:214
 * @astdecl FDerivativeVariable : FAbstractDerivativeVariable;
 * @production FDerivativeVariable : {@link FAbstractDerivativeVariable};

 */
public class FDerivativeVariable extends FAbstractDerivativeVariable implements Cloneable {
    /**
     * Create a derivative variable with only the required children.
     * @aspect Constructors
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:503
     */
    public FDerivativeVariable(VisibilityType vt, 
     ...
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaMiddleEnd\\src\\jastadd\\TransformCanonical.jrag:1218
     */
    ...
    /**
     * @aspect DummyDerivatives
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaMiddleEnd\\src\\jastadd\\TransformCanonical.jrag:1223
     */
     ...
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaMiddleEnd\\src\\jastadd\\optimizations\\AliasElimination.jrag:306
     */
    ...
    @ASTNodeAnnotation.Constructor(
        name = {"VisibilityType", "TypePrefixVariability", "TypePrefixInputOutput", "FAttribute", "DerivedType", "BindingExp", "FStringComment", "FAccess", "Order"},
        type = {"VisibilityType", "TypePrefixVariability", "TypePrefixInputOutput", "List<FAttribute>", "String", "Opt<FExp>", "Opt<FStringComment>", "FAccess", "int"},
        kind = {"Token", "Token", "Token", "List", "Token", "Opt", "Opt", "Child", "Token"}
    )
    public FDerivativeVariable(VisibilityType p0, TypePrefixVariability p1, TypePrefixInputOutput p2, List<FAttribute> p3, String p4, Opt<FExp> p5, Opt<FStringComment> p6, FAccess p7, int p8) {
     ...
     */
    public FDerivativeVariable(VisibilityType p0, TypePrefixVariability p1, TypePrefixInputOutput p2, List<FAttribute> p3, beaver.Symbol p4, Opt<FExp> p5, Opt<FStringComment> p6, FAccess p7, int p8) {
        setVisibilityType(p0);
        setTypePrefixVariability(p1);
        setTypePrefixInputOutput(p2);
        setChild(p3, 0);
     ...
     */
    public FDerivativeVariable clone() throws CloneNotSupportedException {
        FDerivativeVariable node = (FDerivativeVariable) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:68
     */
    public FDerivativeVariable copy() {
        try {
            FDerivativeVariable node = (FDerivativeVariable) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    @Deprecated
    public FDerivativeVariable fullCopy() {
     ...
     */
    public FDerivativeVariable treeCopyNoTransform() {
        FDerivativeVariable tree = (FDerivativeVariable) copy();
        if (children != null) {
     ...
     */
    public FDerivativeVariable treeCopy() {
        doFullTraversal();
        return treeCopyNoTransform();
    }
    /** @apilevel internal 
    ...
    protected boolean is$Equal(ASTNode node) {
        return super.is$Equal(node) && (tokenVisibilityType_VisibilityType == ((FDerivativeVariable) node).tokenVisibilityType_VisibilityType) && (tokenTypePrefixVariability_TypePrefixVariability == ((FDerivativeVariable) node).tokenTypePrefixVariability_TypePrefixVariability) && (tokenTypePrefixInputOutput_TypePrefixInputOutput == ((FDerivativeVariable) node).tokenTypePrefixInputOutput_TypePrefixInputOutput) && (tokenString_DerivedType == ((FDerivativeVariable) node).tokenString_DerivedType) && (tokenint_Order == ((FDerivativeVariable) node).tokenint_Order);    
    }
    /**
     ...
     * @attribute syn
     * @aspect FlatAPI
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\FlatAPI\\FlatAPI.jrag:1160
     */
    @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
    @ASTNodeAnnotation.Source(aspect="FlatAPI", declaredAt="C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\FlatAPI\\FlatAPI.jrag:1160")
    public boolean shouldContributeFiltered() {
        boolean shouldContributeFiltered_value = shouldContribute() && (myDifferentiatedVariable().asFVariable().stateSelectAttributeSet() || uses().size() > 0);
        return shouldContributeFiltered_value;
    }
    /**
     * @attribute syn
     * @aspect FlatAPI
    ...
    public boolean isDerivativeVariable() {
        boolean isDerivativeVariable_value = true;
    ...
    public FDerivativeVariable asDerivativeVariable() {
        FDerivativeVariable asDerivativeVariable_value = this;
        return asDerivativeVariable_value;
    }
    /**
     * @attribute syn
    ...
    public CValue startAttributeCValue() {
        CValue startAttributeCValue_value = new CValueReal(0.0);
        return startAttributeCValue_value;
    }
    /**
     * @attribute syn
     * @aspect FlatAPIAttributes
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\FlatAPI\\FlatAPIAttributes.jrag:228
     */
    @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
    @ASTNodeAnnotation.Source(aspect="FlatAPIAttributes", declaredAt="C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\FlatAPI\\FlatAPIAttributes.jrag:228")
    public boolean nominalAttributeSet() {
        boolean nominalAttributeSet_value = myDifferentiatedVariable().asFVariable().nominalAttributeSet();
        return nominalAttributeSet_value;
    }
    /**
     * @attribute syn
     * @aspect FlatAPIAttributes
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\FlatAPI\\FlatAPIAttributes.jrag:229
     */
    @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
    @ASTNodeAnnotation.Source(aspect="FlatAPIAttributes", declaredAt="C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\FlatAPI\\FlatAPIAttributes.jrag:229")
    public FExp nominalAttributeExp() {
        FExp nominalAttributeExp_value = myDifferentiatedVariable().asFVariable().nominalAttributeExp();
        return nominalAttributeExp_value;
    }
    /**
     * @attribute syn
     * @aspect FlatAPIAttributes
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\FlatAPI\\FlatAPIAttributes.jrag:230
     */
    @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
    @ASTNodeAnnotation.Source(aspect="FlatAPIAttributes", declaredAt="C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\FlatAPI\\FlatAPIAttributes.jrag:230")
    public CValue nominalAttributeCValue() {
        CValue nominalAttributeCValue_value = myDifferentiatedVariable().asFVariable().nominalAttributeCValue();
    ...
    public FAccessExp createAccessExp() {
        FAccessExp createAccessExp_value = new FDerExp(createFAccess(), order());
    ...
    protected void collect_contributors_FClass_differentiatedByFDerExp(FClass _root, java.util.Map<ASTNode, java.util.Set<ASTNode>> _map) {
        // @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\FlatAPI\\FlatAPI.jrag:1073
        if ((shouldContribute())) {
            {
    ...
    protected void collect_contributors_FClass_differentiatedRealVariablesFilteredSet(FClass _root, java.util.Map<ASTNode, java.util.Set<ASTNode>> _map) {
        // @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\FlatAPI\\FlatAPI.jrag:1529
        if ((shouldContributeFiltered())) {
            {
                FClass target = (FClass) (myFClass());
                java.util.Set<ASTNode> contributors = _map.get(target);
                if (contributors == null) {
    ...
    protected void collect_contributors_FClass_derivativeVariables(FClass _root, java.util.Map<ASTNode, java.util.Set<ASTNode>> _map) {
        // @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\FlatAPI\\FlatAPI.jrag:1579
        if ((shouldContribute())) {
            {
                FClass target = (FClass) (myFClass());
                java.util.Set<ASTNode> contributors = _map.get(target);
        ...
        super.collect_contributors_FClass_derivativeVariables(_root, _map);
    }
    /** @apilevel internal */
    protected void contributeTo_FClass_differentiatedByFDerExp(LinkedHashSet<FVariable> collection) {
        ...
        if ((shouldContribute())) {
            collection.add(myDifferentiatedVariable().asFVariable());
        }
    }
    /** @apilevel internal */
    protected void contributeTo_FClass_differentiatedRealVariablesFilteredSet(LinkedHashSet<FRealVariable> collection) {
        ...
        if ((shouldContributeFiltered())) {
            collection.add(myDifferentiatedVariable().asFRealVariable());
        }
    }
    /** @apilevel internal */
    protected void contributeTo_FClass_derivativeVariables(ArrayList<FDerivativeVariable> collection) {
        super.contributeTo_FClass_derivativeVariables(collection);
        if ((shouldContribute())) {
            collection.add(this);
        }
    }
