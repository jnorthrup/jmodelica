...
/**
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\ast\\InstanceTree.ast:123
 * @astdecl InstReplacingComposite : InstComposite ::= <OriginalDecl:SrcComponentDecl> OriginalInstComponent:InstComponentDecl <InstComponentRedeclare:InstComponentRedeclare>;
 * @production InstReplacingComposite : {@link InstComposite} ::= <span class="component">&lt;OriginalDecl:SrcComponentDecl&gt;</span> <span class="component">OriginalInstComponent:{@link InstComponentDecl}</span> <span class="component">&lt;InstComponentRedeclare:InstComponentRedeclare&gt;</span>;

 */
public class InstReplacingComposite extends InstComposite implements Cloneable {
    /**
     * @aspect InstanceErrorCheck
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\errorcheck\\ErrorCheck.jrag:1105
     */
     ...
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\errorcheck\\TypeCheck.jrag:79
     */
    ...
    /**
     * @aspect InstArrays
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\instance\\InstanceTree.jrag:2666
     */
    ...
    public InstReplacingComposite(String p0, InstAccess p1, Opt<FArraySubscripts> p2, SrcComponentDecl p3, Opt<InstModification> p4, Opt<InstConstrainingComponent> p5, Opt<FExp> p6, SrcComponentDecl p7, InstComponentRedeclare p8) {
        setName(p0);
        setChild(p1, 0);
        setChild(p2, 1);
     ...
     */
    public InstReplacingComposite(beaver.Symbol p0, InstAccess p1, Opt<FArraySubscripts> p2, SrcComponentDecl p3, Opt<InstModification> p4, Opt<InstConstrainingComponent> p5, Opt<FExp> p6, SrcComponentDecl p7, InstComponentRedeclare p8) {
        setName(p0);
        setChild(p1, 0);
        setChild(p2, 1);
        setSrcComponentDecl(p3);
     ...
     */
    public InstReplacingComposite clone() throws CloneNotSupportedException {
        InstReplacingComposite node = (InstReplacingComposite) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:79
     */
    public InstReplacingComposite copy() {
        try {
            InstReplacingComposite node = (InstReplacingComposite) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    @Deprecated
    public InstReplacingComposite fullCopy() {
     ...
     */
    public InstReplacingComposite treeCopyNoTransform() {
        InstReplacingComposite tree = (InstReplacingComposite) copy();
        if (children != null) {
     ...
     */
    public InstReplacingComposite treeCopy() {
        doFullTraversal();
        return treeCopyNoTransform();
    }
    /** @apilevel internal 
    ...
    protected boolean is$Equal(ASTNode node) {
        return super.is$Equal(node) && (tokenString_Name == ((InstReplacingComposite) node).tokenString_Name) && (tokenSrcComponentDecl_SrcComponentDecl == ((InstReplacingComposite) node).tokenSrcComponentDecl_SrcComponentDecl) && (tokenSrcComponentDecl_OriginalDecl == ((InstReplacingComposite) node).tokenSrcComponentDecl_OriginalDecl) && (tokenInstComponentRedeclare_InstComponentRedeclare == ((InstReplacingComposite) node).tokenInstComponentRedeclare_InstComponentRedeclare);    
    }
    /**
     ...
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\instance\\InstanceTree.jrag:1621
     */
    @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN, isNTA=true)
    @ASTNodeAnnotation.Source(aspect="InstanceTreeConstruction", declaredAt="C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\instance\\InstanceTree.jrag:1621")
    ...
    public FAccess Define_retrieveFAccess(ASTNode _callerNode, ASTNode _childNode) {
        if (_callerNode == getOriginalInstComponentNoTransform()) {
            // @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\flattening\\FlatteningAccess.jrag:201
    ...
    public InstLookupResult<InstClassDecl> Define_lookupInstClass(ASTNode _callerNode, ASTNode _childNode, String name) {
        if (_callerNode == getClassNameNoTransform()) {
            // @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\instance\\InstLookupClasses.jrag:105
            return getInstComponentRedeclare().lookupInstClass(name);
        }
        else if (_callerNode == getOriginalInstComponentNoTransform()) {
            // @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\instance\\InstLookupClasses.jrag:101
    ...
    public InstLookupResult<InstComponentDecl> Define_lookupInstComponent(ASTNode _callerNode, ASTNode _childNode, String name) {
        if (_callerNode == getOriginalInstComponentNoTransform()) {
            // @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\instance\\InstLookupComponents.jrag:339
