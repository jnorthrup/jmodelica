 ...
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\ast\\FlatModelica.ast:1385
 * @astdecl FBinEventGenExp : FEventGenExp ::= Y:FExp;
 * @production FBinEventGenExp : {@link FEventGenExp} ::= <span class="component">Y:{@link FExp}</span>;

 */
public abstract class FBinEventGenExp extends FEventGenExp implements Cloneable {
    /**
     * @aspect InheritedFactoryMethods
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:901
     */
    public abstract FBinEventGenExp createEmptyNode();
    /**
     * Create new node of same class as this, with the specified children.
     * @aspect InheritedFactoryMethods
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:1150
     */
     ...
     * Create new node of same class as this, with the specified children.
     * @aspect InheritedFactoryMethods
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:1157
     */
    public FBinEventGenExp createNode(FExp x, FExp y) {
     ...
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\flattening\\Flattening.jrag:2553
     */
    public FExp flatten(Flattener f) { return createNode(getX().flatten(f), getY().flatten(f)); }
    /**
     * @aspect Scalarization
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaMiddleEnd\\src\\jastadd\\scalarization\\Scalarization.jrag:1737
     */
    public FExp scalarizeExp(Scalarizer s) { return createNode(getX().scalarize(s),getY().scalarize(s)); }
    /**
     * @declaredat ASTNode:1
     */
    public FBinEventGenExp() {
        super();
    }
    /**
    ...
    public FBinEventGenExp(List<InstFunctionArgument> p0, FExp p1, FExp p2) {
        setChild(p0, 0);
        setChild(p1, 1);
        setChild(p2, 2);
    }
     ...
     */
    public FBinEventGenExp clone() throws CloneNotSupportedException {
        FBinEventGenExp node = (FBinEventGenExp) super.clone();
        return node;
    }
    /**
     ...
     */
    @Deprecated
    public abstract FBinEventGenExp fullCopy();
    /**
     * Create a deep copy of the AST subtree at this node.
     * The copy is dangling, i.e. has no parent.
     * @return dangling copy of the subtree at this node
     ...
     */
    public abstract FBinEventGenExp treeCopyNoTransform();
    /**
     * Create a deep copy of the AST subtree at this node.
     ...
     */
    public abstract FBinEventGenExp treeCopy();
    /**
    ...
    public FType argType() {
        FType argType_value = getX().type().scalarType().numericPromotion(getY().type().scalarType()).sizedType(size());
    ...
    public TypePrefixVariability expVariability() {
        TypePrefixVariability expVariability_value = getX().variability().combine(getY().variability());
