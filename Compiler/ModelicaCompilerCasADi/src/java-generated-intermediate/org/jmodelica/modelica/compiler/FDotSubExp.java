 ...
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\ast\\FlatModelica.ast:796
 * @astdecl FDotSubExp : FArtmBinExp;
 * @production FDotSubExp : {@link FArtmBinExp};

 */
public class FDotSubExp extends FArtmBinExp implements Cloneable {
    /**
     * @aspect InheritedFactoryMethods
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:922
     */
    public FDotSubExp createEmptyNode()    { return new FDotSubExp();    }
    /**
     * @aspect AliasElimination
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaMiddleEnd\\src\\jastadd\\optimizations\\AliasElimination.jrag:155
     */
    ...
    /**
     * @aspect Derivatives
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaMiddleEnd\\src\\jastadd\\structural\\Differentiation.jrag:180
     */
    @Override
    ...
    public FDotSubExp(FExp p0, FExp p1) {
        setChild(p0, 0);
        setChild(p1, 1);
    }
    /** @apilevel low-level 
     ...
     */
    public FDotSubExp clone() throws CloneNotSupportedException {
        FDotSubExp node = (FDotSubExp) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:46
     */
    public FDotSubExp copy() {
        try {
            FDotSubExp node = (FDotSubExp) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    public FDotSubExp treeCopyNoTransform() {
        FDotSubExp tree = (FDotSubExp) copy();
        if (children != null) {
    ...
    public CValue cevalEval(CValue left, CValue right) {
        CValue cevalEval_CValue_CValue_value = type().sub(left, right);
    ...
    public FExp createNegated() {
        FExp createNegated_value = createNodeBinary(getRight().fullCopy(), getLeft().fullCopy());
    ...
    public FExp nominal() {
        FExp nominal_value = FExp.nominalMax(getLeft(), getRight());
    ...
    public String operatorName() {
        String operatorName_value = OP_SUB;
     ...
     * @attribute syn
     * @aspect ExpressionSimplification
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaMiddleEnd\\src\\jastadd\\structural\\Symbolic.jrag:483
     */
    @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
    @ASTNodeAnnotation.Source(aspect="ExpressionSimplification", declaredAt="C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaMiddleEnd\\src\\jastadd\\structural\\Symbolic.jrag:483")
    public FExp convertToAddition() {
        FExp convertToAddition_value = new FDotAddExp(getLeft(), getRight().makeNegated());
        return convertToAddition_value;
    }
    /**
     * @attribute syn
    ...
    public MX toMX() {
        MX toMX_value = getLeft().toMX().__sub__(getRight().toMX());
        return toMX_value;
    }
    /**
    ...
    public int Define_outerCoeff(ASTNode _callerNode, ASTNode _childNode) {
        if (_callerNode == getRightNoTransform()) {
            // @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaMiddleEnd\\src\\jastadd\\optimizations\\LinearEquationElimination.jrag:421
            return - coeff();
        }
        else {
            return getParent().Define_outerCoeff(this, _callerNode);
        }
    }
    /**
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaMiddleEnd\\src\\jastadd\\optimizations\\LinearEquationElimination.jrag:416
    ...
    public boolean Define_isNegativeTerm(ASTNode _callerNode, ASTNode _childNode) {
        if (_callerNode == getRightNoTransform()) {
            // @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaMiddleEnd\\src\\jastadd\\structural\\Symbolic.jrag:292
    ...
    public ASTNode rewriteTo() {
        // Declared at C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaMiddleEnd\\src\\jastadd\\structural\\Symbolic.jrag:502
        if (getLeftNoTransform().isLiteralZero()) {
            return rewriteRule0();
        }
        // Declared at C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaMiddleEnd\\src\\jastadd\\structural\\Symbolic.jrag:503
        if (getRightNoTransform() instanceof FNegExp) {
            return rewriteRule1();
        }
        // Declared at C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaMiddleEnd\\src\\jastadd\\structural\\Symbolic.jrag:504
    ...
    /**
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaMiddleEnd\\src\\jastadd\\structural\\Symbolic.jrag:502
     * @apilevel internal
     */    private FExp rewriteRule0() {
        return getRight().makeNegated();
    }
    /**
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaMiddleEnd\\src\\jastadd\\structural\\Symbolic.jrag:503
     * @apilevel internal
     */    private FExp rewriteRule1() {
        return convertToAddition();
    }
    /**
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaMiddleEnd\\src\\jastadd\\structural\\Symbolic.jrag:504
     * @apilevel internal
