 ...
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\ast\\FlatModelica.ast:525
 * @astdecl FConnPotentialRoot : FConnectionsOp ::= [Priority:FExp];
 * @production FConnPotentialRoot : {@link FConnectionsOp} ::= <span class="component">[Priority:{@link FExp}]</span>;

 */
public class FConnPotentialRoot extends FConnectionsOp implements Cloneable {
    /**
     * @aspect InheritedFactoryMethods
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:1064
     */
    public FConnPotentialRoot createEmptyNode() { return new FConnPotentialRoot(); }
    /**
     * @aspect FlatPrettyPrint
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\PrettyPrint.jrag:1809
     */
     ...
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\flattening\\Connections.jrag:1407
     */
    ...
    @ASTNodeAnnotation.Constructor(
        name = {"OriginalArg", "A", "Priority"},
        type = {"List<InstFunctionArgument>", "FExp", "Opt<FExp>"},
        kind = {"List", "Child", "Opt"}
    )
    public FConnPotentialRoot(List<InstFunctionArgument> p0, FExp p1, Opt<FExp> p2) {
        setChild(p0, 0);
        setChild(p1, 1);
        setChild(p2, 2);
    }
     ...
     */
    public FConnPotentialRoot clone() throws CloneNotSupportedException {
        FConnPotentialRoot node = (FConnPotentialRoot) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:49
     */
    public FConnPotentialRoot copy() {
        try {
            FConnPotentialRoot node = (FConnPotentialRoot) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    @Deprecated
    public FConnPotentialRoot fullCopy() {
     ...
     */
    public FConnPotentialRoot treeCopyNoTransform() {
        FConnPotentialRoot tree = (FConnPotentialRoot) copy();
        if (children != null) {
     ...
     */
    public FConnPotentialRoot treeCopy() {
        doFullTraversal();
        return treeCopyNoTransform();
    }
    /** @apilevel internal 
     ...
     * @apilevel low-level
     */
    public FExp getANoTransform() {
        return (FExp) getChildNoTransform(1);
    }
    /**
     * Replaces the optional node for the Priority child. This is the <code>Opt</code>
     * node containing the child Priority, not the actual child!
     * @param opt The new node to be used as the optional node for the Priority child.
     * @apilevel low-level
     */
    public void setPriorityOpt(Opt<FExp> opt) {
        setChild(opt, 2);
    }
    /**
     * Replaces the (optional) Priority child.
     * @param node The new node to be used as the Priority child.
     * @apilevel high-level
     */
    public void setPriority(FExp node) {
        if (node != null) {
    ...
    /**
     * Check whether the optional Priority child exists.
     * @return {@code true} if the optional Priority child exists, {@code false} if it does not.
     * @apilevel high-level
     */
    public boolean hasPriority() {
        return getPriorityOpt().getNumChild() != 0;
    }
    /**
     * Retrieves the (optional) Priority child.
     * @return The Priority child, if it exists. Returns {@code null} otherwise.
     * @apilevel low-level
     */
    public FExp getPriority() {
        return (FExp) getPriorityOpt().getChild(0);
    }
    /**
     * Retrieves the optional node for the Priority child. This is the <code>Opt</code> node containing the child Priority, not the actual child!
     * @return The optional node for child the Priority child.
     * @apilevel low-level
     */
    @ASTNodeAnnotation.OptChild(name="Priority")
    public Opt<FExp> getPriorityOpt() {
        return (Opt<FExp>) getChild(2);
    }
    /**
     * Retrieves the optional node for child Priority. This is the <code>Opt</code> node containing the child Priority, not the actual child!
     * <p><em>This method does not invoke AST transformations.</em></p>
     * @return The optional node for child Priority.
     * @apilevel low-level
     */
    public Opt<FExp> getPriorityOptNoTransform() {
    ...
    public String builtInName() {
        String builtInName_value = "Connections.potentialRoot";
    ...
    public boolean Define_argumentDefinedTypeValid(ASTNode _callerNode, ASTNode _childNode) {
        if (_callerNode == getOriginalArgListNoTransform()) {
            // @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\errorcheck\\TypeCheck.jrag:1695
