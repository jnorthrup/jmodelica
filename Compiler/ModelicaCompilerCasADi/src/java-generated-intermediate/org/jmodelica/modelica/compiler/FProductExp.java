 ...
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\ast\\FlatModelica.ast:1620
 * @astdecl FProductExp : FReductionExp;
 * @production FProductExp : {@link FReductionExp};

 */
public class FProductExp extends FReductionExp implements Cloneable {
    /**
     * @aspect InheritedFactoryMethods
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:1052
     */
    public FProductExp createEmptyNode()      { return new FProductExp();      }
    /**
     * @aspect FlatPrettyPrint
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\PrettyPrint.jrag:1732
     */
    ...
    /**
     * @aspect Derivatives
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaMiddleEnd\\src\\jastadd\\structural\\Differentiation.jrag:761
     */
    @Override
    ...
    public FProductExp(List<InstFunctionArgument> p0, FExp p1) {
        setChild(p0, 0);
        setChild(p1, 1);
    }
    /** @apilevel low-level 
     ...
     */
    public FProductExp clone() throws CloneNotSupportedException {
        FProductExp node = (FProductExp) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:47
     */
    public FProductExp copy() {
        try {
            FProductExp node = (FProductExp) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    public FProductExp treeCopyNoTransform() {
        FProductExp tree = (FProductExp) copy();
        if (children != null) {
    ...
    public CValue reduceStartValue() {
        CValue reduceStartValue_value = type().createCValue(1);
        return reduceStartValue_value;
    }
    /**
     * @attribute syn
     * @aspect ConstantEvaluation
    ...
    public CValue scalarReduceStartValue() {
        CValue scalarReduceStartValue_value = type().createCValueScalar(1);
    ...
    public CValue reduceOperation(CValue leftValue, CValue rightValue) {
        CValue reduceOperation_CValue_CValue_value = type().mul(leftValue, rightValue);
        return reduceOperation_CValue_CValue_value;
    }
    /**
     * @attribute syn
     * @aspect FlatPrettyPrint
    ...
    public String builtInName() {
        String builtInName_value = "product";
    ...
    public FBinExp scalarReduceExp() {
        FBinExp scalarReduceExp_value = new FMulExp();
        return scalarReduceExp_value;
    }
    /**
     * @attribute syn
    ...
    public FExp scalarReduceExp(FExp reducer, FExp scalar) {
        FExp scalarReduceExp_FExp_FExp_value = new FMulExp(reducer, scalar);
