...
/**
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\ast\\Modelica.ast:123
 * @astdecl SrcBooleanClassDecl : SrcPrimitiveClassDecl;
 * @production SrcBooleanClassDecl : {@link SrcPrimitiveClassDecl};

 */
public class SrcBooleanClassDecl extends SrcPrimitiveClassDecl implements Cloneable {
    /**
     * Create from a SrcFullClassDecl - will destroy that node!
     * @aspect PredefinedTypes
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\source\\PredefinedTypes.jrag:315
     */
    public SrcBooleanClassDecl(SrcFullClassDecl fcd) {
        super(fcd);
    }
    /**
     * @declaredat ASTNode:1
     */
    public SrcBooleanClassDecl() {
        super();
    }
    /**
    ...
    public SrcBooleanClassDecl(SrcIdDecl p0, boolean p1, boolean p2, SrcRestriction p3, boolean p4, boolean p5, boolean p6, boolean p7, boolean p8, Opt<SrcConstrainingClause> p9, Opt<SrcComment> p10, Opt<SrcStringComment> p11, List<SrcClause> p12, Opt<SrcExternalClause> p13, Opt<SrcAnnotation> p14, SrcEndDecl p15) {
        setChild(p0, 0);
        setEncapsulated(p1);
        setPartial(p2);
        setChild(p3, 1);
     ...
     */
    public SrcBooleanClassDecl clone() throws CloneNotSupportedException {
        SrcBooleanClassDecl node = (SrcBooleanClassDecl) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:66
     */
    public SrcBooleanClassDecl copy() {
        try {
            SrcBooleanClassDecl node = (SrcBooleanClassDecl) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    @Deprecated
    public SrcBooleanClassDecl fullCopy() {
     ...
     */
    public SrcBooleanClassDecl treeCopyNoTransform() {
        SrcBooleanClassDecl tree = (SrcBooleanClassDecl) copy();
        if (children != null) {
     ...
     */
    public SrcBooleanClassDecl treeCopy() {
        doFullTraversal();
        return treeCopyNoTransform();
    }
    /** @apilevel internal 
    ...
    protected boolean is$Equal(ASTNode node) {
        return super.is$Equal(node) && (tokenboolean_Encapsulated == ((SrcBooleanClassDecl) node).tokenboolean_Encapsulated) && (tokenboolean_Partial == ((SrcBooleanClassDecl) node).tokenboolean_Partial) && (tokenboolean_Redeclare == ((SrcBooleanClassDecl) node).tokenboolean_Redeclare) && (tokenboolean_Final == ((SrcBooleanClassDecl) node).tokenboolean_Final) && (tokenboolean_Inner == ((SrcBooleanClassDecl) node).tokenboolean_Inner) && (tokenboolean_Outer == ((SrcBooleanClassDecl) node).tokenboolean_Outer) && (tokenboolean_Replaceable == ((SrcBooleanClassDecl) node).tokenboolean_Replaceable);    
    }
    /**
