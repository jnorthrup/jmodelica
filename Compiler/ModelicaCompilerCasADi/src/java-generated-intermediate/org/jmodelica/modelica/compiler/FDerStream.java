 ...
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\ast\\FlatModelica.ast:1646
 * @astdecl FDerStream : FInStream;
 * @production FDerStream : {@link FInStream};

 */
public class FDerStream extends FInStream implements Cloneable {
    /**
     * @aspect InheritedFactoryMethods
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:1056
     */
    public FDerStream createEmptyNode()       { return new FDerStream();       }
    /**
     * @aspect InheritedFactoryMethods
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:1388
     */
    public FDerStream(FExp a1)                { this(emptyArgs(), a1); }
    /**
     * @aspect Connections
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\flattening\\Connections.jrag:88
     */
    ...
    /**
     * @aspect Connections
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\flattening\\Connections.jrag:116
     */
    ...
    public FDerStream(List<InstFunctionArgument> p0, FExp p1) {
        setChild(p0, 0);
        setChild(p1, 1);
    }
    /** @apilevel low-level 
     ...
     */
    public FDerStream clone() throws CloneNotSupportedException {
        FDerStream node = (FDerStream) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:47
     */
    public FDerStream copy() {
        try {
            FDerStream node = (FDerStream) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    public FDerStream treeCopyNoTransform() {
        FDerStream tree = (FDerStream) copy();
        if (children != null) {
    ...
    public String builtInName() {
        String builtInName_value = "derStream";
