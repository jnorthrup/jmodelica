 ...
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\ast\\FlatModelica.ast:791
 * @astdecl FStringAddExp : FDotAddExp;
 * @production FStringAddExp : {@link FDotAddExp};

 */
public class FStringAddExp extends FDotAddExp implements Cloneable {
    /**
     * @aspect InheritedFactoryMethods
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:927
     */
    public FStringAddExp createEmptyNode() { return new FStringAddExp(); }
    /**
     * @aspect CCodeGenExpressions
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaCBackEnd\\src\\jastadd\\CCodeGen\\CCodeGenExpressions.jrag:825
     */
    @Override
    ...
    /**
     * @aspect CCodeGenExpressions
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaCBackEnd\\src\\jastadd\\CCodeGen\\CCodeGenExpressions.jrag:831
     */
    @Override
    ...
    /**
     * @aspect CCodeGenExpressions
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaCBackEnd\\src\\jastadd\\CCodeGen\\CCodeGenExpressions.jrag:837
     */
    @Override
    ...
    /**
     * @aspect CCodeGenExpressions
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaCBackEnd\\src\\jastadd\\CCodeGen\\CCodeGenExpressions.jrag:842
     */
    @Override
    ...
    /**
     * @aspect CCodeGenExpressions
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaCBackEnd\\src\\jastadd\\CCodeGen\\CCodeGenExpressions.jrag:847
     */
    @Override
    ...
    /**
     * @aspect CCodeGenExpressions
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaCBackEnd\\src\\jastadd\\CCodeGen\\CCodeGenExpressions.jrag:853
     */
    @Override
    ...
    public FStringAddExp(FExp p0, FExp p1) {
        setChild(p0, 0);
        setChild(p1, 1);
    }
    /** @apilevel low-level 
     ...
     */
    public FStringAddExp clone() throws CloneNotSupportedException {
        FStringAddExp node = (FStringAddExp) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:47
     */
    public FStringAddExp copy() {
        try {
            FStringAddExp node = (FStringAddExp) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    public FStringAddExp treeCopyNoTransform() {
        FStringAddExp tree = (FStringAddExp) copy();
        if (children != null) {
    ...
    public boolean isKnownStringLength() {
        boolean isKnownStringLength_value = getLeft().isKnownStringLength() && getRight().isKnownStringLength();
        return isKnownStringLength_value;
    }
    /** @apilevel internal */
    private void maxStringLength_C_reset() {
        maxStringLength_C_computed = false;
    }
    /** @apilevel internal */
    protected boolean maxStringLength_C_computed = false;

    /** @apilevel internal */
    protected int maxStringLength_C_value;

    /**
     * @attribute syn
     * @aspect CCodeGenExpressions
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaCBackEnd\\src\\jastadd\\CCodeGen\\CCodeGenExpressions.jrag:1077
     */
    @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
    @ASTNodeAnnotation.Source(aspect="CCodeGenExpressions", declaredAt="C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaCBackEnd\\src\\jastadd\\CCodeGen\\CCodeGenExpressions.jrag:1077")
    public int maxStringLength_C() {
        ASTState state = state();
        if (maxStringLength_C_computed) {
            return maxStringLength_C_value;
        }
        int _boundaries = state.boundariesCrossed;
        boolean isFinal = this.is$Final();
        state().enterLazyAttribute();
        maxStringLength_C_value = Math.min(getLeft().maxStringLength_C() + getRight().maxStringLength_C(), MAX_STRING_LENGTH_C);
        if (isFinal && _boundaries == state().boundariesCrossed) {
        maxStringLength_C_computed = true;
