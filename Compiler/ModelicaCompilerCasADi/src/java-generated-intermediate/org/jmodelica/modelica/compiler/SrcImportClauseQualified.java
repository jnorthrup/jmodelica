...
/**
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\ast\\Modelica.ast:170
 * @astdecl SrcImportClauseQualified : SrcImportClause;
 * @production SrcImportClauseQualified : {@link SrcImportClause};

 */
public class SrcImportClauseQualified extends SrcImportClause implements Cloneable {
    /**
     * @aspect InstImportClauses
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\instance\\InstanceTree.jrag:1920
     */
     ...
     */
    public SrcImportClauseQualified() {
        super();
    }
    /**
    ...
    public SrcImportClauseQualified(SrcAccess p0, SrcComment p1) {
        setChild(p0, 0);
        setChild(p1, 1);
    }
    /** @apilevel low-level 
     ...
     */
    public SrcImportClauseQualified clone() throws CloneNotSupportedException {
        SrcImportClauseQualified node = (SrcImportClauseQualified) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:46
     */
    public SrcImportClauseQualified copy() {
        try {
            SrcImportClauseQualified node = (SrcImportClauseQualified) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    @Deprecated
    public SrcImportClauseQualified fullCopy() {
     ...
     */
    public SrcImportClauseQualified treeCopyNoTransform() {
        SrcImportClauseQualified tree = (SrcImportClauseQualified) copy();
        if (children != null) {
     ...
     */
    public SrcImportClauseQualified treeCopy() {
        doFullTraversal();
        return treeCopyNoTransform();
    }
    /** @apilevel internal 
    ...
    public boolean matches(String str) {
        boolean matches_String_value = getPackageName().getLastAccess().matches(str);
