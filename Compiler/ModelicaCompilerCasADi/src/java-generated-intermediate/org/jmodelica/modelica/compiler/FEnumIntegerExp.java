 ...
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\ast\\FlatModelica.ast:1375
 * @astdecl FEnumIntegerExp : FVectUnaryBuiltIn;
 * @production FEnumIntegerExp : {@link FVectUnaryBuiltIn};

 */
public class FEnumIntegerExp extends FVectUnaryBuiltIn implements Cloneable {
    /**
     * @aspect InheritedFactoryMethods
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:1028
     */
    public FEnumIntegerExp createEmptyNode()  { return new FEnumIntegerExp();  }
    /**
     * @aspect InheritedFactoryMethods
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:1392
     */
    public FEnumIntegerExp(FExp a1)      { this(emptyArgs(), a1); }
    /**
     * @aspect FlatTypeCheck
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\errorcheck\\TypeCheck.jrag:1275
     */
     ...
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaCBackEnd\\src\\jastadd\\CCodeGen\\CCodeGenExpressions.jrag:114
     */
    @Override
    ...
    public FEnumIntegerExp(List<InstFunctionArgument> p0, FExp p1) {
        setChild(p0, 0);
        setChild(p1, 1);
    }
    /** @apilevel low-level 
     ...
     */
    public FEnumIntegerExp clone() throws CloneNotSupportedException {
        FEnumIntegerExp node = (FEnumIntegerExp) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:48
     */
    public FEnumIntegerExp copy() {
        try {
            FEnumIntegerExp node = (FEnumIntegerExp) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    @Deprecated
    public FEnumIntegerExp fullCopy() {
     ...
     */
    public FEnumIntegerExp treeCopyNoTransform() {
        FEnumIntegerExp tree = (FEnumIntegerExp) copy();
        if (children != null) {
     ...
     */
    public FEnumIntegerExp treeCopy() {
        doFullTraversal();
        return treeCopyNoTransform();
    }
    /** @apilevel internal 
    ...
    public CValue cevalCalc(VariableEvaluator evaluator) {
        CValue cevalCalc_VariableEvaluator_value = getFExp().ceval(evaluator).convertInteger();
    ...
    public String builtInName() {
        String builtInName_value = "Integer";
    ...
    public FType type() {
        ...
        type_value = getFExp().type().isEnumScalar() ? fIntegerScalarType() : fUnknownType();
    ...
    public boolean Define_argumentDefinedTypeValid(ASTNode _callerNode, ASTNode _childNode) {
        if (_callerNode == getOriginalArgListNoTransform()) {
            // @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\errorcheck\\TypeCheck.jrag:1686
