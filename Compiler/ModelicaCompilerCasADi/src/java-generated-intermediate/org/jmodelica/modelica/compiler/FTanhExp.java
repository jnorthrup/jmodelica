 ...
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\ast\\FlatModelica.ast:1470
 * @astdecl FTanhExp : FMathematicalFunctionCall;
 * @production FTanhExp : {@link FMathematicalFunctionCall};

 */
public class FTanhExp extends FMathematicalFunctionCall implements Cloneable {
    /**
     * @aspect InheritedFactoryMethods
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:1017
     */
    public FTanhExp createEmptyNode()  { return new FTanhExp();  }
    /**
     * @aspect Derivatives
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaMiddleEnd\\src\\jastadd\\structural\\Differentiation.jrag:363
     */
    @Override
    ...
    public FTanhExp(List<InstFunctionArgument> p0, FExp p1) {
        setChild(p0, 0);
        setChild(p1, 1);
    }
    /** @apilevel low-level 
     ...
     */
    public FTanhExp clone() throws CloneNotSupportedException {
        FTanhExp node = (FTanhExp) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:47
     */
    public FTanhExp copy() {
        try {
            FTanhExp node = (FTanhExp) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    public FTanhExp treeCopyNoTransform() {
        FTanhExp tree = (FTanhExp) copy();
        if (children != null) {
    ...
    public CValue cevalCalc(VariableEvaluator evaluator) {
        CValue cevalCalc_VariableEvaluator_value = new CValueReal(StrictMath.tanh(getFExp().ceval(evaluator).realValue()));
    ...
    public MX toMX() {
        MX toMX_value = getFExp().toMX().tanh();
        return toMX_value;
    }
    /** @apilevel internal */
