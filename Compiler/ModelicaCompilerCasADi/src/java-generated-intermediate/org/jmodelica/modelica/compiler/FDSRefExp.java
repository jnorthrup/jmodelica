 ...
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\ast\\FlatModelica.ast:1025
 * @astdecl FDSRefExp : FVarRefExp ::= <SetId:int> Use:FAccessExp* Org:FAccessExp;
 * @production FDSRefExp : {@link FVarRefExp} ::= <span class="component">&lt;SetId:int&gt;</span> <span class="component">Use:{@link FAccessExp}*</span> <span class="component">Org:{@link FAccessExp}</span>;

 */
public class FDSRefExp extends FVarRefExp implements Cloneable {
    /**
     * @aspect InheritedFactoryMethods
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:982
     */
    public FDSRefExp createEmptyNode()      { return new FDSRefExp();      }
    /**
     * @aspect FlatPrettyPrint
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\PrettyPrint.jrag:1716
     */
    ...
    /**
     * @aspect Derivatives
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaMiddleEnd\\src\\jastadd\\structural\\Differentiation.jrag:458
     */
    @Override
     ...
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaMiddleEnd\\src\\jastadd\\structural\\DynamicStates.jrag:121
     */
    @Override
     ...
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaCBackEnd\\src\\jastadd\\CCodeGen\\CCodeGenExpressions.jrag:643
     */
    @Override
    ...
    public FDSRefExp(int p0, FAccessExp p1) {
        setSetId(p0);
        setChild(p1, 0);
    }
    /** @apilevel low-level 
     ...
     * @apilevel high-level
     */
    public void setOrg(FAccessExp node) {
        setChild(node, 0);
    }
    /**
     ...
     * @apilevel low-level
     */
    public FAccessExp getOrgNoTransform() {
     ...
     * @apilevel high-level
     */
    public FAccessExp getUse(int i) {
        return (FAccessExp) getUseList().getChild(i);
    }
    /**
     ...
     * @apilevel high-level
     */
    public void addUse(FAccessExp node) {
        List<FAccessExp> list = (parent == null) ? getUseListNoTransform() : getUseList();
        if (list == List.EMPTY) {
    ...
    /** @apilevel low-level 
     */
    public void addUseNoTransform(FAccessExp node) {
        List<FAccessExp> list = getUseListNoTransform();
        if (list == List.EMPTY) {
            setChild(new List(node), 2);
        } else {
            list.addChild(node);
     ...
     * @apilevel high-level
     */
    public void setUse(FAccessExp node, int i) {
        List<FAccessExp> list = getUseList();
        if (list == List.EMPTY) {
            setChild(new List(node), 2);
        } else {
     ...
     * @apilevel low-level
     */
    public List<FAccessExp> getUseListNoTransform() {
        return (List<FAccessExp>) getChildNoTransform(2);
    }
    /**
     * @return the element at index {@code i} in the Use list without
     * triggering rewrites.
     */
    public FAccessExp getUseNoTransform(int i) {
        return (FAccessExp) getUseListNoTransform().getChildNoTransform(i);
    }
    /**
     * Retrieves the Use list.
     * @return The node representing the Use list.
     * @apilevel high-level
     */
    public List<FAccessExp> getUses() {
        return getUseList();
    }
    /**
     * Retrieves the Use list.
     ...
     * @apilevel low-level
     */
    public List<FAccessExp> getUsesNoTransform() {
     ...
     * @attribute syn
     * @aspect DynamicStateSelect
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaMiddleEnd\\src\\jastadd\\structural\\DynamicStates.jrag:110
     */
    @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
    @ASTNodeAnnotation.Source(aspect="DynamicStateSelect", declaredAt="C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaMiddleEnd\\src\\jastadd\\structural\\DynamicStates.jrag:110")
    ...
    /** @apilevel internal */
    protected List<FAccessExp> getUseList_value;

    /**
     * @attribute syn nta
     * @aspect DynamicStateSelect
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaMiddleEnd\\src\\jastadd\\structural\\DynamicStates.jrag:113
     */
    @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN, isNTA=true)
    @ASTNodeAnnotation.Source(aspect="DynamicStateSelect", declaredAt="C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaMiddleEnd\\src\\jastadd\\structural\\DynamicStates.jrag:113")
    public List<FAccessExp> getUseList() {
        ASTState state = state();
        if (getUseList_computed) {
            return (List<FAccessExp>) getChild(getUseListChildPosition());
        }
        int _boundaries = state.boundariesCrossed;
        boolean isFinal = this.is$Final();
        state().enterLazyAttribute();
        ...
        state().leaveLazyAttribute();
        List<FAccessExp> node = (List<FAccessExp>) this.getChild(getUseListChildPosition());
        return node;
    }
    /** @apilevel internal */
    private List<FAccessExp> getUseList_compute() {
