 ...
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\ast\\FlatModelica.ast:322
 * @astdecl FStringType : FPrimitiveType;
...
public class FStringType extends FPrimitiveType implements Cloneable {
     ...
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\ConstantEvaluation\\ConstantEvaluation.jrag:1742
     */
    public CValue zeroCValueScalar()  { return new CValueString(""); }
    /**
     * @aspect ConstantEvaluation
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\ConstantEvaluation\\ConstantEvaluation.jrag:1762
     */
    public CValue convert(CValue v)  { return v.convertString(); }
    /**
     * @aspect ExternalProcessCommunication
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\ConstantEvaluation\\ExternalConstantEvaluation.jrag:340
     */
     ...
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\FlatUtil.jrag:1746
     */
     ...
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\TypeAnalysis.jrag:1219
     */
    public static final FStringType SCALAR                 = new FStringType(Size.SCALAR);
    /**
     * @aspect BuiltInFlatTypes
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\TypeAnalysis.jrag:1419
     */
    public FExp zeroLiteral()  { return new FStringLitExp(""); }
    /**
     * @aspect ContentCheck
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\errorcheck\\ContentsCheck.jadd:770
     */
     ...
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaCBackEnd\\src\\jastadd\\CCodeGen\\CCodeGenAlgorithms.jrag:42
     */
    @Override
    ...
    /**
     * @aspect CCodeGenAlgorithms
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaCBackEnd\\src\\jastadd\\CCodeGen\\CCodeGenAlgorithms.jrag:525
     */
    @Override
     ...
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaCBackEnd\\src\\jastadd\\CCodeGen\\CCodeGenTypes.jrag:539
     */
    @Override
    ...
    public FClass.ZType genType() {
        FClass.ZType genType_value = FClass.ZType.STRING;
    ...
    public boolean typeCompatible(CommonType type, boolean allowUnknown) {
        boolean typeCompatible_CommonType_boolean_value = type.isString() && dimensionCompatible(type, allowUnknown);
    ...
    public boolean equivalentTo(CommonType type, boolean allowUnknown) {
        boolean equivalentTo_CommonType_boolean_value = type.isString() && dimensionCompatible(type, allowUnknown);
    ...
    public boolean isType(FType type) {
        boolean isType_FType_value = type.isString();
    ...
    public String nameScalar_C(CodePrinter p) {
        String nameScalar_C_CodePrinter_value = "jmi_string_t";
    ...
    public String nameArray_C(CodePrinter p) {
        String nameArray_C_CodePrinter_value = "jmi_string_array_t";
    ...
    public String argType_C(CodePrinter p, boolean ref) {
        String argType_C_CodePrinter_boolean_value = "const " + super.argType_C(p, ref);
    ...
    public String argTypeBase_C(CodePrinter p) {
        String argTypeBase_C_CodePrinter_value = "char*";
