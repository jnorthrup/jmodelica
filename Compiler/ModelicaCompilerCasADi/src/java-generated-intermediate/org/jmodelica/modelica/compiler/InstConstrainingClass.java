...
/**
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\ast\\InstanceTree.ast:94
 * @astdecl InstConstrainingClass : InstConstraining ::= <SrcBaseClassDecl:SrcBaseClassDecl> <InstRedeclare:InstRedeclareClassNode>;
 * @production InstConstrainingClass : {@link InstConstraining} ::= <span class="component">&lt;SrcBaseClassDecl:SrcBaseClassDecl&gt;</span> <span class="component">&lt;InstRedeclare:InstRedeclareClassNode&gt;</span>;
...
public class InstConstrainingClass extends InstConstraining implements Cloneable {
    ...
    @ASTNodeAnnotation.Constructor(
        name = {"ClassName", "InstClassModification", "SrcBaseClassDecl", "InstRedeclare"},
        type = {"InstAccess", "Opt<InstClassModification>", "SrcBaseClassDecl", "InstRedeclareClassNode"},
        kind = {"Child", "Opt", "Token", "Token"}
    )
    public InstConstrainingClass(InstAccess p0, Opt<InstClassModification> p1, SrcBaseClassDecl p2, InstRedeclareClassNode p3) {
        setChild(p0, 0);
        setChild(p1, 1);
        setSrcBaseClassDecl(p2);
        setInstRedeclare(p3);
    }
    /** @apilevel low-level 
    ...
    protected boolean is$Equal(ASTNode node) {
        return super.is$Equal(node) && (tokenSrcBaseClassDecl_SrcBaseClassDecl == ((InstConstrainingClass) node).tokenSrcBaseClassDecl_SrcBaseClassDecl) && (tokenInstRedeclareClassNode_InstRedeclare == ((InstConstrainingClass) node).tokenInstRedeclareClassNode_InstRedeclare);    
    }
    /**
    ...
    /**
     * Replaces the lexeme SrcBaseClassDecl.
     * @param value The new value for the lexeme SrcBaseClassDecl.
     * @apilevel high-level
     */
    public void setSrcBaseClassDecl(SrcBaseClassDecl value) {
        tokenSrcBaseClassDecl_SrcBaseClassDecl = value;
    }
    /** @apilevel internal 
     */
    protected SrcBaseClassDecl tokenSrcBaseClassDecl_SrcBaseClassDecl;
    /**
     * Retrieves the value for the lexeme SrcBaseClassDecl.
     * @return The value for the lexeme SrcBaseClassDecl.
     * @apilevel high-level
     */
    @ASTNodeAnnotation.Token(name="SrcBaseClassDecl")
    public SrcBaseClassDecl getSrcBaseClassDecl() {
        return tokenSrcBaseClassDecl_SrcBaseClassDecl;
    }
    /**
    ...
    public SrcConstrainingClause getSrcConstrainingClause() {
        ...
        getSrcConstrainingClause_value = getSrcBaseClassDecl().getSrcConstrainingClause();
    ...
    public InstLookupResult<InstClassDecl> Define_lookupInstClass(ASTNode _callerNode, ASTNode _childNode, String name) {
        if (_callerNode == getInstNodeNoTransform()) {
            // @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\instance\\InstLookupClasses.jrag:113
    ...
    public InstLookupResult<InstComponentDecl> Define_lookupInstComponentInInstElement(ASTNode _callerNode, ASTNode _childNode, String name) {
        if (_callerNode == getInstClassModificationOptNoTransform()) {
            // @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\instance\\InstLookupComponents.jrag:753
