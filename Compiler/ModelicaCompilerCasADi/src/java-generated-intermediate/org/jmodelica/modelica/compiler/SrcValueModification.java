...
/**
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\ast\\Modelica.ast:219
 * @astdecl SrcValueModification : SrcModification ::= SrcExp;
 * @production SrcValueModification : {@link SrcModification} ::= <span class="component">{@link SrcExp}</span>;

 */
public class SrcValueModification extends SrcModification implements Cloneable {
    /**
     * @aspect PrettyPrint
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\PrettyPrint.jrag:659
     */
     ...
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\instance\\InstanceTree.jrag:245
     */
    public InstValueModification newInstModification() {
        return new InstValueModification(this);
    }
    /**
     * @aspect SrcAnnotations
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\util\\SrcAnnotations.jrag:284
     */
    @Override
    ...
    /**
     * @aspect SrcAnnotations
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\util\\SrcAnnotations.jrag:319
     */
    ...
    public SrcValueModification(SrcExp p0) {
        setChild(p0, 0);
    }
    /** @apilevel low-level 
     ...
     */
    public SrcValueModification clone() throws CloneNotSupportedException {
        SrcValueModification node = (SrcValueModification) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:46
     */
    public SrcValueModification copy() {
        try {
            SrcValueModification node = (SrcValueModification) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    @Deprecated
    public SrcValueModification fullCopy() {
     ...
     */
    public SrcValueModification treeCopyNoTransform() {
        SrcValueModification tree = (SrcValueModification) copy();
        if (children != null) {
     ...
     */
    public SrcValueModification treeCopy() {
        doFullTraversal();
        return treeCopyNoTransform();
    }
    /** @apilevel internal 
    ...
    public SrcExp getSrcExpNoTransform() {
        return (SrcExp) getChildNoTransform(0);
    }
    /**
     * @attribute syn
     * @aspect InstaceConstrainingClauses
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\instance\\InstanceTree.jrag:1871
     */
    @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
    @ASTNodeAnnotation.Source(aspect="InstaceConstrainingClauses", declaredAt="C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\instance\\InstanceTree.jrag:1871")
    public FExp instantiateExp() {
        FExp instantiateExp_value = getSrcExp().instantiate();
        return instantiateExp_value;
    }
    /** @apilevel internal */
    ...
    public AnnotationNode annotationNode(InstContext instContext) {
        ...
        AnnotationNode annotationNode_InstContext_value = new ValueModAnnotationNode    (this, instContext);
    ...
    public SrcExp annotationValue() {
        SrcExp annotationValue_value = getSrcExp();
    ...
    public ResolvedAccess Define_simpleLookupHelper(ASTNode _callerNode, ASTNode _childNode, String name) {
        if (_callerNode == getSrcExpNoTransform()) {
            // @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\source\\SimpleLookup.jrag:288
