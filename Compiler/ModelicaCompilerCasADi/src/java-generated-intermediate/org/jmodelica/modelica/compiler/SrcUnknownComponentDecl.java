...
/**
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\ast\\Modelica.ast:195
 * @astdecl SrcUnknownComponentDecl : SrcComponentDecl;
 * @production SrcUnknownComponentDecl : {@link SrcComponentDecl};

 */
public class SrcUnknownComponentDecl extends SrcComponentDecl implements Cloneable {
    /**
     * @declaredat ASTNode:1
     */
    public SrcUnknownComponentDecl() {
        super();
    }
    /**
    ...
    public SrcUnknownComponentDecl(SrcIdDecl p0, Opt<SrcArraySubscripts> p1, Opt<SrcModification> p2, Opt<SrcConditionalAttribute> p3, SrcComment p4) {
        setChild(p0, 0);
        setChild(p1, 1);
        setChild(p2, 2);
        setChild(p3, 3);
     ...
     */
    public SrcUnknownComponentDecl clone() throws CloneNotSupportedException {
        SrcUnknownComponentDecl node = (SrcUnknownComponentDecl) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:52
     */
    public SrcUnknownComponentDecl copy() {
        try {
            SrcUnknownComponentDecl node = (SrcUnknownComponentDecl) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    @Deprecated
    public SrcUnknownComponentDecl fullCopy() {
     ...
     */
    public SrcUnknownComponentDecl treeCopyNoTransform() {
        SrcUnknownComponentDecl tree = (SrcUnknownComponentDecl) copy();
        if (children != null) {
     ...
     */
    public SrcUnknownComponentDecl treeCopy() {
        doFullTraversal();
        return treeCopyNoTransform();
    }
    /** @apilevel internal 
    ...
    public SrcUnknownComponentDecl unknownComponentDecl() {
        SrcUnknownComponentDecl unknownComponentDecl_value = this;
