 ...
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\ast\\FlatModelica.ast:1550
 * @astdecl FDiagonal : FAbstractDiagonal;
 * @production FDiagonal : {@link FAbstractDiagonal};

 */
public class FDiagonal extends FAbstractDiagonal implements Cloneable {
    /**
     * @aspect InheritedFactoryMethods
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:1045
     */
    public FDiagonal createEmptyNode()        { return new FDiagonal();        }
    /**
     * @aspect Derivatives
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaMiddleEnd\\src\\jastadd\\structural\\Differentiation.jrag:746
     */
    @Override
    ...
    public FDiagonal(List<InstFunctionArgument> p0, FExp p1) {
        setChild(p0, 0);
        setChild(p1, 1);
    }
    /** @apilevel low-level 
     ...
     */
    public FDiagonal clone() throws CloneNotSupportedException {
        FDiagonal node = (FDiagonal) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:50
     */
    public FDiagonal copy() {
        try {
            FDiagonal node = (FDiagonal) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    public FDiagonal treeCopyNoTransform() {
        FDiagonal tree = (FDiagonal) copy();
        if (children != null) {
    ...
    public String builtInName() {
        String builtInName_value = "diagonal";
    ...
    public FExp scalarizeDiagonalElement(Scalarizer s) {
        FExp scalarizeDiagonalElement_Scalarizer_value = getFExp().scalarize(s);
