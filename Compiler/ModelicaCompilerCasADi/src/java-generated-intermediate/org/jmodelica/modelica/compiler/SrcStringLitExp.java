...
/**
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\ast\\Modelica.ast:289
 * @astdecl SrcStringLitExp : SrcExp ::= <STRING:String>;
 * @production SrcStringLitExp : {@link SrcExp} ::= <span class="component">&lt;STRING:String&gt;</span>;

 */
public class SrcStringLitExp extends SrcExp implements Cloneable {
    /**
     * @aspect PrettyPrint
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\PrettyPrint.jrag:877
     */
    ...
    /**
     * @aspect Flattening
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\flattening\\Flattening.jrag:1484
     */
    @Override
     ...
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\flattening\\Flattening.jrag:3282
     */
    ...
    public SrcStringLitExp(String p0) {
        setSTRING(p0);
    }
    /**
     * @declaredat ASTNode:20
     */
    public SrcStringLitExp(beaver.Symbol p0) {
        setSTRING(p0);
    }
    /** @apilevel low-level 
     ...
     */
    public SrcStringLitExp clone() throws CloneNotSupportedException {
        SrcStringLitExp node = (SrcStringLitExp) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:47
     */
    public SrcStringLitExp copy() {
        try {
            SrcStringLitExp node = (SrcStringLitExp) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    @Deprecated
    public SrcStringLitExp fullCopy() {
     ...
     */
    public SrcStringLitExp treeCopyNoTransform() {
        SrcStringLitExp tree = (SrcStringLitExp) copy();
        if (children != null) {
     ...
     */
    public SrcStringLitExp treeCopy() {
        doFullTraversal();
        return treeCopyNoTransform();
    }
    /** @apilevel internal 
    ...
    protected boolean is$Equal(ASTNode node) {
        return super.is$Equal(node) && (tokenString_STRING == ((SrcStringLitExp) node).tokenString_STRING);    
    }
    /**
    ...
    public CValue ceval() {
        CValue ceval_value = new CValueString(unEscape());
        return ceval_value;
    }
    /**
     * @attribute syn
    ...
    public String avalueString() {
        String avalueString_value = unEscape();
     ...
     * @attribute syn
     * @aspect Strings
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\util\\Util.jrag:1731
     */
    @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
    @ASTNodeAnnotation.Source(aspect="Strings", declaredAt="C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\util\\Util.jrag:1731")
