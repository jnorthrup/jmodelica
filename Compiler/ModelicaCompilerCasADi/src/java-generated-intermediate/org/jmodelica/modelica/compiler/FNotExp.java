 ...
 * Not expression.
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\ast\\FlatModelica.ast:886
 * @astdecl FNotExp : FUnaryExp;
 * @production FNotExp : {@link FUnaryExp};

 */
public class FNotExp extends FUnaryExp implements Cloneable {
    /**
     * @aspect InheritedFactoryMethods
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:936
     */
    public FNotExp createEmptyNode() { return new FNotExp(); }
    /**
     * @aspect FlatPrettyPrint
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\PrettyPrint.jrag:1615
     */
     ...
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaCBackEnd\\src\\jastadd\\CCodeGen\\CCodeGenExpressions.jrag:289
     */
    @Override
    ...
    /**
     * @aspect CCodeGenExpressions
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaCBackEnd\\src\\jastadd\\CCodeGen\\CCodeGenExpressions.jrag:1199
     */
    public static String macro_C = "LOG_EXP_NOT";
    /**
     ...
     */
    public FNotExp clone() throws CloneNotSupportedException {
        FNotExp node = (FNotExp) super.clone();
        return node;
    }
    /** @apilevel internal 
     ...
     */
    public FNotExp treeCopyNoTransform() {
        FNotExp tree = (FNotExp) copy();
        if (children != null) {
    ...
    public CValue cevalEval(CValue val) {
        CValue cevalEval_CValue_value = type().not(val);
    ...
    public Precedence precedence() {
        Precedence precedence_value = Precedence.UNARY;
    ...
    public FType type() {
        ...
        type_value = shouldUseOverloadedOperator() ? 
    ...
    public String operatorName() {
        String operatorName_value = OP_NOT;
