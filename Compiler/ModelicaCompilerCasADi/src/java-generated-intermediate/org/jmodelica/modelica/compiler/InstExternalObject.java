...
/**
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\ast\\InstanceTree.ast:116
 * @astdecl InstExternalObject : InstAssignable ::= DestructorCall:FFunctionCallStmt;
 * @production InstExternalObject : {@link InstAssignable} ::= <span class="component">DestructorCall:{@link FFunctionCallStmt}</span>;

 */
public class InstExternalObject extends InstAssignable implements Cloneable {
    /**
     * @aspect ForceVariability
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\errorcheck\\ContentsCheck.jadd:907
     */
    public void forceVariability(ErrorCheckType checkType, TypePrefixVariability v) {}
    /**
     * @aspect InstanceErrorCheck
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\errorcheck\\ErrorCheck.jrag:1239
     */
    ...
    /**
     * @aspect Flattening
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\flattening\\Flattening.jrag:399
     */
    ...
    /**
     * @aspect Flattening
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\flattening\\Flattening.jrag:1335
     */
    ...
    /**
     * @aspect Flattening
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\flattening\\Flattening.jrag:1559
     */
    ...
    public InstExternalObject(String p0, InstAccess p1, Opt<FArraySubscripts> p2, SrcComponentDecl p3, Opt<InstModification> p4, Opt<InstConstrainingComponent> p5, Opt<FExp> p6) {
        setName(p0);
        setChild(p1, 0);
        setChild(p2, 1);
     ...
     */
    public InstExternalObject(beaver.Symbol p0, InstAccess p1, Opt<FArraySubscripts> p2, SrcComponentDecl p3, Opt<InstModification> p4, Opt<InstConstrainingComponent> p5, Opt<FExp> p6) {
        setName(p0);
        setChild(p1, 0);
        setChild(p2, 1);
        setSrcComponentDecl(p3);
     ...
     */
    public InstExternalObject clone() throws CloneNotSupportedException {
        InstExternalObject node = (InstExternalObject) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:77
     */
    public InstExternalObject copy() {
        try {
            InstExternalObject node = (InstExternalObject) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    @Deprecated
    public InstExternalObject fullCopy() {
     ...
     */
    public InstExternalObject treeCopyNoTransform() {
        InstExternalObject tree = (InstExternalObject) copy();
        if (children != null) {
     ...
     */
    public InstExternalObject treeCopy() {
        doFullTraversal();
        return treeCopyNoTransform();
    }
    /** @apilevel internal 
    ...
    protected boolean is$Equal(ASTNode node) {
        return super.is$Equal(node) && (tokenString_Name == ((InstExternalObject) node).tokenString_Name) && (tokenSrcComponentDecl_SrcComponentDecl == ((InstExternalObject) node).tokenSrcComponentDecl_SrcComponentDecl);    
    }
    /**
    ...
    public FFunctionCallStmt getDestructorCallNoTransform() {
        return (FFunctionCallStmt) getChildNoTransform(16);
    }
    /**
    ...
    public CValue cevalNoBExp(VariableEvaluator evaluator, Index i) {
        CValue cevalNoBExp_VariableEvaluator_Index_value = CValue.UNKNOWN;
        return cevalNoBExp_VariableEvaluator_Index_value;
    }
    /**
     * Extract constructor function for external object class.
     * @attribute syn
     * @aspect InstFunctionBinding
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\instance\\InstFunctionBinding.jrag:937
     */
    @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
    @ASTNodeAnnotation.Source(aspect="InstFunctionBinding", declaredAt="C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\instance\\InstFunctionBinding.jrag:937")
    public InstClassDecl myConstructor() {
        InstClassDecl myConstructor_value = myInstClass().myConstructor();
     ...
     * @attribute syn
     * @aspect InstFunctionBinding
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\instance\\InstFunctionBinding.jrag:947
     */
    @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
    @ASTNodeAnnotation.Source(aspect="InstFunctionBinding", declaredAt="C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\instance\\InstFunctionBinding.jrag:947")
    public InstClassDecl myDestructor() {
        InstClassDecl myDestructor_value = myInstClass().myDestructor();
    ...
    public FType primitiveScalarType() {
        FType primitiveScalarType_value = myInstClass().enumType();
     ...
     * @attribute syn
     * @aspect InstTypeAnalysis
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\instance\\InstTypeAnalysis.jrag:73
     */
    @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN, isNTA=true)
    @ASTNodeAnnotation.Source(aspect="InstTypeAnalysis", declaredAt="C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\instance\\InstTypeAnalysis.jrag:73")
    ...
    /** @apilevel internal */
    private void getDestructorCall_reset() {
        getDestructorCall_computed = false;
        
        getDestructorCall_value = null;
    }
    /** @apilevel internal */
    protected boolean getDestructorCall_computed = false;

    /** @apilevel internal */
    protected FFunctionCallStmt getDestructorCall_value;

    /**
     * @attribute syn nta
     * @aspect InstanceTreeConstruction
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\instance\\InstanceTree.jrag:1650
     */
    @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN, isNTA=true)
    @ASTNodeAnnotation.Source(aspect="InstanceTreeConstruction", declaredAt="C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\instance\\InstanceTree.jrag:1650")
    public FFunctionCallStmt getDestructorCall() {
        ASTState state = state();
        if (getDestructorCall_computed) {
            return (FFunctionCallStmt) getChild(getDestructorCallChildPosition());
        }
        int _boundaries = state.boundariesCrossed;
        boolean isFinal = this.is$Final();
        state().enterLazyAttribute();
        getDestructorCall_value = getDestructorCall_compute();
        setChild(getDestructorCall_value, getDestructorCallChildPosition());
        if (isFinal && _boundaries == state().boundariesCrossed) {
        getDestructorCall_computed = true;
    ...
    public String subType(InstNode t, String name, boolean top) {
        String subType_InstNode_String_boolean_value = compareTypes(t, this, name, t.isExternalObject(), true,  top);
    ...
    public InstLookupResult<InstClassDecl> Define_lookupInstClass(ASTNode _callerNode, ASTNode _childNode, String name) {
        if (_callerNode == getDestructorCallNoTransform()) {
            // @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\instance\\InstLookupClasses.jrag:51
    ...
    public InstLookupResult<InstComponentDecl> Define_lookupInstComponent(ASTNode _callerNode, ASTNode _childNode, String name) {
        if (_callerNode == getDestructorCallNoTransform()) {
            // @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\instance\\InstLookupComponents.jrag:346
