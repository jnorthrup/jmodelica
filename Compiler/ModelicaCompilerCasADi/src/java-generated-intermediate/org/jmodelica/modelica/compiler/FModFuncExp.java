 ...
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\ast\\FlatModelica.ast:1395
 * @astdecl FModFuncExp : FBinEventGenExp;
 * @production FModFuncExp : {@link FBinEventGenExp};

 */
public class FModFuncExp extends FBinEventGenExp implements Cloneable {
    /**
     * @aspect InheritedFactoryMethods
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:1031
     */
    public FModFuncExp createEmptyNode()      { return new FModFuncExp();      }
    /**
     * @aspect FlatExpressions
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\flattening\\Flattening.jrag:2546
     */
    ...
    /**
     * @aspect Derivatives
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaMiddleEnd\\src\\jastadd\\structural\\Differentiation.jrag:473
     */
    @Override
    ...
    public FModFuncExp(List<InstFunctionArgument> p0, FExp p1, FExp p2) {
        setChild(p0, 0);
        setChild(p1, 1);
        setChild(p2, 2);
    }
     ...
     */
    public FModFuncExp clone() throws CloneNotSupportedException {
        FModFuncExp node = (FModFuncExp) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:48
     */
    public FModFuncExp copy() {
        try {
            FModFuncExp node = (FModFuncExp) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    public FModFuncExp treeCopyNoTransform() {
        FModFuncExp tree = (FModFuncExp) copy();
        if (children != null) {
    ...
    public CValue cevalCalc(VariableEvaluator evaluator) {
        CValue cevalCalc_VariableEvaluator_value = type().sub(getX().ceval(evaluator), type().mul(type().div(getX().ceval(evaluator), getY().ceval(evaluator)).convertInteger(),    getY().ceval(evaluator)));
