...
/**
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\ast\\InstanceTree.ast:194
 * @astdecl InstArgument : InstModification ::= <Each:boolean> <Final:boolean>;
 * @production InstArgument : {@link InstModification} ::= <span class="component">&lt;Each:boolean&gt;</span> <span class="component">&lt;Final:boolean&gt;</span>;

 */
public abstract class InstArgument extends InstModification implements Cloneable {
    /**
     * @aspect FlatTypeCheck
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\errorcheck\\TypeCheck.jrag:401
     */
    ...
    @ASTNodeAnnotation.Constructor(
        name = {"SrcModification", "Each", "Final"},
        type = {"SrcModificationOrRedeclareElement", "boolean", "boolean"},
        kind = {"Token", "Token", "Token"}
    )
    public InstArgument(SrcModificationOrRedeclareElement p0, boolean p1, boolean p2) {
     ...
     */
    public InstArgument clone() throws CloneNotSupportedException {
        InstArgument node = (InstArgument) super.clone();
        return node;
    }
    /**
     ...
     */
    @Deprecated
    public abstract InstArgument fullCopy();
    /**
     * Create a deep copy of the AST subtree at this node.
     * The copy is dangling, i.e. has no parent.
     * @return dangling copy of the subtree at this node
     ...
     */
    public abstract InstArgument treeCopyNoTransform();
    /**
     * Create a deep copy of the AST subtree at this node.
     ...
     */
    public abstract InstArgument treeCopy();
    /**
    ...
    /** @apilevel internal 
     */
    protected boolean tokenboolean_Each;
    /**
    ...
    public boolean hasEach() {
        boolean hasEach_value = getEach() || inModWithEach();
    ...
    public boolean isFinal() {
        boolean isFinal_value = getFinal() || inheritsFinal();
