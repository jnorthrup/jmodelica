 ...
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\ast\\FlatModelica.ast:649
 * @astdecl FDerivatedInitArrayStmt : FInitArrayStmt ::= <Order:int>;
 * @production FDerivatedInitArrayStmt : {@link FInitArrayStmt} ::= <span class="component">&lt;Order:int&gt;</span>;

 */
public class FDerivatedInitArrayStmt extends FInitArrayStmt implements Cloneable {
    /**
     * @declaredat ASTNode:1
     */
    public FDerivatedInitArrayStmt() {
        super();
    }
    /**
    ...
    @ASTNodeAnnotation.Constructor(
        name = {"FAccessExp", "Order"},
        type = {"FAccessExp", "int"},
        kind = {"Child", "Token"}
    )
    public FDerivatedInitArrayStmt(FAccessExp p0, int p1) {
        setChild(p0, 0);
        setOrder(p1);
    }
    /** @apilevel low-level 
     ...
     */
    public FDerivatedInitArrayStmt clone() throws CloneNotSupportedException {
        FDerivatedInitArrayStmt node = (FDerivatedInitArrayStmt) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:46
     */
    public FDerivatedInitArrayStmt copy() {
        try {
            FDerivatedInitArrayStmt node = (FDerivatedInitArrayStmt) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    @Deprecated
    public FDerivatedInitArrayStmt fullCopy() {
     ...
     */
    public FDerivatedInitArrayStmt treeCopyNoTransform() {
        FDerivatedInitArrayStmt tree = (FDerivatedInitArrayStmt) copy();
        if (children != null) {
     ...
     */
    public FDerivatedInitArrayStmt treeCopy() {
        doFullTraversal();
        return treeCopyNoTransform();
    }
    /** @apilevel internal 
    ...
    protected boolean is$Equal(ASTNode node) {
        return super.is$Equal(node) && (tokenint_Order == ((FDerivatedInitArrayStmt) node).tokenint_Order);    
    }
    /**
