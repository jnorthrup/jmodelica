 ...
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\ast\\FlatModelica.ast:1532
 * @astdecl FCross : FBuiltInFunctionCall ::= X:FExp Y:FExp;
 * @production FCross : {@link FBuiltInFunctionCall} ::= <span class="component">X:{@link FExp}</span> <span class="component">Y:{@link FExp}</span>;

 */
public class FCross extends FBuiltInFunctionCall implements Cloneable {
    /**
     * @aspect InheritedFactoryMethods
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:1041
     */
    public FCross createEmptyNode()           { return new FCross();           }
    /**
     * @aspect InheritedFactoryMethods
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:1402
     */
    public FCross(FExp a1, FExp a2)               { this(emptyArgs(), a1, a2); }
    /**
     * @aspect FlatExpressions
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\flattening\\Flattening.jrag:2631
     */
    public FCross flatten(Flattener f)        { return new FCross(getX().flatten(f), getY().flatten(f)); }
    /**
     * @aspect FunctionScalarization
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaMiddleEnd\\src\\jastadd\\scalarization\\ScalarizeFunctions.jrag:722
     */
    ...
    /**
     * @aspect Derivatives
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaMiddleEnd\\src\\jastadd\\structural\\Differentiation.jrag:662
     */
    @Override
    ...
    public FCross(List<InstFunctionArgument> p0, FExp p1, FExp p2) {
        setChild(p0, 0);
        setChild(p1, 1);
        setChild(p2, 2);
    }
     ...
     */
    public FCross clone() throws CloneNotSupportedException {
        FCross node = (FCross) super.clone();
        return node;
    }
    /** @apilevel internal 
     ...
     */
    public FCross treeCopyNoTransform() {
        FCross tree = (FCross) copy();
        if (children != null) {
    ...
    public String builtInName() {
        String builtInName_value = "cross";
    ...
    public FType type() {
        ...
        boolean isFinal = this.is$Final();
        state().enterLazyAttribute();
        type_value = getX().type().numericPromotion(getY().type());
        if (isFinal && _boundaries == state().boundariesCrossed) {
        type_computed = true;
