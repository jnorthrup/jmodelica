 ...
 * @ast class
 * @aspect Variability
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Variability.jrag:70
 */
 class CompositeVariability extends TypePrefixVariability {
    public String toString()  { return combine().toString(); }

    public String toStringLiteral() { return combine().toStringLiteral(); }
    ...
    public boolean compositeVariability() { return true; }

    protected int variabilityLevel() { return combine().variabilityLevel(); }

    public TypePrefixVariability combine() {
    ...
    public TypePrefixVariability combineDown() {
        TypePrefixVariability high = Variability.CONSTANT;
        for (TypePrefixVariability v : components.values()) {
    ...
    @Override
    public TypePrefixVariability combine(TypePrefixVariability other) {
        return combine(other, upCombiner);
    }

    @Override
    public TypePrefixVariability combineDown(TypePrefixVariability other) {
    ...
    public TypePrefixVariability combine(TypePrefixVariability other, Combiner combiner) {
    ...
    public TypePrefixVariability combinePropagate(TypePrefixVariability other) {
    ...
    public TypePrefixVariability combineInherit(TypePrefixVariability other) {
    ...
    public String genJMIVariabilityConstant_C() { return null; }
