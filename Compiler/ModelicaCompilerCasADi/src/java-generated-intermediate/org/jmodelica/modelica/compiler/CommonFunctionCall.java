 ...
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\ast\\FlatModelica.ast:1174
 * @astdecl CommonFunctionCall : FAbstractFunctionCall;
 * @production CommonFunctionCall : {@link FAbstractFunctionCall};

 */
public abstract class CommonFunctionCall extends FAbstractFunctionCall implements Cloneable {
    /**
     * @declaredat ASTNode:1
     */
    public CommonFunctionCall() {
        super();
    }
    /**
     ...
     */
    public CommonFunctionCall clone() throws CloneNotSupportedException {
        CommonFunctionCall node = (CommonFunctionCall) super.clone();
        return node;
    }
    /**
     ...
     */
    @Deprecated
    public abstract CommonFunctionCall fullCopy();
    /**
     * Create a deep copy of the AST subtree at this node.
     * The copy is dangling, i.e. has no parent.
     * @return dangling copy of the subtree at this node
     ...
     */
    public abstract CommonFunctionCall treeCopyNoTransform();
    /**
     * Create a deep copy of the AST subtree at this node.
     ...
     */
    public abstract CommonFunctionCall treeCopy();
    /**
    ...
    public boolean containsCommonFunctionCallExp() {
        boolean containsCommonFunctionCallExp_value = true;
        return containsCommonFunctionCallExp_value;
    }
    /**
     * @attribute syn
    ...
    public CommonVariableDecl findOutput(int i) {
        CommonVariableDecl findOutput_int_value = (i >= myCallOutputs().size()) ? unknownInstComponentDecl() : myCallOutputs().get(i);
    ...
    public Size sizeOfOutput(int i) {
        Size sizeOfOutput_int_value = typeOfOutput(i).size();
