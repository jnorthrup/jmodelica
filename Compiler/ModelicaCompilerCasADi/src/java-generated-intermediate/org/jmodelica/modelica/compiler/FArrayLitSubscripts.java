...
/**
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\ast\\FlatModelica.ast:432
 * @astdecl FArrayLitSubscripts : FArraySubscripts;
 * @production FArrayLitSubscripts : {@link FArraySubscripts};

 */
public class FArrayLitSubscripts extends FArraySubscripts implements Cloneable {
    /**
     * @aspect Arrays
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Arrays.jrag:104
     */
    private int[] subscripts = new int[0];
    /**
     * @aspect Arrays
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Arrays.jrag:111
     */
    ...
    /**
     * @aspect Arrays
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Arrays.jrag:119
     */
    public Iterable<Subscript> subscripts() {
        java.util.List<Subscript> list = new ArrayList<>(subscripts.length);
        for (int i : subscripts) {
            list.add(new IntegerSubscript(i));
        }
        return list;
    }
    /**
     * @aspect Arrays
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Arrays.jrag:134
     */
    public FArrayExpSubscripts copyAsFArrayExpSubscripts() {
        FSubscript[] list = new FSubscript[subscripts.length];
        for (int i = 0; i < list.length; i++) {
            list[i] = new FIntegerSubscript(subscripts[i]);
        }
        return new FArrayExpSubscripts(new List(list));
    }
    /**
     * @aspect ArrayHelpers
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Arrays.jrag:4576
     */
    public void expIndices(ArrayList<int[]> newInd, boolean[] newTrim, int offset) {
        for (int k = 0; k < subscripts.length; k++) {
            int[] i = subscript(k).myIndices();
            newInd.add(i);
     ...
     * @aspect Constructors
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:793
     */
    public FArrayLitSubscripts(Index i, int j, int n) {
		this();
    ...
    /**
     * @aspect Constructors
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:800
     */
    public FArrayLitSubscripts(int... subscripts) {
        this();
        this.subscripts = Arrays.copyOf(subscripts, subscripts.length);
    }
    /**
     * @aspect Constructors
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:816
     */
    ...
    /**
     * @aspect Constructors
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:830
     */
    ...
    /**
     * @aspect SizesUtil
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Sizes.jrag:594
     */
     ...
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFrontEnd\\src\\jastadd\\errorcheck\\ErrorCheck.jrag:1193
     */
     ...
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaCBackEnd\\src\\jastadd\\CCodeGen\\CCodeGenExpressions.jrag:753
     */
     ...
     */
    public FArrayLitSubscripts clone() throws CloneNotSupportedException {
        FArrayLitSubscripts node = (FArrayLitSubscripts) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:36
     */
    public FArrayLitSubscripts copy() {
        try {
            FArrayLitSubscripts node = (FArrayLitSubscripts) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    @Deprecated
    public FArrayLitSubscripts fullCopy() {
     ...
     */
    public FArrayLitSubscripts treeCopyNoTransform() {
        FArrayLitSubscripts tree = (FArrayLitSubscripts) copy();
        if (children != null) {
     ...
     */
    public FArrayLitSubscripts treeCopy() {
        doFullTraversal();
        return treeCopyNoTransform();
    }
    /** @apilevel internal 
    ...
    public Subscript subscript(int i) {
        Subscript subscript_int_value = new IntegerSubscript(subscripts[i]);
    ...
    public Size accessSize() {
        Size accessSize_value = Size.SCALAR;
    ...
    public boolean hasUnknownIndices() {
        boolean hasUnknownIndices_value = false;
