 ...
 * @ast node
 * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\ast\\FlatModelica.ast:1163
 * @astdecl FInStreamEpsExp : FAbstractScalarExp;
 * @production FInStreamEpsExp : {@link FAbstractScalarExp};

 */
public class FInStreamEpsExp extends FAbstractScalarExp implements Cloneable {
    /**
     * @aspect InheritedFactoryMethods
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\Constructors.jrag:967
     */
    public FInStreamEpsExp createEmptyNode() { return new FInStreamEpsExp(); }
    /**
     * @aspect FlatPrettyPrint
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaFlatTree\\src\\jastadd\\PrettyPrint.jrag:1651
     */
    ...
    /**
     * @aspect Derivatives
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaMiddleEnd\\src\\jastadd\\structural\\Differentiation.jrag:596
     */
    @Override
     ...
     * @declaredat C:\\stuff\\workspace\\JModelica\\Compiler\\ModelicaCBackEnd\\src\\jastadd\\CCodeGen\\CCodeGenExpressions.jrag:363
     */
    @Override
     ...
     */
    public FInStreamEpsExp clone() throws CloneNotSupportedException {
        FInStreamEpsExp node = (FInStreamEpsExp) super.clone();
        return node;
    }
    /** @apilevel internal 
     * @declaredat ASTNode:36
     */
    public FInStreamEpsExp copy() {
        try {
            FInStreamEpsExp node = (FInStreamEpsExp) clone();
            node.parent = null;
            if (children != null) {
     ...
     */
    @Deprecated
    public FInStreamEpsExp fullCopy() {
     ...
     */
    public FInStreamEpsExp treeCopyNoTransform() {
        FInStreamEpsExp tree = (FInStreamEpsExp) copy();
        if (children != null) {
     ...
     */
    public FInStreamEpsExp treeCopy() {
        doFullTraversal();
        return treeCopyNoTransform();
    }
    /** @apilevel internal 
    ...
    public CValue cevalCalc(VariableEvaluator evaluator) {
        CValue cevalCalc_VariableEvaluator_value = evaluator.inStreamEpsilon();
