...
fclass IndexReduction.IndexReduction2_Mechanical
 ...
 Modelica.SIunits.Torque idealGear.support.tau "Cut torque in the flange";
 ...
 parameter Real sine.offset = 0 "Offset of output signal y" /* 0 */;
 parameter Modelica.SIunits.Time sine.startTime = 0 "Output y = offset for time < startTime" /* 0 */;
 ...
 parameter Modelica.SIunits.Angle idealGear.support.phi "Absolute rotation angle of flange";
 parameter Modelica.SIunits.Angle torque.support.phi "Absolute rotation angle of flange";
